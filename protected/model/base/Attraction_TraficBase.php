...
class Attraction_TraficBase extends DooModel {
    ...
    public $_fields = array('id', 'id_tours', 'type_tour', 'id_park', 'group', 'creation_date', 'starting_date', 'ending_date', 'admission', 'trafic', 'id_cliente', 'type_client', 'id_agencia', 'adult', 'child', 'total_person', 'admission_child', 'admission_adtul', 'totalAdmission', 'precio_varios','cantidad','v_p_child','v_p_adult','transpor_adult','transpor_child','totalTraspor', 'total_paid');
