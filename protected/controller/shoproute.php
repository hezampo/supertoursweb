...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php }
                                    ...
                                    <?php
                                    if (isset($booking['trip_no2']) && $booking['trip_no2'] != "N/A") {
                                                ...
                                                <tr>
                                                    <td width="381"><p><input type="radio" name="pago" id="voucher"  value="voucher">
                                                                ...
                                                                <p>  <div id="agencia" style="display: none;">Agency Name:
                                                                        <input name="agencia" size="20" maxlength="10" class="input-text" id="agencia1" /><p>Other Amount $<input name="amount" size="20" maxlength="10" class="input-text" id="amount1"  value="<?php echo $booking['totaltotal']; ?>"/> </p></div>
