...
//                    $login->address = $signup->address;
    ...
    public function load() {//esta función es la que guarda en la bd después del pago
       ...
       //$approval='';//comentarlas para pasar pago
...
CASE
 ...
 From ( " . $sql . " )as ms  LEft JOIN ( " . $sql_net . " ) as k ON (ms.trip_no = k.trip_no)";
                ...
                $fec_salida = date($booking['fecha_salida']);
                $fec_retorno = date($booking['fecha_retorno']);
                $y = date('Y');
                $limitDate = '12-31-'.$y;
                ...
                if ($booking["tipo_ticket"] == "oneway") {
                    ...
                    //Departure 300
                    if($booking["extension1"]=="12" && $booking["trip_no"]=="300" && $booking["fromt"]=="1"){//Universal Resort
                      if ($c == $limitDate) {
                        $booking["trip_departure"]="15:30:0";
                        }else{
                         
                            if($fec_salida <= '02-29-2020'){                            
                                $booking["trip_departure"]="18:30:0";                            
                            }                            
                            if($fec_salida >= '03-01-2020'){                          
                                $booking["trip_departure"]="18:20:0";                            
                            }
                        }
                    }else if($booking["extension1"]=="11" && $booking["trip_no"]=="300" && $booking["fromt"]=="1"){//International Drive
                      if ($c == $limitDate) {
                        $booking["trip_departure"]="15:30:0";
                        }else{
                            if($fec_salida <= '02-29-2020'){  
                    ...
                    }else if($booking["extension1"]=="13" && $booking["trip_no"]=="300" && $booking["fromt"]=="1"){//Walt Disney Resort
                      if ($c == $limitDate) {
                    ...
                    //arrival 301
                    if($booking["extension3"]=="12" && $booking["trip_no"]=="301" && $booking["tot"]=="1"){//universal resort
                        if($fec_salida <= '02-29-2020'){ 
                    ...
                    }else if($booking["extension3"]=="11" && $booking["trip_no"]=="301" && $booking["tot"]=="1"){//international drive
                        if($fec_salida <= '02-29-2020'){ 
                            $booking["trip_arrival"]="10:20:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                    ...
                    }else if($booking["extension3"]=="13" && $booking["trip_no"]=="301" && $booking["tot"]=="1"){//walt disney resort
                        if($fec_salida <= '02-29-2020'){ 
                            $booking["trip_arrival"]="10:30:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                            $booking["trip_arrival"]="10:45:0";
                        }
                    }

                    //Departure 200
                    if($booking["extension1"]=="12" && $booking["trip_no"]=="200" && $booking["fromt"]=="1"){//universal resort
                        $booking["trip_departure"]="11:20:0";
                    }else if($booking["extension1"]=="11" && $booking["trip_no"]=="200" && $booking["fromt"]=="1"){//int drive
                        $booking["trip_departure"]="11:20:0";
                    }else if($booking["extension1"]=="13" && $booking["trip_no"]=="200" && $booking["fromt"]=="1"){//walt disney resort
                        $booking["trip_departure"]="11:00:0";
                    }
                    //Departure 201
                    if(($booking["pickup1"]=="179") && $booking["trip_no"]=="201" && $booking["fromt"]=="9"){
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_departure"]="18:15:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                            $booking["trip_departure"]="18:10:0";
                        }
                        
                    }
                    
                    if(($booking["pickup1"]=="112") && $booking["trip_no"]=="201" && $booking["fromt"]=="9"){
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_departure"]="18:10:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                            $booking["trip_departure"]="18:05:0";
                        }
                        
                    }
                    //arrival 201
                    if($booking["extension3"]=="12" && $booking["trip_no"]=="201" && $booking["tot"]=="1"){//universal resort
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_arrival"]="23:15:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                            $booking["trip_arrival"]="23:45:0";
                        }
                    }else if($booking["extension3"]=="11" && $booking["trip_no"]=="201" && $booking["tot"]=="1"){//int drive
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_arrival"]="23:15:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                    ...
                    }else if($booking["extension3"]=="13" && $booking["trip_no"]=="201" && $booking["tot"]=="1"){//walt disney resort
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_arrival"]="23:30:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                            $booking["trip_arrival"]="23:59:0";
                        }
                    }
                    //Departure 100
                    if($booking["extension1"]=="12" && $booking["trip_no"]=="100" && $booking["fromt"]=="1"){//universal resort                        
                        $booking["trip_departure"]="6:30:0";                       
                    }else if($booking["extension1"]=="11" && $booking["trip_no"]=="100" && $booking["fromt"]=="1"){//int drive
                        $booking["trip_departure"]="6:30:0";
                    }else if($booking["extension1"]=="13" && $booking["trip_no"]=="100" && $booking["fromt"]=="1"){//walt disney resort
                        $booking["trip_departure"]="6:00:0";
                    }
                    //Departure 101
                    if(($booking["pickup1"]=="179") && $booking["trip_no"]=="101" && $booking["fromt"]=="9"){
                        
                            if($fec_salida <= '02-29-2020'){   
                                $booking["trip_departure"]="14:45:0";
                            }
                            if($fec_salida >= '03-01-2020'){                          
                                    $booking["trip_departure"]="13:10:0";                            
                            }
                    }
                    if(($booking["pickup1"]=="112") && $booking["trip_no"]=="101" && $booking["fromt"]=="9"){
//                        $booking["trip_departure"]="13:05:0";
                            if($fec_salida <= '02-29-2020'){   
                                $booking["trip_departure"]="14:40:0";
                            }
                            if($fec_salida >= '03-01-2020'){                          
                                    $booking["trip_departure"]="13:05:0";                            
                            }
                    ...
                    //arrival 101
                    if($booking["extension3"]=="12" && $booking["trip_no"]=="101" && $booking["tot"]=="1"){//universal resort
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_arrival"]="19:45:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                            $booking["trip_arrival"]="18:45:0";
                        }
                    }else if($booking["extension3"]=="11" && $booking["trip_no"]=="101" && $booking["tot"]=="1"){//int drrive
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_arrival"]="19:45:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                    ...
                    }else if($booking["extension3"]=="13" && $booking["trip_no"]=="101" && $booking["tot"]=="1"){//walt disney resort
                        
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_arrival"]="20:00:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                            $booking["trip_arrival"]="19:00:0";
                        }
...
//                    echo '</pre>';
                    ...
                    }else if($booking["extension1"]=="11" && $booking["trip_no"]=="300" && $booking["fromt"]=="1"){//int drive
                        if ($c == $limitDate) {
                                $booking["trip_departure"]="15:30:0";
                        }else{
                                if($fec_salida <= '02-29-2020'){
                    ...
                    if($booking["extension2"]=="12" && $booking["trip_no2"]=="300" && $booking["tot"]=="1"){//universal resort
                        if ($c == $limitDate) {
                                $booking["trip_departure"]="15:30:0";
                        }else{
                                if($fec_retorno <= '02-29-2020'){
                                    $booking["trip_departure2"]="18:30:0";     
                                }
                                if($fec_retorno >= '03-01-2020'){
                                    $booking["trip_departure2"]="18:20:0";     
                                }
                                
			}
                    }else if($booking["extension2"]=="11" && $booking["trip_no2"]=="300" && $booking["tot"]=="1"){//int drive
                        if ($c == $limitDate) {
                                $booking["trip_departure"]="15:30:0";
                        }else{
                                if($fec_retorno <= '02-29-2020'){
                    ...
                    }else if($booking["extension2"]=="13" && $booking["trip_no2"]=="300" && $booking["tot"]=="1"){//walt disney resort
                        if ($c == $limitDate) {
                                $booking["trip_departure"]="15:00:0";
                        }else{
                    ...
                    //Departure 301
                    if($booking["pickup1"]=="7" && $booking["trip_no"]=="301" && $booking["fromt"]=="7"){//Ramada plaza Marco Polo
                        $booking["trip_departure"]="06:00:0";
                    }else if($booking["pickup1"]=="16" && $booking["trip_no"]=="301" && $booking["fromt"]=="7"){//Newport Beachside hotel
                        $booking["trip_departure"]="05:50:0";
                    }
                    if($booking["pickup2"]=="7" && $booking["trip_no2"]=="301" && $booking["tot"]=="7"){//Ramada Plaza Marco Polo
                        $booking["trip_departure2"]="06:00:0";
                    }else if($booking["pickup2"]=="16" && $booking["trip_no2"]=="301" && $booking["tot"]=="7"){//Newport Beachside hotel
                    ...
                    }else if($booking["extension3"]=="11" && $booking["trip_no"]=="301" && $booking["tot"]=="1"){//int Drive
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_arrival"]="10:20:0";
                        }
                        if($fec_salida >= '03-01-2020'){
                    ...
                    if($booking["extension4"]=="12" && $booking["trip_no2"]=="301" && $booking["fromt"]=="1"){//universal resort
                        if($fec_retorno <= '02-29-2020'){
                    ...
                    }else if($booking["extension4"]=="11" && $booking["trip_no2"]=="301" && $booking["fromt"]=="1"){//int drive
                        if($fec_retorno <= '02-29-2020'){
                            $booking["trip_arrival2"]="10:20:0";
                        }
                        if($fec_retorno >= '03-01-2020'){
                    ...
                    }else if($booking["extension4"]=="13" && $booking["trip_no2"]=="301" && $booking["fromt"]=="1"){//walt disney resort
                        if($fec_retorno <= '02-29-2020'){
                            $booking["trip_arrival2"]="10:30:0";
                        }
                        if($fec_retorno >= '03-01-2020'){
                            $booking["trip_arrival2"]="10:45:0";
                        }
                    }
                    ...
                    //Departure 200
                    if($booking["extension1"]=="12" && $booking["trip_no"]=="200" && $booking["fromt"]=="1"){//universal resort                        
                            $booking["trip_departure"]="11:20:0";//ok                 
                    }else if($booking["extension1"]=="11" && $booking["trip_no"]=="200" && $booking["fromt"]=="1"){//int drive
                        $booking["trip_departure"]="11:20:0";
                    }else if($booking["extension1"]=="13" && $booking["trip_no"]=="200" && $booking["fromt"]=="1"){//wal disney resort
                        $booking["trip_departure"]="11:00:0";
                    }
                    if($booking["extension2"]=="12" && $booking["trip_no2"]=="200" && $booking["tot"]=="1"){//universal resort
                        $booking["trip_departure2"]="11:20:0";
                    }else if($booking["extension2"]=="11" && $booking["trip_no2"]=="200" && $booking["tot"]=="1"){//int drive
                        $booking["trip_departure2"]="11:20:0";
                    }else if($booking["extension2"]=="13" && $booking["trip_no2"]=="200" && $booking["tot"]=="1"){//walt disney resort
                        $booking["trip_departure2"]="11:00:0";
                    }
                    //Departure 201
                    if(($booking["pickup1"]=="179") && $booking["trip_no"]=="201" && $booking["fromt"]=="9"){//chesterfield
                    ...
                    if(($booking["pickup2"]=="179") && $booking["trip_no2"]=="201" && $booking["tot"]=="9"){//chesterfield
                        
                        if($fec_retorno <= '02-29-2020'){
                            $booking["trip_departure1"]="18:15:0";
                        }
                        if($fec_retorno >= '03-01-2020'){
                            $booking["trip_departure1"]="18:10:0";
                        }
                    ...
                    if(($booking["pickup2"]=="112") && $booking["trip_no2"]=="101" && $booking["tot"]=="9"){
                        if($fec_retorno <= '02-29-2020'){
                            $booking["trip_departure2"]="14:40:0";
                        }
                        
                        if($fec_retorno >= '03-01-2020'){
                            $booking["trip_departure2"]="13:05:0";
                        }
                    ...
                    if(($booking["pickup2"]=="179") && $booking["trip_no2"]=="101" && $booking["tot"]=="9"){
                        
                        if($fec_retorno <= '02-29-2020'){
                            $booking["trip_departure2"]="14:45:0";
                        }
                        if($fec_retorno >= '03-01-2020'){
                            $booking["trip_departure2"]="13:10:0";
                        }
                    }
                    ...
                    }else if($booking["extension3"]=="11" && $booking["trip_no"]=="101" && $booking["tot"]=="1"){//int drive
                        if($fec_salida <= '02-29-2020'){
                            $booking["trip_arrival"]="19:45:0";
                        }
                    ...
                    if($booking["extension4"]=="12" && $booking["trip_no2"]=="101" && $booking["fromt"]=="1"){//universal resort
                        if($fec_retorno <= '02-29-2020'){
                            $booking["trip_arrival2"]="19:45:0";
                        }
                        
                        if($fec_retorno >= '03-01-2020'){
                            $booking["trip_arrival2"]="18:45:0";
                        }
                    }else if($booking["extension4"]=="11" && $booking["trip_no2"]=="101" && $booking["fromt"]=="1"){//int drive
                        if($fec_retorno <= '02-29-2020'){
                            $booking["trip_arrival2"]="19:45:0";
                        }
                    ...
                    }else if($booking["extension4"]=="13" && $booking["trip_no2"]=="101" && $booking["fromt"]=="1"){//walt disney resort
                        if($fec_retorno <= '02-29-2020'){
                            $booking["trip_arrival2"]="20:00:0";
                        }
                        
                        if($fec_retorno >= '03-01-2020'){
                            $booking["trip_arrival2"]="19:00:0";
                        }
                    }
					/*echo '<pre><b>';
					 print_r($booking);
