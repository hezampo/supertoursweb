...
{  
    ...
    {        
        ...
        file_put_contents('PDF-E-T/E-TICKET-'.$this->name.'', $output);  
        
        file_put_contents('2021/SUMMARY/E-TICKET-'.$this->name.'', $output);
        
        //file_put_contents('../2018/SUMMARY/E-TICKET-'.$this->name.'', $output);
        // file_put_contents('../sur2019/SUMMARY/E-TICKET-'.$this->name.'', $output);
        
        //file_put_contents('../sur2019/2020/SUMMARY/E-TICKET-'.$this->name.'', $output);
        //Creamos el pdf
