<a id="top" name="top"></a>
        ...
        <div class="header"><strong>Doophp </strong><span class="boldy">i18n</span> demo. Klasse verwendet - <strong><span class="file"><a href="http://www.doophp.com/documentation/api/">DooController</a></span></strong><br/>
      </div>
...
<a style="color:#fff;text-decoration:none;padding-right:20px;" href="<?php echo $data['baseurl']; ?>index.php/home/?lang=de">de</a>
	  ...
	  <div class="nav">
	  	<ul>
			<li><a href="<?php echo $data['baseurl']; ?>index.php/about">Über@</a></li>
			<li><a href="<?php echo $data['baseurl']; ?>index.php/example">Beispiel@</a></li>
		</ul>
	  </div>