...
class ReserveBase extends DooModel {
    ...
    public $pax2;//child
    public $pax3;//infat
    public $pax_r;//adult retorno
    public $pax2_r;//child retorno
    public $pax3_r;//infat retorno
    public $id_clientes;
