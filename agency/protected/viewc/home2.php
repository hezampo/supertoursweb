...
<script type="text/javascript">
  window.location.href="<?php echo $data['rootUrl']; ?>login";
</script>
<META NAME="Title" CONTENT="Super Tours - Transportations Florida">
<META NAME="Author" CONTENT=" Super Tours ">
...
<div id="bannerslider">
 <div id="gallery">
	<a href="<?php echo $data['rootUrl']; ?>tours" class="show">
	...
	<a href="<?php echo $data['rootUrl']; ?>tours">
...
<table width="200" border="0" align="center" cellpadding="5" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" class="titulos2forms"><input name="fecha_salida" size="15" maxlength="10" class="input-text" id="fecha_salida" readonly="readonly" value="<?php echo date("m-d-Y")?>"/></td>
  </tr>
   <tr>
    ...
    <td colspan="2" class="titulos2forms"> <div class="form-row" id="dv_fr">  <input name="fecha_retorno" size="15" maxlength="10" class="input-text" id="fecha_retorno" readonly="readonly"  value="<?php echo date('m-d-Y',time()+84600);?>"/></div></td>
  </tr>
...
<div style="margin-left: 25px;"><flashrichtext version="1">  <textformat font="Verdana" size="11" color="734012" bold="false" italic="false" underline="false" url="" target="" align="left" leftMargin="0" rightMargin="0" indent="0" leading="2" blockIndent="0" kerning="false" letterSpacing="0" display="block"><script type="text/javascript" src="https://sealserver.trustwave.com/seal.js?style=invert&amp;code=w6oj3BfC7ZxlfsRNVXfZ1ih5gYY8Ww"></script> </textformat></flashrichtext><!--<img src="<?php echo $data['rootUrl']; ?>global/images/banner2.png" width="281" height="109" />--></div>
</div>
<div id="foot">
  <h4>Home   |   Our Company  |   My Superclub  |   Tickets Policy   &nbsp;|&nbsp;Baggage   | © 2012 Super Tours<br />
    Copyright ©  1989 - <?php echo date("Y"); ?> Supertours Of  Orlando. All Rights Reserved.  <br />
    <p align="right">Developed by Super Tours</p></h4>
</div>
</div> 
