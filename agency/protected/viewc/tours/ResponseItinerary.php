...
<strong><?php echo date("M-d-Y",strtotime($toursbooking['fecha_salida'])); ?></strong> Check Out Time is 11:00am.<?php  if( $desayuno!=0){ echo " FREE DAILY CONTINENTAL BREKFAST " ;} ?>. Taxes are Included.
<br>
...
Local Round Trip Transfers from your Hotel to
<?php echo "<ul>";
...
Date Arrival <strong><?php echo date("M-d-Y",strtotime($toursbooking['fecha_llegada'])); ?></strong> &#45;you have choosen <strong><?php echo date("h:i A",strtotime($toursbooking['hora1'])); ?></strong>, on a luxury private transportation from <strong><?php echo $toursbooking['city']; ?></strong>, <strong><?php echo $toursbooking['address']; ?></strong> , to <strong><?php echo $toursbooking['hotel']; ?></strong>. 
...
Date Arrival <strong><?php echo date("M-d-Y",strtotime($toursbooking['fecha_llegada'])); ?></strong> &#45 Arriving: By plane  at Orlando International Airport 
Data Transfer In  :   Airline: <strong><?php echo $toursbooking['airlinearrival']; ?></strong>   Flight #:   <strong><?php echo $toursbooking['flightarrival']; ?></strong> Arrival Time:<strong><?php echo date("h:i A",strtotime($toursbooking['hora1'])); ?></strong>
. You will be greeted by your tour guide/driver in orlando to take you to  <strong><?php echo $toursbooking['hotel']; ?></strong>
<hr>
<strong > <div align="left" > ACCOMMODATION</div></strong>
<br>
Hotel accommodation at the <strong><?php echo $toursbooking['hotel']; ?></strong> in <strong><?php echo $toursbooking['rooms']; ?></strong> room(s). for <strong><?php echo $toursbooking['noches']; ?></strong> night(s) from <strong><?php echo date("M-d-Y",strtotime($toursbooking['fecha_llegada'])); ?></strong> Check In Time is 4:00pm . To
...
Date Arrival <strong><? echo date("M-d-Y",strtotime($toursbooking['fecha_llegada'])); ?></strong>7 � Arriving: By Car     - Estimated arrival time to Orlando: <strong><? echo date("h:s A",strtotime($toursbooking['hora1'])); ?></strong> -->
...
<?php
  ...
  <hr>
     ...
     <?php } ?> 
         ...
         <br>
          Date departure <strong><?php echo date("M-d-Y",strtotime($toursbooking['fecha_salida'])); ?></strong> &#45; <strong><?php echo date("g:i A",strtotime($toursbooking ['datedeparturetrip2'])); ?></strong> &#45;  Trip <strong><?php echo $toursbooking['trip2']; ?></strong>, Luxury <strong><?php echo $toursbooking['equipment2']; ?></strong> &#45; transportation from Orlando Super Tours Terminal <strong> <?php echo $area2.' - '.$pickup2; ?></strong> arriving at <strong><?php echo date("g:i A",strtotime($toursbooking ['datearrivingtrip2'])); ?></strong>, Thank you for choosing us !. <br />
          <?php } ?>
          <?php if($toursbooking['sdeparture'] == 2){?>
          		<strong > <div align="left" > ITINERARY DEPARTURE</div></strong>
         <br>
Date departure <strong><?php echo date("M-d-Y",strtotime($toursbooking['fecha_salida'])); ?></strong> &#45; Time:  <strong><?php echo date("h:s A",strtotime($toursbooking['hora2'])); ?></strong>, on a luxury private transportation from <strong><?php echo $toursbooking['city2']; ?></strong>, <strong><?php echo $toursbooking['address2']; ?></strong>, to MIAMI 
...
Transfer Out:   Airline: <strong><?php echo $toursbooking['airlinedeparture']; ?></strong>   Flight #:   <strong><?php echo $toursbooking['flightdeparture']; ?></strong> Departure Time: <strong><?php echo date("h:i A",strtotime($toursbooking['hora2'])); ?></strong>
