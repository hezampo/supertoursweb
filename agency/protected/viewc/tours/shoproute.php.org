...
<?php echo ($_SESSION['toursbooking']['sarrival']==4)?'LOCAL TRANSFERS TO PARKS BY CAR':'LOCAL TRANSFERS TO PARKS';?>&nbsp;</td>
  ...
  <tr>
    ...
    <table id="tableorder"  width="96%">
      <tr>
        <td height="" colspan="6"  ><div align="right" ><strong><? echo $toursbooking['adults'];?></strong> ADULTS AND <strong><? echo $toursbooking['childs'];?></strong> CHILDREN TOTAL OF <strong><? echo $toursbooking['totalpax'];?></strong> PASSENGERS </div></td>
        </tr>
     ...
     $('input[type="radio"]').change(function(){   
		 if($(this).get(0).name=='opcion_pago'){
		  <?php $pagof = $toursbooking['tqp']*$toursbooking['totalpax'];  
			 ...
			 if($(this).val()=='5'){
				  <?php 
						if($toursbooking['totaltotal']>$disponible){
							?>
