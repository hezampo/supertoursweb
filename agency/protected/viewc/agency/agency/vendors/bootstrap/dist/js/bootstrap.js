...
+function ($jq) {
  ...
  $jq.fn.emulateTransitionEnd = function (duration) {
    ...
    var callback = function () { if (!called) $jq($el).trigger($.support.transition.end) }
...
+function ($) {
  ...
  Alert.prototype.close = function (e) {
    ...
    var $parent = $jq(document).find(selector)
...
+function ($) {
  ...
  $jq(document)
    .on('click.bs.button.data-api', '[data-toggle^="button"]', function (e) {
      var $btn = $jq(e.target).closest('.btn')
      Plugin.call($btn, 'toggle')
      if (!($jq(e.target).is('input[type="radio"], input[type="checkbox"]'))) {
    ...
    .on('focus.bs.button.data-api blur.bs.button.data-api', '[data-toggle^="button"]', function (e) {
      $jq(e.target).closest('.btn').toggleClass('focus', /^focus(in)?$/.test(e.type))
    })
...
+function ($) {
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    if (this.$indicators.length) {
      ...
      var $nextIndicator = $jq(this.$indicators.children()[this.getItemIndex($next)])
  ...
  var clickHandler = function (e) {
    ...
    var $target = $jq(document).find(target)
...
+function ($) {
  ...
  var Collapse = function (element, options) {
    ...
    this.$trigger      = $jq('[data-toggle="collapse"][href="#' + element.id + '"],' +
  ...
  Collapse.prototype.getParent = function () {
    return $jq(document).find(this.options.parent)
  ...
  function getTargetFromTrigger($trigger) {
    ...
    return $jq(document).find(target)
  }
...
+function ($) {
  ...
  function getParent($this) {
    ...
    var $parent = selector !== '#' ? $jq(document).find(selector) : null
...
+function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    this.$dialog.on('mousedown.dismiss.bs.modal', function () {
      that.$element.one('mouseup.dismiss.bs.modal', function (e) {
        if ($jq(e.target).is(that.$element)) that.ignoreBackdropClick = true
      })
    })
  ...
  Modal.prototype.resize = function () {
    if (this.isShown) {
      $jq(window).on('resize.bs.modal', $.proxy(this.handleUpdate, this))
    } else {
  ...
  Modal.prototype.backdrop = function (callback) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.$backdrop = $jq(document.createElement('div'))
  ...
  Modal.prototype.setScrollbar = function () {
    ...
    if (this.bodyIsOverflowing) {
      ...
      $jq(this.fixedContent).each(function (index, element) {
        var actualPadding = element.style.paddingRight
        var calculatedPadding = $jq(element).css('padding-right')
        $jq(element)
  ...
  Modal.prototype.resetScrollbar = function () {
    ...
    $jq(this.fixedContent).each(function (index, element) {
      var padding = $jq(element).data('padding-right')
      $jq(element).removeData('padding-right')
...
+function ($) {
  ...
  function allowedAttribute(attr, allowedAttributeList) {
    ...
    var regExp = $jq(allowedAttributeList).filter(function (index, value) {
  ...
  function sanitizeHtml(unsafeHtml, whiteList, sanitizeFn) {
    ...
    var elements = $jq(createdDocument.body).find('*')
  ...
  Tooltip.prototype.init = function (type, element, options) {
    ...
    this.$viewport = this.options.viewport && $jq(document).find($.isFunction(this.options.viewport) ? this.options.viewport.call(this, this.$element) : (this.options.viewport.selector || this.options.viewport))
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      this.options.container ? $tip.appendTo($jq(document).find(this.options.container)) : $tip.insertAfter(this.$element)
  ...
  Tooltip.prototype.tip = function () {
    if (!this.$tip) {
      this.$tip = $jq(this.options.template)
...
+function ($) {
  ...
  Popover.DEFAULTS = $.extend({}, $jq.fn.tooltip.Constructor.DEFAULTS, {
    placement: 'right',
    trigger: 'click',
    content: '',
  ...
  Popover.prototype = $.extend({}, $jq.fn.tooltip.Constructor.prototype)
...
+function ($) {
  ...
  function ScrollSpy(element, options) {
    this.$body          = $jq(document.body)
    this.$scrollElement = $jq(element).is(document.body) ? $jq(window) : $jq(element)
...
+function ($) {
  ...
  Tab.prototype.show = function () {
    ...
    var $target = $jq(document).find(selector)
...
+function ($) {
  ...
  var Affix = function (element, options) {
    ...
    var target = this.options.target === Affix.DEFAULTS.target ? $jq(this.options.target) : $jq(document).find(this.options.target)
