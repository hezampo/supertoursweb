...
<div id="contenedor">    
<div id="header">
<div id="logo"><a href="<?php echo $data['rootUrl']; ?>"><img src="<?php echo $data['rootUrl']; ?>global/images/logo.png" width="316" height="119" border="0" /></a>
</div>
...
<div id="iconsbar">
  <div id="iconobar"><img src="<?php echo $data['rootUrl']; ?>global/images/icon4.jpg" width="62" height="37" /></div>
  <div id="textbar">DVD MOVIES</div></div>
<div id="titusbar"></div>
