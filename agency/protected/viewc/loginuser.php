...
<div id="login"> 
            ...
            <div id="bd-login">
                ...
                <form name="form1" action="<?php echo $data['rootUrl']; ?>booking/pickup-dropoff/autentication/login" method="post">
                    <div id="user-info">
...
<a href="<?php echo $data['rootUrl']; ?>booking/pickup-dropoff/autentication/signup">signup</a></div> <br />
