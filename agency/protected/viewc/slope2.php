 ...
 <div id="header">
  ...
  <div id="content">
    ...
    <div id="center-column" align="center">
       <p align="center"><h1>EMAIL/ USERNAME ALREADY REGISTERED</h1>
       <p align="center"> <button  class="btn" id="btn-cancel" type="button">Back</button> </p>
      </p>
...
$('#btn-cancel').click(function(){
       window.location = '<?php echo $data['rootUrl']; ?>booking/pickup-dropoff/autentication/signup';
    })
