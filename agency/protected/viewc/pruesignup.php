 ...
 <div id="header">
  ...
  <div id="content">
     ...
     <div id="center-column">
              <blockquote>
                <blockquote>
                  <form id="form1" class="form" action="<?php echo $data['rootUrl']; ?>booking/pickup-dropoff/autentication/signup/save" method="post" name="form1">
                    <div id="users" >
  <table width="840" border="0">
    ...
    <tr>
      ...
      <td  id="tdrojo" width="24%"><input type="text" name="username" id="username" size="25" maxlength="50" value="<?php echo (isset($_SESSION['signup2'])? $signup2->username :''); ?>"/></td>
      <td>&nbsp;</td>
      ...
      <td id="tdrojo" width="46%"><span class="input">
        <input name="address" type="text"  id="address" size="25" maxlength="25"  value="<?php echo (isset($_SESSION['signup2'])? $signup2->address :''); ?>" />
        </span></td>
    </tr>
    <tr>
      <td height="31">&nbsp;</td>
      ...
      <td id="tdrojo"><span class="input">
        <input name="city" type="text"  id="city" size="20" maxlength="20"  value="<?php echo (isset($_SESSION['signup2'])? $signup2->city :''); ?>" />
        </span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      ...
      <td id="tdrojo"><span class="input">
        <input name="zip" type="text"  id="zip" size="25" maxlength="25"  value="<?php echo (isset($_SESSION['signup2'])? $signup2->zip :''); ?>" />
        </span></td>
    </tr>
    <tr>
      <td height="32">&nbsp;</td>
      ...
      <td id="tdrojo"><span class="input">
        <input type="text" name="firstname" id="firstname" size="25" maxlength="20" value="<?php echo (isset($_SESSION['signup2'])? $signup2->firstname :''); ?>"/>
      </span></td>
      <td>&nbsp;</td>
      <td id="tdgris"><span class="required" id="phone1" style="width:150px">Phone</span></td>
      <td id="tdrojo"><span class="input">
        <input name="phone" type="text"  id="phone" size="25" maxlength="20"  value="<?php echo (isset($_SESSION['signup2'])? $signup2->phone :''); ?>" />
        </span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      ...
      <td id="tdrojo"><span class="input">
        <input name="lastname" type="text" id="lastname" size="25" maxlength="20" value="<?php echo (isset($_SESSION['signup2'])? $signup2->lastname :''); ?>" />
      </span></td>
      <td>&nbsp;</td>
      ...
      <td id="tdrojo"><span class="input">
        <input name="celphone" type="text"  id="celphone" size="25" maxlength="20"  value="<?php echo (isset($_SESSION['signup2'])? $signup2->celphone :''); ?>" />
        </span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
<script type="text/javascript">
       ...
       window.location = '<?php echo $data['rootUrl']; ?>booking/pickup-dropoff/autentication';
    })
