...
<div id="header_page" >
    <div class="header">Traffic Type Tickets</div>
        ...
        <div class="toolbar-list">
            <ul>
                ...
                <li class="btn-toolbar">
                    <a href="<?php echo $data['rootUrl']; ?>admin/traffic/type_tickets/add" id="btn-add" class="link-button">
                ...
                <li class="btn-toolbar">
                    <a href="<?php echo $data['rootUrl']; ?>admin/traffic/type_tickets/edit" id="btn-edit" class="link-button" >
...
<div id="content_page_tours">
    <div id="data_grid">
        ...
        <tbody>
            <? $i = 0; ?>
            <? foreach($data['all_type_tickets'] as $type_ticket): ?>
                <tr class="row<? echo $i; ?>">
                    <td><label><input name="item" type="radio" value="<? echo $type_ticket->id; ?>" /></label></td>
                    <td><? echo $type_ticket->type; ?></td>
                    <td><? echo $type_ticket->description; ?><input data-id="<? echo $type_ticket->id; ?>" class="bus_name" type="hidden" value="<? echo $type_ticket->description; ?>"></td>
                </tr>
            <?
                if ($i == 0){
                    $i = 1;
...
<form id="form_type_ticket_delete" method="post" action="<?php echo $data['rootUrl']; ?>admin/traffic/type_tickets/delete" style="display: none">
    <input type="hidden" name="id_bus" id="id_type_ticket_delete" value="">
</form>

<script type="text/javascript">
    $(document).ready(function(){
        $('.grid tr').click(function() {
            var id_type_ticket = $(this).find('input[name="item"]').val();
            $('#id_type_ticket_delete').val(id_type_ticket);
