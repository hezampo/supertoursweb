...
<form name="form1" method="post" action="<?php echo $data['rootUrl']; ?>admin/extension"  class="form" id="form1">
    <div id="header_page" >
            ...
            <div class="toolbar-list">
                <ul>
                    ...
                    <li class="btn-toolbar">
                        <a href="<?php echo $data['rootUrl']; ?>admin/extension/add" id="btn-add" class="link-button">
                    ...
                    <li class="btn-toolbar">
                        <a href="<?php echo $data['rootUrl']; ?>admin/extension/edit" id="btn-edit" class="link-button" >
                    ...
                    <li class="btn-toolbar">
                        <a href="<?php echo $data['rootUrl']; ?>admin/extension/delete" id="btn-delete" class="link-button">
...
<div id="form">
    <div id="filter-bar">
        ...
        <select name="filtro" id="filtro" class="select">
            <option value="place" <?php echo $data["filtro"] == 'place' ? 'selected' : '' ?>>Place</option>
            <option value="address" <?php echo $data["filtro"] == 'address' ? 'selected' : '' ?>>Address</option>
        </select>
    ...
    <div id="datagrid">
        ...
        <table class="grid" cellspacing="1" width="100%" id="grid">
            <thead>
                <tr>
                    <th width="31">&nbsp;</th>
                    <th width="280">Place</th>
                    <th width="173">Area</th>
                    <th width="150">Address</th>
                    <th width="150">Price</th>
                    <th width="150">Net Price</th>
            ...
            <tbody>
                ...
                foreach ($data["extension"] as $e) {
                    ...
                    <tr class="row<?php echo $i ?>">
                        ...
                        <td>$ <?php echo $e['precio_neto']; ?></td>
                        <td>$ <?php echo $e['precio_especial']; ?></td>
                    </tr>
                    <?php
                    $i = 1 - $i;
                }
