    ...
    <form id="form1" class="form" action="" method="post" name="form1">
        <div id="info-group" style="width: 900px;">
            ...
            <div id="reservation" style="border-color: #fff;width: 300px;">
                <div class="ho" style="color: #fff; background: #bb0000;"> <p style="margin-top:2px; text-align: center;"> RESERVATION #</p><span></span></div>
                                                ...
                                                <table width="100%"><tr>
                                                        ...
                                                        <td>
                                                            <div id="trip">
                                                                ...
                                                                <div>
                                                                <table><tr><td>
                                                                            <span><input class="field" name="a_trip_no" type="text" id="a_trip_no" size="3" maxlength="3" value="" style="margin-left: -36px; margin-top: -7px; position: absolute; height:22px; width:39px; color: #000; font-weight: bold; font-size: 16px; background-color: #fff;  border: 2px solid dodgerblue;" readonly="readonly"/>
                                                                ...
                                                                <div id="trip" style="margin-left:2px;">
                                                                    ...
                                                                    <table><tr><td>
                                                                                ...
                                                                                <a rel="superbox[ajax][<?php echo $data['rootUrl']; ?>admin/tours/trips/arrival][300x100]">
                                                                                    <img id="popup2" style="cursor:pointer; display: none;" src="<?php echo $data['rootUrl']; ?>global/images/search.png" /><i id="popup2" style="color: #fff; cursor:pointer; margin-left:-35px; position:absolute; margin-top:-42px;" class="fa fa-search-plus fa-2x" onclick="mostrarTrip2();cargando();"></i>
...
<!--                                        <div class="paymentvertblack" style="padding:9px;  text-align: center; margin-top: 9px;">
        ...
        <div id="save2" style="position:fixed; overflow: visible; z-index: 3000; margin-left: 395px; margin-top: -1654px; font-weight: bold; font-size: 39px; display:none;">                

                <i class="fa fa-spinner fa-pulse fa-4x fa-fw" style="color: #CE4233;"></i>

                <i style="margin-left: 61px; margin-top: -118px; position: absolute;" href='<?php echo $data['rootUrl'] ?>admin/tours/add/'><img src ='<?php echo $data['rootUrl'] ?>global/img/loading_trips.gif' width="75px" height="75px" margin-left="85px" margin-top="-127px"></i>

                <div class="cssload-loader" style="position:absolute; color:#4682B4; text-align:center; margin-left: 6px; margin-top: 34px; font-size: 28px;">Loading</div>
