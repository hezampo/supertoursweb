...
<div id="header_page" style="height:50px; background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');">
    <div class="header2"> Multi Rates Commissionable[ <?php echo $data['dato']; ?> ] <div class="multiselect" style="margin-left:322px; width:250px; margin-top:-35px;font-size:12px;line-height: 0.5em;" onclick="darclick(); cambiafondo();">
    ...
    <div id="serpare">    
        ...
        <fieldset>
            ...
            <form id="form1" class="form" action="<?php echo $data['rootUrl']; ?>admin/tours/room-rates/save" method="post" name="form1">
                ...
                <table border = "5"  style="margin: 0 auto; margin-top: 0.5%; width: 726px;">
                    <tr style="background:#708099; height:20px; color: #fff; ">
                    ...
                    <tr style="background:#4B0082; font-size: initial; color:#fff;">
                        ...
                        <th colspan="3" style="width:95px">1st<br>Passenger</th>
                        <th colspan="4" style="width:95px">2nd, 3rd & 4th<br>Passenger<br>Rate per person</th>
<!--                        <th style="width:135px">&nbsp;&nbsp;<i class="fa fa-bed" aria-hidden="true"></i>&nbsp;<i class="fa fa-bed" aria-hidden="true"></i>&nbsp;<i class="fa fa-bed" aria-hidden="true"></i>&nbsp;&nbsp;<br>Triple</th>
                    ...
                    <tr>
                        ...
                        <td colspan="3" height="10" style="text-align: center;background: #D2E0E4;font-size: 135%;color: #000;">$&nbsp;<input type="text" tabindex="6" onkeypress="validate(event)" name="pax1v_21" id="pax1v_21"  size="20" maxlength="20" style="width: 55px; font-weight: bold; color:#000000; text-align: center;" autocomplete="off" value="<?php echo $ratesroom->pax1v_21; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #D2E0E4;font-size: 135%;color: #000;">$&nbsp;<input type="text" tabindex="7" onkeypress="validate(event)" name="pax2v_21" id="pax2v_21"  size="20" maxlength="20" style="width: 55px;font-weight: bold;color:#000000;text-align: center;" autocomplete="off" value="<?php echo $ratesroom->pax2v_21; ?>"/></td>
                    ...
                    <tr style="color: #fff;">
                        ...
                        <td colspan="3" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="13" onkeypress="validate(event)" name="pax1m_21" id="pax1m_21"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1m_21; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="14" onkeypress="validate(event)" name="pax2m_21" id="pax2m_21"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2m_21; ?>"/></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" height="10" style="text-align: center; background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input type="text" tabindex="20" onkeypress="validate(event)" name="pax1v_32" style="width: 55px;font-weight: bold;color:#000000;text-align: center;" id="pax1v_32"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1v_32; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center; background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input type="text" tabindex="21" onkeypress="validate(event)" name="pax2v_32" style="width: 55px;font-weight: bold;color:#000000;text-align: center;" id="pax2v_32"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2v_32; ?>"/></td>
<!--                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">&nbsp;<input type="text" tabindex="22" onkeypress="validate(event)" name="tpl2" style="width: 55px;font-weight: bold;color:#000000;text-align: center;" id="tpl2"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tpl2; */?>"/></td>
                    ...
                    <tr>
                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;"><b>MODERATE</td>
                        <td colspan="3" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="27" onkeypress="validate(event)" name="pax1m_32" id="pax1m_32"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1m_32; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="28" onkeypress="validate(event)" name="pax2m_32" id="pax2m_32"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2m_32; ?>"/></td>
<!--                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="29" onkeypress="validate(event)" name="tplm2" id="tplm2"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tplm2;*/?>"/></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input type="text" tabindex="34" onkeypress="validate(event)" name="pax1v_43" style="width: 55px;font-weight: bold;color:#000000;text-align: center;" id="pax1v_43"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1v_43; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input type="text" tabindex="35" onkeypress="validate(event)" name="pax2v_43" style="width: 55px;font-weight: bold;color:#000000;text-align: center;" id="pax2v_43"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2v_43; ?>"/></td>
<!--                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">&nbsp;<input type="text" tabindex="36" onkeypress="validate(event)" name="tpl3" style="width: 55px;font-weight: bold;color:#000000;text-align: center;" id="tpl3"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tpl3;*/ ?>"/></td>
                    ...
                    <tr>
                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;"><b>MODERATE</td>
                        <td colspan="3" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="41" onkeypress="validate(event)" name="pax1m_43" id="pax1m_43"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1m_43; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="42" onkeypress="validate(event)" name="pax2m_43" id="pax2m_43"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2m_43; ?>"/></td>
<!--                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="43" onkeypress="validate(event)" name="tplm3" id="tplm3"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tplm3;*/ ?>"/></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;"><b>VALUE</td>
                        <td colspan="3" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="48" onkeypress="validate(event)" name="pax1v_54" id="pax1v_54" size="25" maxlength="25"  autocomplete="off" value="<?php echo $ratesroom->pax1v_54; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="49" onkeypress="validate(event)" name="pax2v_54" id="pax2v_54" size="25" maxlength="25"  autocomplete="off" value="<?php echo $ratesroom->pax2v_54; ?>"/></td>
<!--                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="50" onkeypress="validate(event)" name="tpl4" id="tpl4" size="25" maxlength="25"  autocomplete="off" value="<?php /*echo $ratesroom->tpl4; */ ?>"/></td>
                    ...
                    <tr>
                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;"><b>MODERATE</td>
                        <td colspan="3" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="55" onkeypress="validate(event)" name="pax1m_54" id="pax1m_54"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1m_54; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="56" onkeypress="validate(event)" name="pax2m_54" id="pax2m_54"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2m_54; ?>"/></td>
<!--                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="57" onkeypress="validate(event)" name="tplm4" id="tplm4"  size="25" maxlength="25" autocomplete="off" value="<?php /* echo $ratesroom->tplm4; */?>"/></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;"><b>VALUE</td>
                        <td colspan="3" height="10" style="height: 34px; text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="62" onkeypress="validate(event)" name="pax1v_65" id="pax1v_65" size="25" maxlength="25"  autocomplete="off" value="<?php echo $ratesroom->pax1v_65; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="63" onkeypress="validate(event)" name="pax2v_65" id="pax2v_65" size="25" maxlength="25"  autocomplete="off" value="<?php echo $ratesroom->pax2v_65; ?>"/></td>
<!--                    <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="64" onkeypress="validate(event)" name="tpl5" id="tpl5" size="25" maxlength="25"  autocomplete="off" value="<?php /*echo $ratesroom->tpl5; */?>"/></td>
                    ...
                    <tr>
                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;"><b>MODERATE</td>
                        <td colspan="3" height="10" style="height: 34px; text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="69" onkeypress="validate(event)" name="pax1m_65" id="pax1m_65"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1m_65; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="70" onkeypress="validate(event)" name="pax2m_65" id="pax2m_65"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2m_65; ?>"/></td>
<!--                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="71" onkeypress="validate(event)" name="tplm5" id="tplm5"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tplm5; */?>"/></td>
                    ...
                    <tr>
                        ...
                        <td style="height: 34px; text-align: center;background: #D2E0E4;font-size: 125%;color: #000;"><b>VALUE</td>
                        <td colspan="3" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="76" onkeypress="validate(event)" name="pax1v_76" id="pax1v_76"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1v_76; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="77" onkeypress="validate(event)" name="pax2v_76" id="pax2v_76"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2v_76; ?>"/></td>
<!--                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="78" onkeypress="validate(event)" name="tpl6" id="tpl6"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tpl6; */?>"/></td>
                    ...
                    <tr>
                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;"><b>MODERATE</td>
                        <td colspan="3" style="height: 34px; text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="83" onkeypress="validate(event)" name="pax1m_76" id="pax1m_76"  size="25"  maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1m_76; ?>"/></td>
                        <td colspan="4" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="84" onkeypress="validate(event)" name="pax2m_76" id="pax2m_76"  size="25"  maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2m_76; ?>"/></td>
<!--                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="85" onkeypress="validate(event)" name="tplm6" id="tplm6"  size="25"  maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tplm6;*/?>"/></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;"><b>VALUE</td>
                        <td colspan="3" height="10" style="height: 34px; text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="90" onkeypress="validate(event)" name="pax1v_87" id="pax1v_87"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1v_87; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="91" onkeypress="validate(event)" name="pax2v_87" id="pax2v_87"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2v_87; ?>"/></td>
<!--                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="92" onkeypress="validate(event)" name="tpl7" id="tpl7"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tpl7;*/ ?>"/></td>
                    ...
                    <tr>
                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;"><b>MODERATE</td>
                        <td colspan="3" height="10" style="height: 34px; text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="97" onkeypress="validate(event)" name="pax1m_87" id="pax1m_87"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1m_87; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="98" onkeypress="validate(event)" name="pax2m_87" id="pax2m_87"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2m_87; ?>"/></td>
<!--                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="99" onkeypress="validate(event)" name="tplm7" id="tplm7"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tplm7; */?>"/></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;"><b>VALUE</td>
                        <td colspan="3" height="10" style="height: 34px; text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="104" onkeypress="validate(event)" name="pax1v_98" id="pax1v_98"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1v_98; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="105" onkeypress="validate(event)" name="pax2v_98" id="pax2v_98"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2v_98; ?>"/></td>
<!--                        <td style="text-align: center;background: #D2E0E4;font-size: 125%;color: #000;">&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="106" onkeypress="validate(event)" name="tpl8" id="tpl8"  size="25" maxlength="25" autocomplete="off" value="<?php /*echo $ratesroom->tpl8; */?>"/></td>
                    ...
                    <tr>
                        <td style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;"><b>MODERATE</td>
                        <td colspan="3" height="10" style="height: 34px; text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="111" onkeypress="validate(event)" name="pax1m_98" id="pax1m_98"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax1m_98; ?>"/></td>
                        <td colspan="4" height="10" style="text-align: center;background: #0174DF;font-size: 125%;color: #fff;">$&nbsp;<input style="width: 55px;font-weight: bold;color:#000000;text-align: center;" type="text" tabindex="112" onkeypress="validate(event)" name="pax2m_98" id="pax2m_98"  size="25" maxlength="25" autocomplete="off" value="<?php echo $ratesroom->pax2m_98; ?>"/></td>
