...
/*        .booking2{
        background: -moz-linear-gradient(270deg, #000000 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #000000 100%);  ff3.6+ 
        background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #000000), color-stop(10%, #ffffff), color-stop(50%, #ffffff), color-stop(89%, #ffffff), color-stop(100%, #000000));  safari4+,chrome 
        background: -webkit-linear-gradient(270deg, #000000 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #000000 100%);  safari5.1+,chrome10+ 
        background: -o-linear-gradient(270deg, #000000 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #000000 100%);  opera 11.10+ 
        background: -ms-linear-gradient(270deg, #000000 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #000000 100%);  ie10+ 
        background: linear-gradient(180deg, #000000 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #000000 100%);  w3c 
...
<div id="header_page" class="catsandstars" style="height: 67px;">
    <div class="header2"><h6 class='stroke' style="width:290px; margin-top:4px; margin-left:-4px; color:#0B55C4; text-shadow: 1px 4px #999; font-size:33px; font-weight:normal; text-align:center; font-family:Impact;">Multi - Day Tours New</h6><input type="text" readonly="true" style="background: #fff; margin-left: 322px; margin-top: -107px;width: 303px; color: #000;" name="tour_name" id="tour_name" placeholder="Tour Name" value="" /></div>
    <script type="text/javascript">
        function capturar()
        {
    ...
    <div id="toolbar">
        ...
        <select style="margin-right:28px; margin-top:21.2px; width:303px; background: #128020; color: #fff;border-color: transparent;" name="fnombre" id="rate"  onchange="valorObtenido();obtenerValor(this.value);">
...
<!--background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');-->
<div id="content_page_tours" style="width: 984px; height: 1492px; z-index:1; margin-top:-51px;" >
    <form id="form1" class="form" action="" method="post" name="form1">
        ...
        <div id="info-group" style="width: 900px;">
            ...
            <div id="reservation" style="border-color: transparent; width: 300px; height: 39px;">
                ...
                <div id="reser" style="background: #98FB98; margin-top: -13px; font-size: 12px; font-weight: bold; color: #000;"> <p ><?php  echo $_SESSION['codconf']; ?></p><input type="hidden" /></div>
            </div>
            <div id="status">
        ...
        <table><tr><td>
                    ...
                    <fieldset id="inputype" style="margin-left:0px; width:470px; border-radius: 3px 120px 0px 80px; box-shadow: 0 -8px 4px #DC1349;" class="rojo"><legend style="border:1px solid #B83A36; background:#fff;margin-left:5px;">INPUT TYPE</legend>
...
<!--                             <input name="tour_name" readonly="true" style="width:220px; color: #0F0CCB; margin-left: -23%; margin-top: 2%;" type="text" id="tour_name" value="<?php echo $agency['tour_name']; ?>"  />-->
                ...
                <td>
                    ...
                    <fieldset  id="liderpax" style="margin-left:2px; border-radius: 130px 3px 80px 0px; width:85px; box-shadow: 0 -8px 4px #1E90F6;" class="cerati">
        ...
        <table width="100%" style="margin-top: 2%;">
            <tr>
                <td width="49%" valign="top" >
                    ...
                    <fieldset id="arrival" style="border-radius: 7%; margin-left: 3px; box-shadow: 4px 6px 7px 1px #708090;" class="cerati" >
                                                ...
                                                <table width="100%"><tr>
                                                        <td>
                                                            <div id="div_from">
                                                                ...
                                                                <div>
                                                                <select style="width:190px; color: #000; background-color: #fff;" name="from" id="from" class="select" onchange="change_from();">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div id="div_to">
                                                                <div style="color:#FFFFFF; position:absolute; margin-top:-20px; margin-left:-236px;" class="label">TO</div>
                                                                <div>
                                                                <select style="width:201px; position:absolute; margin-left:-236px; margin-top:-7px; height:27.5px; color: #000; background-color: #fff;" name="to" id="to" class="select">
                                                        ...
                                                        <td>
                                                            <div id="trip">
                                                                ...
                                                                <div style="color:#FFFFFF; position:absolute; margin-top:-19px; margin-left:-35px;" class="label">TRIP</div>
                                                                <div>
                                                                <table><tr><td>
                                                                            <span><input class="field" name="a_trip_no" type="text" id="a_trip_no" size="3" maxlength="3" value="" style="margin-left: -36px; margin-top: -7px; position: absolute; height:22px; width:39px; color: #000; font-size: 16px; background-color: #fff;  border: 2px solid dodgerblue;" readonly="readonly"/>
                                                                        ...
                                                                        <td onclick="mostrarTrip1();comprobarScreen();cargando();"><a style="color: #fff; cursor:pointer; position: absolute; margin-top: -44px; margin-left: -29px;" id="popup1"><img id="search1" style="display:none;" src ='<?php echo $data['rootUrl'] ?>global/img/search.png' width='25' height='25'></a>
...
<!--                                                                    <td width="25%" style="color:#FFFFFF;">
                                                                    ...
                                                                    <td width="15%">
                                                                        <div id="rooms">
                                                                            ...
                                                                            <span><input name="a_room1" type="text" id="a_room1" size="4" style="width:51px; margin-left: -3px; height: 23px;" maxlength="6" value="" class="field"/></span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                ...
                <td width="49%" valign="top">
                    <div id="chk_departure" style="color: #eee;">
                        <fieldset id="departure" style="border-radius: 5%; box-shadow: 4px 6px 7px 1px #708090;" class="rojo2" >
                                                ...
                                                <div id="transport2" class="group" align="left">
                                                    ...
                                                    <table width="100%"><tr>
                                                            <td>
                                                                <div id="div_from2">
                                                                    <div style="color:#FFFFFF;" class="label">FROM</div>
                                                                    <select style="width:190px; color: #000; background-color: #fff;" name="from2" id="from2" class="select">
                                                                        <?php foreach ($data["area_park"] as $e) { ?>
                                                                            <option value="<?php echo $e["id"]; ?>" <?php echo ($e["nombre"] == trim("ORLANDO") ? 'selected' : ''); ?> ><?php echo $e["nombre"]; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div id="div_to2">
                                                                    <div style="color:#FFFFFF; position: absolute; margin-top: 0px; margin-left: -51px;" class="label">TO</div>
                                                                    <div>
                                                                    <select style="width:197px; margin-left: -51px; margin-top:14px; color: #000; background-color: #fff;" name="to2" id="to2" class="select" onchange="change_to2();" >
                                                                        <option value="0"></option>
                                                            ...
                                                            <td>
                                                                <div id="trip" style="margin-left:2px;">
                                                                    ...
                                                                    <div style="color:#FFFFFF; margin-left:-41px; position: absolute; margin-top: -20px;" class="label">TRIP</div>
                                                                    
                                                                    <table><tr><td>
                                                                                <span><input class="field" name="d_trip_no" style="position: absolute; margin-left:-42px; margin-top:-7px; height:22px; width:39px; color: #000; font-size: 16px; background-color: #fff;  border: 2px solid dodgerblue;" type="text" id="d_trip_no" size="3" maxlength="3" value=""
                                                                                             readonly="readonly"/>
...
<!--                                                                                <a rel="superbox[ajax][<?php /*echo $data['rootUrl']; */?>admin/tours/trips/arrival][300x100]">
                                                                                    <img id="popup2" style="cursor:pointer; display: none;" src="<?php /*echo $data['rootUrl'];*/ ?>global/images/search.png" /><i id="popup2" style="color: #fff; cursor:pointer; margin-left:-35px; position:absolute; margin-top:-42px;" class="fa fa-search-plus fa-2x" onclick="mostrarTrip2();comprobarScreen();cargando();"></i>

                                                                                </a>-->
<!--                                                                                <td onclick="mostrarTrip2();comprobarScreen();cargando();"><a>&nbsp;<i style="color: #fff; cursor:pointer; position: absolute; margin-top: -37px; margin-left: -30px;" id="popup2" class="fa fa-search-plus fa-2x"></i></a>-->
                                                                                <td onclick="mostrarTrip2();comprobarScreen();cargando();"><a style="color: #fff; cursor:pointer; position: absolute; margin-top: -45px; margin-left: -35px;" id="popup2" ><img id="search2" style="display:none;" src ='<?php echo $data['rootUrl'] ?>global/img/search.png' width='25' height='25'></a>
                                                                                </td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                ...
                <table class="oliveti" style="width: 46%; border: 2px solid #000; margin-left: -8px; margin-top: 9px; height: 155px; ">
                    ...
                    <tr style="width: 700px;">
                        ...
                        <div style="position: absolute; margin-left:-1px; margin-top:1px;">
                            ...
                            <div id="cir1" style="display:none; position:absolute; margin-left:370px; margin-top:105px;" class="circle1"></div>
                            <div id="cir2" style="display:none; position:absolute; margin-left:385px; margin-top:105px;" class="circle2"></div>
                            <div id="cir3" style="display:none; position:absolute; margin-left:400px; margin-top:105px;" class="circle3"></div>
                            <div id="cir4" style="display:none; position:absolute; margin-left:416px; margin-top:105px;" class="circle4"></div>
                            <div id="cir5" style="display:none; position:absolute; margin-left:431px; margin-top:105px;" class="circle5"></div>
                            <div id="cir6" style="display:none; position:absolute; margin-left:446px; margin-top:105px;" class="circle6"></div>
                            <div id="cir7" style="display:none; position:absolute; margin-left:460px; margin-top:105px;" class="circle7"></div>
                            <div id="cir8" style="display:none; position:absolute; margin-left:474px; margin-top:105px;" class="circle8"></div>
                            <div id="cir9" style="display:none; position:absolute; margin-left:488px; margin-top:105px;" class="circle9"></div>
                            <div id="cir10" style="display:none; position:absolute; margin-left:502px; margin-top:105px;" class="circle10"></div>
...
<!--                                        <div class="paymentvertblack" style="padding:9px;  text-align: center; margin-top: 9px;">
        ...
        <input type="text" id="pago_pre1"  name="pago_pre1" title="pago # 1" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre2"  name="pago_pre2" title="pago # 2" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre3"  name="pago_pre3" title="pago # 3" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre4"  name="pago_pre4" title="pago # 4" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre5"  name="pago_pre5" title="pago # 5" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre6"  name="pago_pre6" title="pago # 6" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre7"  name="pago_pre7" title="pago # 7" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre8"  name="pago_pre8" title="pago # 8" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre9"  name="pago_pre9" title="pago # 9" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
        ...
        <input type="text" id="pago_pre10"  name="pago_pre10" title="pago # 10" size="12" style="display:none; margin-top:4px; margin-left:27px; width:18px; height:11px;" value="0" />
    ...
    <div id="save2" style="position:fixed; overflow: visible; z-index: 3000; margin-left: 395px; margin-top: -1655px; font-weight: bold; font-size: 39px; display:none;">                

<!--                <i class="fa fa-spinner fa-pulse fa-4x fa-fw" style="color: #CE4233;"></i>-->
                <a style="margin-left: 40px; margin-top: -17px; position: absolute;" ><img src ='<?php echo $data['rootUrl'] ?>global/img/eclipse.gif' width="150px" height="150px" margin-left="85px" margin-top="-127px">

                <i style="margin-left: 38px; margin-top: -120px; position: absolute;" href='<?php echo $data['rootUrl'] ?>admin/tours/add/'><img src ='<?php echo $data['rootUrl'] ?>global/img/loading_trips.gif' width="75px" height="75px" margin-left="85px" margin-top="-127px"></i>

                <div class="cssload-loader" style="position:absolute; color:#4682B4; text-align:center; margin-left: 6px; margin-top: 40px; font-size: 28px;">Loading</div>
    ...
    <td width="10%" ><div style="display:none;" id="mensajeTrip"  class=""></div></td>
...
//                }
    ...
    function mostrarTrip1() {
        ...
        var trip1 = $('#a_trip_no').val();
        var trip2 = $('#d_trip_no').val();
...
//        }
        ...
        //var url = '<?php echo $data['rootUrl']; ?>admin/tours/selectpark/' + id_park + '/' + id_group + '/' + adult + '/' + child + '/' + fecha_salida + '/' + fecha_retorno + '/' + platinum + '/' + id_agency + '/' + idf + '/' + dias + '/' + noches;
...
//                          $("#paid_driver").val((bal).toFixed(2));
        ...
        if (tipo_pago == 8) {      
            ...
            if (pay_amount > 0 && paid_driver > 0 && otheramount == 0) {
                    ...
                    var pay_amount = $("#pay_amount").val();
                    var result = parseFloat(apagar) + parseFloat(temp_driver) + parseFloat(temp_prepaid);
                    var balance_due = (parseFloat(res_total) - parseFloat(paid_driver)) - parseFloat(pay_amount);
    ...
    function validarTransfer_in() {
        if ($("#opcion_transfer_in").is(':checked')) {
            if ($("#a_bus").is(':checked')) {//BUS
                ...
                if (!Validar(fecha_salida)) {
                    var msj = '- Incorrect tours start date.';
                    var titulo = 'START DATE';
                    mensaje(msj, titulo, 'fecha_salida');
                    return false;
                }
    ...
    function validarTransfer_out() {
        if ($("#opcion_transfer_out").is(':checked')) {
            if ($("#d_bus").is(':checked')) {//BUS
                ...
                var hora2 = trim($("#hora2").val());
                if (hora2 == '') {
                    var msj = '- Enter the time of arrival in orlando.';
                    var titulo = 'Time  arrival orlando';
                    mensaje(msj, titulo, 'hora2');
                    return false;
                }
            }
...
<script type="text/javascript">
	...
	window.resizeTo(screen.width, screen.height);
        ...
        if (window.screen.availWidth == 800) {
            ...
            document.getElementById("save2").style.marginTop = "-1653px";
        }
        
        if (window.screen.availWidth == 960) {
            window.parent.document.body.style.zoom = "70%";
            document.getElementById("save2").style.marginTop = "-1663px";
        } 
        
        if (window.screen.availWidth == 1024) {
            window.parent.document.body.style.zoom = "80%";
            document.getElementById("save2").style.marginTop = "-1606px";
        }
        
        if (window.screen.availWidth == 1152) {
            window.parent.document.body.style.zoom = "90%";
            document.getElementById("save2").style.marginTop = "-1586px";           
        }
        
        if (window.screen.availWidth == 1280) {
            window.parent.document.body.style.zoom = "100%";
            document.getElementById("save2").style.marginTop = "-1637px";
        }
        
        if (window.screen.availWidth == 1360) {
            window.parent.document.body.style.zoom = "100%";
            document.getElementById("save2").style.marginTop = "-1696px";
        } 
        
        if (window.screen.availWidth == 1366) {
            window.parent.document.body.style.zoom = "100%";   
            document.getElementById("save2").style.marginTop = "-1703px";
        }

        if (window.screen.availWidth == 1440) {
            window.parent.document.body.style.zoom = "110%";
            document.getElementById("save2").style.marginTop = "-1632px";
        }

        if (window.screen.availWidth == 1600) {
            window.parent.document.body.style.zoom = "125%";
            document.getElementById("save2").style.marginTop = "-1683px";
        }

        if (window.screen.availWidth == 1680) {
            window.parent.document.body.style.zoom = "125%";
            document.getElementById("save2").style.marginTop = "-1651px";
        }
        if (window.screen.availWidth > 1680) {
            window.parent.document.body.style.zoom = "125%";
            document.getElementById("save2").style.marginTop = "-1647px";
