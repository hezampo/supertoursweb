...
<form name="form1" method="post" action="<?php echo $data['rootUrl']; ?>admin/tours" class="form" id="form1">
    ...
    <div><input name="edition" type="button"  id="edition" style="display:none;" value="Edition" <?php
        ...
        ?> <a href="#" onclick="javascript:void(window.open('<?php echo $url; ?>', 'MULTIDAY', ''))"></div>
    ...
    <div id="header_page" style="width: 99%;">
...
<!--                       <p style="margin-top:40px; margin-left:-99px; width:140px;" align="center"><font style="margin-top:0px; margin-left:0px; font-size:10px; font-weight:bold;" id="Tutores" size="38">■■■■■■■■■■■■■■■■■■■■■■■■■■</font></b></p>-->
                    ...
                    <li class="btn-toolbar" style="height: 40px;">
                        ...
                        <a href="javascript:void(window.open('<?php echo $url1; ?>','MULTIDAY',''))" id="btn-edit"  class="link-button" onclick=""><img src="<?php echo $data['rootUrl']; ?>global/img/admin/edit2.png" style="margin-top:-2px; height:25px;" title="Modify reservation data"/>
...
<!--                    <li class="btn-toolbar"><a href="<?php echo $data['rootUrl']; ?>admin/tours/add" id="btn-add" class="link-button"> <span class="icon-new" title="Nuevo">&nbsp;</span>-->
                        
                    <li class="btn-toolbar"><a id="btn-add" class="link-button" style="margin-left:1px;" href="javascript:void(window.open('<?php echo $data['rootUrl'] ?>admin/tours/add','MULTIADD',''))" > <span class="icon-new" title="Nuevo">&nbsp;</span>        
                        
                        New </a></li>
<!--                    <li class="btn-toolbar"><a href="<?php echo $data['rootUrl']; ?>admin/tours/edit" id="btn-edit"
                                               class="link-button"> <span class="icon-edit" title="Editar">&nbsp;</span>
                        Edit </a></li>-->
                    <li class="divider">&nbsp;</li>
    ...
    <div id="form">
        <div id="filter-bar">
            ...
            <select name="filtro2" id="filtro" class="select">
                ...
                <option value="code_conf" <?php echo $data["filtro2"] == 'code_conf' ? 'selected' : '' ?>>Conf. Code</option>
                <option value="nomcliente" <?php echo $data['filtro2'] == 'nomcliente' ? 'selected' : '' ?>>Pax Name</option>
                <option value="estado" <?php echo $data['filtro2'] == 'estado' ? 'selected' : '' ?>>Status</option>
        ...
        <div id="datagrid">
            <table class="grid" cellspacing="1" id="grid">
                ...
                <tr>
                    ...
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45; width: 53px;" width="20">Id</th>
                    ...
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45; width: 131px;" width="">Agency</th>
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45;" width="">Employee</th>
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45; width: 76px;" width="">Creation Date</th>
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45;" width="">Starting Date</th>
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45;" width="">Ending Dare</th>
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45;" width="">Days</th>
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45; width: 36px;" width="">Nights</th>
                ...
                <tr class="row<?php echo $i ?>">
                    ...
                    <td style="font-size: 9px; text-align:left;"><?php echo $e['company_name']; ?></td>
                    ...
                    <td style="font-size: 10px; text-align:center;"><?php echo date('M-d-Y',strtotime($e['ending_date']));?></td>
                    <td style="font-size: 10px; text-align:center;"><?php echo $e['length_day']; ?></td>
                    <td style="font-size: 10px; text-align:center;"><?php echo $e['length_nights'] ?></td>
                    <td style="font-size: 10px; text-align:right;"><?php echo  number_format($total, '2','.','.'); ?></td>
                </tr>
                    <?php
                    $i = 1 - $i;
                }
