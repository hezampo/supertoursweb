...
<form name="form1" method="post" action="<?php echo $data['rootUrl']; ?>admin/onedaytour/quoted" class="form" id="form1">
    ...
    <div id="header_page">
        <div class="header">One day Tours Quoted</div>
        <div id="toolbar">
...
<!--                    <li class="btn-toolbar"><a href="<?php echo $data['rootUrl']; ?>admin/onedaytour/add" id="btn-add" class="link-button"> <span class="icon-new" title="Nuevo">&nbsp;</span>-->                         
                    <li class="btn-toolbar"><a id="btn-add" class="link-button" style="margin-left:1px;" href="javascript:void(window.open('<?php echo $data['rootUrl'] ?>admin/onedaytour/add','ONEDAYADD',''))" ><span class="icon-new" title="Nuevo">&nbsp;</span>
                        New </a></li>
<!--                    <li class="btn-toolbar"><a href="<?php echo $data['rootUrl']; ?>admin/onedaytour/edit" id="btn-edit"
    ...
    <div id="form">
        <div id="filter-bar">
            ...
            <select name="filtro2" id="filtro" class="select">
                ...
                <option value="code_conf">Confirmation Code</option>
        ...
        <div id="datagrid">
            <table class="grid" cellspacing="1" id="grid">
                ...
                <tr class="row<?php echo $i ?>">
                    <td><input name="item" type="radio" onclick="capturar();" value="<?php echo $e['id']; ?>"/></td>
                    ...
                    <td><?php if($e['estado'] == "CANCELED") {?> <strike>  <?php } ?><?php echo $e['code_conf']; ?><?php if($e['estado'] == "CANCELED") {?> </strike>  <?php } ?></td>
                    <td><?php echo $e['nomcliente']; ?></td>
                    <td><?php echo $e['company_name']; ?></td>
                    <td><?php echo $e['nomempleado']; ?></td>
                    <td><?php echo date('Y-m-d',strtotime($e['creation_date'])).'/ '.date('h:i:s A',strtotime($e['creation_date']));?></td>
