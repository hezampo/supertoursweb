...
<input type="hidden" name="ssl_state" value="<? echo ($login->state!='')?$login->state:$login->country; ?>">
...
<input type="hidden" name="ssl_receipt_decl_get_url" value="<?php echo $data['rootUrl']; ?>/transaction/admin/onedaytours/decline">
<input type="hidden" name="ssl_receipt_apprvl_method" value="REDG">
<input type="hidden" name="ssl_receipt_apprvl_get_url" value="<?php echo $data['rootUrl']; ?>transaction/admin/onedaytours/approval">
