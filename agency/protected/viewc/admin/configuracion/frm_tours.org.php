...
//$codigo_trasportation = $_SESSION['codconf'];
//echo $codigo_trasportation;
...
<!--                    <input type="text" id="reser" name="reser" style="background: #98FB98; margin-top: -13px; font-size: 12px; font-weight: bold; color: #000;" value="<?php  /*echo $_SESSION['codconf'];*/ ?>"/>-->
                
                <div>
                    
                    <input type ="text" id="reser" name="reser" style="background: chartreuse; margin-top:0px; margin-left:0px; text-align: center; font-size: 12px; font-weight: bold; color: darkblue; width: 297px; height: 12px;" value="<?php echo $_SESSION['code_conf']; ?>" readonly="readonly"/>
                    <input type="text"  id="codconf" name="codconf" style="display:none;" value="<?php echo $_SESSION['code_conf']; ?>"/>
...
//    $("#pago_agente").click(function () {
    ...
    var url = ('<?php echo $data['rootUrl'] ?>admin/pago/agente/' + cantidad + '/' + email1 + '/' + primer_n + '/' + segundo_n + '/' + phone1 + '/' + '<?php echo $_SESSION['code_conf']; ?>');
