...
//            $breakfastdato = '';
//        }
//Variables que se necesitan para el calculo de de los precios en tiempo de ejecucion.	
...
if ($agencia->id != -1) {
 ...
 $sqlih = "SELECT id  FROM hotel_reserves WHERE id_tours = '$tours->id'";
 $rsih = Doo::db()->query($sqlih);
 $resultih = $rsih->fetchAll();
 
    
 foreach ($resultih as $rih) {      
    $idhotel_reserve = $rih['id'];  
 } 
 ...
 Doo::db()->query("UPDATE tours SET  id_hotel_reserve = '$idhotel_reserve'  WHERE id = '$tours->id'"); 

 //Contamos los grupos repetidos del array
// `` usamos estas comillas para hacer la consulta ya que el campo group usa una palabra reservada de mysql
 
 $sql_group= "SELECT `group`  FROM attraction_trafic WHERE id_tours = $tours->id AND type_tour = 'MULTI'";
 $rs_group = Doo::db()->query($sql_group);
 $id_group = $rs_group->fetchAll();
 //print_r($id_group);
 
 $sql_park= "SELECT id_park FROM attraction_trafic WHERE id_tours = $tours->id AND type_tour = 'MULTI'";
 $rs_park = Doo::db()->query($sql_park);
 $id_park = $rs_park->fetchAll();
 
 foreach ($id_park as $idpark){
     
 
 $parke = $idpark['id_park'];

 $sql_atr= "SELECT id FROM attraction_trafic WHERE id_tours = $tours->id AND type_tour = 'MULTI' AND id_park = '$parke'";
 $rs_atr = Doo::db()->query($sql_atr);
 $id_atract = $rs_atr->fetchAll();

     //print_r($id_atract);
     //$registros = count($id_atract);
     //$id_atr = explode(",", $id_atract);
    ...
    foreach ($id_atract as $idat){          
        ...
        Doo::db()->query("UPDATE traffic_report SET  id_attraction_trafic = '$id_atr'  WHERE id_tour = '$tours->id' AND type_tour = 'MULTI' AND parking = '$parke'");

    }

}

$sqlpag = "SELECT SUM(pagado) AS SUMPAG FROM tours_pago WHERE id_tours = '$tours->id' AND tipo = 'MULTI'";
...
<style>
    ...
    .gris1{
        ...
        background: -moz-linear-gradient(45deg, #262626 0%, #777777 79%, #808080 87%, #FFFFFF 100%); /* ff3.6+ */
        background: -webkit-gradient(linear, left bottom, right top, color-stop(0%, #262626), color-stop(79%, #777777), color-stop(87%, #808080), color-stop(100%, #FFFFFF)); /* safari4+,chrome */
        background: -webkit-linear-gradient(45deg, #262626 0%, #777777 79%, #808080 87%, #FFFFFF 100%); /* safari5.1+,chrome10+ */
        background: -o-linear-gradient(45deg, #262626 0%, #777777 79%, #808080 87%, #FFFFFF 100%); /* opera 11.10+ */
        background: -ms-linear-gradient(45deg, #262626 0%, #777777 79%, #808080 87%, #FFFFFF 100%); /* ie10+ */
        background: linear-gradient(45deg, #262626 0%, #777777 79%, #808080 87%, #FFFFFF 100%); /* w3c */
        filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#FFFFFF', endColorstr='#262626',GradientType=1 ); /* ie6-9 */
    ...
    .azufre{
        background-image: -ms-linear-gradient(bottom left, #260505 0%, #ff6200 75.5%, #FFC7C7 100%);

        /* Mozilla Firefox */ 
        background-image: -moz-linear-gradient(bottom left, #260505 0%, #ff6200 75.5%, #FFC7C7 100%);

        /* Opera */ 
        background-image: -o-linear-gradient(bottom left, #260505 0%, #ff6200 75.5%, #FFC7C7 100%);

        /* Webkit (Safari/Chrome 10) */ 
        background-image: -webkit-gradient(linear, left bottom, right top, color-stop(0, #260505), color-stop(75.5, #ff6200), color-stop(100, #FFC7C7));

        /* Webkit (Chrome 11+) */ 
        background-image: -webkit-linear-gradient(bottom left, #260505 0%, #ff6200 75.5%, #FFC7C7 100%);

        /* W3C Markup */ 
        background-image: linear-gradient(to top right, #260505 0%, #ff6200 75.5%, #FFC7C7 100%); 
    }
    ...
    .booking2{
        background: -moz-linear-gradient(270deg, #0096d2 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #0096d2 100%); /* ff3.6+ */
        background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #0096d2), color-stop(10%, #ffffff), color-stop(50%, #ffffff), color-stop(89%, #ffffff), color-stop(100%, #0096d2)); /* safari4+,chrome */
        background: -webkit-linear-gradient(270deg, #0096d2 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #0096d2 100%); /* safari5.1+,chrome10+ */
        background: -o-linear-gradient(270deg, #0096d2 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #0096d2 100%); /* opera 11.10+ */
        background: -ms-linear-gradient(270deg, #0096d2 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #0096d2 100%); /* ie10+ */
        background: linear-gradient(180deg, #0096d2 0%, #ffffff 10%, #ffffff 50%, #ffffff 89%, #0096d2 100%); /* w3c */
        filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#0096d2', endColorstr='#0096d2',GradientType=0 ); /* ie6-9 */
    ...
    .verde{
        ...
        background: -moz-linear-gradient(270deg,  #0167CC 0%, #FFFFFF 8%, #FFFFFF 49%, #FFFFFF 97%,  #0167CC 100%); /* ff3.6+ */
        background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,  #FFFFFF), color-stop(8%, #FFFFFF), color-stop(49%, #FFFFFF), color-stop(97%, #FFFFFF), color-stop(100%,  #F0F8FF)); /* safari4+,chrome */
        background: -webkit-linear-gradient(270deg,  #0167CC 0%, #FFFFFF 8%, #FFFFFF 49%, #FFFFFF 97%,  #0167CC 100%); /* safari5.1+,chrome10+ */
        background: -o-linear-gradient(270deg,  #0167CC 0%, #FFFFFF 8%, #FFFFFF 49%, #FFFFFF 97%,  #0167CC 100%); /* opera 11.10+ */
        background: -ms-linear-gradient(270deg,  #0167CC 0%, #FFFFFF 8%, #FFFFFF 49%, #FFFFFF 97%,  #0167CC 100%); /* ie10+ */
        background: linear-gradient(180deg,  #0167CC 0%, #FFFFFF 8%, #FFFFFF 49%, #FFFFFF 97%,  #0167CC 100%); /* w3c */
        filter: progid:DXImageTransform.Microsoft.gradient( startColorstr=' #dfe0df', endColorstr=' #dfe0df',GradientType=0 ); /* ie6-9 */
...
/*height: 103%;*/
    ...
    .catsandstars {        
      background-image:  url("<?php echo $data['rootUrl'] ?>global/img/bck_multi.jpg");                         
...
<div id="openModal" class="modalDialog">
	...
	<div>
            ...
            <form id="myform" class="form-wizard">
                <h2 class="form-wizard-heading">Type your Password</h2>
                <input type="password" id="clave" name=clave value="" style="width:144px; font-size:17px; font-weight:bold; margin-left: 90px;"/>
<!--                <input type="submit"/>-->
                <input type=button value=Submit onclick="unblock_invoiced();" style="margin-left: 14px; height:26px; margin-top:3px;"> 
            </form>
...
<script>
        function block_invoiced() {  
            ...
            var estado = "<?php echo $tours->estado; ?>";
            
            if(estado == 'INVOICED'){
            
            document.getElementById("unlock").style.display = "";
            document.getElementById("estado_transfer_out").options[1].disabled = true;
            document.getElementById("estado_transfer_out").options[3].disabled = true;
            ...
            document.getElementById("arrival").className  = "gris";
            //document.getElementById("departure").className  = "gris";
            document.getElementById("mascara").style.display = "";
//            document.getElementById("byrp").disabled = true;
//            document.getElementById("byrm").disabled = true;
//            document.getElementById("byrw").disabled = true;         
            document.getElementById("fecha_salida").disabled = true;
            document.getElementById("fecha_retorno").disabled = true;
            document.getElementById("type_services_premiun").disabled = true;
            document.getElementById("type_services_vip").disabled = true;
            document.getElementById("opcion_transfer_in").disabled = true;
            document.getElementById("opcion_transfer_out").disabled = true;
            document.getElementById("estado_transfer_in").disabled = true;
            //document.getElementById("estado_transfer_out").disabled = true;
            document.getElementById("estado_transfer_in").style.backgroundColor = "#d4d4d4";  
            //document.getElementById("estado_transfer_out").style.backgroundColor = "#d4d4d4";
            document.getElementById("opcion_hotel").disabled = true;
            document.getElementById("opcion_traffic").disabled = true;
            document.getElementById("hotel_name").disabled = true;
//            document.getElementById("fecha_salida_h").disabled = true;
//            document.getElementById("fecha_retorno_h").disabled = true;
            document.getElementById("frday").disabled = true;
            document.getElementById("select_rooms").disabled = true;
            document.getElementById("adult").disabled = true;
            document.getElementById("child").disabled = true;
            //document.getElementById("quitar_hotel").style.display = "none";
...
//            document.getElementById("tablePark").style.backgroundColor = "red";
            document.getElementById("categoria_park").disabled = true;
...
//            document.getElementById("child1").disabled = true;           
            ...
            document.getElementById("tipo_pass").disabled = true;            
            document.getElementById("a_bus").disabled = true;
            document.getElementById("a_vip").disabled = true;
            document.getElementById("a_airpoty").disabled = true;
            document.getElementById("a_car").disabled = true;
            document.getElementById("from").disabled = true;
            document.getElementById("to").disabled = true;
            document.getElementById("search1").style.display = "none";
            document.getElementById("a_pickup1").disabled = true;
            document.getElementById("ext_from1").disabled = true;
            document.getElementById("a_luggage").disabled = true;
            document.getElementById("a_room1").disabled = true;
            document.getElementById("a_pickup2").disabled = true;         
            
            document.getElementById("d_bus").disabled = true;
            document.getElementById("d_vip").disabled = true;
            document.getElementById("d_airpoty").disabled = true;
            document.getElementById("d_car").disabled = true;
            
            document.getElementById("from2").disabled = true;
            //document.getElementById("to2").disabled = true;
            document.getElementById("search2").style.display = "none";
            //document.getElementById("d_pickup1").disabled = true;
            document.getElementById("ext_to2").disabled = true;
            document.getElementById("d_luggage").disabled = true;
            document.getElementById("d_room1").disabled = true;
            document.getElementById("d_pickup2").disabled = true;
            
            //document.getElementById("img_admision_park").disabled = true;
            document.getElementById("img_transport_park").disabled = true; 
            ...
            if(password == "$uper3001Tours"){  
                ...
                setTimeout(function () { 
                    ...
                    if(estado == 'INVOICED'){
                        ...
                        document.getElementById("inputype").className  = "rojo";
                        document.getElementById("liderpax").className  = "cerati";
                        document.getElementById("arrival").className  = "cerati";
                        document.getElementById("departure").className  = "rojo";
                        ...
                        document.getElementById("fecha_retorno").disabled = false;
                        document.getElementById("adult").disabled = false;
                        document.getElementById("child").disabled = false;
//                        document.getElementById("wdwus").disabled = false;
//                        document.getElementById("wphol").disabled = false;
//                        document.getElementById("kspc").disabled = false;


                        document.getElementById("from").disabled = false;
                        document.getElementById("to").disabled = false;
                        document.getElementById("a_pickup1").disabled = false;
                        document.getElementById("ext_from1").disabled = false;
                        document.getElementById("a_luggage").disabled = false;
                        document.getElementById("a_room1").disabled = false;
                        document.getElementById("a_pickup2").disabled = false;
                        document.getElementById("estado_transfer_out").disabled = false;
                        document.getElementById("from2").disabled = false;
                        document.getElementById("to2").disabled = false;
                        document.getElementById("d_pickup1").disabled = false;
                        document.getElementById("ext_to2").disabled = false;
                        document.getElementById("d_luggage").disabled = false;
                        document.getElementById("d_room1").disabled = false;
                        document.getElementById("d_pickup2").disabled = false;
                        document.getElementById("categoria_park").disabled = false;
                        document.getElementById("park_name").disabled = false;
                        document.getElementById("add_attraction_list").disabled = false;
                        document.getElementById("include_ticket").disabled = false;
                        document.getElementById("delete_park").disabled = false;           
                        ...
                        document.getElementById("byrp").disabled = false;
                        document.getElementById("byrm").disabled = false;
                        document.getElementById("byrw").disabled = false;
                        ...
                        document.getElementById("estado_transfer_out").style.backgroundColor = "#98fb98";  
                        //document.getElementById("openModal").style.display = "none";
...
//echo '-->'.$id_agency; 
?>
<a  style="border: transparent;"></a>  
<img  id="mascara" style="display:none; position: absolute; margin-top: 618px; margin-left: 27px; width: 948px; height: 792px;" src ='<?php echo $data['rootUrl'] ?>global/img/mascara.png' width="776px" height="193px" margin-left="85px" margin-top="-127px">          
<!--background-image: url('<?php /*echo $data['rootUrl'] */?>global/img/bg2.jpg');-->

<div id="header_page" class="catsandstars" style="height: 67px;" >
    
    <div style= "margin-left:0px; margin-top:0px;">     

       <a href="#openModal" style="border: transparent;"><img id="unlock" onclick="" style="display:none; cursor:pointer; position: absolute; margin-top: 84px; margin-left: 342px; width: 30px; height: 30px;" src ='<?php echo $data['rootUrl'] ?>global/img/unlock_red.png' width="75px" height="75px" margin-left="85px" margin-top="-127px"></a>            

    </div>
    
    <div class="header"><h6 class='stroke' style="width:290px; margin-top:6px; margin-left:-36px; color:#0B55C4; text-shadow: 1px 4px #999; font-size:33px; font-weight:normal; text-align:center; font-family:Impact;">Tours Edit &nbsp; <?php echo $tours->id; ?> </h6><input type="text" readonly="true" style="display:none; background: #fff; margin-left: 7px; margin-top: -11px;width: 290px;color: #fff;" name="tour_name" id="tour_name"  value="" /></div>
    ...
    <div  id="toolbar">
        ...
        <select style="margin-right:-19px; height: 19px; margin-top:22px; width:290px; background: #128020; color: #fff;border-color: transparent;" name="fnombre" id="rate" onclick = "capturar();" onchange="obtenerValor(this.value);">
            ...
            <ul>
                <li style="margin: 0 -92px -26px; margin-top: 6px;">
                    ...
                    <form name="formulario" id="formulario" action="" method="post" onsubmit="onEnviar()">
                        ...
                        <button name="bt1" id="bt1" type="submit" style="cursor:pointer; color: #AC1B29;font-weight: 700; margin-top: 9px; margin-left: -306px; padding: 10px; font-size:9px; width: 118px;"  onclick="f_Cmb()">Summary Agency</button>

                        <button name="bt2" id="bt2" type="submit" style="cursor:pointer; color: #AC1B29;font-weight: 700; margin-top: 9px; margin-left: -246px; padding: 10px; font-size:9px; width: 118px;"  onclick="f_Cmb1()">Summary Passenger</button>

                        <button name="bt3" id="bt3" type="submit" style="cursor:pointer; color: #AC1B29;font-weight: 700; margin-top: 9px; margin-left: -306px; padding: 10px; font-size:9px; width: 118px;"  onclick="f_Cmb2()">Summary Passenger</button>
                ...
                <li class="btn-toolbar" id="btn-print">                        
                        <img id="print" title= "Print Credit Card" onclick="window.print();" style="cursor:pointer; position:absolute; margin-left: 5px; margin-top: -9px; "src ='<?php echo $data['rootUrl'] ?>global/img/print.png' width="35px" height="35px" margin-left="0px" margin-top="0px">
                </li>
                
                <li style="margin-left: -1px; margin-top: 1px;" class="btn-toolbar" id="btn-rastro">
                    <a class="link-button" id="btn-rastro2" style="border: transparent; margin-left: 5px; margin-top: 0px;">
                        <span class="icon-32-rastro" title="Nuevo" style="margin-left: 29px; margin-top: -14px; height:32px; width:32px;">&nbsp;</span>
                        Traces
                    </a>
                </li>

                <li style="margin-left: -1px; margin-top: 1px;" class="btn-toolbar" id="btn-pagos">
                    <a  style="margin-left: 19px; margin-top: -13px; border: transparent;" class="link-button" id="btn-pagos">    
                        <span class="pagos" title="Pagos" style="margin-left: 3px; margin-top: 0px; color:#4B0082; width: 32px; height: 32px; ">&nbsp;</span>
                        Payments
                    </a>
                </li>
                <li style="margin-left: -1px; margin-top: 1px;" class="btn-toolbar" id="btn-cancel">
                    <a class="link-button" style="border: transparent; margin-left:19px; margin-top:0px;"><i class="fa fa-arrow-left fa-3x" title="Regresar" style="color: #33449C; margin-top: -11px;"></i> <br>Back</a>
                </li>
            </ul>
            <div class="clear"></div>
        </div>
...
<!--background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');-->
<div id="content_page_tours" style="z-index:1; width:984px; height:1490px; margin-top:-54px;">
    ...
    <form id="form1" class="form" action="" method="post" name="form1">
        ...
        <div id="info-group" style="width: 900px; margin-left:6px;">
            ...
            <div id="reservation"  style="width:200px; font-size: 12px; margin-left: 121px; position: absolute;">
                ...
                <div>
                    <input type="text" id="reser" name="reser" style="background: #fff; font-weight: bold; font-size: 11px; width: 199px; text-align: center; height: 15px; padding-top: 1px;" value="<?php echo $tours->code_conf; ?>" readonly="readonly">
                </div>
            </div>
        ...
        <fieldset id="inputype" class="rojo" style="float: left; margin-bottom: 2%; border-radius: 0px 120px 0px 14px; box-shadow: 0 -8px 4px #DC1349; width: 47%;">
            ...
            <div id="opera" class="input">
                <table width="100%" >
                    <tr align="left">
                        ...
                        <td >
                            <input name="nombre" style="position:absolute; margin-left:-351px; margin-top:-10px; width:178px;" type="text"  id="nombre" value="<?php echo trim($login->nombre . ' (' . $login->usuario . ')'); ?>" readonly="readonly"/>
                        </td>
                    </tr>
                    <tr><td colspan="2" >
                            <table width="100%">
        ...
        <fieldset id="liderpax" style="position:absolute; margin-left:492px;  border-radius: 130px 0px 14px 0px; width: 180px; box-shadow: 0 -8px 4px #1E90F6;" class="cerati" >
        ...
        <fieldset style="margin-top: 5px; border-radius: 10%;margin-top: 2%; margin-bottom: 1%;  box-shadow: 6px 7px 4px #999;"class="booking2">
            <div id="date" align="center">
                <table width="90%">
                    ...
                    <input type="text" name="frates" readonly="readonly" id="frates" hidden="hidden"  value= "<?php echo $agency['tour_name']; ?>" />
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <select style="position:absolute; border: #000 2px solid; width:149px; margin-left: 1px; margin-top:24px; border-radius: 0px 0px 0px 0px; font-weight:bold;" id="estado_transfer_out" name="estado_transfer_out" onchange="fecha_transfer_out();">
                                                        ...
                                                        <optgroup  label="STATUS">
                                                            ...
                                                            <option style="font-weight:bold;" value="1">CONFIRMED</option>
                                                            <option style="font-weight:bold;" disabled="disabled" value="2">CANCELED</option> 
                                                            <option style="font-weight:bold;" value="5">CANCELED W/F</option> 
                                                            <option style="font-weight:bold;" disabled="disabled" value="3">NO SHOW</option> 
                                                            <option style="font-weight:bold;" value="6">NO SHOW W/F</option>                                                            
                                                            <option style="font-weight:bold;" value="4">CHANGE W/F</option> 
                                        ...
                                        <td id="tdRomm">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <input type="text" name="costo_hotel" id="costo_hotel" style="display:none;" value=""/>                                                 
</div>
                                                    </td>
                                                </tr>
                                                <td colspan="2">
...
//                                                            exit;
        ...
        <!--                                                                                    <td><? echo $hotel_reserve["sql"]; ?></td>-->
            <!--                                                                        <td><? echo $hotel_reserve['adult']+ $hotel_reserve['child']; ?></td>-->
                                                                                    ...
                                                                                    <td id="quitar_hotel" title="DELETE"><img src="<?php echo $data['rootUrl']; ?>global/img/admin/x01.png" style="cursor:pointer;" width="20" height="20" id="img_delete_hotel_<?php echo $hotel_reserve['id']; ?>" onclick='delete_hotel("<?php echo $hotel_reserve['id_hotel']; ?>");' /></td>
                                                                                </tr>
...
<!--                        <label for="opcion_traffic" style=" cursor:pointer; " >TRAFFIC TOURS  </label><input type="checkbox" id="opcion_traffic" checked="checked" <?php /*echo ($numpark > 0) ? 1 : 0; */?> name="opcion_traffic"/>-->
        ...
        <br />
        <fieldset style="border-radius: 5%; height:432px;  box-shadow: 6px 7px 4px #999;" class="blue">
...
<!--                                    <samp id="saldoactual">$0.00</samp>-->
                    ...
                    <tr style="width: 700px;" ><td>
                            ...
                            <input type="button" id="btn_rever_cob" name="btn_rever_cob" title="Reverse Payment" class="button_sliding_bg" style="display:none; position:absolute; background-color: #8c261a; border-color: lavenderblush; cursor:pointer; color:#fff; margin-left: -561px; margin-top: 82px; padding:2.1px; padding-left:3px; width:17px; height:17px; font-weight: bold; font-size:9px;"  size="20"   value="X" onclick="rever_collect_on_board();"  />
                        <td>
                        ...
                        <div style="position:absolute; margin-left:-2px; margin-top:0px;">
                            ...
                            <div id="trian1" style="display:none; position:absolute; margin-left:372px; margin-top:110px;" class="triangulo1"></div>
                            <div id="trian2" style="display:none; position:absolute; margin-left:385px; margin-top:110px;" class="triangulo2"></div>
                            <div id="trian3" style="display:none; position:absolute; margin-left:399px; margin-top:110px;" class="triangulo3"></div>
                            <div id="trian4" style="display:none; position:absolute; margin-left:413px; margin-top:110px;" class="triangulo4"></div>
                            <div id="trian5" style="display:none; position:absolute; margin-left:428px; margin-top:110px;" class="triangulo5"></div>
                            <div id="trian6" style="display:none; position:absolute; margin-left:442px; margin-top:110px;" class="triangulo6"></div>
                            <div id="trian7" style="display:none; position:absolute; margin-left:457px; margin-top:110px;" class="triangulo7"></div>
                            <div id="trian8" style="display:none; position:absolute; margin-left:472px; margin-top:110px;" class="triangulo8"></div>
                            <div id="trian9" style="display:none; position:absolute; margin-left:486px; margin-top:110px;" class="triangulo9"></div>
                            <div id="trian10" style="display:none; position:absolute; margin-left:500px; margin-top:110px;" class="triangulo10"></div>
                    ...
                    <tr style="width: 700px;" >
                        ...
                        <td>
                            ...
                            <input type="text" id="balance_due_copy" name="balance_due_copy" class="" style="display:none; text-align: right; width: 47px;" value="0.00" autocomplete="off" /> 
                        </td>
                    </tr>                
                ...
                <table class="oliveti" style="width: 46%; border: 2px solid #000; margin-left: -8px; margin-top: 9px; height: 166px; ">
                    ...
                    <tr style="width: 700px;">
                        ...
                        <td>
                            ...
                            <div>
                                ...
                                <input type="text" id="totalAmount_copy" name="totalAmount_copy" class="" style="display:none; text-align: right; width: 47px;" value="0.00" autocomplete="off" />  
                            </div>
                    ...
                    <tr style="width: 700px;">
                        <td>
                            ...
                            <input type="button" id="btn_rever_prepaid" name="btn_rever_prepaid" title="Reverse Payment" class="button_sliding_bg" style="display:none; position:absolute; background-color: #8c261a; border-color: lavenderblush; cursor:pointer; color:#fff; margin-left: 150px; margin-top: -4px; z-index: 1; padding:2.1px; width:17px; height:17px; font-weight: bold; font-size:9px;"  size="20"   value="X" onclick="rever_prepaid();"  />
                        </td>
                        
                        <div style="position: absolute; margin-left:-1px; margin-top:1px;">
                                    
                            <div id="cir1" style="display:none; position:absolute; margin-left:370px; margin-top:93px;" class="circle1"></div>
                            <div id="cir2" style="display:none; position:absolute; margin-left:385px; margin-top:93px;" class="circle2"></div>
                            <div id="cir3" style="display:none; position:absolute; margin-left:400px; margin-top:93px;" class="circle3"></div>
                            <div id="cir4" style="display:none; position:absolute; margin-left:416px; margin-top:93px;" class="circle4"></div>
                            <div id="cir5" style="display:none; position:absolute; margin-left:431px; margin-top:93px;" class="circle5"></div>
                            <div id="cir6" style="display:none; position:absolute; margin-left:446px; margin-top:93px;" class="circle6"></div>
                            <div id="cir7" style="display:none; position:absolute; margin-left:460px; margin-top:93px;" class="circle7"></div>
                            <div id="cir8" style="display:none; position:absolute; margin-left:474px; margin-top:93px;" class="circle8"></div>
                            <div id="cir9" style="display:none; position:absolute; margin-left:488px; margin-top:93px;" class="circle9"></div>
                            <div id="cir10" style="display:none; position:absolute; margin-left:502px; margin-top:93px;" class="circle10"></div>
...
<!--    <label  style="padding-left:57px; font-size:16px; "><strong style="padding-bottom:10px; color: #000; margin-left:-55px;">$</strong></label> -->
                ...
                <!--class="money"-->
                <input type="text" name="pago_driver" id="pago_driver" size="12" style="font-size: 22px; font-weight:bold; text-align:right; margin-top:-21px; margin-left:54px; width:114px; height:20px;" value="" placeholder="0.00" onkeypress="return solopagodriver(event);"  onkeyup="dupliPago(); ponDecimales(2);" autocomplete="off"/>
                                            ...
                                            <tr>
                                                <td>
                                                    <div id="opera" class="enviarForm" style="padding-top:5px; cursor:pointer;" align="left">
                                                        ...
                                                        <input type="button" style="display:none" id="enviar_escondido2" value="0"  />
                                                </td>
                                            </tr>
...
<!--        <input type="text" name="tempwf"  id="tempwf" title="temp W/Fees" size="12" style="display:none; margin-top:4px; margin-left:17px; width:114px; height:20px;" value="<?php echo $cargos; ?>" />-->
        ...
        <input type="text" id="temp_driver"  name="temp_driver" title="Temp Driver" size="12" style="display:none; margin-top:4px; margin-left:140px; width:114px; height:20px;" value="<?php echo $cargoscob; ?>" />
        <input type="text" id="temp_prepaid"  name="temp_prepaid" title="Temp Prepaid" size="12" style="display:none; margin-top:4px; margin-left:141px; width:114px; height:20px;" value="<?php echo $cargospp; ?>" />
        ...
        <input type="text" id="estado_pre1"  name="estado_pre1" title="estado_pre1" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre2"  name="estado_pre2" title="estado_pre2" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre3"  name="estado_pre3" title="estado_pre3" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre4"  name="estado_pre4" title="estado_pre4" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre5"  name="estado_pre5" title="estado_pre5" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre6"  name="estado_pre6" title="estado_pre6" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre7"  name="estado_pre7" title="estado_pre7" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre8"  name="estado_pre8" title="estado_pre8" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre9"  name="estado_pre9" title="estado_pre9" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
        ...
        <input type="text" id="estado_pre10"  name="estado_pre10" title="estado_pre10" size="12" style="display:none; margin-top:4px; margin-left:3px; width:59px; height:11px; text-align:right;" value="" />
...
<!--    <div id="dialog2" title="History of Payments [Multi-Day Tours]" style="display:none; width:550px; margin-left:-12px;">
    ...
    <div id="dialog2" title="History of Payments [Multi-Day Tours]" style="display:none; width:550px; margin-left:1px;">
            <div style="overflow-y: scroll;height:270px; width:579px; margin-left:-11px;">
                <table style="margin-left:0px; width:564px;" class="grid2" cellspacing="1" id="grid2">
                    <thead>
                        <tr>
                            <td style="font-weight:bold; text-align: center; width:560px; padding-left:2px;">DETAILS</td>
                            <td style="font-weight:bold; text-align: center; width:100px; padding-left:2px;">STATUS</td>
                            <td style="font-weight:bold; text-align: center; width:210px; padding-right:10px;">DATE</td>                          
                    ...
                    <tbody>
                        ...
                        $sqlras = "SELECT id_tours, detalles, fecha, tipo_usuario FROM tours_rastro where id_tours = $id_multi AND tipo_usuario = 'Removed' order by fecha DESC;";
                        $rsras = Doo::db()->query($sqlras);
                        $pagos = $rsras->fetchAll();
                        foreach ($pagos as $p):
                            ?>
                            <tr class="row1">
                                <td style="text-align: left; width:560px; height:30px;"><?php echo '<pre>'; echo $p['detalles']; echo '<pre>'; ?></td>
                                <td style="text-align: center; center; color: red; font-weight:bold;"><?php echo $p['tipo_usuario']; ?></td>                                
                                <td style="text-align: center;"><?php echo $p['fecha']; ?></td>                               
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <!--Boton Para eliminar Pagos-->
                ...
                <div class="" style="position: absolute; margin-left: 452px; margin-top: 54px;" id="btn-pagos3">
                    <a  style="margin-left: -3px; margin-top: -9px;" class="" id="btn-pagos3"> 
                        <label  style="float:right;  font-size:14px;  margin-top: -734px; margin-left:-20px;"><strong id="labelpay" style="display:none; padding-bottom:10px; color: #ff4500;"><i>Payments</i></strong></label>
                        <span id="histo_pagos" class="pagos" title="" onclick="historia_pagos();" style="position:absolute; cursor:pointer; margin-left: 0px; margin-top: -767px; color:#4B0082; width: 32px; height: 32px; ">&nbsp;</span>                    
                    </a>
                </div>
                
               <div>             
                
               <div id="titulo_tabla" class="azufre" style="border-collapse:collapse; display:none; position:absolute; text-align:center; margin-top:-548px; margin-left:436px; height:25px; width:529px; font-weight:bold; font-size:15px; color:#fff; border-radius:0px 0px 0px 0px; border: 0px #000 solid;"><marquee style="margin-left:50px;" scrolldelay=350 width=200 BEHAVIOR=alternate>History of Payments</marquee><img id="cerrar" title="close" onclick="cerrar_historia();" style="position:absolute; margin-left:125px; margin-top:0px; width:13px; height:14px; cursor:pointer;" src ='<?php echo $data['rootUrl'] ?>global/img/remove.png' width='12px' height='12px'>
                <table id="encabezado" class="grid2" cellspacing="1">
                  <thead>
                    <tr>
                        <td style="width: 172.5px; background-color:#fff; border-left: 1px solid #d7d7d7; border-right: 1px solid #d7d7d7; border-bottom: 1px solid #d7d7d7;border-top: 1px solid #d7d7d7;">
                        ...
                        <td style="text-align: center; width:129.7px; background: #f60018; color: #fff;">Method</td>
                        <td style="text-align: center; width:151.2px; background: #f60018; color: #fff;">Type Pay</td>
                ...
                <div id = "historia_pagos" class="oliveti" style="display:none; position:absolute; overflow-y: scroll; height:176px; width:529px; margin-left:436px; margin-top:-506px;">
                ...
                <table class="grid2" cellspacing="1" id="grid2" style="background-color:#fff;">
                    ...
                    <tbody>
                        ...
                        $sql_pagos = "SELECT id, pago, tipo_pago, pagado, fecha FROM tours_pago where id_tours = '$idmulti' AND tipo = 'MULTI' AND pagado <> '0.00' order by fecha DESC";
                ...
                <marquee style="font-size:10px;" width=515 direction=left>
                Guarda la Reserva despues de Eliminar los Pagos !!!
                </marquee> 
            ...
            <script type="text/javascript">
                ...
                function fecha_transfer_out()
                {
                    ...
                    //CANCELED W/F
                        ...
                        document.getElementById('estado_transfer_out').value = "5";
                    ...
                    //NO SHOW W/F
                        ...
                        document.getElementById('estado_transfer_out').value = "6";

                        document.getElementById('fec_retor').value = "N/S W/F";
                    ...
                    //CHANGE W/F
                        ...
                        document.getElementById('estado_transfer_out').value = "4";

                        document.getElementById('fec_retor').value = "CH W/F";
                        
                        document.getElementById('estado_transfer_out').style.background = "#fcf75e";  
                        document.getElementById('estado_transfer_out').style.color = "#000";
                        document.getElementById('estado_transfer_out').style.border = "2px solid #FFFFFF";
...
//                                var id_tours = "<?php echo $tours->id; ?>"; 
//                                //alert(id_tours);
//                                $("#flotador").load(encodeURI('<?php /*echo $data['rootUrl']*/ ?>admin/tours/idtour/' + id_tours));
...
//        $("#pago_agente").click(function () {
        ...
        $(window).load(function () {
            ...
            document.getElementById('totalAmount_copy').value = document.getElementById('totalAmount').value;
...
//                    document.getElementById('otheramountp').value = document.getElementById('otheramount').value;
//                    document.getElementById('saldoporpagar_copy').value = document.getElementById('saldoactual').value;
//                    document.getElementById('paid_driver_copy').value = document.getElementById('paid_driver').value;
//                    document.getElementById('balance_due_copy').value = document.getElementById('balance_due').value;
//                    document.getElementById('totalAmount_copy').value = document.getElementById('totalAmount').value;
//                    document.getElementById('pay_amount_copy').value = document.getElementById('pay_amount').value;
...
//                var totalpark = parseFloat(priceTransportLocal) + parseFloat(priceAdmision);
               ...
               if ($("#opcion_parks_edit").is(':checked')) {
                ...
                $("#costo_hotel").val((totalHotel).toFixed(2));
...
//                    $("#totaltotal").text(((apagar) - (pay_amount)).toFixed(2));
            ...
            }else if (tipo_pago == 5) {  //CREDIT VOUCHER                
...
//                    $("#opcion_saldo1").attr('disabled',false);*/
                    ...
                    if (pay_amount == 0 && paid_driver == 0 && otheramount == 0) {
                        ...
                        var agency_balance_due = (parseFloat(apagar) - parseFloat(paid_driver)) - parseFloat(pay_amount);
...
//                        $("#totaltotal").text(((apagar) - (pay_amount)).toFixed(2));
                    ...
                    if (pay_amount > '0' && paid_driver == '0' && otheramount == '0') {
                        ...
                        var temp_prepaid = $("#temp_prepaid").val();
                        var result = parseFloat(apagar) + parseFloat(temp_prepaid);
                        var totalbalance = (parseFloat(result) - parseFloat(paid_driver)) - parseFloat(pay_amount); 
                        var agency_balance_due = (parseFloat(result) - parseFloat(paid_driver)) - parseFloat(pay_amount); 
...
//                            $("#totaltotal").text((result).toFixed(2));
                            ...
                            var result = parseFloat(apagar) + parseFloat(temp_prepaid);
                            var res_total = (parseFloat(result) - parseFloat(paid_driver)) - parseFloat(pay_amount);
                            var agency_balance_due = (parseFloat(result) - parseFloat(paid_driver)) - parseFloat(pay_amount);
...
//                            $("#totaltotal").text((result).toFixed(2));  
                    ...
                    $("#tot_amount_paidp").val((tot_amount_paid).toFixed(2));
                    $("#agency_balance_due").val((agency_balance_due).toFixed(2));
            ...
            if (tipo_pago == 3) {    
                ...
                if (pay_amount == 0 && paid_driver == 0 && other_amount == 0) { 
                    ...
                    var bd = (parseFloat(result) - parseFloat(paid_driver)) - parseFloat(pay_amount);
                    var totalbalance = (parseFloat(result) - parseFloat(paid_driver)) - parseFloat(pay_amount);              
                    var agency_balance_due = (parseFloat(result)- parseFloat(paid_driver)) - parseFloat(pay_amount);
                ...
                if (other_amount > 0 && paid_driver == 0 && pay_amount == 0) {
                    ...
                    var agency_balance_due = (parseFloat(resultado) - parseFloat(paid_driver)) - parseFloat(pay_amount);
                    var tot_amount = parseFloat(paid_driver) + parseFloat(pay_amount);                
...
//                          $("#paid_driver").val((bal).toFixed(2));
            ...
            if (tipo_pago == 8) { 
                ...
                if (pay_amount == 0 && paid_driver == 0 && other_amount == 0) {
                    ...
                    var totalbalance = (parseFloat(result) - parseFloat(paid_driver)) - parseFloat(pay_amount);              
                    var agency_balance_due = (parseFloat(result)- parseFloat(paid_driver)) - parseFloat(pay_amount);
                    var total_amount_paid = parseFloat(paid_driver) + parseFloat(pay_amount);        
                    ...
                    if(op_pag_conduct == "3"){
                        ...
                        $("#balance_due").val((bd).toFixed(2));
                        $("#totalAmount").val((result).toFixed(2));
                        $("#tot_amount_paid").val((total_amount_paid).toFixed(2)); 
                        $("#agency_balance_due").val((agency_balance_due).toFixed(2));                        
            ...
            /***************************3***********************************ok**/
                ...
                if (other_amount > 0 && paid_driver == 0 && pay_amount == 0) {
                    ...
                    var agency_balance_due = (parseFloat(res_total)- parseFloat(paid_driver)) - parseFloat(pay_amount);
...
<script type="text/javascript">
    ...
    function duplisaldo()
    {
        ...
        document.getElementById('temp_copy').value = document.getElementById('temp').value; 
        document.getElementById('pay_amountp').value = document.getElementById('pay_amount').value;
        document.getElementById('tot_amount_paidp').value = document.getElementById('tot_amount_paid').value;  
        document.getElementById('tot_charge').value = document.getElementById('temp').value;
        document.getElementById('paid_driverp').value = document.getElementById('paid_driver').value;
    }
</script>
...
<script type="text/javascript">
    ...
    $("#btn_remove_cob").click(function(){   
        ...
        var id_multiday = "<?php echo $tours->id; ?>"; 
        ...
        var paid_driver = $("#paid_driver").val();        
        var pay_amount = $("#pay_amount").val();        
        var saldoactual = $("#saldoporpagar").val();       
        var totalAmount = $("#totalAmount").val();        
        var temp = $("#temp").val();        
        var otheramount = "<?php echo $otheramount; ?>";        
        var prepaid = "<?php echo $pre_paid_amount; ?>";
            
        if(id_radio == ''){            
            alert("Selecciona el Pago a Eliminar");            
            //exit;            
        }else{
        ...
        //****************************************COLLECT ON BOARD***********************************************        
         ...
         if(metodo_pago == 'COLLECT ON BOARD' && tipo_pago == 'CREDIT CARD WITH FEE' && otheramount == '0.00' && pay_amount >= '0.00'){
            ...
            var totpagar = parseFloat(totalAmount) - parseFloat(fee);
            var apagare1 = apagare;     
            ...
            if (confirm('Desea Eliminar Este Pago?')) {           
                ...
                if (tempo > '0.00' && otheramount == '0.00') {                           
                    ...
                    setTimeout(function () {                        
                        ...
                        $("#totalAmount").val((totpagar).toFixed(2));
...
//                        $("#op_pago_id").val((8).toFixed(2));
        ...
        if(metodo_pago == 'COLLECT ON BOARD' && otheramount == '0.00' && pay_amount >= '0.00' && (tipo_pago == 'CREDIT CARD NO FEE' || tipo_pago == 'CASH' || tipo_pago == 'CHECK')){   
            ...
            var result_paid_driver = parseFloat(paid_driver) - parseFloat(valor_pagado); 
            var tot_amount_paid = parseFloat(result_paid_driver) + parseFloat(pay_amount);            
            var balance_due = parseFloat(saldoactual) - parseFloat(tot_amount_paid);
            var agency_balance_due = balance_due;
            var collect = result_paid_driver;    
            var apagare1 = apagare;     
            var totpagar = parseFloat(totalAmount);
            //var apagar = parseFloat(apagare1) + parseFloat(extra) - parseFloat(desc_porc) - parseFloat(desc_valor) - parseFloat(desc_temporal);
            var apagar = parseFloat(apagare1) + parseFloat(extra) - parseFloat(desc_porc) - parseFloat(desc_valor);
    ...
    //                $("#op_pago_id").val((8).toFixed(2));
        ...
        if(metodo_pago == 'COLLECT ON BOARD' && tipo_pago == 'CREDIT CARD WITH FEE' && otheramount > '0.00' && pay_amount >= '0.00'){            
            ...
            var prepaid = $("#prepaid").val();
            var temp_driver = $("#temp_driver").val();
            var totalAmounte = $("#totalAmount").val();
            var desc_porc = $("#descuento").val();
            var desc_valor = $("#descuento_valor").val();
            var extra = $("#extra").val(); 
            //var desc_temporal = $("#descuento_temporal").val(); 
            ...
            var fee_driver = (parseFloat(saldoactual) - parseFloat(otheramount)).toFixed(2);  
            
            var apagare1 = apagare; 
            var apagar = parseFloat(apagare1) + parseFloat(extra) - parseFloat(desc_porc) - parseFloat(desc_valor);
            //var apagar = parseFloat(apagare1) + parseFloat(extra) - parseFloat(desc_porc) - parseFloat(desc_valor) - parseFloat(desc_temporal);
            
            var tot_fee_amount = (parseFloat(totalAmounte) - parseFloat(apagar)).toFixed(2);
            ...
            if (confirm('Desea Eliminar Este Pago?')){  
                ...
                setTimeout(function () {                        
                    ...
                    $("#paid_driver").val((result_paid_driver).toFixed(2));                        
                    $("#balance_due").val((balance_due).toFixed(2));
                    $("#totalAmount").val((total_pagare).toFixed(2));
        ...
        if(metodo_pago == 'COLLECT ON BOARD'  && otheramount > '0.00' &&  pay_amount >= '0.00' && (tipo_pago == 'CREDIT CARD NO FEE' ||  tipo_pago == 'CASH' ||  tipo_pago == 'CHECK')){ 
            ...
            var apagar = parseFloat(apagare1) + parseFloat(extra) - parseFloat(desc_porc) - parseFloat(desc_valor); 
            //var apagar = parseFloat(apagare1) + parseFloat(extra) - parseFloat(desc_porc) - parseFloat(desc_valor) - parseFloat(desc_temporal);
            var tot_fee_amount = (parseFloat(totalAmount) - parseFloat(apagar)).toFixed(2); 
...
//                        $("#op_pago_id").val((8).toFixed(2));
    ...
    //                $("#op_pago_id").val((8).toFixed(2));
        ...
        if(metodo_pago == 'PRED-PAID' && tipo_pago == 'CREDIT CARD WITH FEE' && otheramount > '0.00' && paid_driver >= '0.00'){  
            ...
            //y hay que restar el fee del valor prepagado al temp total
            // temp es igual al total de los fee pagados
            //var totalAmounte = document.getElementById('totalAmount').value; 
            var temp = $("#temp").val();
            var valor_pagado = $("#pago_tabla").val();              
            var paid_driver = $("#paid_driver").val();            
            var pay_amount = $("#pay_amount").val();                    
    ...
    //                $("#descuento_temporal").val((tmp).toFixed(2));                        
        ...
        if(metodo_pago == 'PRED-PAID'  && otheramount > '0.00' && paid_driver >= '0.00' && (tipo_pago == 'CREDIT CARD NO FEE' ||  tipo_pago == 'CASH' ||  tipo_pago == 'CHECK')){ 
            ...
            var saldoactual = $("#saldoporpagar").val();
            var otheramount = $("#otheramount").val();
            var fee_driver = parseFloat(saldoactual) - parseFloat(otheramount);
            var apagare1 = apagare; 
            var apagar = parseFloat(apagare1) + parseFloat(extra) - parseFloat(desc_porc) - parseFloat(desc_valor); 
            var tot_fee_amount = (parseFloat(totalAmount) - parseFloat(apagar)).toFixed(2); 
            var fee_amount = (parseFloat(tot_fee_amount) - parseFloat(fee_driver)).toFixed(2);      
            ...
            if(temp > '0.00' && paid_driver > '0.00'){                 
                ...
                var total_other = parseFloat(otheramount) + parseFloat(fee_driver);
                var result_paid_amount = parseFloat(pay_amount) - parseFloat(valor_pagado); 
                var result_paid_driver = parseFloat(paid_driver);              
                var balance_due = parseFloat(total_other) - parseFloat(result_paid_driver);
                var totpagar = parseFloat(apagar) + parseFloat(fee_driver) + parseFloat(fee_amount);
                var tot_amount_paid = parseFloat(result_paid_driver) + parseFloat(result_paid_amount);
                var agency_balance_due = parseFloat(totpagar) - parseFloat(tot_amount_paid);
                var collect = parseFloat(result_paid_driver);
                var prepaid = parseFloat(result_paid_amount);                
                var res_temp = parseFloat(fee_driver) + parseFloat(fee_amount);     
            ...
            if (confirm('Desea Eliminar Este Pago?')){  
                    ...
                    $("#balance_due").val((balance_due).toFixed(2));
                    $("#totalAmount").val((totpagar).toFixed(2));                    
                    $("#pay_amount").val((result_paid_amount).toFixed(2));
                    $("#tot_amount_paid").val((tot_amount_paid).toFixed(2)); 
                    $("#agency_balance_due").val((agency_balance_due).toFixed(2));
                    $("#temp").val((res_temp).toFixed(2));                    
                    $("#prepaid").val((prepaid).toFixed(2));
    ...
    //              $("#op_pago_id").val((8).toFixed(2));    
                ...
                if(result_paid_amount == '0.00'  && paid_driver >= '0.00'){
        ...
        //Retrasamos el envio de datos 100 milisegundos para que los datos se carguen previamente desde la fucion duplisaldo()
            ...
            setTimeout(function () {
                ...
                var saldoactual_copy = document.getElementById('saldoporpagar_copy').value;
                var paid_driver_copy = document.getElementById('paid_driver_copy').value;       
                var balance_due_copy = document.getElementById('balance_due_copy').value;
                var totalAmount_copy = document.getElementById('totalAmount_copy').value;
                var pay_amount_copy = document.getElementById('pay_amount_copy').value;
                ...
                $.ajax({
                        ...
                        url:   '<?php echo $data['rootUrl']?>admin/multidaytours/elimina_pagos_cob/'+ id_multiday + '/' + id_radio + '/' + saldoactual_copy + '/' + paid_driver_copy + '/' + balance_due_copy + '/' + totalAmount_copy + '/' + pay_amount_copy + '/' + tot_amount_paid_copy + '/' + agency_balance_due_copy + '/' + temp_copy + '/' + valor_pagado + '/' + metodo_pago + '/' + tipo_pago + '/' + fecha_actual + '/' + usuario + '/' + otheramount_copy, //archivo que recibe la peticion fecha_actual
