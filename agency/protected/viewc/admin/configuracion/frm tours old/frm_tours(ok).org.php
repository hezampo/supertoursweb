...
<div id="header_page" style="background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');">
    <div class="header2">Multi - Day  Tours [New]<input type="text" readonly="true" style="background: #33449C;margin-left: 212px;margin-top: -36px;width: 303px;color: #fff;" name="tour_name" id="tour_name" placeholder="Tour Name" value="" /></div>
<script type="text/javascript">
    function capturar()
    {
        var x = document.getElementById('tour_name1').value;
        document.getElementById('tour_name').value = x;
        document.getElementById('tour_name2').value = x;
    }
    
</script>
    <div id="toolbar">

        <select style="margin-left:3px; margin-top:11px; width:303px; background: #AC1B29;color: #fff;border-color: transparent;" name="fnombre" id="rate"  onchange="valorObtenido();obtenerValor(this.value);">
        ...
        <script type="text/javascript">
            var obtenerValor = function (x) {
                ...
                net_rate.value = x;
                //document.getElementById('tour_name2').value = $('#rate').val();
            };
        </script>    
        <script type="text/javascript">
            function valorObtenido(){
               var id_oculto = $('#rate').val();
                ...
                if(id_oculto == 0){
                    ...
                    //document.getElementById('tour_name2').value = document.getElementById('tour_name').value;
                    //document.getElementById('tour_name2').value = document.getElementById('rates').value;
                    document.getElementById('tour_name2').value = $('#rate').val();
                }else{
...
<!--                             <input name="tour_name" readonly="true" style="width:220px; color: #0F0CCB; margin-left: -23%; margin-top: 2%;" type="text" id="tour_name" value="<?php echo $agency['tour_name']; ?>"  />-->
                            ...
                            <input type="text" readonly="true" style=" display:none; background: #33449C;margin-left: 212px;margin-top: -36px;width: 303px;color: #fff;" name="tour_name2" id="tour_name2" placeholder="Tour Name2" value="" />
                        </div>
                    </fieldset>
                    <!-- end lider pass -->
                </td>
