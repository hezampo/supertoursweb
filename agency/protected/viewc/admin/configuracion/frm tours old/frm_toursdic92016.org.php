...
<div id="header_page" style="background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');">
    <div class="header2">Multi - Day  Tours [New]
<input type="text" style="background: #33449C;margin-left: 212px;margin-top: -36px;width: 303px;color: #fff;border-color: transparent;font-family: Arial, Helvetica, sans-serif;" name="tour_name" id="tour_name" placeholder="Tour Name" /></div>
...
<script>
function myFunction() {
    //el id de la caja de los tarifarios es id="rate"
    var x = 'TOUR NAME ----------------------------------------------->';
    document.getElementById("tour_name").value = x;
}
</script>   
