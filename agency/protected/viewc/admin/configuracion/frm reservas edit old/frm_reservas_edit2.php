...
<!--            <div  style="width: 102px;color:#4B0082;"><strong>CHANGE STATUS</strong></div>-->
            <div class="ho" style="color: #fff;background: #bb0000;padding: 4px;margin-top: 3px; margin-left:47px; width:44px; ">STATUS</div>
...
<!--                    <td>                    
                        href="javascript:void(window.close('<?php echo $url1; ?>','RESERVAS','resizable=no,location=no,menubar=no, scrollbars=no,status=no,toolbar=no,fullscreen=no,d ependent=no,width=950,height=664,left=100,top=100' ))" id="btn-edit" class="link-button" > <img  src="<?php echo $data['rootUrl']; ?>global/img/admin/edit2.png" title="Modify reservation data"/>
...
<!--                     <a href="#" onclick="javascript:var win = window.open('','_self');win.close();return false;">CERRAR</a> -->
<!--                <a href = "javascript: parent.close ();" Target = "_ top"> Cerrar </a>-->
...
//        var cantidad = parseFloat(paid_driver) + parseFloat(pay_amount);
    ...
    $(window).load(function () {
        //alert("Se cargo");
        ocultarmenu();
//        document.getElementById('menu-bar').disabled="true";
//        setTimeout(function () {
//            $('#pay_driver').click();
//            //document.getElementById('tot_amount_paid').value = '0.00';
//
