                ...
                <tbody>
                    ...
                    foreach ($data["reservas"] as $e) {
                        ...
                        if ($e['type_tour'] == 'ONE') {
                            ...
                            $pagado2 = $rs2->fetchAll();
                            
                            
                            
                            $sql1 = "select agency_balance_due, total, op_pago  from tours_oneday where id = ?";
                            $rs1 = Doo::db()->query($sql1, array($e['id_tours']));
                            $pagado1 = $rs1->fetchAll();  
                            
                            foreach($pagado1 as $pag1){
                                
                                $totalcargos = $pag1['total'];
                                $op_pago = $pag1['op_pago'];
