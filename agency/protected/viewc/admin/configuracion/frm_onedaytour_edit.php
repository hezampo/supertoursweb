...
/*    .booking2{
    ...
    .booking2{
        background: #00ea38;  /* fallback for old browsers */
        background: -webkit-linear-gradient(to top, #00ea38, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF);  /* Chrome 10-25, Safari 5.1-6 */
        background: linear-gradient(to top, #00ea38, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF, #FFFFFF); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    ...
    .azul2017{
        background: #78b8f2;  /* fallback for old browsers */
        background: -webkit-linear-gradient(to top, #126aba, #248cea, #78b8f2);  /* Chrome 10-25, Safari 5.1-6 */
        background: linear-gradient(to top, #126aba, #248cea, #78b8f2); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    }
...
/*height: 103%;*/
    ...
    .stroke {
        ...
        -webkit-text-stroke: 2px #ff2301;
    }
   
    
    .catsandstars {        
      background-image:  url("<?php echo $data['rootUrl'] ?>global/img/bck_one.jpg");                         
...
<?php
    ...
    $otheramount = $data['tour']->otheramount; 
    $paid_driver = $data['tour']->paid_driver; 
    $pred_paid_amount = $data['tour']->pred_paid_amount;
    $total_charge = $data['tour']->total_charge;
    ...
    $group_park = $data['tour']->group_park;    
    

    $sqlpag = "SELECT SUM(pagado) AS SUMPAG FROM tours_pago WHERE id_tours = '$id_oneday' AND tipo = 'ONE'";
...
<div class="catsandstars" id="header_page" style="height: 67px;" >
    <div style="margin-top: -11px;" class="header">
        <h6   class='stroke'  style="width:370px; margin-top:17px; margin-left:-4px; color:#0B55C4; text-shadow: 1px 4px #999; font-size:33px; font-weight:normal; text-align:center; font-family:Impact;">One Day Tours Edit &nbsp; ID  <?php echo $data['tour']->id; ?></h6>            
...
//        $estado_transf_in = $est['estado_one'];
        ...
        $fecha_retorno_tour = $data['tour']->ending_date;
        
                
        
        list ($anyor, $mesr, $diar) = explode("-", $data['tour']->ending_date);
        $fecha2 = $diar . "-" . $mesr . "-" . $anyor;
        $fecha3 = $mesr . "-" . $diar . "-" . $anyor;
...
//                    echo $tours_total;
    ...
    <script>
        function block_invoiced() {  
            ...
            var estado = "<?php echo $data['tour']->estado; ?>";
            ...
            document.getElementById("wdwus").disabled = true;
            document.getElementById("wphol").disabled = true;
            document.getElementById("kspc").disabled = true;
            ...
            document.getElementById("include_ticket").disabled = true;
            document.getElementById("delete_park").disabled = true;           
            ...
            document.getElementById("saldoactual").disabled = true;           
...
<script>
        function unblock_invoiced() {   
            ...
            var result_pagos = "<?php echo $resultado_pagos; ?>"; 
            var estado = "<?php echo $data['tour']->estado; ?>";
            ...
            if(password == "$uper3001Tours"){
                ...
                document.getElementById("saldoactual").disabled = false;           
    ...
    <div style= "margin-left:0px; margin-top:0px;">     
       ...
       <a href="#openModal" style="border: transparent;"><img id="unlock" onclick="" style="display:none; cursor:pointer; position: absolute; margin-top:-53px; margin-left: 11px; width: 30px; height: 30px;" src ='<?php echo $data['rootUrl'] ?>global/img/unlock_red.png' width="75px" height="75px" margin-left="85px" margin-top="-127px"></a>            

    </div>
    
    <div style="margin-top:-65px;" id="toolbar">
        ...
        <div class="toolbar-list">
            <ul>
                ...
                <li class="btn-toolbar" id="btn-print">
                        ...
                        <img id="print" title= "Print Credit Card" onclick="window.print();" style="position:absolute; margin-left: 17px; margin-top: 5px; cursor:pointer;"src ='<?php echo $data['rootUrl'] ?>global/img/print.png' width="35px" height="35px" margin-left="0px" margin-top="0px">
                ...
                <li class="btn-toolbar" id="btn-rastro">
                    <a   class="link-button" id="btn-rastro" style="margin-top: 5px; margin-left: 5px; border:transparent; color:#000;">
                ...
                <li style="margin-left: -1px; margin-top: 1px;" class="btn-toolbar" id="btn-pagos">
                    <a  style="margin-left: 1px; margin-top: -15px; border:transparent; color:#000;" class="link-button" id="btn-pagos">    
                        <span class="pagos" title="Pagos Eliminados" style="margin-left: 5px; margin-top: 12px; color:#4B0082; width: 32px; height: 32px; ">&nbsp;</span>
                        Deleted<br>
                        Payments
                    </a>
                </li>
...
<div id="content_page_tours" style="z-index:1; margin-top: -55px; width: 984px; height: 1424px;">
...
<!--        <input type="text" name="opc_ap"  id="opc_ap" size="12" style="" value="0" />-->
        ...
        <div id="info-group" style="width: 900px;">
            ...
            <div id="reservation" style="width:300px;">
                ...
                <div> 
                    <input type="text" id="reser" name ="reser" style="background: #ffffff; text-align: center; width: 299px; font-weight: 600; font-size: 11px; padding-top: 1px; height: 10px;" value="<?php echo $data['tour']->code_conf; ?>" readonly="readonly" />
                </div>
...
<!--                <div><strong>CHANGE STATUS</strong></div>-->
        ...
        <fieldset id="bck1" style="width: 97.3%;margin-top: 5px; border-radius: 10%;background-color:#DCDCDC;" class="gris3">
...
<!--                        <td width="4%" align="right"><a href="" id="dataclick2" ><img src="<?php echo $data['rootUrl']; ?>global/images/calendar.png" alt=""  align="absmiddle" width="19" height="20" border="0" style="padding-bottom: 3.1px;" /></a></td>-->
                    ...
                    <input type="text" name="group_park" id="group_park" style="display:none;" size="2" maxlength="10" style="margin-left: 254px;" value="<?php echo $data['tour']->group_park; ?>">
        ...
        <fieldset id="inputype2" title="" style="width:97%; margin-top: 4px; height:70%; border-radius: 10%;"class="booking2"><legend style="border:1px solid #00C; background-color: #fff;">ONE DAY TOUR TO</legend>
            <div id="opera" class="input">
...
<!--                                        <a  href='<?php echo $data['rootUrl'] ?>admin/reservas/add'><img src ='<?php echo $data['rootUrl'] ?>global/estilos/img/one-day/WDW1.png' width='370px' height='70px'></a>-->
                ...
                //Datos de las variables en PHP
                                ...
                                <fieldset  style="margin-left: 132px; border:4px solid #AC1B29; width:150px; color:#fff; height: 83px; border-radius: 20px 20px 0px 0px; background-color: transparent;" class="round">
                                    ...
                                    <marquee align="center" height="50"  style="border-radius:10px 10px 0px 0px;" direction="up" onmouseover="this.stop();" onmouseout="this.start();" scrolldelay="420" class="wdw1" ><strong>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="text" name="fechale_retorno" id="fechale_retorno"  style="color:#3b83bd; font-size:14px; font-weight:bold;  text-align:center;"  size="10" maxlength="15" readonly="readonly" value="<?php if($fecha_retorno_reservas == 'N/A'){echo "NO SHOW"; } if($fecha_retorno_reservas == '-C-'){ echo "CANCELED"; } if($fecha_retorno_reservas == ''){ echo "ERROR"; } if($fecha_retorno_reservas == $fec_retorno2){ echo "ERROR"; }  if($fecha_retorno_reservas == $fec_retorno3){ echo "ERROR"; } if($fecha_retorno_reservas == $fecha_retorno_tour){ echo "CONFIRMED";} ?>"   autocomplete="off" />
                                                    </td>
                                                    <td></td>
                                                    <td>&nbsp;</td>
                                                    <td title="Price of transport per person"style="width: 43%;">
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        <td>
                                                            <div id="div_from2">
                                                                <div class="label">FROM</div>
                                                                <select style="width:190px; color:#000; font-size: 12.5px;" name="from2" id="from2" class="select">
                                                                    <option value="1">Orlando</option>
                                                                </select>
                                                            </div>
                                                        </td>
                                    ...
                                    <tbody>
                                        <tr class="">
                                            <td width="10%"><?php echo $data['res']->trip_no2 ?>
                                                <input type="hidden" name="trip2" id="trip2" value="300" class="trip1">
                                                <input name="sarrival" type="hidden" value="1">
                                            </td>
...
<!--<option value="0"> <p style="display: none;">.</p></option>-->
        ...
        <fieldset style="border-radius: 5%; margin-top: -6px; height:445px;" class="super">
...
<!--                        <a href="#" class="a-btn">
                          <span class="a-btn-text">Add Payment</span>
                          <span class="a-btn-slide-text">Now!!!</span>
                                ...
                                <td>
                                    <table class="oliveti" style="width: 39%; border: 2px solid #000; margin-left: 0px; margin-top: 4px; height: 157px;">
                                            ...
                                            <td>
                                                ...
                                                <div  style="width:116px;">
                                                    <div class="price">
                                                        ...
                                                        <input type="text" id="saldoactual_copy" name="saldoactual_copy" class="" style="display:none; text-align: right; width: 47px;" value="0.00" autocomplete="off" />             
                                                    </div>
                                        ...
                                        <tr style="width: 700px;" ><td>
                                                ...
                                                <input type="button" id="btn_rever_cob" name="btn_rever_cob" title="Reverse Payment" class="button_sliding_bg" style="display:none; position:absolute; background-color: #8c261a; border-color: lavenderblush; cursor:pointer; color:#fff; margin-left: 245px; margin-top: 94px; padding:2.1px; padding-left:3px; width:17px; height:18px; font-weight: bold; font-size:9px;"  size="20"   value="X" onclick="rever_collect_on_board();"  />
                                            <td>                                               
                                            ...
                                            <div style="position:absolute; margin-left:8px; margin-top:12px;">
                                                ...
                                                <div id="trian1" style="display:none; position:absolute; margin-left:364px; margin-top:113px;" class="triangulo1"></div>
                                                <div id="trian2" style="display:none; position:absolute; margin-left:379px; margin-top:113px;" class="triangulo2"></div>
                                                <div id="trian3" style="display:none; position:absolute; margin-left:394px; margin-top:113px;" class="triangulo3"></div>
                                                <div id="trian4" style="display:none; position:absolute; margin-left:409px; margin-top:113px;" class="triangulo4"></div>
                                                <div id="trian5" style="display:none; position:absolute; margin-left:424px; margin-top:113px;" class="triangulo5"></div>
                                                <div id="trian6" style="display:none; position:absolute; margin-left:439px; margin-top:113px;" class="triangulo6"></div>
                                                <div id="trian7" style="display:none; position:absolute; margin-left:454px; margin-top:113px;" class="triangulo7"></div>
                                                <div id="trian8" style="display:none; position:absolute; margin-left:469px; margin-top:113px;" class="triangulo8"></div>
                                                <div id="trian9" style="display:none; position:absolute; margin-left:484px; margin-top:113px;" class="triangulo9"></div>
                                                <div id="trian10" style="display:none; position:absolute; margin-left:499px; margin-top:113px;" class="triangulo10"></div>
                                    ...
                                    <table class="oliveti" style="width: 39%; border: 2px solid #000; margin-left: 0px; margin-top: 11px; height: 171px; ">
                                        ...
                                        <tr id="pay_amount_html" style="height: 50px; width: 700px;">
                                            <td>
                                                ...
                                                <input type="button" id="btn_rever_prepaid" name="btn_rever_prepaid" title="Reverse Payment" class="button_sliding_bg" style="display:none; position:absolute; background-color: #8c261a; border-color: lavenderblush; cursor:pointer; color:#fff; margin-left: 242px; margin-top: -5px; z-index: 1; padding:2.1px; width:17px; height:17px; font-weight: bold; font-size:9px;"  size="20"   value="X" onclick="rever_prepaid();"  />
                                            ...
                                            <td>
                                                <div id="t-total2">
                                                    <!--$data['pagado']-->
                                                    <input type="text" id="pay_amount" name="pay_amount" class="azu" class="txtNumbers" disabled="disabled"  onKeyUp="calcularTotalPago(); outcharge();" onclick="valida_pago2(this,'two');" value="<?php echo number_format($data['tour']->pred_paid_amount, 2, '.', ''); ?>"  style=" text-align: right; margin-top: -5px; margin-right:6px; float:right; width: 106px; height:25px; font-size:22px; font-weight:bold; border: 1px #33F solid;" onkeypress="validate(event);" autocomplete="off"/>
                                            ...
                                            <div style="position:absolute; margin-left:8px; margin-top:-1px;">
                                                ...
                                                <div id="cir1" style="display:none; position:absolute; margin-left:366px; margin-top:97px;" class="circle1"></div>
                                                <div id="cir2" style="display:none; position:absolute; margin-left:381px; margin-top:97px;" class="circle2"></div>
                                                <div id="cir3" style="display:none; position:absolute; margin-left:396px; margin-top:97px;" class="circle3"></div>
                                                <div id="cir4" style="display:none; position:absolute; margin-left:411px; margin-top:97px;" class="circle4"></div>
                                                <div id="cir5" style="display:none; position:absolute; margin-left:426px; margin-top:97px;" class="circle5"></div>
                                                <div id="cir6" style="display:none; position:absolute; margin-left:441px; margin-top:97px;" class="circle6"></div>
                                                <div id="cir7" style="display:none; position:absolute; margin-left:456px; margin-top:97px;" class="circle7"></div>
                                                <div id="cir8" style="display:none; position:absolute; margin-left:471px; margin-top:97px;" class="circle8"></div>
                                                <div id="cir9" style="display:none; position:absolute; margin-left:486px; margin-top:97px;" class="circle9"></div>
                                                <div id="cir10" style="display:none; position:absolute; margin-left:501px; margin-top:97px;" class="circle10"></div>
...
-->
        ...
        <div id="dialog2" title="History of Payments [One Day Tours]" style="display:none; width:550px; margin-left:1px;">
...
<!--                    $sql122 = "SELECT pago, tipo_pago, pagado, fecha FROM tours_pago where id_tours= $id_onetour AND pagado <> '0.00' AND tipo='ONE' order by fecha";-->
                    <tbody>
                        ...
                        $sql122 = "SELECT id_tours, detalles, fecha, tipo_usuario FROM toursone_rastro where id_tours = $id_onetour AND tipo_usuario = 'Removed' order by fecha DESC;";
...
<!--    <label  style="padding-left:57px; font-size:16px; "><strong style="padding-bottom:10px; color: #000; margin-left:-55px;">$</strong></label> -->
            ...
            <input type="text" name="tempwf"  id="tempwf" title="temp W/Fees" size="12" style="display:none; margin-top:4px; margin-left:17px; width:114px; height:20px;" value="<?php echo $cargoscob; ?>" />
...
<!--                    <input name="descuento_valor" type="number" class="txtNumbers" id="descuento_valor" size="12" maxlength="10" pattern="6[0-9]" style="height:16px; width:75px;" value="<?php echo $data['tour']->descuento_valor ?>"  />-->
            ...
            <tr>
                ...
                <td>
                    <div id="t-total2" style="width:170px;">
                        <input  type="text" class="txtNumbers"  name="otheramount3" id="otheramount3" value="<?php /*echo $data['tour']->otheramount_sin_tax;*/ ?>"  style="display:none; padding-left:5px; width:160px; height:20px;" autocomplete="off" />
                    </div>
                </td>
            </tr>
            <tr>
...
<!--                                    <a  id="pago_agente" style="display:block" ><img style="width: 4px;  height:4px; margin-left: 374px;  margin-top: -753px; cursor:pointer" src="<?php echo $data['rootUrl']; ?>global/img/admin/charge.png" />
                                ...
                                <td>
                                    <div id="t-total2" style="width:170px;">
                                        <input autocomplete="off" type="text" class="txtNumbers"  name="pay_amount_x" id="pay_amount_x" value=""  style="padding-left:5px; width:160px; height:20px; font-weight:bold;" />
                                    </div>
                                </td>
                                <td>
<!--                                    <select name="opcion_pago_2" style="margin-left:15px;">
                            ...
                            <tr>
                                <td align="right">
                                    &nbsp;<a style="cursor:pointer; margin-left:-18px;" id="btn-save22"><img width="50" height="40" src="<?php echo $data['rootUrl']; ?>global/img/admin/save2.png" /></a>
                                    <a title="Save" class="oliverty" style="margin-top: 16px; margin-right: -44px; cursor:pointer" id="btn-save211"><i class="fa fa-floppy-o fa-4x" style="color: #AC1B29;"></i></a>
                                    <input  type="button" id="btn-save222" title="Save" class="oliverty"   class="link-button" value="SAVE"/>
                                </td>
                                <td align="right">
            ...
            <!--Boton Para eliminar Pagos-->
                ...
                <div class="" style="position: absolute; margin-left: 452px; margin-top: 54px;" id="btn-pagos3">
                    <a  style="margin-left: -3px; margin-top: -9px;" class="" id="btn-pagos3"> 
                        <label  style="float:right;  font-size:14px;  margin-top: -386px; margin-left:-30px;"><strong id="labelpay" style="display:none; padding-bottom:10px; color: #ff4500;"><i>Payments</i></strong></label>
                        <span id="histo_pagos" class="pagos" title="" onclick="historia_pagos();" style="position:absolute; cursor:pointer; margin-left: -9px; margin-top: -420px; color:#4B0082; width: 32px; height: 32px; ">&nbsp;</span>                    
                    </a>
                </div>
                
               <div>             
                
               <div id="titulo_tabla" class="azufre" style="border-collapse:collapse; display:none; position:absolute; text-align:center; margin-top:-192px; margin-left:419px; height:25px; width:529px; font-weight:bold; font-size:15px; color:#fff; border-radius:0px 0px 0px 0px; border: 0px #000 solid;"><marquee style="margin-left:50px;" scrolldelay=350 width=200 BEHAVIOR=alternate>History of Payments</marquee><img id="cerrar" title="close" onclick="cerrar_historia();" style="position:absolute; margin-left:125px; margin-top:0px; width:13px; height:14px; cursor:pointer;" src ='<?php echo $data['rootUrl'] ?>global/img/remove.png' width='12px' height='12px'>
                ...
                <div id = "historia_pagos" class="oliveti" style="display:none; position:absolute; overflow-y: scroll; height:176px; width:529px; margin-left:419px; margin-top:-151px;">
                ...
                <table class="grid2" cellspacing="1" id="grid2" style="background-color:#fff;">
                    ...
                    <tbody>
                        ...
                        $idone_tour = $data['tour']->id;
                        
                        $sql_pagos = "SELECT id, pago, tipo_pago, pagado, fecha FROM tours_pago where id_tours = '$idone_tour' AND tipo = 'ONE' AND pagado <> '0.00' order by fecha DESC";
...
<!--                <marquee style="font-size:10px;" width=515 direction=right>
        ...
        <input type="text" id="temp" name="temp" title="Fees" size="12" style="display:none; margin-top:4px; margin-left:186px; width:114px; height:20px;" value="<?php echo number_format($data['tour']->total_charge, 2, '.', ''); ?>" />
        <input type="text" id="temp_copy"  name="temp_copy" title="" size="12" style="display:none;" value="" />

<!--    <input type="text" id="temp_driver"  name="temp_driver" title="Temp Driver" size="12" style=" margin-top:4px; margin-left:322px; width:114px; height:20px;" value="<?php /*echo $cargoscob;*/ ?>" />
        <input type="text" id="temp_prepaid"  name="temp_prepaid" title="Temp Prepaid" size="12" style=" margin-top:4px; margin-left:17px; width:114px; height:20px;" value="<?php /*echo $cargospp;*/ ?>" />-->
        
        <input type="text" id="temp_driver"  name="temp_driver" title="Temp Driver" size="12" style="display:none; margin-top:4px; margin-left:322px; width:114px; height:20px;" value="0.00" />
...
<!--        <img id="print" title= "Print Credit Card" onclick="window.print();" style="position:absolute; margin-left: 173px; margin-top: -12px; "src ='<?php echo $data['rootUrl'] ?>global/img/print.png' width="35px" height="35px" margin-left="0px" margin-top="0px">-->
...
<script>
                ...
                $(window).load(function () {
                    ...
                    document.getElementById('saldoactual_copy').value = document.getElementById('saldoactual').value;
...
//                    $("#fechale_retorno").val(fecha_salida);
                    fechale2();
...
//                    $("#fechale_retorno").val(fecha_retorno);
...
//            }
        ...
        var balance_due = (parseFloat(result) - parseFloat(paid_driver)) - parseFloat(pay_amount);
        ...
        if (totalbalance < 0) {
                ...
                var pay_amount = $("#pay_amount").val(); 
                var op_pag_conduct = $("#selectcond").val();
                var result = (parseFloat(result) -  parseFloat(temp_driver)) - parseFloat(pay_amount);
...
//        var total = parseFloat(agbd) - parseFloat(pay_amount);
    ...
    if (otheramount > 0 && paid_driver == 0 && pay_amount == 0) {
        ...
        var temp_driver = $("#temp_driver").val();
        var temp_prepaid = $("#temp_prepaid").val();
        var tempwf = $("#tempwf").val();        
        var tempppwf = $("#tempppwf").val();        
        ...
        var resultado = parseFloat(apagar) + parseFloat(temp_driver) + parseFloat(temp_prepaid) + parseFloat(tempwf) + parseFloat(tempppwf);        
    ...
    if(otheramount > 0 && paid_driver > 0 && pay_amount == 0){ 
        ...
        var op_pag_conduct = $("#selectcond").val();        
        var result = parseFloat(apagar_2) + parseFloat(temp_driver) + parseFloat(tempwf);                   
        var resultado = parseFloat(apagar) + parseFloat(temp_prepaid) + parseFloat(temp_driver) + parseFloat(tempwf) + parseFloat(tempppwf);                    
        var bd = parseFloat(result) - parseFloat(paid_driver);  
        var agency_balance_due = (parseFloat(resultado) - parseFloat(paid_driver)) - parseFloat(pay_amount);
        var total_amount_paid = parseFloat(paid_driver) + parseFloat(pay_amount);
    ...
    if (otheramount > 0 && paid_driver > 0 && pay_amount > 0) {
        ...
        var agency_balance_due = (parseFloat(resultado) - parseFloat(paid_driver)) - parseFloat(pay_amount);                 
        var balance_due = parseFloat(result) - parseFloat(paid_driver);
...
//                  $("#bal_duep").val((tot_balance).toFixed(2));                                  
    ...
    if (pay_amount > 0 && paid_driver == 0 && otheramount == 0) {
        ...
        var agency_balance_due = parseFloat(agbd) - parseFloat(pay_amount);      
    ...
    if (otheramount > 0 && paid_driver == 0 && pay_amount == 0) {        
        ...
        var result = parseFloat(apagar_2) + parseFloat(temp_driver) + parseFloat(tempwf);
        var bd = parseFloat(result) - parseFloat(paid_driver);                      
        var res_total = parseFloat(apagar) + parseFloat(temp_driver) + parseFloat(tempwf) + parseFloat(temp_prepaid) + parseFloat(tempppwf);
    ...
    if (otheramount > 0 && paid_driver > 0 && pay_amount == 0) {      
        ...
        var paid_driver = $("#paid_driver").val();        
        var result = parseFloat(apagar_2) + parseFloat(temp_driver) + parseFloat(tempwf); 
        var res_total = parseFloat(apagar) + parseFloat(temp_driver) + parseFloat(temp_prepaid) + parseFloat(tempwf) + parseFloat(tempppwf);                    
        var bd = parseFloat(result) - parseFloat(paid_driver);  
        var agency_balance_due = (parseFloat(res_total) - parseFloat(paid_driver)) - parseFloat(pay_amount);
        var total_amount_paid = parseFloat(paid_driver) + parseFloat(pay_amount);
...
<script type="text/javascript">
    ...
    function captura_error()
    {

      var fechale_retorno = document.getElementById('fechale_retorno').value;

      if(fechale_retorno == 'ERROR'){

        document.getElementById("estado_transfer_out").selectedIndex = 4;       
...
<script type="text/javascript">
                ...
                function fecha_transfer_out()
                {
                    ...
                    if(opcone == '1'){
                        ...
                        document.getElementById('fechale_retorno').value = document.getElementById('fecha_retorno').value;
                    ...
                    //CANCELED
                        ...
                        document.getElementById('fechale_retorno').value = "CANC";
                    ...
                    //NO SHOW
                        ...
                        document.getElementById('fechale_retorno').value = "N/S";
...
//      var no_prep =  document.getElementById("no_prep").value;
        ...
        var estado_cob9 = $("#estado_cob9").val();
        var estado_cob10 = $("#estado_cob10").val();
        var saldo_por_pagar = $("#saldoactual").val();
...
<script type="text/javascript">
    ...
    $("#btn_remove_cob").click(function(){   
        ...
        var id_oneday = "<?php echo $id_oneday; ?>"; 
            ...
            if (confirm('Desea Eliminar Este Pago?')) {           
                ...
                if (tempo > '0.00' && otheramount == '0.00') {                           
                    ...
                    setTimeout(function () {                        
                        ...
                        $("#saldoactual").val((salpagar).toFixed(2));                   
        ...
        if(metodo_pago == 'COLLECT ON BOARD' && tipo_pago == 'CREDIT CARD WITH FEE' && otheramount > '0.00' && pay_amount >= '0.00'){            
            ...
            if (confirm('Desea Eliminar Este Pago?')){  
                ...
                setTimeout(function () {                        
                    ...
                    $("#saldoactual").val((total_other).toFixed(2));                                       
                    $("#paid_driver").val((result_paid_driver).toFixed(2));                        
                    $("#balance_due").val((balance_due).toFixed(2));
    ...
    //              $("#op_pago_id").val((8).toFixed(2));    
        ...
        //Retrasamos el envio de datos 100 milisegundos para que los datos se carguen previamente desde la fucion duplisaldo()
            ...
            setTimeout(function () {
                ...
                var saldoactual_copy = document.getElementById('saldoactual_copy').value;
                var paid_driver_copy = document.getElementById('paid_driver_copy').value;       
