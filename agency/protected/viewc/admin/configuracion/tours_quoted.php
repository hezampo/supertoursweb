...
<form name="form1" method="post" action="<?php echo $data['rootUrl']; ?>admin/tours/quoted" class="form" id="form1">
    ...
    <div id="header_page">
        <div class="header">Tours Quoted</div>
        <div id="toolbar">
        ...
        <div id="datagrid">
            <table class="grid" cellspacing="1" id="grid">
                ...
                <tr>
                    ...
                    <th style="font-size: 11px; color:#fff; background-color:#F90A45;" width="">Nights</th>
                ...
                <tr class="row<?php echo $i ?>">
                    ...
                    <td style="text-align:center; font-size: 10px; color:#000; font-weight:bold;"><?php echo $e['code_conf']; ?></td>
                    <td style="font-size: 9px; text-align:left;"><?php echo $e['nomcliente']; ?></td>
                    <td style="font-size: 9px; text-align:center;"><?php echo $e['company_name']; ?></td>
