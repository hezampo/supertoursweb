...
<input type="hidden" name="ssl_first_name" value="<?php echo $login->firstname; ?>">
<input type="hidden" name="ssl_last_name" value="<?php echo $login->lastname; ?>">
<input type="hidden" name="ssl_phone" value="<?php echo $login->phone; ?>">

<input type="hidden" name="ssl_state" value="<?php echo ($login->state!='')?$login->state:$login->country; ?>">
<input type="hidden" name="ssl_description" value="Paid Reserve Operator">
...
<input type="hidden" name="ssl_receipt_decl_get_url" value="<?php echo $data['rootUrl']; ?>/transaction/admin/reserva/decline">
<input type="hidden" name="ssl_receipt_apprvl_method" value="REDG">
<input type="hidden" name="ssl_receipt_apprvl_get_url" value="<?php echo $data['rootUrl']; ?>transaction/admin/reserva/approval">
