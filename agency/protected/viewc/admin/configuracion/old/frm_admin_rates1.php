...
<form id="form1" class="form" action="<?php echo $data['rootUrl']; ?>admin/tours/admision-rate/save" method="post" name="form1" enctype="multipart/form-data">
    <div id="header_page" >
        <div class="header2">(park) Admision Rates  [ <? echo $data['dato'];?> -  <?php if($admision_rates->type_rate==1){
                echo 'Net';
            }else{
                echo 'Special Net';
            }?>]</div>
            ...
            <fieldset><legend>General Information</legend>
                ...
                <div  class="input" style="display:<?php echo $display ;?>" >
                    ...
                    <div class="ausu-suggest" >
                        <input name="company_name" type="text" id="company_name" size="40" maxlength="40" value="<? echo $admision_rates->company_name; ?>" autocomplete="off"
