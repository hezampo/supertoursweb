...
//            var idAgencia = $("#id_agency").val();
    //var idAgencia =11;
    //document.getElementById("id_agency").value = r;
...
$sql2 = "SELECT tour_name FROM agencia where id='11'";
...
<div id="header_page" style="background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');">
    <div class="header2">Multi - Day  Tours [New]<input type="text" readonly="true" style="margin-left:96px; margin-top:-112px; width:220px;" name="tour_name" id="tour_name" value="<?php echo $nombre_tour; ?>" /></div>


    <div id="toolbar">

        <select style="margin-left:3px; margin-top:11px; width:303px; background: #AC1B29;color: #fff;border-color: transparent;" name="fnombre" id="rate" onclick = "capturar();" onchange="obtenerValor(this.value);">
...
<div id="content_page_tours" style="width: 984px;z-index:1; background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');" >
    <!--<div id="content_page_tours" style="width: 984px;z-index:1; " >    -->

<!--<div style="margin-left:885px; margin-top:-8px; color:red; font-size:16px; font-weight:bold;" class="content"><strgong>PROMO</strong></div>-->


<!--<script> var fecha_salida = $('#fecha_salida').val(); </script>-->


<!--<script>

var fec_sal = "hola";
//fec_sal = document.getElementById("fecha_sal").value;
document.cookie ='variable='+fec_sal+';';
document.getElementById("fecha_sal").value;

</script>-->

<!--<script>
var miVariable = "hola 2";
document.cookie ='variable='+miVariable+';';
    ...
    //            echo $mivarPHP;
    //            
    //            $sql = "SELECT rate	FROM  ratesvalid  WHERE fecha_ini <= $mivarPHP  AND fecha_fin >= $mivarPHP AND id=141;";
    //            
    //            $rs = Doo::db()->query($sql);
    //            $taripromo = $rs->fetch();
    ////            print_r($taripromo);
    ////            exit;            
    //        
    //            $tarifario =   $taripromo['rate'];                   
    //            echo '<font style="margin-left: 855px;">'.$tarifario.'</font>';-->



<!--<script>
var res = document.getElementById("fecha_sal").value;
alert(res);
</script>-->
    ...
    <form id="form1" class="form" action="" method="post" name="form1">
        <div id="info-group" style="width: 900px;">
            ...
            <div id="reservation" style="border-color: #fff;width: 300px;">
                ...
                <div id="reser" style="background: #fff;"> <p ><?php /* echo $_SESSION['codconf']; */ ?></p><input type="hidden" /></div>
            </div>
            <div id="status">
            ...
            <div id="status-change">
                <div style="color: #fff;background: #bb0000;padding: 4px; margin-left: 47px; margin-top: 1px;text-align: -webkit-auto;">CHANGE STATUS</div>
        ...
        <table><tr><td>
                    ...
                    <fieldset id="inputype" style="margin-left:0px; width:470px; border-radius: 3px 120px 0px 80px;" class="rojo"><legend style="border:1px solid #B83A36; background:#fff;margin-left:5px;">INPUT TYPE</legend>
                                            ...
                                            <tr>
                                                ...
                                                <td width="40%">
                                                    <div class="ausu-suggest" >
                                                        <input name="agency" style=" border-bottom-left-radius: 17px; margin-top:15px; margin-left:4px;" tabindex="1" type="text"  id="agency" size="19" maxlength="30" value=""  autocomplete="off"/>
                                                        <input type="" style="margin-top:15px;" size="4" value="-1" name="id_agency" id="id_agency" autocomplete="off"  readonly="readonly"/>
                                                        <input type="hidden" style="margin-top:15px;" size="4" value="0" name="type_rate" id="type_rate" autocomplete="off"  readonly="readonly"/>
...
<!--                             <input name="tour_name" readonly="true" style="width:220px; color: #0F0CCB; margin-left: -23%; margin-top: 2%;" type="text" id="tour_name" value="<?php echo $agency['tour_name']; ?>"  />-->
                ...
                <td>
                    ...
                    <fieldset  id="liderpax" style="margin-left:2px; border-radius: 130px 3px 80px 0px; width:85px;" class="cerati">
        ...
        <!-- date of tours -->
        <fieldset style="margin-top: 5px; border-radius: 10%;margin-top: 2%;" class="booking2" >
                        ...
                        <td>
                            <div id="opera" class="input" >
                                <table >
                                    ...
                                    <tr><td>
                                            <a href="" id="dataclick1" ><i class="fa fa-calendar fa-2x" style="color: #000;"></i></a>
                                            ...
                                            <input name="fecha_salida" type="text"  id="fecha_salida" size="10" maxlength="15" value="" onchange="fechaRetorno(this.value);" readonly="readonly"  autocomplete="off"  />
<!--                                            <input name="fecha_sal" type="hidden"  id="fecha_sal" size="10" maxlength="15" value="1478764800"  autocomplete="off"  />-->
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div id="opera" class="input"> <table><tr><td>
                                    ...
                                    <tr><td>
                                            ...
                                            <a href="" id="dataclick2">
                                                <i class="fa fa-calendar fa-2x" style="color: #000;"></i>
                                            </a>
                                                                ...
                                                                <div id="trip">
                                                                    ...
                                                                    <table><tr><td>
                                                                                ...
                                                                                <a rel="superbox[ajax][<?php echo $data['rootUrl']; ?>admin/tours/trips/arrival][300x100]">
                                                                                    <img id="popup2" style="cursor:pointer; display: none;" src="<?php echo $data['rootUrl']; ?>global/images/search.png" /><i id="popup2" style="cursor:pointer; margin-left:3px;" class="fa fa-search-plus fa-2x" onclick="mostrarTrip2()"></i>
                                            ...
                                            <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div id="rooms-selection">
                                                                        <select name="select_rooms" id="select_rooms" class="select" style="margin-left: 16%;">
                                                ...
                                                <td colspan="2">
                                                    <table width="100%"><tr>
                                                            ...
                                                            <td width="25%" >
                                                                <div  style="width:100%" class="ausu-suggest">
                                                                    <input  style="width:250px;    margin-left: -6px;" class="field" type="text" value="" id="hotel_name" autocomplete="off">
                                                            ...
                                                            <td>
                                                                <fieldset style="width: 270px;float: left; background: transparent;border: 1px solid #000;"><legend style="color: #000;">START DATE / END DATE</legend>
                                                                    ...
                                                                    <a href="" id="dataclick1_h" ><i class="fa fa-calendar fa-2x" style="color: #000;"></i></a>
                                                                    ...
                                                                    <a href="" id="dataclick2_h" ><i class="fa fa-calendar fa-2x" style="color: #000;"></i></a>
                                                                    <input name="fecha_retorno_h" type="text"  id="fecha_retorno_h" size="10" maxlength="15" value=""   autocomplete="off"   />
                                                                </fieldset>
                                                                <fieldset style="float: left;height: 39px; background: transparent; border: 1px solid #000;"><legend style="color: #000; ">FREE DAYS</legend>
                                                                    <table width="100%">
                                                                        <tr>
                                                                            <td width="10%">
                                                                        ...
                                                                        <input style="font-size:16px; margin-left:6px; margin-top:2px; width:29px; " name="frday" id="frday" type="number" value="0" max="8" min="0" autocomplete="off">
                                                                        <td width="30%">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="width:300px;" align="left" valign="bottom">
                                        <div id="" class="input"> <div style="width:275px;"><label style="width:150px; color: #000; margin-left:369px;" ><strong>NOTES</strong></label></div><textarea id="comments" name="comments" cols="" rows="0"  style="width: 406px; height: 250px;border: transparent; "></textarea></div>
                                    </td>
                                </tr>
