            ...
            <ul>
                <li class="btn-toolbar" id="" style="padding: 0 35px;">
                    <form action="<?php echo $data['rootUrl'] ?>admin/resumen/oneday_tour" id="formulario" method="post" name="formulario" onsubmit="onEnviar()">
                        ...
                        <input  type="submit" value="Summary" style="margin-top: 2px;padding: 10px; color: #AC1B29;font-weight: 700; cursor:pointer;" />                        
                    </form>
...
<div id="content_page_tours" style="z-index:1; margin-top: -9px; width: 984px; height: 1406px; background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');">
...
<!--<option value="0"> <p style="display: none;">.</p></option>-->
        ...
        <fieldset style="border-radius: 5%; margin-top: -6px; height:454px;" class="azul2017">
                                ...
                                <td>
                                    <table class="oliveti" style="width: 39%; border: 2px solid #000; margin-left: 0px; margin-top: 4px; height: 157px;">
                                        ...
                                        <tr style="width: 700px;" >
                                            ...
                                            <td>                                              
                                                <input type="text" id="balance_due" name="balance_due"  class="ama2"  style="float:right; border: 1px #33F solid; margin-top: -29px; margin-right:5.1px;  text-align: right; height: 25px; font-size: 22px; width:106px;" autocomplete="off"  value="" readonly="readonly"  />
                                            </td>
                                        </tr>
                                    ...
                                    <table class="oliveti" style="width: 39%; border: 2px solid #000; margin-left: 0px; margin-top: 11px; height: 171px; ">
                                        ...
                                        <tr style="width: 700px;">
                                            ...
                                            <td>
                                                ...
                                                <div id="t-total2" >
                                                    <input type="text"  id="totalAmount" name="totalAmount" class="orangered"  value="" onKeyUp="dupliac();" style="float: right; width:85px; height: 25px; margin-top: 3px; margin-right:6px; width:106px; text-align: right; font-weight:bold; color:#fff; border: 1px #33F solid; font-size:22px;" autocomplete="off" onkeypress="validate(event);" /> 
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="pay_amount_html" style="height: 50px; width: 700px;">
                                            ...
                                            <td>
                                                <div id="t-total2">
                                                    ...
                                                    <!--$data['pagado']-->
                                                    <input type="text" id="pay_amount" name="pay_amount" class="azu" class="txtNumbers"   onKeyUp="calcularTotalPago(); outcharge();" onclick="calcularTotalPago();" value="<?php echo number_format($data['tour']->pred_paid_amount, 2, '.', ','); ?>"  style=" text-align: right; margin-top: -5px; margin-right:6px; float:right; width: 106px; height:25px; font-size:22px; border: 1px #33F solid;" autocomplete="off" onkeypress="validate(event);"/>
        ...
        <div id="dialog2" title="History of Payments [One Day Tours]" style="display:none; width:550px; margin-left:12px;">
            <div style="overflow-y: scroll;height:250px; width:550px;">
                <table class="grid2" cellspacing="1" id="grid2">
                    <thead>
                        <tr>
                            <td style="text-align: center; width:149px; padding-left:2px;">Pago</td>
...
<!--                                <td style="text-align: center;"><?php echo $login->usuario; ?></td>-->
        ...
        <a  id="pago_agente1" style="display:none; position: absolute; margin-right: 2px;"><img style="width:77px; height:28px; margin-top:106px; margin-left:374px;" src="<?php echo $data['rootUrl']; ?>global/img/admin/chargedisabled.png" /></a>
        <a  id="pago_agente" style="display:block" ><img style="width: 77px;  height:28px; margin-left: 374px;  margin-top: -155px; cursor:pointer" src="<?php echo $data['rootUrl']; ?>global/img/admin/charge.png" /></a>
        ...
        <select name="opcion_pago" id="op_pago_id" style="margin-left:372px; margin-top:-277px; width: 171px;">
            <optgroup label="COLLECT ON BOARD">
                <option value="8">Credit Card no fee</option>
                <option value="3">Credit Card with fee</option>
                <option value="4">Cash</option>
...
//                                               andromeda();
                                    ...
                                    if (pay_amount > 0 && paid_driver == 0) {
                                        ...
                                        var temp = parseFloat($("#temp").val());
                                        var paid_driver1 = parseFloat($("#paid_driver").val());
                                        var pay_amount1 = parseFloat($("#pay_amount").val());
                                        var tot_amount_paid1 = parseFloat($("#tot_amount_paid").val());

                                        $("#saldoactual").val((total_total + temp).toFixed(2));
                                        $("#balance_due").val(((total_total + temp) - (paid_driver1) - (pay_amount1)).toFixed(2));
                                        $("#totalAmount").val((total_initial + temp).toFixed(2));
                                        $("#agency_balance_due").val(((total_initial + temp) - (paid_driver1) - (pay_amount1)).toFixed(2));
...
//                                        $("#agency_balance_due").val(((total_initial + temp) - (paid_driver) - (pay_amount)).toFixed(2));
                                    ...
                                    if (pay_amount > 0 && paid_driver > 0) {
                                        ...
                                        var paid_driver1 = parseFloat($("#paid_driver").val());
                                        var pay_amount1 = parseFloat($("#pay_amount").val());
                                        var grupo_parque = document.getElementById('group_park1').value;
                                        ;
                                    ...
                                    if (otheramount > 0 && paid_driver > 0) {
                                        ...
                                        if (tipo_pago == 8) {
                                            ...
                                            $("#agency_balance_due").val(((total_initial + temp) - (tap)).toFixed(2));
                                        ...
                                        if (tipo_pago == 3) {
                                            ...
                                            $("#saldoactual").val((othera + temp).toFixed(2));

                                            $("#balance_due").val(((othera + temp) - (paid_driver)).toFixed(2));
                                    ...
                                    if (otheramount > 0 && paid_driver == 0 && prepago == 2) {
                                        //CREDIT CARD NO FEE
                                    ...
                                    if (otheramount > 0 && paid_driver == 0 && prepago == 1) {
                                        //CREDIT CARD WITH FEE
                                    ...
                                    if (otheramount > 0 && paid_driver == 0 && prepago == 6) {
                                        //CASH                                        
                                    ...
                                    if (otheramount > 0 && paid_driver == 0 && prepago == 10) {
                                        //CHECK
...
<!--                        <script type="text/javascript">
    ...
    function reset_descuento_valor()
    {

        var descuento_valor = document.getElementById('descuento_valor').value;
