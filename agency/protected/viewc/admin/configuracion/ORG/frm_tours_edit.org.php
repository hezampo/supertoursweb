...
<div id="content_page_tours" style="z-index:1;width: 984px; margin-top: -15px; background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');">
    ...
    <form id="form1" class="form" action="" method="post" name="form1">
        ...
        <div id="info-group" style="width: 900px;">
            ...
            <div id="status-change">
                <div style="color: #fff;background: #bb0000;padding: 4px;margin-top: 0px; margin-left: 148px; text-align: -webkit-auto;">CHANGE STATUS</div>
        <!--        <select id="estado" name="estado">
                ...
                <select id="estado" name="estado" style="margin-left: -23px; margin-top: -2px; width:112px;">
                    <option></option>
                    <option <?php
        ...
        <fieldset id="liderpax" style="margin-left:0px; width: 180px;border-radius: 130px 3px 80px 0px; width:90px;" class="cerati" >
        ...
        <!-- date of tours -->
        <fieldset style="margin-top: 5px; border-radius: 10%;margin-top: 2%; margin-bottom: 1%;"class="booking2">
                                                                    ...
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td onclick="mostrarTrip1()">
                                                                                <a><i style="cursor:pointer; color: #fff; font-size: 23px; margin-left:4px;" id="popup1" class="fa fa-search-plus"></i></a>
                                                                            </td>                                                                          
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                            ...
                                                            <td width="100%" colspan="3">
                                                                <div id="pick-drop">
                                                                    ...
                                                                    <div  style="width:100%;" class="ausu-suggest">
                                                                        <input name="a_pickup1" style="width:444px;"
                                                                        <?php
                                                                ...
                                                                <td>
                                                                    <div id="trip">
                                                                        ...
                                                                        <table><tr><td>
                                                                                ...
                                                                                <td onclick="mostrarTrip2()">
                                                                                    <a rel="superbox[ajax][<?php echo $data['rootUrl']; ?>admin/tours/trips/arrival][300x100]">
                                                                                        <i style="cursor:pointer; color: #fff; font-size: 23px; margin-left:4px;" id="popup2" class="fa fa-search-plus"></i>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="25%" >
                                                                <div  style="width:100%; font-size: 10px;" class="ausu-suggest">
                                                                    <input  style="width:250px; font-size: 14px;" class="field" type="text" value="" id="hotel_name" autocomplete="off"
                                                                    <?php
                                                                    if ($tours->id_hotel_reserve == -1) {
                                                                        echo ' disabled="disabled" ';
                                                                    }
                                                            ...
                                                            <td>
                                                                ...
                                                                <fieldset style="float: left; height:36px; background: transparent;border: 1px solid #000;"><legend style="color: #000;">FREE DAYS</legend>
                                                                    <table width="100%">
                                                                        ...
                                                                        <input type="number" style="font-size:15px; margin-left:20px; margin-top:1px; width:29px; " name="frday" id="frday"  value="<?php echo $hotel_reserve['freeday']; ?>" max="8" min="0" autocomplete="off">
...
//                                                            exit;
        ...
        <td><? echo ($hotel_reserve["room4_adult"] > 0?1:0); ?></td>-->
                                                                            ...
                                                                            <input type="hidden" name="hotel_breakfast_<?php echo $i; ?>" id="hotel_breakfast_<?php echo $i; ?>" value="<?php if ($tours->id_hotel_reserve != -1) {
                                                                                    echo $data['hoteles'][$i]->breakfast;
                                                                                } else {
                                                                                    echo 0;
                                                                                } ?>"/>
                                                                            <input type="hidden" name="hotel_buffet_<?php echo $i; ?>" id="hotel_buffet_<?php echo $i; ?>" value="<?php if ($hotel_reserve['breakfastprice'] == 0) {
                                                                                    echo 0;
                                                                                } else {
                                                                                    echo 1;
                                                                                } ?>"/>                                                                   
...
//             echo   $respuesta_html4 .= "<p style='margin-left: 64px; color: #07218B;'><blink> <b>" . "</b> TOTAL ADMISSION PARKS: $&nbsp;<strong>" .$totadparks."</strong></blink></p>"; 
        ...
        <!-- Parks -->
        <div id="traffic">
            <fieldset style="border-radius: 5%; margin-top:-15px;" class="verdefosf">
                <legend style="background-color:#F6F6F6;border: 1px solid #CCCCCC;">
                    <div id="chk_traffic">
<!--                        <label for="opcion_traffic" style=" cursor:pointer; " >TRAFFIC TOURS  </label><input type="radio" id="opcion_traffic" checked="checked" <?php echo ($numpark > 0) ? 1 : 0; ?> name="opcion_traffic"/>-->
...
?>
        ...
        <br />
        <fieldset style="border-radius: 5%; height:364px;" class="blue">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div id="t-total" style="width:168px;">
                                                        <div class="price" style="margin-top: -13px;margin-left: -1px; border: 1px #33F solid;background-color: #00f;color: #fff; border-radius: 0px;">
...
//            var answer = confirm("Desea Crear una Nueva Reserva [Multiday Tours]?");
////        var answer1 = confirm("Desea Salir de este Sitio?");
//
//            if (answer) {
//                window.location = '<?php echo $data['rootUrl'] ?>admin/tours/add';
//
//            } else {
//
////             if (answer1){    
