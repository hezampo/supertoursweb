...
<div id="header_page" style="background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');">
    <div class="header2">Multi - Day  Tours [New]<input type="text" readonly="true" style="margin-left:96px; margin-top:-112px; width:220px;" name="tour_name" id="tour_name" value="" /></div>
<script type="text/javascript">
    ...
    <div id="toolbar">
        ...
        <select style="margin-left:3px; margin-top:11px; width:303px; background: #AC1B29;color: #fff;border-color: transparent;" name="fnombre" id="rate"  onchange="obtenerValor(this.value);">
