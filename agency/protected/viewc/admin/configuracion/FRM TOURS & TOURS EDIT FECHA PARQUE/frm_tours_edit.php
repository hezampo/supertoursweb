                                            ...
                                            <div id="category-selection">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td valign="bottom">
                                                            <div class="label"><strong style="font-size: 12px; margin-left:0px;">SEARCH PARK</strong></div>
                                                        ...
                                                        <td colspan="">
                                                            <label><strong style="font-size: 12px; margin-top:10px; margin-left:0px;">LENGTH OF TOUR</strong></label>
                                                        </td>
                                                    </tr>
                                                    <tr>                            <td valign="bottom">
