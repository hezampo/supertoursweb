...
<div id="content_page_tours" style="width: 984px; height: 1492px; z-index:1;" >
    <form id="form1" class="form" action="" method="post" name="form1">
        ...
        <table><tr><td>
                    ...
                    <fieldset id="inputype" style="margin-left:0px; width:470px; border-radius: 3px 120px 0px 80px; box-shadow: 0 -14px 4px #DC1349;" class="rojo"><legend style="border:1px solid #B83A36; background:#fff;margin-left:5px;">INPUT TYPE</legend>
...
<!--                             <input name="tour_name" readonly="true" style="width:220px; color: #0F0CCB; margin-left: -23%; margin-top: 2%;" type="text" id="tour_name" value="<?php echo $agency['tour_name']; ?>"  />-->
                ...
                <td>
                    ...
                    <fieldset  id="liderpax" style="margin-left:2px; border-radius: 130px 3px 80px 0px; width:85px; box-shadow: 0 -14px 4px #1E90F6;" class="cerati">
                                                ...
                                                <tr>
                                                    ...
                                                    <td  style="width:630px;">
                                                        ...
                                                        <div id="t-total" style="width:170px;float: right;">
                                                            ...
                                                            <div class="price" name="amount_hotel" id="amount_hotel"><?php /*echo '$ '.number_format($hotel_reserve->total_paid,2,'.','.'); */       ?></div>
                                            ...
                                            <div id="category-selection">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td valign="bottom">
                                                            <div class="label" style="margin-top:10px; margin-left:0px;"><strong>SEARCH PARK</strong></div>
                                                        </td>
                                                        <td colspan="">
                                                           <div  <label style=" margin-top:10px; margin-left:0px;"><strong>DATE</strong></label></div>
                                                        </td>
                                                        <td colspan="">
                                                            <div  <label style=" margin-top:10px; margin-left:0px;"><strong>LENGTH OF TOUR</strong></label></div>
                                                        </td>
                                                    </tr>
                                                    <tr>                            <td valign="bottom">
                                                        ...
                                                        <td>
                                                            <input type="text" id="fecha_parque"  name="fecha_parque" style="text-align:center; width:87px; height:23px; margin-top: 16px; margin-left: 0px; border: 1px solid #33449C;" class="" value=""  autocomplete="off" onchange="addpark();" />                                      
...
<!--                                            <tr id="pay_amount_html">
                            ...
                            <div id="priceTransporA1" style="">0</div>
                            <div id="priceTransporC1" style="">0</div>
                            <div id="comisionTranspor1" style="display:none">0</div>
                            <div id="priceTransporA2" style="">0</div>
                            <div id="priceTransporC2" style="">0</div>
                            ...
                            <div id="totalpriceNights" style="">0</div>
                            <div id="totalpriceBreakfast" style="">0</div>
                            <div id="totalpriceAdmision" style="display:none">0</div>
                            <div id="totalpriceTransporLocal" style="">0</div>
...
//        }
        ...
        var url = '<?php echo $data['rootUrl']; ?>admin/tours/selectpark/' + id_park + '/' + id_group + '/' + adult + '/' + child + '/' + fecha_salida + '/' + fecha_retorno + '/' + platinum + '/' + id_agency + '/' + idf + '/' + fecha_parque; 
        $("#tablePark").load(url);
