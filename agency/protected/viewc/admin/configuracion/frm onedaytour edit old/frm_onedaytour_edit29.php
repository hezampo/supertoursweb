...
<div id="content_page_tours" style="z-index:1;margin-top: -9px;width: 984px; height: 1560px; background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');">
...
//            echo $price_child_KENNEDYSPC;
        ...
        <!-- date of tours -->
        <fieldset style="width: 97.3%;margin-top: 5px; height: 34px; border-radius: 10%;background-color:#DCDCDC;" class="gris3">
            <div id="date" align="center">
                <table width="90%" border="0">
                    <tr>
                        ...
                        <td width="17%"><input name="fecha_salida" type="text" style="text-align: center;" id="fecha_salida" onchange="fecha_retorno(this.value);" size="10" maxlength="16" value="<?php
                            list($anio, $mes, $dia) = explode('-', $data['tour']->starting_date);
                            echo $mes . '-' . $dia . '-' . $anio;
                        ...
                        <td width="17%"><input name="fecha_retorno" type="text"  style="text-align: center;"  id="fecha_retorno" size="10" maxlength="16" value="<?php
                            list($anio, $mes, $dia) = explode('-', $data['tour']->ending_date);
                            echo $mes . '-' . $dia . '-' . $anio;
                            ?>" autocomplete="off"  style="height: 22px;" /></td>
                        <td width="9%"><strong>ADULT(S)</strong></td>
                        <td width="15%"><input style="font-size:16px; text-align: center; font-weight:bold;" name="adult" id="adult" autocomplete="off" type="number" onclick="capturar();" value="<?php echo $data['tour']->adult ?>" max="16" min="1" ></td>
                        <td width="8%"><strong>CHILD(S)</strong></td>
                        <td width="29%"><input style="font-size:16px; text-align: center; font-weight:bold;" name="child" id="child" autocomplete="off" type="number" onclick="capturar();" value="<?php echo $data['tour']->child ?>" max="15" min="0" ></td>
        ...
        <fieldset id="inputype" title="" style="margin-top:4px; margin-top: 4px; width:958px; height:170%; border-radius: 10%;"class="booking2"><legend style="border:1px solid #00C; background-color: #fff;">ONE DAY TOUR TO</legend>
            <div id="opera" class="input">
                    ...
                    <tr valign="top">
                      <!-- <form id="form2" class="form" action="<?php echo $data['rootUrl'] ?>admin/onedaytour" target="_blank" method="POST" name="form2" > -->
                        ...
                        <td style="width: 20%;">
                            ...
                            <div style="margin-right:70px; margin-top:-3px;">
...
//Datos de las variables en PHP
                        ...
                        <td style="width: 20%;">
                            ...
                            <div style="margin-right:36px; margin-top:-3px;">
...
<!--                                    <input type="radio" name="wdw" id="wphol" style="height: 20px; width: 20px; margin-right: 241px;" value="2" required="required" onClick="capturar();habilitar(2)" />-->
                        ...
                        <td style="width: 20%;">
                            ...
                            <div style="margin-right:64px; margin-top:-3px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div id="div_to2" style="margin-left: 69px;">
                                                                ...
                                                                <select style="width: 227px; margin-left: -36px; color:#000; font-size:14px; font-weight:bold;" name="to2" id="to2" class="select">
                                                                    <option value="0"></option>
                                                                    <?php foreach ($data["to_areas"] as $e) { ?>
                                                                        <option value="<?php echo $e["id"]; ?>"><?php echo $e["nombre"]; ?></option>
                                                                    <?php } ?>
...
<!--<option value="0"> <p style="display: none;">.</p></option>-->
        ...
        <fieldset style="border-radius: 5%; margin-top: -6px; height:626px;" class="blue">
            <legend style="background-color:#fff; border: 1px solid #00C;"><div id="chk_traffic">

                    <div class="label">COSTO SUMMARY 1</div></div></legend>

            <div id="opera" class="input" style="width: 85%;" >



                <table class="oliveti" style="width: 43%; border: 2px solid #000; margin-left: -8px; margin-top: 4px; height: 157px;">
...
<!--                                                    <input autocomplete="off" type="text"  class="verd"   id="saldoporpagar" value=""  style=" border: 1px #33F solid; margin-top: -31px; margin-left: 3px; text-align: center; height: 25px; font-family: sans-serif; font-size: 22px; width:138px;"  />-->
                            <div id="div_actual" class="t-total3">
                                <!--                                                        <div class="price" autocomplete="off">-->
                                <!--                                                            <samp id="saldoactual"></samp>-->
                                <input  type="text"  id="saldoporpagar" name="saldoporpagar" class="verd" class="price" value="<?php echo number_format($data['tour']->total, 2, '.', ','); ?>" style=" margin-left:3px; margin-top: -23px; width:90px; height:25px; text-align: right; border:1px #33F solid;  color:#000; font-family:arial; font-size: 22px; font-weight:bold;" onKeyUp="dupliac();" autocomplete="off" onkeypress="validate(event);" />
                    ...
                    <tr style="width: 700px;" ><td>
                        ...
                        <td>
                            <input readonly="readonly" autocomplete="off" type="text" id="paid_driver" name="paid_driver" class="brown3"   style="float:right; text-align: right; height: 25px; font-size: 22px;font-weight: bold;color: #000; border: 1px #33F solid; margin-top: -45px;  width:90px; font-weight:bold; color:fff;" value="<?php echo number_format($data['tour']->paid_driver, 2, '.', ','); ?>"  />
                    ...
                    <tr style="width: 700px;" >
                        ...
                        <td>
                            <input type="text" id="balance_due" name="balance_due"  class="ama2"  class="txtNumbers" style="float:right; border: 1px #33F solid; margin-top: -29px;  text-align: right; height: 25px; font-size: 22px; width:90px;" autocomplete="off"  value="<?php echo number_format($data['tour']->passenger_balance_due, 2, '.', ','); ?>" readonly="readonly"  />
                        </td>
                    </tr>
                ...
                <table class="oliveti" style="width: 43%; border: 2px solid #000; margin-left: -8px; margin-top: 11px; height: 171px; ">
                    ...
                    <tr style="width: 700px;">
                        <td>
                            ...
                            <label  style=" float:right; padding-left: 94px; font-size:16px;  margin-top: -16px;"><strong style=" color:#000;">Total Net Fare&nbsp;$</strong></label>
                    ...
                    <tr id="pay_amount_html" style="height: 50px; width: 700px;">
                        ...
                        <td>
                            <div id="t-total2">
                                <input type="text" class="azu" class="txtNumbers"  name="pay_amount" id="pay_amount" value="<?php echo number_format($data['tour']->pred_paid_amount, 2, '.', ','); ?>"  style=" text-align: right; margin-top: -5px; float:right; width: 90px; height:25px; font-size:22px; border: 1px #33F solid;" autocomplete="off" onkeypress="validate(event);"/>
                            </div>
                        </td>
                    ...
                    <tr style="height:33px; width: 700px;">
                        <td>
                            <b style="float: right;"><strong style=" color:#000;font-size: 16px; font-weight:bold;">Total Amount Paid&nbsp;$</strong></b>                                         
                        </td>
                        <td>
                            <input readonly="readonly" autocomplete="off" type="text" class="verdefos3"  class="txtNumbers"  name="tot_amount_paid" id="tot_amount_paid" value="<?php echo number_format($data['tour']->total_paid, 2, '.', ','); ?>"  style="float:right;  border: 1px #33F solid;  margin-top:-10px; text-align: right; height: 25px; font-size: 22px; width:90px;" />
                        </td>
                    ...
                    <tr width: 700px;>
                        ...
                        <td>
                            <input readonly="readonly" autocomplete="off" type="text" class="roge"  class="txtNumbers"  name="agency_balance_due" id="agency_balance_due" value=""  style="float:right; border: 1px #33F solid; margin-top:-1px; text-align: right; height: 25px; font-size: 22px; width:90px;" />
                        </td>
                    </tr>  
                </table>
                <img class="ventana-imagen-class" style="margin-right:123px; margin-top:-376px; width: 181px; height: 174px; " src="<?php echo $data['rootUrl']; ?>global/img/admin/ventana.png" />

                <table class="oliveti" style="width: 31%; border: 2px solid #000; margin-left: 691px; margin-top: -375px; height: 157px; border-radius: 0px 0px 0px 0px;">
                    ...
                    <tr style="width: 700px;" >
                        <td>
                            <label  style=" float:right; font-size:16px; margin-top:-19px; "><strong style="padding-bottom:10px; color: #000;">Discount&nbsp;%</strong></label>
                        </td>

                        <td>

                            <input name="descuento" type="number" id="descuento" maxlength="3" class="descuentos" class="txtNumbers" onKeyUp="desporc();" max="100" min="0"  value="<?php echo $data['tour']->descuento_procentaje ?>"  autocomplete="off" style="text-align: right; color:#000; font-size: 22px;font-weight: bold; border: #33F solid thin; float:left; margin-top: -14px; margin-left:1px; height:25px; width:89px; " />
                        </td>
                    </tr>

                    <tr style="width: 700px;" >
                        <td>
                            <label  style="float:right; font-size:16px;  margin-top: 1px; "><strong style="padding-bottom:10px; color:#000;">Discount&nbsp;&nbsp;&nbsp;$</strong></label>

                        </td>

                        <td>

                            <input name="descuento_valor" type="text" class="descuentos" class="txtNumbers" id="descuento_valor" size="12" style="float:right; border: 1px #33F solid; margin-top: 7px;  text-align: right; color:#000; font-size: 22px; font-weight: bold; height: 25px; width:90px;" value="<?php echo $data['tour']->descuento_valor; ?>" autocomplete="off" onkeypress="validate(event);"  onkeyup="desval();"  />
...
<!--                                                    <label  style="float:right;  font-size:16px; margin-top:-32px;"><strong   id="txtamountpendiente" style="padding-bottom:0px; color:#000">Extra Charges&nbsp;$</strong></label>-->
                            <label  style="float:right;  font-size:16px;  margin-top: -21px;"><strong style="padding-bottom:10px; color: #000;">Extra Charges&nbsp;$</strong></label>
                        </td>
...
<!--                            <input name="extra" type="number" class="txtNumbers" id="extra" size="12" maxlength="10" pattern="6[0-9]" style="float:right; border: 1px #33F solid; margin-top: -17px; margin-right:0px; text-align: right; color:#000; font-size: 22px;font-weight: bold; height: 25px; font-size: 22px; width:106px;" value="<?php echo $data['tour']->extra_charge; ?>" autocomplete="off"  />-->
                            <input name="extra" type="text" class="extracargos"  id="extra" size="12" style="float:right;  text-align: right; color:#000; margin-top: -17px; margin-right:0px;  width:90px; height:25px;  border: 1px #33F solid; font-family: sans-serif; font-size: 22px;"   value="<?php echo $data['tour']->extra_charge; ?>" autocomplete="off" onkeypress="validate(event);" onkeyup="resetextra();"/>
 <!--                            <input class="txtNumbers" name="extraz" readonly="readonly" type="text" id="extraz" size="12" style="float:right;  text-align: right; color:#dcdcdc; background-color: #dcdcdc; margin-top: -29px; margin-left:-15px;  width:15px; height:25px;  border: 1px #33F solid; font-family: sans-serif; font-size: 22px;" min="0"   value="" />-->
                            <br />
                        </td>
                    </tr>
            ...
            <div id="tabs" style="margin-left:518px; margin-top:193px; width:425px; height:182px;">
                <ul>
                    <li><a  href="#tabs-2">Saved Notes</a></li>
                    <li><a title="Type your notes" href="#tabs-1">Notes</a></li>


                </ul>

                <div id="tabs-2">
                    <textarea id="comments2" name="comments2" cols="0" rows="0"  disabled="disabled" style="border-color:blue; margin: 13px; width: 418px; height: 134px; margin-top:-10px; margin-left:-18px;"><?php echo $data['tour']->comments2; ?></textarea> 
                </div>
                <div id="tabs-1">
                    <textarea id="comments" name="comments" cols="0" rows="0" style="border-color:red; margin: 13px; width: 418px; height:134px; margin-top:-10px; margin-left:-18px;"></textarea> 
                </div>


            </div>

<!--              <textarea id="comments" name="comments" cols="0" rows="0" placeholder="Notes"  style="display:none; width: 390px; height: 280px; margin-top:-601px; border-radius: 0px 25px 0px 0px;"></textarea>
                        <textarea id="comments2" name="comments2" cols="0" rows="0" placeholder="Notes"  disabled="disabled" style="display:none; width: 390px; height: 280px; margin-left:0px; margin-top:-294px; border-radius: 0px 0px 25px 0px;"><?php echo $data['tour']->comments2; ?></textarea>-->



            <tr id="pay_amount_html">
                <td valign="" >
                    <a  id="pago_agente" style="display:block" ><img style="width: 67px;   margin-left: -473px;  margin-top: 302px;  height: 28px; cursor:pointer" src="<?php echo $data['rootUrl']; ?>global/img/admin/charge.png" />
                ...
                <td>
                    <select name="opcion_pago_2" style="margin-left:358px; margin-top:8px; width: 152px;">
            ...
            <table ><tr>
                    <td width="70%">
                        ...
                        <div id="miVentana2" style="position: fixed; width: 174px; height: 170px;  top:355px; left: 993px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; border: #333333 3px solid; background-color: #FAFAFA; color: #000000; display:none; ">
...
<!--    <label  style="padding-left:57px; font-size:16px; "><strong style="padding-bottom:10px; color: #000; margin-left:-55px;">$</strong></label> -->
                            ...
                            <label  id="dolares" style="float:left; padding-left:94px; font-size:16px; "><strong style="padding-bottom:10px; color:#006394; margin-left:-55px;">$</strong></label> 

                            <!--class="money"-->
                            <input autocomplete="off" name="pago_driver"   type="text" id="pago_driver" size="12" style="font-size: 22px;  text-align:right; margin-top:-19px; margin-left:53px; width:114px; height:20px;" value="0.00" onkeypress="validate(event);"  onkeyup="dupliPago();"/>
...
<!--    <input name="someTextBox" type="text" id="someTextBox" size="12" style="display:none; margin-top:9px; margin-left:27px; width:114px; height:20px;" value="0.00" />-->
                            ...
                            <select name="opcion_pago1" id="op_pago_id1" style="margin-left:13px; margin-top: 8px;" disabled= "disabled" onclick="calculos();">
   ...
   ?*/>
                            ...
                            <script type="text/javascript">
                                function reset()
                                {
                                    ...
                                    document.getElementById('temp').value = <?php echo $data['tour']->total_charge; ?>;


                                    document.getElementById('tot_charge').value = <?php echo $data['tour']->total_charge; ?>;

                                    //document.getElementById('prepaid').value = '0.00';

                                    document.getElementById('prepaid').value = <?php echo $data['tour']->pred_paid_amount; ?>;

                                    //document.getElementById('collect').value = '0.00';     

                                    document.getElementById('collect').value = <?php echo $data['tour']->paid_driver; ?>;
                            ...
                            <div class="paymentvertblack" style="padding: 10px;  text-align: center; margin-top: 9px;">
                                ...
                                <input id="btnExit" onclick="Exit();" style=" background-color: #006394; border-color: red; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; border-top-left-radius: 5px; border-top-right-radius: 5px; cursor:pointer; color:#fff; padding:2px; width:43px; font-weight: 700;"name="btnExit" size="20" type="button" value="Exit"  />
                        ...
                        <table style="display: none;"><tr><td>
                                    <table>
                                        <tr>
                                            ...
                                            <td><span style="margin-left:50px; display:none;"><strong> Disc %</strong></span>
<!--                                                <input name="descuento" type="number" id="descuento" maxlength="3" class="txtNumbers" onkeyup="" max="100" min="0"  value="<?php echo $data['tour']->descuento_procentaje ?>"  style="display:none;height:16px; width:75px;" />-->
                                            </td>

                                        </tr>
                                        <tr>
                                            <td><label style="display:none; margin-left:66px;font-weight:bold;">Extra Charges</label></td>
                                            <td colspan="">
<!--                                                <input class="txtNumbers" name="extra" type="text" id="extra" size="12" style="display:none; padding-left:5px; width:160px; height:20px;" min="0"   value="<?php echo $data['tour']->extra_charge; ?>" autocomplete="off" onkeypress="validate(event);"/>-->
                                            </td>
                                            <td>
                                                <label style="display:none; margin-left:50px;"><strong> Disc &nbsp;$</strong></label>
<!--                                                <input name="descuento_valor" type="number" class="txtNumbers" id="descuento_valor" size="12" maxlength="10" pattern="6[0-9]" style="display:none; height:16px; width:75px;" value="<?php echo $data['tour']->descuento_valor ?>" onkeypress="validate(event);" onkeyup="resetextra();"  />-->
                                            </td>
                                        </tr>
                                        <tr >
                                        ...
                                        <tr id="pay_amount_html">
                                            ...
                                            <td>
                                                <select id= "opcion_pago_2" name="opcion_pago_2" style="margin-left:15px;  ">
                                                    <optgroup label="PRED-PAID">
                                                        <option value="2">Credit Card no fee</option>
                                                        <option value="1">Credit Card with fee</option>
                                                        <option value="6">Cash</option>
...
<!--                                                <a href="<?php echo $data['rootUrl'] ?>admin/home" title="Exit" style="margin-top: 16px; margin-right: 4px; cursor:pointer" id="btn-exit"><i class="fa fa-external-link-square fa-4x" style="color:#AC1B29;"></i></a>  -->
        ...
        <div>
            <select name="opcion_pago" id="op_pago_id" style="margin-left:373px; margin-top:-478px; width:152px;">
                <optgroup label="COLLECT ON BOARD">
                    <option value="8">Credit Card no fee</option>
                    <option value="3">Credit Card with fee</option>
                    <option value="4">Cash</option>
...
<!--         <input title="Add Payment" class="brown2" type="button" id="pay_driver" name="pay_driver" onclick="mostrarVentana2();" style="border-color: brown; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; border-top-left-radius: 5px; border-top-right-radius: 5px; margin-left: 415px; margin-top: -361px; height: 30px; cursor:pointer; color: #000;font-weight: 700; width: 93px;  padding: 6px; padding-left: 2px;" value="Add Payment"/>-->
    ...
    <div id="miVentana2" style="position: absolute; width: 175px; height: 167px;  top:1145px; left: 1000px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; border: #333333 3px solid; background-color: #FAFAFA; color: #000000; display:none;"  >
        ...
        <select name="opcion_pago_2" id="op_pago_id2" style="margin-left:358px; margin-top: -57px; width: 152px; display:none;">
            <optgroup label="PRED-PAID">
                <option value="2">Credit Card no fee</option>
                <option value="1">Credit Card with fee</option>
                <option value="6">Cash</option>
...
//            $("#paid_driver").val(((total_total)).toFixed(2));
            $("#balance_due").val(((total_total) - (paid_driver)).toFixed(2));
...
<script type="text/javascript">
    ...
    function mostrarVentana2() {
        ...
        if (window.screen.availWidth <= 640) {
            ...
            ventana2.style.marginTop = "767px"; // Definimos su posición vertical.        
        ...
        if (window.screen.availWidth <= 1280) {
            ...
            window.parent.document.body.style.zoom = "100";
            var ventana2 = document.getElementById('miVentana2'); // Accedemos al contenedor  
            ventana2.style.marginTop = "757.5px"; // Definimos su posición vertical.        
        ...
        if (window.screen.availWidth == 1366) {
            ...
            window.parent.document.body.style.zoom = "100%";
            var ventana2 = document.getElementById('miVentana2'); // Accedemos al contenedor  
            ventana2.style.marginTop = "764.5px"; // Definimos su posición vertical.        
            ventana2.style.marginLeft = "-276.4px"; // Definimos su posición horizontal
            ventana2.style.display = 'block'; // Y lo hacemos visible
            ventana2.style.position = 'absolute';
            ventana2.style.height = '170px';
