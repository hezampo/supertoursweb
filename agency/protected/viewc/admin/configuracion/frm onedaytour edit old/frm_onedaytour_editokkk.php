            ...
            <ul>
                <li class="btn-toolbar" id="" style="padding: 0 35px;">
                    <form action="<?php echo $data['rootUrl'] ?>admin/resumen/oneday_tour" id="formulario" method="post" name="formulario" onsubmit="onEnviar()">
                        ...
                        <input  type="submit" value="Summary" style="cursor:pointer; margin-top: 1px;padding: 10px; color: #AC1B29;font-weight: 700;" />
                    </form>
            ...
            <div id="date" align="center">
                <table width="90%" border="0">
                    <tr>
                        ...
                        <td width="15%"><input style="font-size:16px" name="adult" id="adult" autocomplete="off" type="number" value="<?php echo $data['tour']->adult ?>" max="16" min="1"></td>
                        <td width="8%"><strong>CHILD(S)</strong></td>
                        <td width="29%"><input style="font-size:16px" name="child" id="child" autocomplete="off" type="number" value="<?php echo $data['tour']->child ?>" max="15" min="0"></td>
            ...
            <div id="opera" class="input">
                <table align="center" cellspacing="10" style="margin-top: 27px;">
                    <tr valign="top">
                       <form id="form2" class="form" action="<?php echo $data['rootUrl'] ?>admin/onedaytour" target="_blank" method="POST" name="form2" > 
                        <td style="width: 20%;">
                            ...
                            <input type="radio" name="wdw" id="wdwus" style="margin-right: 50px;"  value="1" onClick="capturar();
                                    habilitar(1)"/>
                        </td>
                        <td style="width: 20%;">
                            <label style="color:#33449C;"><b style="margin-left: 56px;">WATER PARKS & HOLY LAND</b></label>
                            <input type="radio" name="wdw" id="wphol" style="margin-right: 47px;"  value="2" onClick="capturar();
                                    habilitar(2)" />
                        </td>
                        <td style="width: 20%;">
                            <label style="color:#33449C;"><b style="margin-left: 85px;">KENNEDY SPACE CENTER</b></label>
                            <input type="radio"  name="wdw" id="kspc" style="margin-right: 45px;"   value="3" onClick="capturar();
                                    habilitar(3)" />
                        </td>
                        </form>
                    <div style="display:none;" id="resultado"></div>
                    ...
                    <div style="margin-left: 100%;margin-top: -35px;">
                        <input type="text" name="priceadults" id="priceadults" style="display:none;" size="10" maxlength="10" style="margin-left: 250px;" value="<?php echo $tour->t_price_adult; ?>"></div>
...
<!--                                                                <option value="9">FULL DAY SHOPPING TOURS</option>-->
        ...
        <fieldset style="border-radius: 5%; margin-top: -6px; height:375px;" class="blue">
                        ...
                        <table><tr><td>
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <div id="t-total2">
                                                    <div class="label" style="width:150px; color:#F00;" ><strong><label class="label"  id="txtSaldoPorPagar" style="font-weight:bold; margin-left:22px;">Total Tour Cost</label></strong></div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div id="t-total3" >
                                                    <div class="label" style="width:150px; color:#AC1B29;" ><strong><label class="label"  id="txtSaldoprepaid" style="font-weight:bold;  margin-left:68px;">Paid Amount</label></strong></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div id="div_actual" class='t-total3'>
                                                    <div class="price" style="border:1px #AC1B29 solid; background-color:#AC1B29; color:#fff;">
                                        ...
                                        <tr id="pay_amount_html">
                                            <td valign="" >
                                                <a  id="pago_agente" style="display:block" ><img style="width: 59px;   margin-left: -3px;  margin-top: 12px;cursor:pointer" src="<?php echo $data['rootUrl']; ?>global/img/admin/charge.png" />
                                                    <label style="text-align:left; font-weight:bold;   position: absolute;   margin-top: 19px;    margin-left: 1px;">Invoice Amount</label>
                                                </a>
...
//      
      ...
      //      }    
        ...
        if (gp == 1) {
            ...
            //document.getElementById("wdwus").click();
            //document.getElementById("wdwus").disabled;            
            //alert("hola");
        ...
        if (gp == 2) {
            ...
            //document.getElementById("wphol").click();
            //document.getElementById("wphol").disabled;
            //alert("hola");
        ...
        if (gp == 3) {
            ...
            //document.getElementById("kspc").click();
            //document.getElementById("kspc").disabled;
            //alert("hola");
