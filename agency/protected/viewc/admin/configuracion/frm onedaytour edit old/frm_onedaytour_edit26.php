            ...
            <div id="date" align="center">
                <table width="90%" border="0">
                    <tr>
                        ...
                        <td width="4%" align="right"><a href="" id="dataclick1" ><img src="<?php echo $data['rootUrl']; ?>global/images/calendar.png" alt=""  align="absmiddle" width="19" height="20" border="0" style="padding-bottom: 0px; margin-top: -2px;" /></a></td>
                        <td width="17%"><input id="fecha_salida" name="fecha_salida" type="text" style="text-align: center; height: 20px;"  onchange="fecha_retorno(this.value);" size="10" maxlength="16" value="<?php
                            list($anio, $mes, $dia) = explode('-', $data['tour']->starting_date);
                            echo $mes . '-' . $dia . '-' . $anio;
                            ?>" autocomplete="off"  style="height: 22px;" /></td>
                        <td width="4%" align="right"><a href="" id="dataclick2" ><img src="<?php echo $data['rootUrl']; ?>global/images/calendar.png" alt=""  align="absmiddle" width="19" height="20" border="0" style="padding-bottom: 0px; margin-top: -2px;" /></a></td>
                        <td width="17%"><input id="fecha_retorno" name="fecha_retorno" type="text"  style="text-align: center; height: 20px;" size="10" maxlength="16" value="<?php
...
<!--<option value="0"> <p style="display: none;">.</p></option>-->
                                                                ...
                                                                <tbody>
                                                                    <tr id="park-selected" class="row1">
                                                                        ...
                                                                        <td><img src="<?php echo $data['rootUrl']; ?>global/img/admin/check2.png" style="cursor:pointer;" width="20" height="20"></td><td>$ <?php echo $data['attr']->totalAdmission; ?>.00</td><td>$ <?php
                                                                            ...
                                                                            ?>0.00</td>
                                                                        <td><img id="delete_park"  onclick="borrar_parque();" style="cursor:pointer;" width="20" height="20" src="<?php echo $data['rootUrl']; ?>global/img/admin/x01.png"></td>
        ...
        <fieldset style="border-radius: 5%; margin-top: -6px; height:626px;" class="blue">
            ...
            <div id="opera" class="input" style="width: 85%;" >
                ...
                <table class="oliveti" style="width: 43%; border: 2px solid #000; margin-left: -8px; margin-top: 4px; height: 139px;">
...
<!--                                                    <input autocomplete="off" type="text"  class="verd"   id="saldoporpagar" value=""  style=" border: 1px #33F solid; margin-top: -31px; margin-left: 3px; text-align: center; height: 25px; font-family: sans-serif; font-size: 22px; width:138px;"  />-->
                ...
                <table class="oliveti" style="width: 43%; border: 2px solid #000; margin-left: -8px; margin-top: 51px; height: 171px; ">
                    ...
                    <tr style="width: 700px;">
                        ...
                        <td>
                            ...
                            <div id="t-total2" >
                                ...
                                <input type="text"  class="orangered"   id="totalAmount" value="<?php echo number_format($data['tour']->totalouta, 2, '.', ','); ?>" onKeyUp="dupliac();" style="float: right; width:85px; height: 25px; margin-top: -6px; text-align: right; font-weight:bold; color:#fff; border: 1px #33F solid; font-size:22px; padding-left:5px; " autocomplete="off" onkeypress="validate(event);" />
                ...
                <table class="oliveti" style="width: 43%; border: 2px solid #000; margin-left: -8px; margin-top: 37px; height: 142px; border-radius: 0px 0px 0px 25px;">

                    <caption class="olivo" style=" font-weight:bold; font-size:16px; color:#fff; ">Extra Charges & Discounts</caption>
                    ...
                    <tr style="width: 700px;" >
                        ...
                        <td>
                            ...
                            <input name="descuento" type="number" id="descuento" maxlength="3" class="txtNumbers" onKeyUp="desporc();" max="100" min="0"  value="<?php echo $data['tour']->descuento_procentaje ?>"  autocomplete="off" style="text-align: right; color:#000; font-size: 22px;font-weight: bold; border: #33F solid thin; float:left; margin-top: -14px; margin-left:1px; height:25px; width:89px; " />
                        </td>
                    </tr>
...
<!--                            <input class="txtNumbers" name="extraz" readonly="readonly" type="text" id="extraz" size="12" style="float:right;  text-align: right; color:#dcdcdc; background-color: #dcdcdc; margin-top: -29px; margin-left:-15px;  width:15px; height:25px;  border: 1px #33F solid; font-family: sans-serif; font-size: 22px;" min="0"   value="" />-->
            ...
            <tr id="pay_amount_html">
                <td valign="" >
                    <a  id="pago_agente" style="display:block" ><img style="width: 67px;   margin-left: -472px;  margin-top: 366px;  height: 28px; cursor:pointer" src="<?php echo $data['rootUrl']; ?>global/img/admin/charge.png" />
                ...
                <td>
                    <select name="opcion_pago_2" style="margin-left:360px; margin-top:-272px; width: 181px;">
...
<div id="miVentana2" style="position: fixed; width: 174px; height: 170px;  top:497px; left: 835px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; border: #333333 3px solid; background-color: #FAFAFA; color: #000000; display:none; ">
...
<!--                                                <a href="<?php echo $data['rootUrl'] ?>admin/home" title="Exit" style="margin-top: 16px; margin-right: 4px; cursor:pointer" id="btn-exit"><i class="fa fa-external-link-square fa-4x" style="color:#AC1B29;"></i></a>  -->
         ...
         <div>
                <select name="opcion_pago" id="op_pago_id" style="margin-left:373px; margin-top:-494px; width:181px;">
                    <optgroup label="COLLECT ON BOARD">
                        <option value="8">Credit Card no fee</option>
                        <option value="3">Credit Card with fee</option>
                        <option value="4">Cash</option>
...
//        });
    $(window).load(function () {
        ...
        var gp = <?php echo $data['tour']->group_park ?>;
...
//            $("#paid_driver").val(((total_total)).toFixed(2));
            $("#balance_due").val(((saldoporpagar) - (paid_driver)-(pay_amount)).toFixed(2));
            $("#totalAmount").val((totalamount).toFixed(2));
            $("#agency_balance_due").val(((saldoporpagar) - (paid_driver) - (pay_amount)).toFixed(2));
