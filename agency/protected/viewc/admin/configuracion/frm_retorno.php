...
?>
                ...
                <div id="accordion" style="margin-top: 2px;   margin-left: -12px;   width: 950px;" >

<!--                    <h6  style="color: transparent; background:#fff; border-color: transparent; margin-top:-57px; margin-left: -11px; width: 986px;  padding: 0em 2.2em;" >Rutas</h6>
...
<!--                    class="ui-accordion-content ui-corner-bottom ui-helper-reset ui-widget-content ui-accordion-content-active"-->
                    ...
                    <h3 class="oliveti" style="color: red; border-color: transparent; margin-top:-38px; margin-left: 2px; width: 1000px; font-size: 138%; font-weight: bold; ">&nbsp;&nbsp;&nbsp;Editar</h3>

<!--                    <div style="margin-top:2px; margin-left:-12px;  width: 950px; height:144px;">-->
                    <div style="margin-top: 2px; margin-left: 2px; width: 1000px; height: 140px;">
                            ...
                            <thead> 
                                ...
                                <tr>
                                    ...
                                    <td style="background:#F2F2F2; border-top: 1px double #000000; border-bottom: 1px double #000000; border-right: 1px double #000000;" rowspan=3 align="center" width="55" valign=middle><font color="#000000">Capacity</font>
                                        <input type="text" title="Capacidad Total" id="capatot" name="capatot" style="margin-top: -32px; text-align:center; width: 48px; font-weight: bold; color:#000;" size="20" value="" autocomplete="off"/>
...
?>
    ...
    <h3 class="oliveti" style="color: red; border-color: transparent; margin-top:5px; margin-left: -10px; width: 1001px; height: 36px; font-size: 138%; font-weight: bold; padding-top: 8px; padding-left: 15px;">&nbsp;&nbsp;&nbsp;Editar Rutas</h3>
    
    <div> 
    
        
    <table style="width: 726px; height:8px; font-size: 11px; margin-top: 10px; margin-left:-5px; border-top: 1px double #000000; border-left: 1px double #000000; border-right: 1px double #000000;" cellspacing='0' border='1' class=""  id='tabla'>          
                        
                        
                        <thead style='background-color:#007bb6; color:#fff;'>
                            
                            <tr>
                                <th style="text-align: center; background:#D2E0E4; border-top: 1px double #000000; border-left: 1px double #000000; border-right: 1px double #000000; "  colspan="6" align="center" valign=bottom bgcolor="#BDD7EE"><font align="center"  color="#000000" style="text-align:center; color:#315C9B; font-size:12px; ">»»»» <?php echo "  "; ?> RUTAS TRIP <?php echo $trip_no; ?> <?php echo "  "; ?> »»»»</font></th>
                            </tr>
                            <tr>
                                
                                <th style='width:40px; text-align:center; font-size:12px;'  align='center'>Trip</th>
                                <th style='width:210px; text-align:center; font-size:12px;' align='center' > From </th>                
                                <th style='width:210px; text-align:center; font-size:12px;' align='center' > To </th>  
                                <th style='width:140px; text-align:center; font-size:12px;' align='center' > Departure </th>
                                <th style='width:140px; text-align:center; font-size:12px;' align='center' > Arrive </th> 
                                <th style='width:140px; text-align:center; font-size:12px;' align='center' ></th>
                            </tr>
                        </thead>
                        
<?php

$sqlw = "SELECT DISTINCT r.id, r.trip_from AS TRIP_FROM, r.trip_to AS TRIP_TO, r.trip_no AS TRIP, r.fecha_ini AS FECHAINI, r.fecha_fin AS FECHAFIN, a.nombre AS DESDE, a2.nombre AS HASTA, r.trip_departure AS SALIDA, r.trip_arrival AS LLEGADA FROM routes r LEFT JOIN areas a ON (r.trip_from = a.id) LEFT JOIN areas a2 ON (r.trip_to = a2.id) WHERE r.trip_from NOT IN('13') AND fecha_ini = '$fec1'  AND trip_no = '$trip_no' ORDER BY SALIDA, LLEGADA ASC";
$rsw = Doo::db()->query($sqlw);
$resultw = $rsw->fetchAll();


foreach ($resultw as $reg) {

    $tripno = $reg['TRIP'];
    $fecha_ini = $reg['FECHAINI'];
    $fecha_fin = $fec2;
    $r_trip_from = $reg['TRIP_FROM'];
    $r_trip_to = $reg['TRIP_TO'];
    $froma = $reg['DESDE'];
    $toa = $reg['HASTA'];
    $r_departure = $reg['SALIDA'];
    $r_arrive = $reg['LLEGADA'];
    
?>
                        <tr>
                            <td style='background-color:#fff; width:40px; text-align:center; font-weight:bold; color:#315C9B; font-size: 11px;'><?php echo $reg['TRIP'] ?></td>
                            <td style='background-color:#fff; width:210px; text-align:left; font-weight:bold;  color:#315C9B; font-size: 11px;'><?php echo $reg['DESDE'] ?></td>
                            <td style='background-color:#fff; width:210px; text-align:left; font-weight:bold; color:#315C9B; font-size: 11px;'><?php echo $reg['HASTA'] ?></td>
                            <td style='background-color:#fff; width:140px; text-align:center;  font-weight:bold; color:#315C9B; font-size: 11px;'>
                                <span id="fecha_salida<?php echo $reg['id'] ?>"><?php echo $reg['SALIDA'] ?></span>
                            </td>
                            <td style='background-color:#fff; width:140px; text-align:center;  font-weight:bold; color:#315C9B; font-size: 11px;'>
                                <span id="fecha_llegada<?php echo $reg['id'] ?>"><?php echo $reg['LLEGADA'] ?></span>
                            </td>         
                            <td id="resuledit" onclick = "this.style.background = '#C0C0C0'" style='background-color:#fff; width:140px; text-align:center;  font-weight:bold; color:#315C9B; font-size: 11px;' >
                                
                                <button style="" type="button"   data-toggle="modal" data-target="#myModal<?php echo $reg['id'] ?>">
                                    Edit <span id="resultado<?php echo $reg['id']?>" style="text-align: -webkit-center;"></span>
                                </button>
                            </td>
                        </tr>
                        <!-- Modal -->
                    <div class="modal fade" id="myModal<?php echo $reg['id']?>" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Edit from <?php echo $reg['DESDE']; ?> to <?php echo $reg['HASTA']; ?></h4>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label style="display:none;" for="trip_no">Trip No:</label>
                                        <input style="display:none;" type="text" id="trip_no<?php echo $reg['id'];?>" name="trip_no" value="<?php echo $reg['TRIP']; ?>" />
                                    </div>
                                    
                                    <div class="form-group">
                                        <label style="display:none;" for="fecha_ini">Fecha Ini:</label>
                                        <input style="display:none;" type="text" id="fecha_ini<?php echo $reg['id'];?>" name="fecha_ini" value="<?php echo $reg['FECHAINI']; ?>" />
                                    </div>
                                    
                                    <div class="form-group">
                                        <label style="display:none;" for="fecha_fin">Fecha Fin:</label>
                                        <input style="display:none;" type="text" id="fecha_fin<?php echo $reg['id'];?>" name="fecha_fin" value="<?php echo $fec2; ?>" />
                                    </div>
                                    
                                    <div class="form-group">
                                        <label style="display:none;" for="trip_from">Trip From:</label>
                                        <input style="display:none;" type="text" id="trip_from<?php echo $reg['id'];?>" name="trip_from" value="<?php echo $reg['TRIP_FROM']; ?>" />
                                    </div>
                                    
                                    <div class="form-group">
                                        <label style="display:none;" for="trip_to">Trip To:</label>
                                        <input style="display:none;" type="text" id="trip_to<?php echo $reg['id'];?>" name="trip_to" value="<?php echo $reg['TRIP_TO']; ?>" />
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="departureTime">Departure Time:</label>
                                        <input type="text" id="departureTime<?php echo $reg['id'];?>" name="departureTime" onkeypress="validate(event)" value="<?php echo $reg['SALIDA']; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <label for="arrivalTime">Arrival Time:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                        <input type="text" id="arrivalTime<?php echo $reg['id'];?>" name="arrivalTime" onkeypress="validate(event)" value="<?php echo $reg['LLEGADA']; ?>" />
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $("#mandarDatos<?php echo $reg['id']?>").click(function(){
        ...
        $.ajax({
                ...
                url:   '<?php echo $data['rootUrl']?>admin/datos/'+ departureTime + '/' + arrivalTime + '/' + trip_from + '/' + trip_to + '/' + trip_no + '/' + fecha_ini + '/' + fecha_fin, //archivo que recibe la peticion
                type:  'post', //método de envio
                beforeSend: function () {
                        $("#resultado<?php echo $reg['id']?>").html('<i class="fa fa-spinner fa-spin" style="font-size:15px"></i>');
                },
                success:  function (response) { //una vez que el archivo recibe el request lo procesa y lo devuelve
                        $("#resultado<?php echo $reg['id']?>").html(response);
                }
        });
    });
</script>
...
<!-- table table-bordered table-hover align='center'  width='1550' cellspacing='0' border='1'      style='margin-top: 10px;  width: 726px; height:25px;  border: 1px solid #000; border-left: 1px solid #000;  font-size: 11px;'-->
<!--<div id="div11" class="datagrid" style=" margin-left: -434px; margin-top: 40px; width: 967px; overflow-y:auto;"> -->
...
<!--</div>-->
        ...
        <table style="display: none; margin-top: 6px; width: 712px; height:15px;  border: 1px solid #000; border-left: 1px solid #000;  font-size: 11px;" width="1550" align="center" cellspacing="0" border="1">

            <thead style="background-color:#0078ae; color:#fff;">

                <tr>
                    <th style="width:100px;" colspan="1" rowspan="1" align="center">Trip</th>
                    <th style="width:720px;" colspan="1" rowspan="1" align="center" > From </th>                
                    <th style="width:720px;" colspan="1" rowspan="1" align="center" > To </th>                 
                    <th style="width:475px;" colspan="1" rowspan="1" align="center" > Departure </th>
                    <th style="width:475px;" colspan="1" rowspan="1" align="center" > Arrive </th>                            
                </tr>
...
<!--        <tr onclick = "this.style.background = '#f01133'">-->
            ...
            <tr onclick = "this.style.background = '#f01133'">
                ...
                <td style="background-color:#fff; color:#000;">
                    <input style="width:40px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="tripno" name="tripno" type="text"  autocomplete="off"  size="20" value="<?php echo $tripno; ?>"/>
                </td>

                <td style="background-color:#fff; color:#000;">
                    <input style="width:180px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="froma" name="froma" type="text"  autocomplete="off"  size="20"  value="<?php echo $froma; ?>"/>
                </td>


                <td style="background-color:#fff; color:#000;">
                    <input style="width:180px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="toa" name="toa" type="text"  autocomplete="off"  size="20"  value="<?php echo $toa; ?>"/>
                </td>

                <td style="background-color:#fff; color:#000;">
                    <input style="width:140px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="r_departure" name="r_departure" type="text"  autocomplete="off"  size="20"  value="<?php echo $r_departure; ?>"/>
                </td> 

                <td style="background-color:#fff; color:#000;">                            
                    <input style="width:140px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="r_arrive" name="r_arrive" type="text"  autocomplete="off"  size="20"  value="<?php echo $r_arrive; ?>"/>
                </td>
            ...
            <tr onclick = "this.style.background = '#f01133'">
                ...
                <td style="background-color:#fff; color:#000;">
                    <input style="width:40px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="tripno1" name="tripno1" type="text"  autocomplete="off"  size="20" value="<?php echo $tripno; ?>"/>
                </td>

                <td style="background-color:#fff; color:#000;">
                    <input style="width:180px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="froma1" name="froma1" type="text"  autocomplete="off"  size="20"  value="<?php echo $froma; ?>"/>
                </td>


                <td style="background-color:#fff; color:#000;">
                    <input style="width:180px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="toa1" name="toa1" type="text"  autocomplete="off"  size="20"  value="<?php echo $toa; ?>"/>
                </td>

                <td style="background-color:#fff; color:#000;" >
                    <input style="width:140px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="r_departure1" name="r_departure1" type="text"  autocomplete="off"  size="20"  value="<?php echo $r_departure; ?>"/>
                </td> 

                <td style="background-color:#fff; color:#000;" >                            
                    <input style="width:140px; text-align:center; font-weight: bold; color:#000; font-size: 11px;" id="r_arrive1" name="r_arrive1" type="text"  autocomplete="off"  size="20"  value="<?php echo $r_arrive; ?>"/>
                </td>
        ...
        <div  id="save2" style="position:absolute; overflow: visible; z-index: 1000; margin-left: 0px; margin-top: -1439px; font-weight: bold; font-size: 16px; display:none;">                

            <h6 style="position:absolute; margin-left: 449px; margin-top: -57px;  width: 100px; color: #0B55C4;">Saving...</h6> 
            <a style="margin-left: 455px; margin-top: -36px; position: absolute;" href='<?php echo $data['rootUrl'] ?>admin/routes/edit/'><img src ='<?php echo $data['rootUrl'] ?>global/img/spinner1.gif' width="25px" height="35px" margin-left="0px" margin-top="0px">

                </div>   

                <div style="display:none; margin-left:-526px; margin-top:40px; height: 488px;" id="div2" class="datagrid"> 

                    <table  width="15" align="center" border="2" cellpadding="2" cellspacing="2">

                        <thead>

                        <th style="width:25px; height: 26px;" colspan="1" rowspan="1" align="center" class="dato">Date</th>   

                        </thead>

<?php
$sql111 = "SELECT  DISTINCT fecha_ini FROM routes WHERE (fecha_ini >= '$fec1' AND fecha_fin <= '$fec2') AND trip_no = '$trip_no'";
$rs111 = Doo::db()->query($sql111);
$result111 = $rs111->fetchAll();

foreach ($result111 as $registro111) {

    echo "  
            <tr> 
                <td class='locked_left' style='width: 390px; height:8px;' >" . $registro111['fecha_ini'] . "</td> 
            </tr>";
}
?>
                ...
                <div id="div1" class="datagrid" style="display:none; margin-left: -434px; margin-top: 40px; width: 967px; overflow-y:auto;">         



                    <table style="overflow-y:auto;" width="1550" align="center" border="2" cellpadding="2" cellspacing="2">


                        <thead>

                            <tr>
                                <th style="width:6200px;" colspan="1" rowspan="1" align="center" class="locked_left">Date</th>
                                <th style="width:1909px;" colspan="1" rowspan="1" align="center" class="dato">Trip</th>
                                <th style="width:475px;" colspan="1" rowspan="1" align="center" class="dato">Vehicles</th>
                                <th style="width:475px;" colspan="1" rowspan="1" align="center" class="dato">Capacity</th>
                                <!--<th style="width:6800px;" colspan="1" rowspan="1" align="center" class="dato">Seats Remain</th>-->
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Super Promo Adult</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Super Promo Child</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Super Discount Adult</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Super Discount Child</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Web Fare Adult</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Web Fare Child</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Standard Adult</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Standard Child</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Super Flex Adult</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Super Flex Child</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Fl. Resident Adult</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Fl. Resident Child</th>
                                <!--<th style="width:6800px;" colspan="1" rowspan="1" align="center" class="dato">Super Promo [Seats]</th>
                                <th style="width:6800px;" colspan="1" rowspan="1" align="center" class="dato">Super Discount [Seats]</th>
                                <th style="width:6800px;" colspan="1" rowspan="1" align="center" class="dato">WEB FARE [Seats]</th>
                                <th style="width:6800px;" colspan="1" rowspan="1" align="center" class="dato">Standard [Seats]</th>
                                <th style="width:6800px;" colspan="1" rowspan="1" align="center" class="dato">Super Flex [Seats]</th>
                                <th style="width:6800px;" colspan="1" rowspan="1" align="center" class="dato">Special Prices [Seats]</th>
                                <th style="width:6800px;" colspan="1" rowspan="1" align="center" class="dato">Tours [Seats]</th>-->
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Universal Ext.</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Walt Disney Ext.</th>   
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Ft Pierce -> Orlando </th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">L Worth -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">FTL -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">H/Wood -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">NM Beach -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M Beach -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">S Beach -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">D/town -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">POM -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Airport -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M.I.A. -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Hialeah -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Kendall -> Orlando</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Ft Pierce -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">L Worth -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">FTL -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">H/Wood -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">NM Beach -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M Beach -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">S Beach -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">D/town -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">POM -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Airport -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M.I.A. -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Hialeah -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Kendall -> Kissimmee</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">L Worth -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">FTL -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">H/Wood -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">NM Beach -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M Beach -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">S Beach -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">D/town -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">POM -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Airport -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M.I.A. -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Hialeah -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Kendall -> Ft Pierce</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">FTL -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">H/Wood -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">NM Beach -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M Beach -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">S Beach -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">D/town -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">POM -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Airport -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M.I.A. -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Hialeah -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Kendall -> L Worth</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">H/Wood -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">NM Beach -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M Beach -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">S Beach -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">D/town -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">POM -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Airport -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">M.I.A. -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Hialeah -> FTL</th>
                                <th style="width:3200px;" colspan="1" rowspan="1" align="center" class="dato">Kendall -> FTL</th>
                            </tr>
                        </thead>
...
foreach ($result as $reg) {
    ...
    echo " <tr>  
                        <td class='locked_left' style='width: 320px;'>" . $reg['fecha_ini'] . "</td>
                        <td class='enlace' title='Trip' style='width: 120px;' class='dato'>" . $reg['trip_no'] . "</td> 
                        <td class='enlace' title='Vehicles' style='width: 120px;' class='dato'>" . $reg['vehicles'] . "</td> 
                        <td class='enlace' title='Capacity' style='width: 120px;'class='dato'>" . $capatot . "</td> 
                        <!--<td class='enlace' title='Seats Remain' style='width: 120px;'class='dato'>" . $reg['seats_remain'] . "</td>-->
                        <td class='enlace' title='Super Promo Adult' style='width: 120px;'class='dato'>" . $reg['spprc_adult'] . "</td>
                        <td class='enlace' title='Super Promo Child' style='width: 120px;'class='dato'>" . $reg['spprc_child'] . "</td> 
                        <td class='enlace' title='Super Discount Adult' style='width: 120px;'class='dato'>" . $reg['sdprc_adult'] . "</td>
                        <td class='enlace' title='Super Discount Child' style='width: 120px;'class='dato'>" . $reg['sdprc_child'] . "</td> 
                        <td class='enlace' title='Web Fare Adult' style='width: 120px;'class='dato'>" . $reg['wfprc_adult'] . "</td>
                        <td class='enlace' title='Web Fare Child' style='width: 120px;'class='dato'>" . $reg['wfprc_child'] . "</td> 
                        <td class='enlace' title='Standard Adult' style='width: 120px;'class='dato'>" . $reg['stprc_adult'] . "</td>
                        <td class='enlace' title='Standard Child' style='width: 120px;'class='dato'>" . $reg['stprc_child'] . "</td> 
                        <td class='enlace' title='Super Flex Adult' style='width: 120px;'class='dato'>" . $reg['sflexprc_adult'] . "</td>
                        <td class='enlace' title='Super Flex Child' style='width: 120px;'class='dato'>" . $reg['sflexprc_child'] . "</td>
                        <td class='enlace' title='Fl. Resident Adult' style='width: 120px;'class='dato'>" . $reg['flresprc_adult'] . "</td>
                        <td class='enlace' title='Fl. Resident Child' style='width: 120px;'class='dato'>" . $reg['flresprc_child'] . "</td>
                        <!--<td class='enlace' title='Super Promo [Seats]' style='width: 120px;'class='dato'>" . $reg['spseats'] . "</td>
                        <td class='enlace' title='Standard [seats]' style='width: 120px;'class='dato'>" . $reg['sdseats'] . "</td>
                        <td class='enlace' title='Web Fare [seats]' style='width: 120px;'class='dato'>" . $reg['wfseats'] . "</td>
                        <td class='enlace' title='Standard [seats]' style='width: 120px;'class='dato'>" . $reg['stseats'] . "</td>
                        <td class='enlace' title='Super Flex [seats]' style='width: 120px;'class='dato'>" . $reg['sflexseats'] . "</td>
                        <td class='enlace' title='Special Prices [seats]' style='width: 120px;'class='dato'>" . $reg['spprcseats'] . "</td>
                        <td class='enlace' title='Tours [seats]' style='width: 120px;'class='dato'>" . $reg['toursseats'] . "</td>-->                          
                        <td class='enlace' title='Universal Ext.' style='width: 120px;'class='dato'>" . $reg['univext'] . "</td> 
                        <td class='enlace' title='Walt Disney Ext.' style='width: 120px;'class='dato'>" . $reg['wdext'] . "</td> 
                        <td class='enlace' title='Ft Pierce -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t3'] . "</td> 
                        <td class='enlace' title='L Worth -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t4'] . "</td> 
                        <td class='enlace' title='FTL -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t5'] . "</td> 
                        <td class='enlace' title='H/Wood -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t6'] . "</td> 
                        <td class='enlace' title='NM Beach -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t7'] . "</td> 
                        <td class='enlace' title='M Beach -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t8'] . "</td> 
                        <td class='enlace' title='S Beach -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t9'] . "</td> 
                        <td class='enlace' title='D/Town -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t10'] . "</td>
                        <td class='enlace' title='POM -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t19'] . "</td> 
                        <td class='enlace' title='Airport -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t12'] . "</td>
                        <td class='enlace' title='M.I.A. -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t11'] . "</td>                          
                        <td class='enlace' title='Hialeah -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t13'] . "</td> 
                        <td class='enlace' title='Kendall -> Orlando' style='width: 120px;'class='dato'>" . $reg['f1t14'] . "</td> 
                        <td class='enlace' title='Ft Pierce -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t3'] . "</td> 
                        <td class='enlace' title='L Worth -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t4'] . "</td> 
                        <td class='enlace' title='FTL -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t5'] . "</td> 
                        <td class='enlace' title='H/Wood -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t6'] . "</td> 
                        <td class='enlace' title='NM Beach -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t7'] . "</td> 
                        <td class='enlace' title='M Beach -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t8'] . "</td> 
                        <td class='enlace' title='S Beach -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t9'] . "</td> 
                        <td class='enlace' title='D/Town -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t10'] . "</td>
                        <td class='enlace' title='POM -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t19'] . "</td> 
                        <td class='enlace' title='Airport -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t12'] . "</td>
                        <td class='enlace' title='M.I.A. -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t11'] . "</td>                         
                        <td class='enlace' title='Hialeah -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t13'] . "</td> 
                        <td class='enlace' title='Kendall -> Kissimmee' style='width: 120px;'class='dato'>" . $reg['f2t14'] . "</td> 
                        <td class='enlace' title='L Worth -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t4'] . "</td> 
                        <td class='enlace' title='FTL -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t5'] . "</td> 
                        <td class='enlace' title='H/Wood -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t6'] . "</td> 
                        <td class='enlace' title='NM Beach -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t7'] . "</td> 
                        <td class='enlace' title='M Beach -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t8'] . "</td> 
                        <td class='enlace' title='S Beach -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t9'] . "</td> 
                        <td class='enlace' title='D/Town -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t10'] . "</td>
                        <td class='enlace' title='POM -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t19'] . "</td> 
                        <td class='enlace' title='Airport -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t12'] . "</td>
                        <td class='enlace' title='M.I.A. -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t11'] . "</td>                         
                        <td class='enlace' title='Hialeah -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t13'] . "</td> 
                        <td class='enlace' title='Kendall -> Ft Pierce' style='width: 120px;'class='dato'>" . $reg['f3t14'] . "</td> 
                        <td class='enlace' title='FTL -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t5'] . "</td> 
                        <td class='enlace' title='H/Wood -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t6'] . "</td> 
                        <td class='enlace' title='NM Beach -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t7'] . "</td> 
                        <td class='enlace' title='M Beach -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t8'] . "</td> 
                        <td class='enlace' title='S Beach -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t9'] . "</td> 
                        <td class='enlace' title='D/Town -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t10'] . "</td>
                        <td class='enlace' title='POM -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t19'] . "</td> 
                        <td class='enlace' title='Airport -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t12'] . "</td>
                        <td class='enlace' title='M.I.A. -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t11'] . "</td>                          
                        <td class='enlace' title='Hialeah -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t13'] . "</td> 
                        <td class='enlace' title='Kendall -> L Worth' style='width: 120px;'class='dato'>" . $reg['f4t14'] . "</td> 
                        <td class='enlace' title='H/Wood -> FTL' style='width: 120px;'class='dato'>" . $reg['f5t6'] . "</td> 
                        <td class='enlace' title='NM Beach -> FTL' style='width: 120px;'class='dato'>" . $reg['f5t7'] . "</td> 
                        <td class='enlace' title='M Beach -> FTL'  style='width: 120px;'class='dato'>" . $reg['f5t8'] . "</td> 
                        <td class='enlace' title='S Beach -> FTL' style='width: 120px;'class='dato'>" . $reg['f5t9'] . "</td> 
                        <td class='enlace' title='D/Town -> FTL' style='width: 120px;'class='dato'>" . $reg['f5t10'] . "</td>
                        <td class='enlace' title='POM -> FTL' style='width: 120px;'class='dato'>" . $reg['f5t19'] . "</td> 
                        <td class='enlace' title='Airport -> FTL' style='width: 120px;'class='dato'>" . $reg['f5t12'] . "</td> 
                        <td class='enlace' title='M.I.A. -> FTL' style='width: 120px;'class='dato'>" . $reg['f5t11'] . "</td>                         
                        <td class='enlace' title='Hialeah -> FTL' style='width: 120px; 'class='dato'>" . $reg['f5t13'] . "</td> 
                        <td class='enlace' title='Kendall -> FTL' style='width: 120px; 'class='dato'>" . $reg['f5t14'] . "</td> 
                    </tr>";
}
?>
...
<script type="text/javascript">
    ...
    function remain_tours()
    {
        ...
        //seats_remain cupos disponibles
        //sflexseats cupos asignados a tarifa superflex
...
//            var wfseats2 = $("#wfseats2").val();
//            var sdseats2 = $("#sdseats2").val();
                        
            
            if(result_superdiscount > result_standard){
                
                $("#sdseats2").val(result_standard);
            ...
            if(result_superpromo > result_standard){
                
                $("#spseats2").val(result_standard);
            ...
            var result_standard;            
            var result_webfare;
            var result_superpromo;
            var result_superdiscount;
            var result_superflex;
            ...
            //tours asignado
            var toursseats = parseInt($("#toursseats").val());
            // tours vendido
            var toursseats1 = parseInt($("#toursseats1").val());
            
            //precios speciales asignados
            var spprcseats = parseInt($("#spprcseats").val());
            //precios speciales vendidos
            var spprcseats1 = parseInt($("#spprcseats1").val());            
            
            //var result_superflex = parseInt($("#sflexseats").val()) - (parseInt($("#sflexseats1").val()) + parseInt($("#spprcseats1").val()) + parseInt($("#toursseats1").val())); 
                        
            //var result_standard = (parseInt($("#stseats").val()) - (parseInt($("#wfseats1").val()) + parseInt($("#stseats1").val())));
            
            var remain_tours = parseInt(spseats1) + parseInt(sdseats1) + parseInt(wfseats1) + parseInt(stseats1) + parseInt(spprcseats1) + parseInt(toursseats1);
                 
            if(remain_tours > stseats){
                
                result_standard = 0;
                result_webfare = 0;
                result_superpromo = 0;
                result_superdiscount = 0;
                
                result_superflex = seats_remain;
                
                
            }else{
                
               result_standard = ((capatot - sflexseats)-(remain_tours));
               result_webfare = result_standard;
               result_superflex = sflexseats - sflexseats1;
            }
            
            //var result_webfare = (parseInt($("#wfseats").val()) - (parseInt($("#wfseats1").val()) + parseInt($("#stseats1").val())));
            ...
            if(result_webfare == 0){
                ...
                if(result_webfare < sdseats){
                    
                    result_superdiscount = result_webfare;                    
                    
                }else{
                    result_superdiscount = sdseats - sdseats1;
                }
                
                
                if(result_webfare < spseats){
                    
                    result_superpromo = result_webfare;
                    
                }else{
                    result_superpromo = spseats - spseats1;
