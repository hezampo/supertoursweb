...
<!--                                                    <td>&nbsp;</td>-->
                        ...
                        <div id="opera" class="input" style="width: 80%;" >
                            ...
                            <table class="oliveti" style="width: 47%; border: 2px solid #000; margin-left: -8px; margin-top: -9px; height: 122px;">
...
<!--                                        <label  style="font-weight:bold; padding-left:20px; height: 20px; font-size:16px; color:#000;"><strong style="margin-top:-18px; margin-left: 108px; padding-bottom:10px; "><strong>Total Fare&nbsp;$</strong></label>-->
                                    </td>
                                    <td>
...
<!--                                <tr>
                                ...
                                <tr id="tr_otheramount" style=" height:13px; width:180px;">

                                    <td style="width: 700px;">
                                        <label  style="padding-left:58px; font-size:16px; margin-top:-18px;"><strong   id="txtamountpendiente" style="padding-bottom:0px; color:#000">Amount to Collect&nbsp;$</strong></label>
                                    </td>
                                    <td>
...
<!--                                      <label style="text-align: center;  width:105px; background-color: #BCED91; color:#000; font-size: 22px; font-weight: bold; margin-left:3px; border: 1px #33F solid;  margin-top: -11px;width: 106px;height: 23px;  font-family: sans-serif;" id="saldoporpagarp" >$  </label>-->
                                        <input autocomplete="off" type="text"  class="txtNumbers"  id="saldoporpagar" value=""  style="background-color: #BCED91; border: 1px #33F solid; margin-top: -15px; margin-left: 3px; text-align: center; height: 25px; font-family: sans-serif; font-size: 22px; width:106px;" />
                                        <input autocomplete="off" type="text"  class="black"  name="otheramount"  id="otheramount"  style="margin-top: 5px; margin-left: 3px; text-align: center; height: 25px; font-size: 22px;font-weight: bold;font-size: 22px; color: #fff;border: #AC1B29 solid thin; background-color: #1B1478; width: 103px;float:left;width:106px; font-weight:bold; color:fff;"   value="" onkeyup="CalcularTotalTotal();"/>

<!--<input style="text-align: center;background-color: #fff; color:#4B0082; font-size: 19px; font-weight: bold; margin-left:0px;  margin-top: -2px;width: 108px;height: 24px;" id="saldoporpagar"  />-->
                                        <br />
                                    </td>
                                </tr>
                                <td>&nbsp;</td>
                                ...
                                <tr  style="width: 700px;" ><td>
                                        <label  style="padding-left:62px; font-size:16px; margin-left:63px; margin-top:-9px; "><strong style="padding-bottom:10px; color: #000;">Pay Driver&nbsp;$</strong></label>    </td>
                                    <td><!--onkeyup-->
<!--                                            <input type="text" id="otheramount" name="otheramount"  style="text-align: center; height: 24px; font-size: 22px;font-weight: bold;color: #fff;border: #AC1B29 solid thin; background-color: #AC1B29; width: 104px;float:left;width:106px; font-weight:bold; color:fff;" value="" onkeyup="CalcularTotalTotal();"  />-->
<!--                                            <input autocomplete="off" type="text" class="txtNumbers"  name="otheramount"  id="otheramount"  style="text-align: center; height: 24px; font-size: 22px;font-weight: bold;color: #fff;border: #AC1B29 solid thin; background-color: #AC1B29; width: 104px;float:left;width:106px; font-weight:bold; color:fff;" value="" onkeyup="CalcularTotalTotal();"  />-->
                                        <!--                                            <label style="text-align: center;background-color: #fff; color:#4B0082; font-size: 19px; font-weight: bold; margin-left:0px;  margin-top: -2px;width: 108px;height: 24px;" id="saldoporpagar" >$  </label>-->
                                    </td>
                                </tr>
                                
                                <tr style="width: 700px;" >
                                    <td>
                                         <label  style="padding-left:-4px; font-size:16px; margin-left: 7px; "><strong style="padding-bottom:10px; color:#000;">Passenger Balance Due&nbsp;$</strong></label>
                                         
                                    </td>
                                    
                                    <td>
                                       <input autocomplete="off" type="text" class="gris2"  class="txtNumbers"  name="balance_due" id="balance_due" value=""  style="    border: 1px #33F solid; margin-top: 11px; margin-left: -22px; text-align: center; height: 25px; font-size: 22px; width:106px;" />
                                    </td>
                                </tr>
...
<!--                                <tr id="pay_amount_html" style="height: 50px;">
                            ...
                            <table class="oliveti" style="width: -8%; border: 2px solid #000; margin-left: -8px; margin-top: 9px; height: 152px; ">
                            ...
                            <tr>
                                <td>
                                    <b style="font-size: 18px;">Total Net Fare&nbsp;$</b>
                                </td>
                                
                                
                                <td>
                                <font  class="black" style="float: left; height:24px; text-align: center;border: #AC1B29 solid thin; background-color: #1B1478; width: 103px; margin-top:3px; font-size:22px; padding-left:3px; height:25px; font-weight:bold; color:#fff;  margin-left: 10px;" id="totalPagar" ></font>
                                <input name="totP" type="hidden"  id="totP" value="" /> 
                                  <input type="text"  class="orangered" style="display:none; float: left; height:24px; text-align: center;border: #AC1B29 solid thin; font-weight:bold; color:#fff; background-color: #1B1478; height:25px; width: 103px; margin-left: 10px; margin-top:-7px; font-size:22px; padding-left:3px;"  id="totalPagarnet" />
                                </td>
                                 
                            </tr>
                            <tr id="pay_amount_html" style="height: 50px;">
                                <td>
                                   <b style=" color:#000;font-size: 18px;">Amount Pay&nbsp;$</b>                                       
                                </td>
                                <td>
                                    <input autocomplete="off" type="text" class="txtNumbers"  name="pay_amount" id="pay_amount" value=""  style="text-align: center; z-index: 100; position: absolute; margin-top: -17px; margin-left:-108px; width: 106px; height:25px; font-size:22px;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <input autocomplete="off" type="hidden" class="txtNumbers"  name="pay_amount" id="pay_amount121212" value=""  style=" " />
                        ...
                        <input name="pay_driver" type="button" id="pay_driver"  onclick="pago_driver();" style=" display:none; border-bottom-color: #000; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px; cursor:pointer; margin-top: -51px; margin-left: 11px; padding: 10px;  height: 35px;   width: 118px; color: #000;font-weight: 700; background-color: #8AF960" value="Pay Driver" />
...
//                    }
                ...
                <select name="opcion_pago" style="margin-left:-417px; margin-top: 73px;" id="op_pago_id">
                ...
                <input  title="Confirm Booking" type="button" id="btn-save2"  style="margin-left: 812px; margin-top:222px; height: 35px; cursor:pointer; color: #000;font-weight: 700; width:124px;" value="Confirm Booking" />
<!--                <i class="fa fa-floppy-o fa-5x" style="color:#fff;"></i>-->


            </fieldset>
            <select name="opcion_pago_2" style="margin-left:380px; margin-top: -107px; ">
...
<div id="miVentana" style="position: fixed; width: 195px; height: 170px;  top:441px; left: 55px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; border: #333333 3px solid; background-color: #FAFAFA; color: #000000; display:none;">
    ...
    <label  style="padding-left:57px; font-size:16px; margin-left:-55px;"><strong style="padding-bottom:10px; color: #000;">$</strong></label> 
...
<div id="miVentana2" style="position: fixed; width: 195px; height: 170px;  top:441px; left: 55px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; border: #333333 3px solid; background-color: #FAFAFA; color: #000000; display:none;">

    <div style="font-weight: bold; text-align: left; color: #FFFFFF; padding: 5px; background-color:#006394">Pay Driver</div>
    <label  style="padding-left:57px; font-size:16px; margin-left:-55px;"><strong style="padding-bottom:10px; color: #000;">$</strong></label> 
    <input name="pago_driver" type="text" id="pago_driver" size="12" style=" width:114px; height:20px;" value="0.00" />
<!--    <p style="padding: 5px; text-align: justify; line-height:normal">Suspendisse vehicula, nisl vitae molestie pulvinar, eros nunc volutpat neque, sit amet ultricies nulla sem at ipsum.</p>-->
    <select name="opcion_pago" id="op_pago_id" style="margin-left:6px; margin-top: 5px;" >
        <optgroup label="COLLECT ON BOARD">
            <option value="8">Credit Card no fee</option>
            <option value="3">Credit Card with fee</option>
            <option value="4">Cash</option>
    ...
    <div style="padding: 10px; background-color: #F0F0F0; text-align: center; margin-top: 44px;">
        <input id="btnAceptar" onclick="ocultarVentana2();" name="btnAceptar" size="20" type="button" value="Aceptar" />
...
<script type="text/javascript">
    ...
    function ocultarVentana2()
    {
        ...
        document.getElementById('otheramount').value = pago_driver;
...
//        if (apagar > 0) {
//            //alert(apagar);
//            document.getElementById('otheramount2').value = apagar + '.00';
//
//           
//
//
...
//        if (apagar == 0) {
//            //alert(apagar);
//            document.getElementById('otheramount2').value = 0 + '.00';
//
//        }
        ...
        if (otheramount_2 > 0) {
            ...
            //  document.getElementById('otheramount').value = apagar_2+'.00';
            //alert(apagar_2);
        ...
        if (tipo_pago == 5) {
            if (disponible - balance < 0) {
                ...
                //$("#saldoporpagarp").text(((apagar_2 - pay_amount)).toFixed(2));
...
//          $("#opcion_pago_saldo").val('2');
            ...
            if (otheramount_2 > 0) {
                ...
                //$("#saldoporpagarp").text((((apagar_2 + fee) - pay_amount)).toFixed(2));
