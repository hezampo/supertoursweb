...
<!--        <input type="text" name="textfield" onKeyDown="return validar(event)"> -->
...
<!--                <input type='text' id='x' style='font-size: 10px' name='x' size='5' value ='0,0' onchange='checkDecimals(this.value, this.value)'>-->
 ...
 <tr>
   ...
   <td colspan="2">&nbsp;</td>
            ...
            <fieldset id="pymen" style="margin-top:4px; border-radius: 5%; height:370px;" class="super" ><legend style="border:1px solid #00C; background:#fff" >PAYMENT INFORMATIONS</legend>
...
<!--                                                    <td>&nbsp;</td>-->
                        ...
                        <div id="opera" class="input" style="width: 80%;" >
                            ...
                            <table class="oliveti" border="1px" style="width: 42%; height:45%; border: 1px solid #000; margin-left: 15px; margin-top: 45px;"> 
                                <caption>Passenger Payment Information</caption>
                                <tr>
                                    <td style="text-align: right; width: 260px; height:27px; font-weight:bold; font-size:16px;" >TOTAL FARE $ </td>
                                    <td style="font-weight:bold; color:blue; text-align: center; width: 166px; height:23px;">
                                        <font  class="caja1" id="totalPagar" ></font>
...
<!--                                <td>&nbsp;</td>-->
                                <tr>
                                    <td style="text-align: right; width:  738px; height:27px; font-weight:bold; font-size:16px;">TOTAL AMOUNT PAID $ </td>
                                    <td style="font-weight:bold; text-align: center; width: 166px; height:23px;">
                                        <input readonly="readonly" class="caja2" id="totalAmountPaid" style="color: green; font-weight:bold; text-align: center;">
                                    </td>
...
<!--                                <td>&nbsp;</td>-->
                                ...
                                <tr>
                                    <td style="text-align: right; width: 260px; height:27px; font-weight:bold; font-size:16px;">AMOUNT TO COLLECT $ </td>
                                    <td style="font-weight:bold; text-align: center; width: 166px; height:27px;">
                                        <label style="font-weight:bold; text-align: center; font-family: sans-serif; font-size: 19px; color: #AC1B29;" class="caja3" id="saldoporpagar" >$  </label>
...
<!--                                <td>&nbsp;</td>-->
                                ...
                                <tr>
                                    <td style="text-align: right; width: 260px; height:27px; font-weight:bold; font-size:16px;">PAY DRIVER $ </td>
                                    <td style="font-weight:bold; text-align: center; width: 166px; height:27px;">
                                        <input autocomplete="off" type="text" class="caja4"  name="otheramount"  id="otheramount"  style="display: none; height:23px;  color:blue;  border: transparent;" value="" onKeyDown="return validar(event)" onkeyup="CalcularTotalTotal();"  />
                                        <input autocomplete="off" type="text" class="caja4"  name="otheramount2"  id="otheramount2" onclick="ocultar()"  style="height:23px;  color:blue; border: transparent;" value="" onKeyDown="return validar(event)" />
...
<!--                                <td>&nbsp;</td>-->
                                ...
                                <tr>
                                    <td style="text-align: right; width: 260px; height:27px; font-weight:bold; font-size:16px;">ADD PAYMENT $ </td>
                                    <td style="font-weight:bold; text-align: center;  width: 166px; height:27px; ">
                                ...
                                <tr style="">
                                    <td>
                                        <label  style="margin-top:-18px; margin-left: -21px; padding-left:20px; font-size:12px; "><strong style="padding-bottom:0px; color:#090;">Total Amount Paid $</strong></label>
                                    </td>
                                    <td>
                            ...
                            <tr style="background-color: #BCED91; height:35px;">
                            
<!--                                <td>
                                    <label  style="padding-left:20px; font-size:14px;"><strong   id="txtamountpendiente" style="padding-bottom:0px; color:#4B0082">Amount to Collect&nbsp;&nbsp;$</strong></label>
                                </td>-->
                                <td><select name="opcion_pago" style="margin-left:18px;" id="op_pago_id">
                                    ...
                                    <label style="color:#4B0082; font-size: 16px; font-weight: bold; margin-left:31px;    margin-top: -2px;" id="saldoporpagar" >$  </label>
                                    <br />
                                </td>
                            </tr>
                            <td>&nbsp;</td>
...
<!--                            <tr id="tr_otheramount"  ><td>
                                <label  style="padding-left:20px; font-size:16px; "><strong style="padding-bottom:10px; color: #4B0082;">Other Amount&nbsp;&nbsp;&nbsp;&nbsp;$</strong></label>    </td>
                            <td>
                                <input type="text" id="otheramount" name="otheramount" style="text-align: center;font-size: 22px;font-weight: bold;color: #fff;border: #AC1B29 solid thin; background-color: #AC1B29; width: 104px;float:left;width:106px; font-weight:bold; color:fff;" value="" onkeyup="CalcularTotalTotal();"  />
                            </td>
                            </tr>-->
                            <tr id="pay_amount_html" style="height: 50px;">
<!--                                <td>
                                    <label  style="padding-left:20px; font-size:16px; "><strong style="padding-bottom:10px; color:#4B0082;">Add Payment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$</strong></label>
                                </td>-->
                                <td>
                                     <input autocomplete="off" type="text" class="txtNumbers"  name="pay_amount" id="pay_amount" value=""  style="text-align: center;font-size: 22px;font-weight: bold;color: #fff;border: 1px #33F solid; background-color: #00f; padding-left:5px; width:100px; height:20px;float:left; margin-top:4px;" />
                                     <select name="opcion_pago_2" style="margin-left:1px; margin-top: 7px;">
...
<!--                <select name="opcion_pago" style="margin-left:-426px; margin-top: 128px;" id="op_pago_id">
                    <optgroup label="COLLECT ON BOARD">
                        <option value="8">Credit Card no fee</option>
                        <option value="3">Credit Card with fee</option>
                        <option value="4">Cash</option>
                ...
                <input  title="Confirm Booking" type="button" id="btn-save2"  style="margin-left: 812px; margin-top:151px; height: 35px; cursor:pointer; color: #000;font-weight: 700; width:124px;" value="Confirm Booking" />
<!--                <i class="fa fa-floppy-o fa-5x" style="color:#fff;"></i>-->


            </fieldset>
<!--            <select name="opcion_pago_2" style="margin-left:369px; margin-top: -171px; ">
                <optgroup label="PRED-PAID">
                    <option value="2">Credit Card no fee</option>
                    <option value="1">Credit Card with fee</option>
                    <option value="6">Cash</option>
...
//        alert(comi);
        ...
        if (apagar > 0) {
            ...
            //document.getElementById('saldoporpagar').value = document.getElementById('otheramount').value+'.00';
        ...
        if (tipo_pago == 5) {
            if (disponible - balance < 0) {
                ...
                $("#saldoporpagar").text(((apagar_2 - pay_amount)).toFixed(2));
...
//          $("#opcion_pago_saldo").val('2');
            ...
            if (otheramount_2 > 0) {
                ...
                $("#saldoporpagar").text((((apagar_2 + fee) - pay_amount)).toFixed(2));
            }
        } else {
            $("#opcion_saldo2").attr('disabled', false);
            $("#opcion_saldo1").attr('disabled', false);
