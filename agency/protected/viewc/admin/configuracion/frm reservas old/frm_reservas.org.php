...
<!--                <input type='text' id='x' style='font-size: 10px' name='x' size='5' value ='0,0' onchange='checkDecimals(this.value, this.value)'>-->
 ...
 <tr>
   ...
   <td colspan="2">&nbsp;</td>
            ...
            <fieldset id="pymen" style="margin-top:4px; border-radius: 5%; height:370px;" class="verdefosf" ><legend style="border:1px solid #00C; background:#fff" >PAYMENT INFORMATIONS</legend>
...
<!--                                    <tr id="tr_agencycomision" style="display:none">
    ...
    <td width="296">
        <label id="totalComision" style="margin-top: 30px; padding-bottom:8px;color: #BDBDBD; "></label>
                                    ...
                                    <tr>
                                        <td>
                                            <label  style="padding-left:20px; height: 20px; font-size:16px; color:#4B0082;"><strong style="margin-top:-18px; margin-left: 33px; padding-bottom:10px; ">TOTAL FARE&nbsp;$</strong></label>
                                        </td>
                                        <td>
                                    ...
                                    <tr style=" height:13px; width:180px;">
                                        ...
                                        <td>
                                            <label  style="padding-left:48px; font-size:16px;"><strong   id="txtamountpendiente" style="padding-bottom:0px; color:#4B0082">Amount Paid&nbsp;$</strong></label>
                                        </td>
                                        <td><select name="opcion_pago" style="margin-left:18px; display: none" id="op_pago_id">
                                            ...
                                            <label style="text-align: center;background-color: #BCED91; color:#4B0082; font-size: 19px; font-weight: bold; margin-left:0px;  margin-top: -2px;width: 108px;height: 24px;" id="saldoporpagar" >$  </label>
                                            <br />
                                        </td>
                                    </tr>
                                    <td>&nbsp;</td>
                                    ...
                                    <tr id="tr_otheramount"  ><td>
                                            <label  style="padding-left:57px; font-size:16px; margin-left:12px;"><strong style="padding-bottom:10px; color: #4B0082;">Pay Driver&nbsp;$</strong></label>    </td>
                                        <td>
...
<!--                                            <label  style="padding-left:20px; font-size:16px; "><strong style="padding-bottom:10px; color:#4B0082;">Add Payment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$</strong></label>-->
                                            <label  style="padding-left:52px; font-size:16px; "><strong style="padding-bottom:10px; color:#4B0082;">Balance Due&nbsp;$</strong></label>
                                        </td>
                                        <td>
                                           
                                            
                                            
                                            <input autocomplete="off" type="text" class="txtNumbers"  name="pay_amount" id="pay_amount" value=""  style=" display:none; text-align: center;font-size: 22px;font-weight: bold;color: #fff;border: 1px #33F solid; background-color: #00f; padding-left:5px; width:100px; height:20px;float:left; margin-top:4px;" />
                                            <input autocomplete="off" type="text" class="txtNumbers"  name="balance_due" id="balance_due" value=""  style=" text-align: center;font-size: 22px;font-weight: bold;color: #fff;border: 1px #33F solid; background-color: #72CBEC; padding-left:5px; width:100px; height:20px;float:left; margin-top:4px;" />
                                            <select name="opcion_pago_2" style="margin-left:1px; margin-top: 7px; display: none">
                            ...
                            <a title="Save" style=" display:none; margin-left: 344px; margin-top:-41px; cursor:pointer" id="btn-save2"><i class="fa fa-floppy-o fa-5x" style="color:#4B0082;"></i></a>

                            <input name="button" type="button" id="apply_payment"  style="border-bottom-color: #000; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px; cursor:pointer;  margin-left: 31px; padding: 10px;  height: 33px;   width: 119px; color: #AC1B29;font-weight: 700; background-color: #F3FE76;" value="Apply Payment" />
                            
                            <input name="button" type="button" id="pay_driver"  style=" border-bottom-color: #000; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px; cursor:pointer; margin-top: -51px; margin-right: 111px; padding: 10px;  height: 33px;   width: 119px; color: #AC1B29;font-weight: 700; background-color: #8AF957" value="Pay Driver" />
...
<!--                            <input  type="button" value="Pay Driver" style="cursor:pointer; margin-top: -10px; margin-left: 303px; padding: 10px;  height: 33px;   width: 119px; color: #AC1B29;font-weight: 700;" />-->
                        ...
                        <td>
                            <div id="comco" class="input"> <div style="width:275px;">  <label style="color:#4B0082; width:150px;padding-left:100%; margin-left:107px; margin-top:-69px;"  ><strong>NOTES</strong></label></div><textarea id="comments" name="notes" cols="0" rows="0"  style="margin: 2px; width: 379px; height: 271px; margin-top: -50px; margin-left:40px; "></textarea></div>
                        </td>
                    </tr>
