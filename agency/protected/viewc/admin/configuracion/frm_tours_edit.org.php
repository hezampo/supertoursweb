...
<!--                        <input type="button" id="btnReversar" name="btnReversar" size="20"  style="margin-left: 0px; margin-top: -150px; background-color: #000; border-color: #fff; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; border-top-left-radius: 5px; border-top-right-radius: 5px; cursor:pointer; color:#fff; font-weight: 200; width: 80px; font-size: 9px; padding-top: 1px; height: 20px;" value="Reversar Pagos" onclick="Reseteo(); Resetal();" />-->
...
<!--        <input type="button" style="margin-left: 0px; margin-top: -130px; width:85px; cursor:pointer;" name="actualiza_cajas" id="actualiza_cajas" onclick="actualiza_cajas();" value="Update Box" />-->
...
<!--    <div id="dialog2" title="History of Payments [Multi-Day Tours]" style="display:none; width:550px; margin-left:12px;">
        <div style="overflow-y: scroll;height:250px; width:550px;">
            <table class="grid2" cellspacing="1" id="grid2">
                <thead>
                    <tr>
                        <td style="text-align: center; width:143px;">Pago</td>
                        <td style="text-align: center; width:158px;">Tipo Pago</td>
                        <td style="text-align: center; width:78px;">Valor Pagado</td>
                        <td style="text-align: center; width:150px;">Fecha</td>
                    </tr>
...
//            
        ...
        function delete_park(id_park) {
            ...
            //return $("#tablePark").load('<?php /*echo $data['rootUrl']; */?>admin/tours/delete_park/' + id_park + '/' + adult + '/' + child + '/' + id_tour);
...
//                          $("#paid_driver").val((bal).toFixed(2));
            ...
            /***************************3***********************************ok**/
                if (pay_amount > 0 && paid_driver == 0 && other_amount == 0) {
                    ...
                    var balance_due = parseFloat($("#balance_due").val());
                    var pay_amount = parseFloat($("#pay_amount").val());  
                    var apagar = pay_amount - temp_prepaid;
...
function actualiza_cajas()
    {  
                    
            var amount_to_collect = $("#saldoporpagar").val();
            var pass_bal_due = $("#balance_due").val();
            var total_net_fare = $("#balance_due").val();
            var agency_bal_due = $("#totalAmount").val();         
            
            $("#actualiza_cajas").load(encodeURI('<?php /* echo $data['rootUrl']; */?>admin/tours/actualiza_cajas/' + amount_to_collect + '/' + pass_bal_due + '/' + total_net_fare + '/' + agency_bal_due);          
