...
<div id="header_page" >
    ...
    <div id="info-group" style="float: left;">
...
<form  id="formula" class="form" action="<?php echo $data['rootUrl']; ?>admin/reservas/save" method="post" name="formula" target="_blank" >
    ...
    <div id="content_page"  >
        <div id="serpare">
            ...
            <table><tr><td>
                        <fieldset> <legend>INPUT TYPE</legend>
                                    ...
                                    <tr><td colspan="2" >
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td width="40%">
                                                        <div class="ausu-suggest" >
                                                          <select name="employ"  style="width:125px; height:25px;" id="from"> 
                                                            <option value="0"></option> 
                            <?php foreach ($data["agency_account"] as $e) { ?>
                                <option value="<?php echo $e["id"]; ?>"  ><?php echo $e["person_charge"]; ?></option>           
                            <?php } ?>                     
                      </select>
    ...
    <fieldset id="liderpax" style=""><legend>LEADER PASS</legend>
                                        ...
                                        <div id="opera" class="input" >
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td width="">
                                                        <input name="firstname1" type="text"  id="firstname1" size="20" maxlength="20" value="<?php
                                                        if (isset($cliente) && isset($reserva)) {
                                                            if ($cliente->id == $reserva->id_clientes) {
                                                    ...
                                                    <td width="">  
                                                        <input name="lastname1" type="text"  id="lastname1" size="20" maxlength="20" value="<?php
                                                        if (isset($cliente) && isset($reserva)) {
                                                            if ($cliente->id == $reserva->id_clientes) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>  
                                                        <input name="email1" type="text"  id="email1" size="20" value="<?php
                                                        if (isset($cliente) && isset($reserva)) {
                                                            if ($cliente->id == $reserva->id_clientes) {
            ...
            <fieldset id="boo" ><legend>BOOKING</legend>
                ...
                <div id="opera" class="input" style="float: right;"><input name="byr" type="checkbox" value="1" /><label id="labeldere" style="background-color: rgb(243, 229, 155);"> Customer With Disabilities </label></div>
        ...
        <!--<div id="opera" class="input" style="padding-right:200px; padding-top:10px;"><input name="byr" type="radio" value="" /><label id="labeldere"> Customer With Disabilities </label></div>-->
            ...
            <fieldset id="onew" ><legend>ONE WAY</legend>
                ...
                <div id="opera" class="input" style="padding-top:18px; "> 
                    ...
                    <input name="fecha_salida" type="text"  id="fecha_salida" size="10" maxlength="15" value=""  autocomplete="off" />
                </div>
                ...
                <div id="opera" class="input">        
                    ...
                    <div style="width:50px;"> <input name="trip_no" type="text"  id="trip_no" size="3" maxlength="3" value="<?php
                        if (isset($reserva)) {
                ...
                <div id="opera" class="input"  style="clear:right; padding-left:7px;">        
                    ...
                    <div style="width:50px;">
                        <input name="departure1" type="text"  id="departure1" size="5" maxlength="8" value="<?php
                        if (isset($reserva)) {
                ...
                <div id="opera" class="input"  >        
                    ...
                    <div style="width:200px;">
                        <div class="ausu-suggest" >
                            <input name="dropoff1" type="text"  id="dropoff1" size="39" maxlength="55" value="<?php
                ...
                <div id="opera" class="input"  >        
                    ...
                    <div style="width:50px;">
                        <input name="arrival1" type="text"  id="arrival1" size="5" maxlength="8" value="<?php
                        if (isset($reserva)) {
                ...
                <div id="opera" class="input"  style="padding-left:13px; clear:right;">        
                    ...
                    <input name="room1" type="text"  id="room1" size="4" maxlength="6" value="" />
                </div>
                <div id="opera" class="input"  style="clear:left; ">  
            ...
            <fieldset id="round" style="display:none;"><legend><font color="#990000">ROUND TRIP</font></legend>
                ...
                <div id="opera" class="input"  >        
                    ...
                    <div style="width:50px;"> <input name="trip_no2" type="text"  id="trip_no2" size="3" maxlength="3" value="<?php
                        if (isset($reserva)) {
                ...
                <div id="opera" class="input"  style="clear:right; padding-left:7px;">        
                    <div style="width:50px;">  <label style="width:45px"  > DEP.TIME</label></div>
                    <div style="width:50px;">
                        <input name="departure2" type="text"  id="departure2" size="5" maxlength="8" value="<?php
                        if (isset($reserva)) {
                ...
                <div id="opera" class="input"  >        
                    ...
                    <div style="width:200px;">
                        <div class="ausu-suggest" >
                            <input name="dpoff2" type="text"  id="dropoff2" size="39" maxlength="55" value="<?php
                ...
                <div id="opera" class="input"  >        
                    <div style="width:50px;"><label style="width:45px"  >ARR.TIME</label></div>
                    <div style="width:50px;">
                        <input name="arrival2" type="text"  id="arrival2" size="5" maxlength="8" value="<?php
                        if (isset($reserva)) {
                ...
                <div id="opera" class="input"  style="padding-left:13px; clear:right;">        
                    <label style="width:48px"  >ROOM #</label>
                    <input name="room2" type="text"  id="room2" size="4" maxlength="6" value="" />
                </div>
                <div id="opera" class="input"  style="clear:left; ">        
                    <div style="width:300px;">  <label style="width:250px"  >EXTENSION PICK UP POINT/ADDRESS</label></div>
                    <div style="width:200px;">
            ...
            <fieldset id="pymen" style="" ><legend >PAYMENT INFORMATIONS</legend>
                    ...
                    <tr><td colspan="2">
                            <table width="100%" border="0">
                                <tr>
                                    ...
                                    <td style="width:50px" ><a id="btn-save2" title="Save"><img width="50" height="40" src="<?php echo $data['rootUrl']; ?>global/img/admin/save2.png" /></a>
...
<div id="opera" class="input" style="padding-top:5px; width:450px;"> 
                            ...
                            <tr style="background-color: #DCE6F2;">
                                ...
                                <td><select name="opcion_pago" style="margin-left:10px;" id="op_pago_id">
                            ...
                            <td>
                                    <input type="text" id="otheramount" name="otheramount" style="float:left;width:100px; font-weight:bold; font-family:Verdana, Geneva, sans-serif;" value="" onkeyup="CalcularTotalTotal();"  />
                            </td>
                            </tr>
