            ...
            <ul>
                <li style="margin: 0 -92px -26px;margin-top: 6px;">
                   ...
                   <!-- <input type="submit" value="summary" />-->
                        <input  type="submit" value="Summary" style="margin-top: -4px; margin-left: -14px; padding: 10px; color: #AC1B29;font-weight: 700;" />
                    </form>
                ...
                <li class="btn-toolbar" id="btn-rastro">
                    <a class="link-button" id="btn-rastro2">
                        <span class="icon-32-rastro" title="Nuevo" style="margin-top: -25px; margin-left: -4px; ">&nbsp;</span>
                        Traces
                    </a>
                </li>
                <li class="btn-toolbar" id="btn-cancel">
                    <a class="link-button" >
                        <span class="icon-back" title="Editar" style="margin-top: -25px; margin-left: 4px;" >&nbsp;</span>
                        Back
                    </a>
                </li>
            </ul>
...
<div id="content_page_tours" style="z-index:1;width: 984px;">
    ...
    <form id="form1" class="form" action="" method="post" name="form1">
        ...
        <div id="info-group" style="width: 900px;">
            ...
            <div id="reservation"  style="width:200px;">
                ...
                <div id="reser"><?php echo $tours->code_conf; ?></div>
            </div>
            <div id="status">
                <div class="ho" style="background: #bb0000;">STATUS</div>
                <div id="stat"><?php echo $tours->estado; ?></div>
            </div>
        ...
        <fieldset id="inputype" class="rojo" style="float: left; margin-bottom: 2%; border-radius: 3px 120px 0px 80px;width: 46%;">
                                ...
                                <tr>
                                    ...
                                    <td width="40%">
                                        <div class="ausu-suggest" >
                                            <input name="agency" type="text" style="margin-top:15px; margin-left:4px;"  id="agency" size="19" maxlength="30" value="<?php echo $agencia->company_name; ?>" autocomplete="off"  disabled="disabled" />
        ...
        <fieldset id="liderpax" style="width: 460px;border-radius: 130px 3px 80px 0px; width:90px;" class="cerati" >
                    ...
                    <td>
                        <div id="opera" class="input" style="padding-top:5px;">
                            <table>
                                <tr>
                                    <td>
                                        <label style="margin-left:24px; color:#FFFFFF;" id="label"> SEARCH </label>
                                    </td>
                                    <td>
                                        <div class="ausu-suggest" id="opera">
                                            <input type="text" size="65" style="margin-left:12px; width:352px;" value="<?php echo $data['cliente']->lastname . ' ' . $data['cliente']->firstname . ' - E-Mail -' . $data['cliente']->username ?>" name="cliente" id="cliente" autocomplete="off">
                        ...
                        <div id="opera" class="input" >
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <input name="firstname1" type="text" id="firstname1" style="margin-left:11px; width:131px;"  size="20" maxlength="20" value="<?php echo $data['cliente']->firstname ?>">
                                    </td>
                                    <td width="" align="right">
                                        <label style="color:#FFFFFF;" id="labeldere12" >LAST NAME </label>
                                    </td>
                                    <td>
                                        <input name="lastname1" type="text" style="margin-left:6px; width:140px;" id="lastname1" size="20" maxlength="20" value="<?php echo $data['cliente']->lastname ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td>
                                        <input name="phone1" type="text" id="phone1" size="20" maxlength="20" style="margin-left:10px; margin-top:6px; width:132px;"  value="<?php echo $data['cliente']->phone ?>">
                                        <input type="hidden" name="type_cliente" id="type_cliente" value="<?php echo $data['cliente']->tipo_client ?>">
                                    </td>
                                    <td align="right">
                                        <label style="color:#FFFFFF;" id="labeldere12" style="margin-left:-32px;">E-MAIL </label>
                                    </td>
                                    <td>
                                        <input name="email1" type="text" id="email1" size="20" style="margin-left:6px; width:140px; margin-top:6px;" value="<?php echo $data['cliente']->username ?>">
                                    </td>
                                </tr>
                            </table>
                        </div>
...
//                            }
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <fieldset style="float: left; height:45px; background: transparent;border: 1px solid #000;"><legend style="color: #000;">FREE DAYS</legend>
                                                                    <table width="100%">
                                                                        <tr>
                                                                            <td width="10%"><!--
    ...
    <!--                                                                        <span><input type="checkbox" <?php
                                                                            if (count($hotel_reserves) > 0) {
                                                                                if ($hotel_reserves[count($hotel_reserves) - 1]['free_night_buffet'] == 1) {
                                                                                    echo ' checked';
                                                                                }
                                                                            }
                                                                            ?> id="free_buffet" name="free_buffet" value="<?php
                                                                            if (count($hotel_reserves) > 0) {
                                                                                echo $hotel_reserves[count($hotel_reserves) - 1]['free_night_buffet'];
                                                                            }
                                                                            ?>"  /></span>-->
                                                                        </td>
                                                                        </tr>
...
//                                                            exit;
            ...
            <!--                                                                        <td><? echo $hotel_reserve['adult']+ $hotel_reserve['child']; ?></td>-->
                                                                                    ...
                                                                                    <td><?php echo $hotel_reserve['free_night_buffet']; ?></td>
            ...
            <!--                                                                    <td><? echo ($hotel_reserve["room1_adult"] > 0?1:0); ?></td>
                                                                            ...
                                                                            ?>"/>
        <!--                                                                    <input type="hidden" name="hotel_nochesfree_<? echo $i; ?>" id="hotel_nochesfree_<? echo $i; ?>"  min="0" value="<? echo trim($hotel_reserve['free_night']);?>"/>-->
                                                                            ...
                                                                            <input type="number" name="freeday_<?php echo $i; ?>" id="freeday_<?php echo $i; ?>"  value="<?php echo $hotel_reserve['free_night_buffet']; ?>" style="width: 4%;margin-left: 68%; margin-top: -54px;">
                                                                            <input type="hidden" name="hotel_resort_<?php echo $i; ?>" id="hotel_resort_<?php echo $i; ?>" value=""/>
                                                                            ...
                                                                            <input type="hidden" name="hotel_subtotal_<?php echo $i; ?>" id="hotel_subtotal_<?php echo $i; ?>" value="<?php echo ($tours->id_hotel_reserve != -1) ? $hotel_reserve['total_paid'] : 0; ?>" />
                                                                            <?php
                                                                            $i += 1;
                                                                        }
                                                                        ?>
        ...
        <fieldset style="border-radius: 5%;" class="brown">
            <legend style="background-color:#F6F6F6;border: 1px solid #CCCCCC;">
                <div id="parks_edit">                   
                    <div> <label>PARKS EDIT</label> </div>                            
                </div>
            </legend>
            ...
            $sql2 = "SELECT a1.adult,a1.child,a1.cantidad,g1.nombre AS GRUPO, ROUND(SUM(total_paid)) AS TOTAL, ROUND(SUM(totalAdmission)) AS TOTADM, ROUND(SUM(admission_adtul)) AS SUMADMADULT, ROUND(SUM(admission_child)) AS SUMADMCHILD, ROUND(SUM(totalTraspor)) AS TTRANSPORT,
            ...
            if ($cantidad == 3) {
                echo $respuesta_html .= "<p style='margin-left: 20px; color: #07218B;'><blink> <b>" . $key['cantidad'] . "</b> tickets to <strong>" . $key['GRUPO'] . "</strong> Adult $ <strong>" . $key["ADM_ADULT"] . "</strong> Child $ <strong>" . $key["ADM_CHILD"] . "</strong> per person.</blink></p>";
                echo $respuesta_html2 .= "<p style='margin-left: 20px; color: #07218B;'><blink> <b>" . "</b> TOTAL ADMISSION ADULT: $&nbsp;<strong>" . $totadadult . "</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; TOTAL ADMISSION CHILD: $&nbsp;<strong>" . $totadninos . "</strong><b>" . "</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; TOTAL ADMISSION PARKS: $&nbsp;<strong>" . $totadparks . ".00</strong>.</strong>.</b>&nbsp;&nbsp;&nbsp; TOTAL TRANSPORT. SUPPLEMENT: $&nbsp;<strong>" . $totTransport . ".00</strong></blink></p>";
            }
                                                        ...
                                                        <td>
                                                            <table class="fields2"><tr></tr>
                                                                <tr>
                                                                    ...
                                                                    <td><span>Nights:<br /> <input name="nights1" id="nights2" type="text" value="<?php echo $tours->length_nights; ?>" readonly="readonly">
                                                                        </span>
                                                                    </td></tr></table>
                                                        </td>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#fecha_retorno").change(function () {
                mensaje("Ha hecho un Cambio en las fechas, esto representa un cambio en el numero de dias y noches por lotanto, necesario volver a realizar la distribución de habitaciones e ingresar nuevamente el hotel.", "Cambiar Distribución de Hoteles", '');
                var fecha_retorno = $('#fecha_retorno').val();
...
?>
        ...
        function valorTransfer(tipo_transfer, tipo_transport, sentido) {
            ...
            $("#userr").load('<?php echo $data["rootUrl"]; ?>admin/tours/valorTransfer/' + tipo_transfer + '/' + tipo_transport + '/' + child + '/' + adult + '/' + id_agencia + '/' + fecha + '/' + sentido);
...
<?php } ?>
        ...
        function cargarHoteles() {
            ...
            if (datosroom != '') {
                ...
                var noches_escogidas = 0;
                if (d < noches_escogidas) {
                    msj = '- The number of  nights exceeds the size of the tour';
                    titulo = 'Nights';
                    mensaje(msj, titulo, 'noches_escogidas');
                    return false;
                }

                var today = new Date();
                var x = $("#fecha_salida").val().split("-");
                var starting_date = new Date(parseInt(x[2]), parseInt(x[0]) - 1, parseInt(x[1]));
                ...
                if (today < starting_date) {
                    ...
                    var url = '<?php echo $data['rootUrl']; ?>admin/tours/selecthotel/' + id_hotel + '/' + fecha_salida + '/' + fecha_retorno + datosroom + '/' + id_agency + '/' + fdadult + '/' + free_buffet;
                    $("#tablehoteles").load(url);
                } else {
                    $("#mascaraP").show();
                    $("#dialog_message6").dialog(
                            {
                                buttons: [
                                    {
                                        text: 'Yes',
                                        click: function () {
                                            if (parseInt($("#hotel_cat").val()) > 2 || $("#super_breakfast").val() == '1') {
                                                $("#buffet2").dialog({
                                                    buttons: [
                                                        {
                                                            text: 'Yes',
                                                            click: function () {
                                                                $("#buffetYes").attr('checked', true);
                                                                dialog7();
                                                                $(this).dialog('close');
                                                            }
                                                        },
        ...
        function calcularTotal() {
            ...
            if (totalpax > 0) {
                ...
                var priceAdmision = calcularAdmision(adult, child) + (priceadults.value);
