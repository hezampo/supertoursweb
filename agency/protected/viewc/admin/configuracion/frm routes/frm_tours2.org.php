        ...
        <div class="toolbar-list">
            <ul>
                <li class="btn-toolbar" id="btn-save"><a class="link-button" id="btn-save"> <span class="icon-32-save"
                                                                                                  title="Nuevo">&nbsp;</span>
                    Save </a></li>
                <li class="btn-toolbar" id="btn-cancel"><a class="link-button"> <span class="icon-back" title="Editar">&nbsp;</span>
                    Back </a></li>
            </ul>
            <div class="clear"></div>
        </div>
...
<div id="content_page_tours" style="z-index:1;">
...
<div id="info-group">
    ...
    <div id="reservation" style="width:300px;">
        ...
        <div id="reser">00000</div>
    </div>
    <div id="status">
        <div class="ho">STATUS</div>
        <div id="stat">CINFIRMED</div>
    </div>
    ...
    <br />
            ...
            <table>
        	 <tr>
                ...
                <table>
                	<tr>
                    	<td>
                        	 <label style="" id="label" >SEARCH CLIENT</label>
                         </td>
                         <td>
            <div class="ausu-suggest" id="opera">
               <input type="text" size="65" value="" name="cliente" id="cliente" autocomplete="off" />
              
    		<input type="hidden" size="4" value="" name="id_leader" id="id_leader" autocomplete="off" disabled="disabled"  readonly="readonly"/>
          </div> 
                        </td>
                        <td>
                        	<div   class="ausu-suggest" style="margin-top:-5px; margin-left:2px; ">		
		...
		<div id="clienteN" style="display: none; margin:auto" >
        </div>
                        </td>
                    </tr>
                </table>
          ...
          <label style="" id="label">FIRST NAME</label>		
                    		...
                    		<tr>
                                ...
                                <td>  
                                 <input name="email1" type="text"  id="email1" size="20" maxlength="40" value=""/>
                                </td>
                            </tr>
                    	</table>   
                    </div>
          ...
          <fieldset id="inputype" ><legend>INPUT TYPE</legend>
             ...
             <table  >
             	<tr align="left">
                    ...
                    <td width="351" >
                         <input name="nombre" type="text"  id="nombre" value="<?php echo  trim($login->nombre.' ('.$login->usuario.')');?>" readonly="readonly"/></td>
                ...
                <tr><td colspan="2" >&nbsp;</td></tr>
                 <tr><td colspan="2">
                 	<table  align="center" cellspacing="5">
                    	<tr valign="top">
                        	<td><label> BY PHONE</label> <input name="byr" type="radio" value="1" />  </td>
                            <td><label> BY MAIL</label> <input name="byr" type="radio" value="2" /> </td>
                            <td><label> WEBSALE </label><input name="byr" type="radio" value="3" />  </td>
                        </tr>
                    </table>
                </td></tr>
             </table>
        ...
        <div id="date" align="center">
          ...
          <label style="width:100px;"  >STARTING DATE </label>
          </td></tr>
          <tr><td>
          ...
          <input name="fecha_salida" type="text"  id="fecha_salida" size="10" maxlength="15" value="" onchange="fechaRetorno(this.value);" autocomplete="off"  /></td></tr></table>
        </div>
                    </td>
                    <td>
                    <div id="opera" class="input"> <table><tr><td>
                     
          <label style="width:100px;"  >ENDING DATE</label> 
          </td></tr>
          <tr><td><a href="" id="dataclick2" ><img src="<?php echo $data['rootUrl']; ?>global/images/calendar.png" alt=""  align="absmiddle" width="19" height="20" border="0"  /></a>
          <input name="fecha_retorno" type="text"  id="fecha_retorno" size="10" maxlength="15" value=""   autocomplete="off"   />
                    ...
                    <td>
                     <div class="fields">
                        ...
                        <input style="font-size:16px" name="adult" id="adult" type="number" value="1" max="16" min="1">
                    </div>
                    </td>
                    <td>
                ...
                <div class="fields">
                    ...
                    <input style="font-size:16px" name="child" id="child" type="number" value="0" max="15" min="0">
                </div>
                    </td>
        ...
        <td><span>Nights:<br /> <input name="nights" id="nights" type="text" value="" readonly="readonly">
        </span>
        </td></tr></table>
    </div>
                    </td>
                    ...
                    <table width="100%">
                    	<tr>
                            ...
                            <table width="100%">
                                ...
                                <td>
                                 <ul class="list">
            <li><input id="a_bus" name="a_type" type="radio" value="0" checked="checked"><label style="cursor:pointer"  for="a_bus">BUS</label></li>
            <li><input id="a_vip" name="a_type" type="radio" value="1"/><label style="cursor:pointer"  for="a_vip">VIP</label></li>
            <li><input id="a_airpoty" name="a_type" type="radio" value="2"/><label style="cursor:pointer"  for="a_airpoty">AIRPORT</label></li>
            <li><input id="a_car" name="a_type" type="radio" value="3"/><label style="cursor:pointer"  for="a_car">BY CAR</label></li>
        </ul>
                                </td>
                                  <td>&nbsp;</td>
            ...
            <div id="price_transport1pp" class="price">$ 0.00</div>
              ...
              <select name="ext_from1" id="ext_from1" class="select" style="width:200px;" onchange="change_ext_from1();"></select>
                                    ...
                                    <div class="label">LUGGAGE</div>
                                            <span><input name="a_luggage" type="text" id="a_luggage" size="2" maxlength="1" value=""
                                                         class="field"/></span>
                                        </div>
                                        </td>
                                        <td width="15%">
                                    ...
                                    <div class="label">ROOM #</div>
                                            <span><input name="a_room1" type="text" id="a_room1" size="2" maxlength="1" value=""
                                                         class="field"/></span>
                                        </div>
                                        </td>
                                    </tr>
				...
				<fieldset id="departure" style="background-color: #F3DCDC;">	
                 <legend style="background-color: #F3DCDC; border: #B83A36 solid thin;" >
   <label for="opcion_transfer_out" style=" cursor:pointer; " >TRANSFER OUT</label><input type="checkbox" name="opcion_transfer_out" id="opcion_transfer_out" value="1" checked="checked"/> 
                    ...
                    <table width="100%">
                    	<tr>
                            ...
                            <table width="100%">
                                ...
                                <td>
                                 <ul class="list">
              <li><input id="d_bus" name="d_type" type="radio" value="0" checked="checked"><label style="cursor:pointer" for="d_bus">BUS</label></li>
            <li><input id="d_vip" name="d_type" type="radio" value="1"/><label style="cursor:pointer" for="d_vip">VIP</label></li>
            <li><input id="d_airpoty" name="d_type" type="radio" value="2"/><label style="cursor:pointer" for="d_airpoty">AIRPORT</label></li>
            <li><input id="d_car" name="d_type" type="radio" value="3"/><label style="cursor:pointer" for="d_car">BY CAR</label></li>
        </ul>
                                </td>
                                  <td>&nbsp;</td>
                                 <td title="Price of transport per person">   <div id="t-total">
                        	...
                        	<td>
                               ...
                               <input type="hidden" name="trip2c"  id="trip2c" value="0" />
                                            ...
                                            <a rel="superbox[ajax][<?php echo $data['rootUrl']; ?>admin/tours/trips/arrival][300x100]">
                                                <img id="popup2" style="cursor:pointer" src="<?php echo $data['rootUrl']; ?>global/images/search.png" onclick="mostrarTrip2()"/>
                    	...
                    	<tr>
                            <td id="tdRomm">
                            	<table width="100%">
                                	<tr>
                                    	<td width="15%"  valign="middle">
                                        	<table >
                                            	<tr>
                                                	<td>
                                        <div class="label"><strong>ROOMS</strong></div>
                                        			</td>
                                                    <td>
                             	...
                             	<td width="7%">
        <div class="label"><strong>HOTEL</strong></div>
        </td>
        <td width="35%" >
        <div  style="width:100%" class="ausu-suggest"><input  style="width:350px" class="field" type="text" value="" id="hotel_name" autocomplete="off" disabled="disabled" >
         <input type="hidden" name="hotel_id" id="hotel_id" value=""/>
        <input type="hidden" name="hotel_id_select" id="hotel_id_select" value="-1"/>
        <input type="hidden" name="hotel_breakfast" id="hotel_breakfast" value=""/>
        <input type="hidden" name="hotel_buffet" id="hotel_buffet" value=""/>
          <input type="hidden" name="hotel_nochesfree" id="hotel_nochesfree" value="0"/>
          <input type="hidden" name="hotel_nochesfree_buffet" id="hotel_nochesfree_buffet" value="1"/>
        <input type="hidden" name="hotel_resort" id="hotel_resort" value=""/>
         <input type="hidden" name="hotel_category" id="hotel_category" value=""/>
        </div>
        </td>
     	<td>
        <fieldset><legend>FREE NIGHTS</legend>
        	<table width="100%">
            	<tr>
            	<td width="10%">
               ...
               <td width="5%">
                <span><input style="width:50px;" class="field" type="number"  min="0" value="0" id="nochesfree"/></span></td>
                <td width="">&nbsp;</td>
                <td width="30%">
                <div class="label"><strong><label style="cursor:pointer;" for="free_buffet">Free Buffet&nbsp;</label></strong></div>
                </td>
               <td width="5%">
                <span><input type="checkbox" checked="checked" id="free_buffet" name="free_buffet" value="1"  /></span></td>
    ...
    <div id="add" style="vertical-align:bottom;">
        <input type="button" id="add_Hotel_list" value="Add to list"  style="height:30px" />
    </div>
                            </td>
                            ...
                            <td>&nbsp;</td>
                             ...
                             <td rowspan="2">
                             <div id="t-total" style="width:170px;">
            <div class="label">TOTAL PRICE PER PERSON</div>
            <div class="price" id="amount_hotel">$ 0.00</div>
        </div>
                            </td>
                         </tr>
                         <tr><td>&nbsp;</td></tr>
...
<tr>                            <td valign="bottom">
   ...
   <tr id="tipo_passager" style="height:20px;width:160px; ">
    ...
    <tr id="tipo_predpaid_cash" style="position:static;">
      	<td><input name="opcion_pago" id="opcion_pago_predpaid_cash"  value="6" agencypago="true" type="radio"></td>
  ...
  <tr id="tipo_CrediFee">
    ...
    <td align="left"  nowrap="nowrap" > <label id="label_tipo_CrediFee" for="opcion_pago_CrediFee" class="opcion_pago">Credit Card+ 4 % FEE</label></td>
  </tr>
  <tr id="tipo_Cash">
   ...
   <td style="width:300px;" align="left" valign="bottom">
    <div id="" class="input"> <div style="width:275px;">  <label style="width:150px;"  ><strong>NOTES</strong></label></div><textarea id="comments" name="comments" cols="0" rows="0"  style="width: 339px; height: 120px; "></textarea></div>
    </td>
   </tr>
   ...
   <tr><!-- Detalles -->
        ...
        <table><tr><td>
            ...
            <tr>
                    ...
                    <div id="t-total2" style="width:168px;">
                                <div class="price">
                    <samp  id="totalAmount">$ 0.00</samp></div>
                    </div>
                    </td>
                </tr>
            <tr>
                ...
                <td colspan="2">
                  <input name="extra" type="text" id="extra" size="12" style=" padding-left:5px; width:160px; height:20px;" min="0" onkeyup="valorExtra();"  value="0" autocomplete="off" />
                </td>
            </tr>
                <tr >
                    <td valign="" >
                    <div style="display:none" id="div_tex_comision">
                        <div class="label">Comisi&oacute;n</div>
                    </div>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <div id="t-total2" style="width:170px;">
                        ...
                        <input autocomplete="off" type="text"  name="otheramount" id="otheramount" value="0"  style="padding-left:5px; width:160px; height:20px;" />
                    </div>
                    </td>
                </tr>  
                 <tr>
             <td>
               <div id="t-total2">
                <div class="label" style="width:150px; color:#F00;" ><strong><label class="label"  id="txtSaldoPorPagar" style="font-weight:bold;  text-align:left; ">AMOUNT PAYABLE</label></strong>  </div>
    ...
    <td colspan="2">
      <input name="descuento" type="number" id="descuento" maxlength="3" onkeyup="valorDescuentoPorec();" max="100" min="0"  value="0"  style="height:16px; width:100px;" />
    </td>
    </tr>
    <tr>
    <td><label style="text-align:left;"><strong> Discount &nbsp;$</strong></label></td>
    <td colspan="2">
      <input name="descuento_valor" type="number" id="descuento_valor" size="12" maxlength="10" pattern="6[0-9]" style="height:16px; width:100px;" onkeyup="valorDescuentoValor();"  value="0"  />
    </td>
                    <tr>
        	<tr>
            	<td align="right">
...
<script type="text/javascript">
	...
	function valorTransferGeneral(){
		...
		if(a_type != 0){
			valorTransfer(a_type,1);
		}
		if(d_type != 0){
			valorTransfer(d_type,2);
		}
	}
	function valorTransfer(tipo_transfer, tipo_transport){
		var child = $('#child').val();
		var adult = $('#adult').val();
		if(child == ""){
			child = 0;
		...
		$("#userr").load('<?php echo $data["rootUrl"]; ?>admin/tours/valorTransfer/'+tipo_transfer+'/'+tipo_transport+'/'+child+'/'+adult+'/'+type_rate);
	...
	function mostrarTrip1(){
			...
			var url = '<?php echo $data["rootUrl"]; ?>admin/tours/selectTrip1/'+from+'/'+to+'/'+fecha_salida+'/'+totalpax+'/'+tipopas+'/'+agency;
		...
		function mostrarTrip2(){
			...
			var url = '<?php echo $data["rootUrl"]; ?>admin/tours/selectTrip2/'+from+'/'+to+'/'+fecha_retorno+'/'+totalpax+'/'+tipopas+'/'+agency;
			$('.content-popup').load(url);	
	   ...
	   function change_from(){
		...
		function validarAcomodacion(){
			...
			if ($('#child1').length!=0){ var  child1 =  $('#child1').val(); }else{ var  child1 =  0; }
			if ($('#adult2').length!=0){ 
			...
			if ($('#child2').length!=0){ var  child2 =  $('#child2').val(); }else{ var  child2 =  0; }
			if ($('#adult3').length!=0){ 
			...
			if ($('#child3').length!=0){ var  child3 =  $('#child3').val(); }else{ var  child3 =  0; }
			if ($('#adult4').length!=0){ 
			...
			if ($('#child4').length!=0){ var  child4 =  $('#child4').val(); }else{ var  child4 =  0; }
			...
			var dato = '/'+adult1+'/'+adult2+'/'+adult3+'/'+adult4;
			return dato;
		}
		...
		function cargarHoteles(){
			...
			if(datosroom != ''){
				...
				if(d<nochesfree){
					msj = '- The number of free nights exceeds the size of the tour';
					titulo = 'Free nights';
					mensaje(msj,titulo,'nochesfree');
					return false;	
				}
				var free_buffet  = $("#free_buffet").val();
				var id_agency = $("#id_agency").val();
				var nochesfree = $("#nochesfree").val();
				var url = '<?php echo $data['rootUrl']; ?>admin/tours/selecthotel/' + id_hotel +'/' +fecha_salida+ '/'+fecha_retorno+datosroom+'/'+id_agency+'/'+nochesfree+'/'+free_buffet ;
		...
		function checker_admision(check, img, id_park){
			...
			$("#userr").load('<?php echo $data['rootUrl']; ?>admin/tours/gastionpark/'+id_park+'/'+opcion+'/'+adult+'/'+child);
		}
		...
		$('.buff').change(function(){
			...
			if($("#buffetYes").is(':checked')){
				...
				priceBreakfast = calcularBreakfast(adult,child);
				if((noches-nochesfree) == 0 && free_buffet == 1){
					var valorDesyuno = 0;	
				}else{
