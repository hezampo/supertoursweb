        ...
        <div class="toolbar-list">
            <ul>
                <li class="btn-toolbar" id="btn-save">
                    ...
                    <a class="link-button" id="btn-save"> <i class="fa fa-hdd-o fa-3x" style="margin-left: 4px; color: #AC1B29;"></i><br>Save</a>
                </li>
    ...
    <form id="form1" class="form" action="" method="post" name="form1">
        <div id="info-group" style="width: 900px;">
            ...
            <div id="reservation" style="border-color: #fff;width: 300px;">
                <div class="ho" style="color: #f6f6f6; background: #f6f6f6;"> <p style="display: none;"> RESERVATION </p>.<span></span></div>
            ...
            <tr>
                ...
                <td width="49%" valign="top">
                    <div id="chk_departure" style="color: #eee;">
                        <fieldset id="departure" style="border-radius: 5px;" class="rojo" >
                                    ...
                                    <td>
                                        <table >
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="0">
                                                    <input name="extra" type="text" id="extra" size="12" style="margin-right:8px; padding-left:5px; width:162px; height:16px; font-size: 16px;
                                                ...
                                                <td>
                                                    <div id="t-total2" style="width:168px;">
                                                        <input autocomplete="off" type="text"  name="otheramount" id="otheramount" value=""
                                                               style="margin-right: 2px; padding-left:5px; font-size: 16px; font-weight: 600; width:162px; height:16px;" />
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <a style="margin-top: 20px; margin-right: -55px; cursor:pointer" id="btn-save2"><i class="fa fa-hdd-o fa-5x" style="color: #AC1B29;"></i></a>
                                                &nbsp;   
                                                </td>
                                            </tr>
                                        </table>
