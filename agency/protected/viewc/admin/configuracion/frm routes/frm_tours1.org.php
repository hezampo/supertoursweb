                                    ...
                                    <table width="100%">
                                        ...
                                        <td colspan="2">
                                            <table width="100%"><tr>
                                                    ...
                                                    <td>
                                                        <fieldset style="width: 270px;float: left;"><legend>STARTING DATE / ENDING DATE</legend>
                                                        ...
                                                        <fieldset style="float: left;"><legend>FREE NIGHTS</legend>
                                                            <table width="100%">
                                                                <tr>
                                                                    <td width="10%">
                                                                        <div class="label"><strong>Nigths&nbsp;</strong></div>                                                                    </td>
                                                                    <td width="5%">
                                                                        <span><input class="field" style="width:40px;"  type="number"  min="0" value="0" id="nochesfree"/></span></td>
                                                                    <td width="">&nbsp;</td>
                                                                    <td width="30%">
                                                                        <div class="label"><strong><label style="cursor:pointer;" for="free_buffet">Free Buffet&nbsp;</label></strong></div>                                                                    </td>
                                                                    <td width="5%">
                                                                        <span><input type="checkbox"  id="free_buffet" name="free_buffet"/></span></td>
                                                                </tr></table>
                                                        </fieldset>                                                    </td>
...
<!--                                <tr id="tipo_passager" style="height:20px;width:160px; display:block;">
                ...
                <td>
                    <table >
                        <tr>
                            <td valign="" >
                                <div id="t-total2">
                                    <div class="label" style="font-size: 14px;"><strong>TOTAL AMOUNT </strong>  </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td><label style="font-weight:bold;text-align:left;">Extra Charges</label></td>
                            <td colspan="0">
                                <input name="extra" type="text" id="extra" size="12" style=" padding-left:5px; width:160px; height:16px; font-size: 16px;
	font-weight: 600;" min="0" onkeyup="valorExtra();"  value="<?php echo $tours->extra_charge?>" autocomplete="off" />
                        ...
                        <tr>
                            <td valign="" >
                                <label style="font-weight:bold;text-align:left;">Amount to Collect</label>
                            </td>
                            <td>
                                <div id="t-total2" style="width:170px;">
                                    <input autocomplete="off" type="text"  name="otheramount" id="otheramount" value=""
                                           style="padding-left:5px; font-size: 16px; font-weight: 600; width:160px; height:16px;" />
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr id="pay_amount_html">
                            <td valign="" >
                                <label style="text-align:left;">Add Payment</label>
                            </td>
                            <td>
                                <div id="t-total2" style="width:170px;">
