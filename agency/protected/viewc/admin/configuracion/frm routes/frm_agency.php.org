...
<? $agency  = $data['agency'];?> 
    ...
    <form id="form1" class="form" action="<?php echo $data['rootUrl']; ?>admin/agency/save" method="post" name="form1">
       <div id="header_page" >
<div class="header2">Agency [ <? echo $data['dato'];?> ]</div>
        <div  id="toolbar">
...
<div id="content_page" >
        <div id="serpare">    
            ...
            <fieldset  id="acompany"><legend><strong>COMPANY</strong></legend><div class="input">
                ...
                <input type="text" name="company_name" id="company_name"  size="25"   value="<? echo $agency['company_name']; ?>"/>
      </div>
            <div class="input">
                <label style="width:150px" class="required" id="addresss">Address: </label>
                <input type="text" name="address" id="address"  size="25"   value="<? echo $agency['address']; ?>"/>
            </div>
            <div class="input">
                <label style="width:150px" class="required" id="cityy">City: </label>
                <input type="text" name="city" id="city"  size="25"   value="<? echo $agency['city']; ?>"/>
            </div>
            <div class="input" style="padding-top:5px;">
                ...
                <select name="state" id="state" class="select" style="width:200px; height:23px;">
                  ...
                  <?php foreach($data["state"] as $e):?>
                       ...
                       <option value="<?php echo  $e['name']; ?>"  <?php echo ($agency['state'] == trim($e['name'])?'selected':''); ?>><?php echo $e["name"]; ?></option>
                   <?php endforeach;?>
                </select>
            </div>
            ...
            <div class="input">
                ...
                <input name="zipcode" type="text"  id="zipcode" size="5"   value="<? echo $agency['zipcode']; ?>" />
            </div>
...
<div class="input" style="padding-top:5px;">
           ...
           <div class="input">
                ...
                <input name="position" type="text"  id="position" size="20"   value="<? echo $agency['position']; ?>" />
            </div>             
            <div class="input">
                <label style="width:150px" class="required" id="phone11">Phone 1</label>
                <input name="phone1" type="text"  id="phone1" size="15"  value="<? echo $agency['phone1']; ?>" />
            </div> 
           <div class="input">
                <label style="width:150px" class="required" id="phone22">Phone 2</label>
                <input name="phone2" type="text"  id="phone2" size="15"  value="<? echo $agency['phone2']; ?>" />
            </div> 
            
                <div class="input">
                <label style="width:150px" class="required" id="faxx">Fax: </label>
                <input name="fax" type="text"  id="fax" size="25"  value="<? echo $agency['fax']; ?>" />
            </div> 
           <div class="input">
                <label style="width:150px" class="required" id="main_emaill">E-Mail: </label>
                <input name="main_email" type="text"  id="main_email" size="25"   value="<? echo $agency['main_email']; ?>"/>
            </div> 
            <div class="input">
                <label style="width:150px" class="required" id="web_pagee">Web Page: </label>
                <input name="web_page" type="text"  id="web_page" size="25"  value="<? echo $agency['web_page']; ?>" />
            </div> 
             <div class="input">
                <label style="width:150px" class="required" id="iata_cliaa">IATA/CLIA#: </label>
                <input name="iata_clia" type="text"  id="iata_clia" size="25"  value="<? echo $agency['iata_clia']; ?>" />
            </div> 
<div class="input">
                <label style="width:150px" class="required" id="managerr">Manager: </label>
                <input name="manager" type="text"  id="manager" size="30"  value="<? echo $agency['manager']; ?>" />
      </div> 
             <div class="input">
                <label style="width:150px" class="required" id="iata_cliaa">Birthdate: </label>
                <input name="birthdate" type="text"  id="birthdate" size="10" maxlength="10" value="<? echo $agency['birthdate']; ?>"/>
            </div> </fieldset>
            <fieldset><legend><strong>ACCOUNTING</strong></legend>
             <div class="input">
                <label style="width:150px" class="required" id="acountt">Account: </label>
                <input name="acount" type="text"  id="acount" size="25"   value="<? echo $agency['acount']; ?>" />
            </div>
   
              <div class="input">
                <label style="width:150px" class="required" id="costumer_sincee">Costumer Since: </label>
                <input name="customer_since" type="text"  id="customer_since" size="25"   value="<? echo $agency['customer_since']; ?>" />
            </div>
            ...
            <fieldset><legend><strong>CUSTOMER ACCOUNTING DEPARTMENT</strong></legend>
             <div class="input">
                ...
                <input name="person_charge" type="text"  id="person_charge" size="25"   value="<? echo $agency['person_charge']; ?>" />
            </div>
              <div class="input">
                <label style="width:150px" class="required" id="eemaill">E-mail: </label>
                <input name="eemail" type="text"  id="eemail" size="25"  value="<? echo $agency['eemail']; ?>" />
            </div>
              <div class="input">
                <label style="width:150px" class="required" id="phonee">Phone: </label>
                <input name="phone" type="text"  id="phone" size="15"  value="<? echo $agency['phone']; ?>"/>
            </div>
           <!--  <div class="input">
  ...
  <tr>
    <td width="23"><input type="checkbox" name="opcion1" id="opcion1" value="1" <?  echo ($agency['opcion1'] == 1?'checked':''); ?> /></td>
 ...
 -->
  ...
  <tr>
    <td width="23"><input type="checkbox" name="opcion3" id="opcion3" value="1" <?  echo ($agency['opcion3'] == 1?'checked':''); ?>/></td>
    <td width="164">Credit Car+ 4 % FEE</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="opcion4" id="opcion4" value="1" <?  echo ($agency['opcion4'] == 1?'checked':''); ?>/></td>
    <td>Cash</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
           ...
           <fieldset style="background-color:#F8F8F8;"><legend> <font color="#999999">VOUCHER<input  <?  echo ((($agency['opcion5'] == 1)||($agency['opcion5'] == 2))?"checked=\"checked\"":''); ?> type="checkbox" name="active_vaucher" id="active_vaucher" value="1" /></font></legend>
            <table width="200" border="0" cellspacing="1">
  <tr>
    <td colspan="2"></td>
    </tr>
  <tr>
    <td width="23"><input type="radio" name="opcion5" id="opcion5" value="1" <?  echo ((($agency['opcion5'] != 1)&&($agency['opcion5'] != 2))?"disabled=\"disabled\"":''); ?> <?  echo ($agency['opcion5'] == 1?'checked':''); ?>/></td>
    <td width="164">Open Credit Voucher</td>
  </tr>
  <tr>
    <td><input type="radio" name="opcion5" id="opcion6" value="2" <?  echo ((($agency['opcion5'] != 1)&&($agency['opcion5'] != 2))?"disabled=\"disabled\"":''); ?>  <?  echo ($agency['opcion5'] == 2?'checked':''); ?>/></td>
    ...
    <td>&nbsp;</td>
       ...
       <fieldset id="acompany" style="margin-bottom:20px;" ><legend><strong>ACCOUNTING</strong></legend>
             <div class="input">
                ...
                <input type="radio" name="type_rate" id="net_rate" value="1" <?  echo ($agency['type_rate'] == 1?'checked':''); ?> />
            </div>
               <div class="input">
                <label style="width:150px" class="required" id="costumer_sincee">Commissionable Rates: </label>
                <input type="radio" name="type_rate" id="commission_rate" value="0" <?  echo ($agency['type_rate'] == 0?'checked':''); ?> />
            </div>
         </fieldset>     
