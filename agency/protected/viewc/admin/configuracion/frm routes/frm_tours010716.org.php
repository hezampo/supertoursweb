    ...
    <form id="form1" class="form" action="" method="post" name="form1">
        <div id="info-group" style="width: 900px;">
            ...
            <div id="reservation" style="border-color: #fff;width: 300px;">
                <div class="ho" style="color: #eee; background: #eee;"> <p style="display: none;"> RESERVATION </p>.<span></span></div>
                                            ...
                                            <tr>
                                                ...
                                                <td width="40%">
                                                    <div class="ausu-suggest" >
                                                        <input name="agency" tabindex="1" type="text"  id="agency" size="19" maxlength="30" value=""  autocomplete="off"   />
                                                ...
                                                <td width="40%">
                                                    <div class="ausu-suggest" >
                                                        <input style="width:120px;" name="uagency" tabindex="2" type="text"  id="uagency" autocomplete="off" size="11" maxlength="30" value="" disabled="disabled"  />
...
<!--                             <input name="tour_name" readonly="true" style="width:220px; color: #0F0CCB; margin-left: -23%; margin-top: 2%;" type="text" id="tour_name" value="<?php echo $agency['tour_name']; ?>"  />-->
                ...
                <td>
                    ...
                    <fieldset style="width:300px;"id="liderpax">
                                ...
                                <td >
                                    <div id="opera" class="input" style="padding-top:5px;">
                                        <table>
                                            <tr>
                                                <td>
                                                    <label style="margin-left:2px;" id="label" >SEARCH </label>
                                                </td>
                                                <td>
                                                    <div class="ausu-suggest" id="opera">
                                                        <input type="text" style="margin-left:24px; width:408px;" size="65" tabindex="3" value="" name="leader" id="cliente" autocomplete="off" />
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td width="" align="right">
                                                    ...
                                                    <label style="margin-left:-28px;" id="labeldere12">FIRST NAME</label>		
                                                </td>
                                                <td width="">
                                                    <input name="firstname1" style="margin-left:3px;" type="text" tabindex="4"  id="firstname1" size="20" maxlength="20" value="" />
                                                </td>
                                                ...
                                                <td width="">  
                                                    <input name="lastname1" style="margin-left:3px;" type="text" tabindex="5" id="lastname1" size="20" maxlength="20" value="" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">
                                                ...
                                                <td>
                                                    <input name="phone1" type="text"  tabindex="6" id="phone1" size="20" maxlength="20" value="" />
                                                ...
                                                <td>
                                                    <input name="email1" tabindex="7" type="text"  id="email1" size="20" value=""/>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
