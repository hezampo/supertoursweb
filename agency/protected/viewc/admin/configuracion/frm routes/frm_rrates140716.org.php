...
<div id="header_page" style="background:#F0F8FF;" >
    ...
    <td>
        <label style="margin-top:18px;margin-left:2px;"  for="bck_tarifario"><span><strong>Duplicar Tarifario</strong></span></label>
        <input style="margin-top:22px; margin-left:4px;" type="checkbox" id="bck_tarifario" name="bck_tarifario" value="1"/>
...
<!--   <input type = "hidden" name = "check1" value= "0" onclick="valuecheck(this)" /> 
   <input type="checkbox" name="check1"  value="1" onclick="valuecheck(this)"/>
   
   <input type="checkbox" name="check2"  value="1" onclick="valuecheck(this)"/>
   <input type="checkbox" name="check3"  value="1" onclick="valuecheck(this)"/> 

   <input type="checkbox" name="check4" value="1"  onclick="valuecheck(this)"/>
         
   <input type="checkbox" name="bck_tarifario" value="1" onclick="valuecheck(this)"/>-->

<!--<input type="checkbox" id="checkbox1" /> <br />-->
<input type="text" id="dupli" name="dupli" value="<?php echo $ratesroom->dupli=0; ?>"/>
...
<script type="text/javascript">
    ...
    $('#btn-save').click(function () {
        if (validateForm()) {
            ...
            //var dupli = document.getElementById("textbox1").value;
         
          // alert(dupli);
           //var url = '<?php //echo $data['rootUrl']; ?>admin/tours/room-rates/duplitari/' + dupli;
            //$("#userr").load('<?php //echo $data['rootUrl']; ?>admin/tours/room-rates/duplitari/' + dupli);
