...
<!--            <div class="ho" style="color: #fff;background: #bb0000; height:12px;">STATUS</div>
            -->
            <div  id="stat"><?php if($reserva->estado=='CONFIRMED'){ 
...
//                echo $reserva->estado;
                ...
                <?php if($reserva->estado=='QUOTE'){ 

                echo '<input style="background-color:green; color:#fff; text-align:center; font-weight:bold; font-size:24px; width:417px; margin-top: -1px; margin-left: 0px; height: 23px;" type="text" id="reservita" name="reservita" value="' . $reserva->estado . '" />';
//                echo $reserva->estado;
                };?>
                
                <?php if($reserva->estado=='INVOICED'){ 
...
//                echo $reserva->estado;
                ...
                <?php if($reserva->estado=='NO SHOW W/ CHARGE'){ 
...
//                echo $reserva->estado;
                ...
                <?php if($reserva->estado=='NO SHOW W/ O CHARGE'){ 
                    
                echo '<input style="background-color:#FF2121; color:#fff; text-align:center; font-weight:bold; font-size:24px; width:417px; margin-top: -1px; margin-left: 0px; height: 23px;" type="text" id="reservita" name="reservita" value="' . $reserva->estado . '" />';
//                echo $reserva->estado;
                };?>
                
                <?php if($reserva->estado=='CANCELED'){ 
...
//                echo $reserva->estado;
    ...
    <!--    <div id="content_page"  >-->
    <div id="content_page" style="margin-top: -26px; width: 1000px;z-index:1; background-image: url('<?php echo $data['rootUrl'] ?>global/img/bg2.jpg');" >
        <div id="serpare">
...
<!--                                            <input name="nombre" type="text"  id="nombre" value="<?php echo trim($login->nombre . ' (' . $login->usuario . ')'); ?>" readonly="readonly"/>-->
            ...
            <fieldset id="boo" style="width:952px; height: 65px; border-radius: 26%;margin-top: 3px;" class="booking2" ><legend style="border:1px solid #00C; background:#fff;">BOOKING</legend>
                ...
                <div id="opera" class="input" style="padding-top:5px;"> <label style="color:#00f;"><strong>ONE WAY</strong> </label> <input name="tipo_ticket"  id="oneway" onclick="capturar(); coordenadas_modal();reset_roundtrip();" type="radio" value="1"
                       <?php
                       if (isset($reserva)) {
                           if ($reserva->tipo_ticket == 'oneway') {
                               echo ' checked ';
                    ...
                    ?>/></div>
                <div id="opera" class="input" style="padding-top:5px;"> <label style="color:#AC1B29;"><strong>ROUND TRIP</strong></label><input name="tipo_ticket" id="roundtrip" type="radio" value="2" onclick="capturar(); coordenadas_modal();" <?php
                                                                                                                                            if (isset($reserva)) {
                                                                                                                                                if ($reserva->tipo_ticket != 'oneway') {
                                                                                                                                                    echo ' checked ';
                                                                                                                                                }
...
<!--            <table width="200"  cellspacing="0" class="sup" >
            ...
            <fieldset id="onew" style="border-radius: 7%; margin-top:0px;  height:211px;" class="cerati"><legend style="margin-top:4px; border:1px solid #00C; background:#fff;">ONE WAY</legend>
...
<!--            <table width="246" cellspacing="0" class="sup2" style="margin-top: 2px;">-->
            <table class="sky" border="1" width="256" height="205" cellspacing="0" class="sup2" style="margin-top: 12px;">
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:center; color:#fff;"><span id="subtoadult" style="font-size: 15px; font-weight:bold; "></span></td>
                    <td style="text-align:center; color:#fff;"><span id="subtochild" style="font-size: 15px; font-weight:bold; "></span></td>
                </tr>
                <tr>
                    <td><label style="color:#ffffff;" ><strong>Total</strong></label></td>
                    <td style="text-align:center;" colspan="2"><label style="color:#fff;"><strong   id="totaltotal" style="font-size: 15px; font-weight:bold; " >$ 00.0</strong></label></td>
            ...
            <fieldset id="pymen" style="margin-top:8px; height:423px; border-radius: 5%;" class="super" ><legend style="border:1px solid #00C; background:#fff" >PAYMENT INFORMATIONS</legend>
...
<!--                </table>-->
                ...
                <table class="oliveti" style="width: 39%; border: 2px solid #000; margin-left: 10px; margin-top: -331px; height: 117px;">
...
<!--                                <tr style="display:none;">
                                ...
                                <tr  style=" height:33px; width:180px; ">
                                    ...
                                    <td style="width: 700px; margin-top:-49px; ">
                                        <label  style="padding-left:100px; font-size:16px;"><strong   id="txtamountpendiente" style="padding-bottom:0px; color:#000;">Amount to Collect&nbsp;$</strong></label>
                                    </td>
                                    <td>
                                        

                                            
                                        <input type="text"  autocomplete="off" class="verd"  style="font-family: sans-serif; font-size: 22px; color:#000; font-weight: bold; margin-left:3px; text-align:center; width: 106px; margin-top: 0px;" onKeyUp="dupliac();" id="saldoporpagar"  value="<?php echo $reserva->totaltotal; ?>"  />             
...
<!--                                <td>&nbsp;</td>-->
                                ...
                                <tr style="height:33px; width: 700px; " >
                                    <td>
                                        <label  style="display:none; padding-left:87px; font-size:16px; margin-left:68px; margin-top:-53px; "><strong style="padding-bottom:10px; color:#090">Paid Driver&nbsp;$</strong></label>    
                                        <label  style=" padding-left:86px; font-size:16px; margin-left: 68px; margin-top: -53px; "><strong style="padding-bottom:10px; color:#000;">Paid Driver&nbsp;$</strong></label>
                                    </td>
                                    <td>
...
<!--                                        <label id="saldoPagado" class="brown2" <strong style="font-family: sans-serif; font-size: 22px; color:#000; font-weight: bold; padding-left:4px;" ><?php echo number_format($pagado, 2, '.', ','); ?></strong></label>-->
                                        <input type="text" id="saldoPagado" class="brown2" style="display:none; font-family: sans-serif; font-size: 22px; color:#000; font-weight: bold; padding-left:23px; margin-left: -22px; width: 83px;" value="<?php echo number_format($pagado, 2, '.', ','); ?>" onKeyUp="CalcularTotalTotal();" onclick="CalcularTotalTotal();"  />
                                         ...
                                         <input autocomplete="off" readonly="readonly" type="text" id="paid_driver" name="paid_driver" class="brown3"   style="text-align: center; height: 24px; font-size: 22px;font-weight: bold;color: #000; border: #33F solid thin; margin-top: -3px; margin-left: 3px; width: 104px;float:left;width:106px; font-weight:bold; color:#000;" value="<?php echo number_format($reserva->paid_driver, 2, '.', ','); ?>" onKeyUp="CalcularTotalTotal();" onclick="CalcularTotalTotal();" />
                                    </td>
                                </tr>

                                <tr style="height:33px; width: 700px; " >
                                    <td>
                                        <label  style=" font-size:16px; margin-left: 57px; margin-top: -30px; "><strong id="Passenger_Balance_Due" style="padding-bottom:10px; color:#000;">Passenger Balance Due&nbsp;$</strong></label>

                                    </td>

                                    <td>
                                        <input  readonly="readonly" style="border: 1px #33F solid; margin-top: -1px; margin-left: 3px; text-align: center; height: 25px; font-size: 22px; width:106px;" autocomplete="off" type="text" class="ama2"  class="txtNumbers"  name="balance_due" id="balance_due" value="<?php echo number_format($reserva->passenger_balance_due, 2, '.', ','); ?>"    />
                                    </td>
                                </tr>
...
<!--                                <tr id="pay_amount_html" style="height: 50px;">
   ...
   <td>
       ...
       <input autocomplete="off" type="text" class="txtNumbers"  name="balance_due" id="balance_due" value=""  style="display:none; height: 24px; text-align: center;font-size: 22px;font-weight: bold;color: #fff;border: 1px #33F solid; background-color: #72CBEC; padding-left:5px; width:100px; height:24px; float:left; margin-top:4px;" />
                                ...
                                -->
                                <select name="opcion_pago" id="op_pago_id" style="margin-left:389px; margin-top:-228px;">
                                                                <optgroup label="COLLECT ON BOARD">
                                                                    <option value="8">Credit Card no fee</option>
                                                                    <option value="3">Credit Card with fee</option>
                                                                    <option value="4">Cash</option>
...
<!--                                        <input autocomplete="off" type="text"  class="black"  name="otheramount"  id="otheramount"  style="margin-top: -151px; margin-left: -107px; text-align: center; height: 25px; font-size: 22px;font-weight: bold;color: #fff;border: #AC1B29 solid thin; background-color: #1B1478; width: 103px;float:left;width:106px; font-weight:bold; color:fff;"   value="" onkeyup="ClkPay_Amount();" />-->
                                ...
                                <tr style="height:33px; width: 700px;">
                                    ...
                                    <td>
                                        <font  class="orangered" style="float: left; height:24px; text-align: center;border: #AC1B29 solid thin; background-color: #1B1478; width: 103px; margin-top:-8px; font-size:22px; padding-left:3px; height:25px; font-weight:bold; color:#fff;  margin-left: 10px;" id="totalPagar" ></font>
                                        <input name="totP" type="hidden"  id="totP" value="" /> 
...
<!--                                        <input name="totP" type="hidden"  id="totP" value="" />
                                ...
                                <tr id="pay_amount_html" style="height: 33px; width: 700px;">
                                    <td>
                                        <b style=" color:#000;font-size: 18px; margin-left:85px;">Pre Paid Amount&nbsp;$</b>                                       
                                    </td>
                                    <td>
...
<!--                                        <label id="saldoPagado" <strong style="font-family: sans-serif; font-size: 22px; color:#000; font-weight: bold; padding-left:38px;" ><?php echo number_format($pagado, 2, '.', ','); ?></strong></label>-->
                                             <input autocomplete="off" type="text" readonly="readonly" class="azu" class="txtNumbers"  name="pay_amount" id="pay_amount" value="<?php echo number_format($reserva->pred_paid_amount, 2, '.', ','); ?>"  onKeyUp="CalcularTotalTotal();" onclick="CalcularTotalTotal();" style="padding-left:5px; text-align: center;font-size: 22px;font-weight: bold; color: #000; border: 1px #33F solid; padding-left:5px; width:101px; height:25px;float:left; margin-top:-10px; margin-left: 10px;" />
                                    </td>
                                </tr>
                                ...
                                <tr style="height:33px; width: 700px;">
                                    <td>
                                        <b style="padding-left:123px;"><strong style="margin-left:-50px; color:#000;font-size: 18px; font-weight:bold;">Total Amount Paid&nbsp;$</strong></b>                                         
                                    </td>
                                    <td>
                                        <input readonly="readonly" autocomplete="off" type="text" class="verdefos3"  class="txtNumbers"  name="tot_amount_paid" id="tot_amount_paid" value="<?php echo number_format($reserva->total_paid, 2, '.', ','); ?>"  style="border: 1px #33F solid; margin-left: 10px; margin-top:-10px; text-align: center; height: 25px; font-size: 22px; width:106px;" />
                                    </td>
                                ...
                                <tr style="height:33px; width: 700px;">
                                    ...
                                    <td>
                                        <input readonly="readonly" autocomplete="off" type="text" class="roge"  class="txtNumbers"  name="agency_balance_due" id="agency_balance_due" value=""  style="border: 1px #33F solid; margin-left: 10px; margin-top:-8px; text-align: center; height: 25px; font-size: 22px; width:106px;" />
                                    </td>
...
<!--                                                        <tr id="pay_amount_html" style="height: 50px;">
            ...
            <select id="opcion_pago_2" name="opcion_pago_2" style="margin-left:404px; margin-top: -168px;">
                                                <optgroup label="PRED-PAID">
                                                    <option value="2">Credit Card no fee</option>
                                                    <option value="1">Credit Card with fee</option>
                                                    <option value="6">Cash</option>
            ...
            <input type="button" style="display:none" id="enviar_escondido" value="0"  />
            <a  id="pago_agente" style="display:block" ><img style="width: 77px;   height: 28px; margin-left:404px;  margin-top: -139px;cursor:pointer" src="<?php echo $data['rootUrl']; ?>global/img/admin/charge.png" /></a>
...
<div id="dialog2" title="History of Payments" style="display:none; width:550px;">
...
<!--    <label  style="padding-left:57px; font-size:16px; "><strong style="padding-bottom:10px; color: #000; margin-left:-55px;">$</strong></label> -->
    ...
    <!--class="money"-->
    <input autocomplete="off" name="pago_driver"   type="text" id="pago_driver" size="12" style="font-size: 22px;  text-align:right; margin-top:-3px; margin-left:37px; width:114px; height:20px;" value="0.00" onkeypress="validate(event);"  onkeyup="dupliPago();"/>
...
<script type="text/javascript">
    ...
    <div class="paymentvertblack" style="padding: 10px;  text-align: center; margin-top: 9px;">
        ...
        <input id="btnCancelar" onclick="reset(); reset2();" style="background-color: #006394; border-color: red; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; border-top-left-radius: 5px; border-top-right-radius: 5px; cursor:pointer; color:#fff; font-weight: 700;" name="btnCancelar" size="20" type="button" value="Reset"  />
        <input type="button" id="btnAceptar" name="btnAceptar" size="20" value="Save"  style="border-color: red; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; border-top-left-radius: 5px; border-top-right-radius: 5px; font-weight: 700;" onclick="ocultarVentana2();banner();" disabled="true" />
...
<script type="text/javascript">
    ...
    function mostrarVentana2() {   
        ...
        if (z == 1) {     
           ...
           var ventana2 = document.getElementById('miVentana2'); // Accedemos al contenedor  
           ventana2.style.marginTop = "397px"; // Definimos su posición vertical.        
        ...
        if (z == 2) {               
            ...
            var ventana2 = document.getElementById('miVentana2'); // Accedemos al contenedor              
            ventana2.style.marginTop = "637px"; // Definimos su posición vertical.        
            ventana2.style.marginLeft = "768.4px"; // Definimos su posición horizontal
            ventana2.style.display = 'block'; // Y lo hacemos visible
            ventana2.style.position = 'absolute';
            ventana2.style.height = '170px';
...
////            $("#totaltotal").text((saldo_porpagar + fees).toFixed(2));
//
//
//            $("#saldoporpagar").val((apagar + fees).toFixed(2));
//
...
//                //alert('20');
//
//                $("#agency_balance_due").val(((apagar) - (pay_amount) - (paid_driver)).toFixed(2));
//
//            }
//
...
//                }, 100);
                ...
                if(paid_driver > 0){
                    ...
                    $("#saldoporpagar").val((salpag).toFixed(2));
