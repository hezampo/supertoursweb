...
<form name="form1" method="post" action="<?php echo $data['rootUrl']; ?>admin/facturacion/proceso" class="form" id="form1">
    ...
    <div id="maincontent" style="background-color: #f6f6f6; width:100%; height:300px; padding:10px;">
        <fieldset id="invoicing-period">
            <legend>Invoicing Period</legend>
            <label for="starting-date" > Starting Date : </label><input class="datepick" name="starting-date" id="starting-date" type="datetime" value="">
            <label for="ending-date" > Ending Date : </label><input class="datepick" name="ending-date" id="ending-date" type="datetime" value="">
