...
$route['*']['/admin/tours/valorTransfer/:tipo1/:tipo2/:child/:adult/:type_rate/:fecha/:sentido'] = array('admin/ToursController', 'valorTransfer');
...
$route['*']['/admin/tours/selecthotel/:id/:fecha_salida/:fecha_retorno/:room1/:room2/:room3/:room4/:room1_c/:room2_c/:room3_c/:room4_c/:id_agency/:nochesfree/:free_night_buffet/:rates'] = array('admin/ToursController', 'selectHotel');
