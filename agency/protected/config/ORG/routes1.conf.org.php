...
$route['*']['/admin/trips/passengers/bus/list/:bus/:trip/:fecha/:order/:agency/:conductor'] = array('admin/TripsController', 'pdf');
...
$route['*']['/admin/tours/selectTrip1/:from/:to/:fecha/:totalpax/:tipo_pass/:agency/:rates'] = array('admin/ToursController', 'selectTrip1');
$route['*']['/admin/tours/selectTrip2/:from/:to/:fecha/:totalpax/:tipo_pass/:agency/:rates'] = array('admin/ToursController', 'selectTrip2');
...
$route['*']['/tours/onedaytour/:sentido/:idArea/:fechaS/:totalpax'] = array('ToursControllerWeb', 'selectTrip');
...
$route['*']['/admin/oneday/getcosttransf/:type_rate/:fecha/:id_agencia'] = array('admin/OnedaytourController','getCosto'); //obtiene el costo x niño y adulto del transfer de onedaytour
