...
$route['*']['/admin/trips/passengers/bus/list/:bus/:trip/:fecha/:order/:agency'] = array('admin/TripsController', 'pdf');
...
$route['*']['/admin/tours/selecthotel/:id/:fecha_salida/:fecha_retorno/:room1/:room2/:room3/:room4/:room1_c/:room2_c/:room3_c/:room4_c/:id_agency/:nochesfree/:free_night_buffet'] = array('admin/ToursController', 'selectHotel');
