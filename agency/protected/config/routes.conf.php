...
//$route['*']['/admin/ok'] = array('admin/AdminController', 'index');
$route['*']['/login'] = array('admin/AdminController', 'index');
$route['*']['/admin/login'] = array('admin/AdminController', 'login');
$route['*']['/admin/login_agency'] = array('admin/AdminController', 'loginpage');
$route['*']['/admin/logout'] = array('admin/AdminController', 'logout');
$route['*']['/admin/home'] = array('admin/AdminController', 'home');
$route['*']['/admin/tablas/:temporal'] = array('admin/AdminController', 'tablas');
$route['*']['/admin/contacto'] = array('admin/AdminController', 'contacto');
$route['*']['/admin/setting_agency'] = array('admin/AdminController', 'setting_agency');
$route['*']['/admin/faq'] = array('admin/AdminController', 'faq');
$route['*']['/blog/all'] = array('BlogController', 'showAll');
$route['*']['/admin/agency/rechangepass'] = array('admin/AdminController', 'rechangepass');
...
$route['*']['/admin/datos/:departureTime/:arrivalTime/:trip_from/:trip_to/:trip_no/:fecha_ini/:fecha_fin'] = array('admin/RoutesController', 'actualizarDato');

// rutas para RoutesController

//ruta para obtener informacion
//$route['*']['/admin/routes_net/:special_price_name'] = array('admin/RoutesController', 'specialTransport');
//ruta para el metodo de ajax
$route['*']['/admin/routes/busquedaPuesto'] = array('admin/RoutesController', 'puesto');
...
$route['*']['/admin/routes/edit'] = array('admin/RoutesController', 'edit');
...
$route['*']['/admin/trips/passengers/:trip/:fecha_ini/:orden'] = array('admin/TripsController', 'passengers');
...
#ruta para el reporte del listado
$route['*']['/admin/trips/passengers/resumen'] = array('admin/TripsController', 'reporte');
...
$route['*']['/admin/trips/passengers/bus/list/:bus/:trip/:fecha/:order/:agency/:conductor/:capacidad/:tipo/:vehiculo'] = array('admin/TripsController', 'pdf');

$route['*']['/admin/trips/passengers/bus/list/pdf'] = array('admin/TripsController', 'pdf');

$route['*']['admin/trips/passengers/:trip_no/:fecha_salida/:orden'] = array('admin/TripsController', 'passengers');
...
$route['*']['/leader/ajax2/:id/:id2/:fecha_inicio/:fecha_actual'] = array('admin/ReservasController', 'ajaxcliente2');

//actualizacion
$route['*']['/driver/ajax'] = array('admin/TripsController', 'pdf');

//$route['*']['/consul/trips/:tripNo'] = array('admin/ReservasController', 'trips');
//
$route['*']['/consul/trips/:from/:to/:fecha/:resid/:fromto/:tipo/:agency/:special_price_name/:total/:est/:tipo_reserva/:total_pasajeros/:trip_1/:trip_2'] = array('admin/ReservasController', 'trips');
//$route['*']['/consul/disponible/:temporal'] = array('admin/ReservasController', 'disponible');
//$route['*']['/consul/extenprice/:from/:to/:fecha/:resid/:fromto/:tipo/:agency'] = array('admin/ReservasController', 'trips');
...
////////////////////////////////////////$route['*']['/consul/exten/:id/:from/:to/:trip_no/:fechasal'] = array('MainController', 'exten');
$route['*']['/consul/exten/:id/:id_agencia'] = array('MainController', 'exten');
//$route['*']['/consul/superclub/:id'] = array('admin/ReservasController', 'superclub');
//$route['*']['/admin/reservas/super/:fecha_inicio/:fecha_actual/:firsname/:lastname'] = array('admin/ReservasController', 'super_club');
$route['*']['/consul/superclub/:id_leader/:fecha_inicio/:fecha_actual'] = array('admin/ReservasController', 'superclub');
//$route['*']['/consul/extenp/:id/:id2/:transAdult/:transChild/:type_rate/:id_agencia'] = array('admin/ReservasController', 'extenprice');
///////$route['*']['/consul/extenp/:id/:id2/:transAdult/:transChild/:type_rate/:id_agencia/:from/:to/:trip_no/:fechasal/:tp'] = array('admin/ReservasController', 'extenprice');
$route['*']['/consul/extenp/:id/:id2/:transAdult/:transChild/:type_rate/:id_agencia/:from/:to/:trip_no/:fechasal/:tp/:from2/:to2/:trip_no2/:fecharetor'] = array('admin/ReservasController', 'extenprice');
...
//$route['*']['/admin/tours/idtour/:id_tours'] = array('admin/ToursController', 'totalValorPark');
...
$route['*']['/admin/tours/selectTrip1/:from/:to/:fecha/:totalpax/:total_pasajeros/:tipo_reserva/:trip1/:trip2/:tipo_pass/:agency/:rates'] = array('admin/ToursController', 'selectTrip1');
$route['*']['/admin/tours/selectTrip2/:from/:to/:fecha/:totalpax/:total_pasajeros/:tipo_reserva/:trip1/:trip2/:tipo_pass/:agency/:rates'] = array('admin/ToursController', 'selectTrip2');
$route['*']['/admin/tours/comisionTransport/:trip/:tipo'] = array('admin/ToursController', 'comisionTransport');
$route['*']['/admin/tours/valorTransfer/:tipo1/:tipo2/:child/:adult/:type_rate/:fecha/:sentido/:rates'] = array('admin/ToursController', 'valorTransfer');
...
$route['*']['/admin/tours/selecthotel/:id/:fecha_salida/:fecha_retorno/:room1/:room2/:room3/:room4/:room1_c/:room2_c/:room3_c/:room4_c/:id_agency/:nochesfree/:free_night_buffet/:rates/:frday'] = array('admin/ToursController', 'selectHotel');
//$route['*']['/admin/tours/rastro_tours/:id/:fecha_salida/:fecha_retorno/:room1/:room2/:room3/:room4/:room1_c/:room2_c/:room3_c/:room4_c/:id_agency/:nochesfree/:free_night_buffet/:rates/:frday'] = array('admin/ToursController', 'rastro_tours');
$route['*']['/admin/tours/redishotels/:id_tour/:id/:fecha_salida/:fecha_retorno/:room1/:room2/:room3/:room4/:id_agency/:buffet/:nochesfree/:free_night_buffet/:nhotels/:nightsr/:noches_escogidas'] = array('admin/ToursController', 'redisHotel');
...
$route['*']['/admin/tours/selectpark/:id_park/:id_group/:adult/:child/:fecha_salida/:fecha_retorno/:platinum/:id_agency/:idf'] = array('admin/ToursController', 'selectPark');
//$route['*']['/admin/tours/selectpark/:id_park/:id_group/:adult/:child/:fecha_salida/:fecha_retorno/:platinum/:id_agency/:idf/:dias/:noches'] = array('admin/ToursController', 'selectPark');
//$route['*']['/admin/tours/totalvalorpark/:dias/:noches'] = array('admin/ToursController', 'totalValorPark');
//$route['*']['/admin/tours/selectpark/:id_park/:id_group/:adult/:child/:fecha_salida/:fecha_retorno/:platinum/:id_agency/:idf/:fecha_parque'] = array('admin/ToursController', 'selectPark');

$route['*']['/admin/tours/delete_hotel/:id_hotel'] = array('admin/ToursController', 'delete_hotel');
$route['*']['/admin/tours/activar/superbreakfast/:id_hotel/:estado'] = array('admin/ToursController', 'activar_super_breakfast');
$route['*']['/admin/tours/limpiar'] = array('admin/ToursController', 'limpiar');

$route['*']['/admin/tours/gastionpark/:id_park/:opcion/:adult/:child/:id_agency'] = array('admin/ToursController', 'gestionAdminision');
$route['*']['/admin/tours/change/pax/attractions/:adults/:childs/:id_agency'] = array('admin/ToursController', 'change_pax_attractions');
...
//$route['*']['/admin/tours/delete_park/:id_park/:adult/:child/:id_tour'] = array('admin/ToursController', 'borrar_park');

$route['*']['/admin/tours/listTablaPark/:adult/:child/:id_agency'] = array('admin/ToursController', 'listTablaPark');


$route['*']['/admin/tours/:filtro/:texto/page/:pindex'] = array('admin/ToursController', 'index');

//la ruta que cargara el Id de la agencia automaticamente
$route['*']['/admin/tours/cargarId/:id_agency'] = array('admin/ToursController', 'cargarId');
...
//ruta para el resumen
$route['*']['/admin/tours/edit/resumen'] = array('admin/ToursController', 'resumen');
$route['*']['/admin/tours/edit/resumen2'] = array('admin/ToursController', 'resumen2');
$route['*']['/admin/tours/edit/resumen3'] = array('admin/ToursController', 'resumen3');

//$route['*']['/admin/tours/actualiza_cajas/:amount_to_collect/:pass_bal_due/:total_net_fare/:agency_bal_due'] = array('admin/ToursController', 'actualizaCajas');

//Eliminar pagos collect on board
$route['*']['/admin/multidaytours/elimina_pagos_cob/:id_multiday/:id_radio/:saldoactual_copy/:paid_driver_copy/:balance_due_copy/:totalAmount_copy/:pay_amount_copy/:tot_amount_paid_copy/:agency_balance_due_copy/:temp_copy/:valor_pagado/:metodo_pago/:tipo_pago/:fecha_actual/:usuario/:otheramount_copy'] = array('admin/ToursController','eliminar_pagos_cob');
...
$route['*']['/admin/tours/tarifa-vip/:filtro/:texto/:type_rate/:id_agency/page/:pindex'] = array('admin/OnedaytourController', 'index');
...
$route['*']['/admin/tours/room-rates/add_comi'] = array('admin/RatesroomController', 'add_comi');
...
$route['*']['/admin/tours/room-rates/edit_comi/:pindex'] = array('admin/RatesroomController', 'edit_comi');
$route['*']['/admin/tours/room-rates/delete'] = array('admin/RatesroomController', 'delete');

//crud de tours: Rates - Room Costos
$route['*']['/admin/tours/room-rates-cost'] = array('admin/Ratesroom_CostController', 'index');
$route['*']['/admin/tours/room-rates-cost/:type_rate'] = array('admin/Ratesroom_CostController', 'index');
$route['*']['/admin/tours/room-rates-cost/:filtro/:texto/:type_rate/page/:pindex'] = array('admin/Ratesroom_CostController', 'index');
$route['*']['/admin/tours/room-rates-cost/:filtro/:texto/:type_rate/:id_agency/page/:pindex'] = array('admin/Ratesroom_CostController', 'index');

$route['*']['/admin/tours/room-rates-cost/add'] = array('admin/Ratesroom_CostController', 'add');
$route['*']['/admin/tours/room-rates-cost/save'] = array('admin/Ratesroom_CostController', 'save');
$route['*']['/admin/tours/room-rates-cost/edit/:pindex'] = array('admin/Ratesroom_CostController', 'edit');
$route['*']['/admin/tours/room-rates-cost/delete'] = array('admin/Ratesroom_CostController', 'delete');
...
$route['*']['/admin/tours/admision-rate/carga_grupo/:type_rate/:filtro/:texto'] = array('admin/Admin_ratesController', 'cargar_grupos');
//$route['*']['/admin/tours/admision-rate/:type_rate/:filtro/:texto/page'] = array('admin/Admin_ratesController', 'index');
...
$route['*']['/mysuperclub/:error'] = array('MySuperClubController', 'login');
$route['*']['/mysuperclub/login'] = array('MySuperClubController', 'login');
...
$route['*']['/tours/step-two'] = array('ToursControllerWeb', 'step_two');
$route['*']['/tours/step-three'] = array('ToursControllerWeb', 'step_three');
...
$route['*']['/tours/autentication/login'] = array('ToursControllerWeb', 'logueo');
...
$route['*']['/tours/question2/:id/:id2/:id3/:corte'] = array('ToursControllerWeb', 'question');
...
$route['*']['/tours/question14/:id'] = array('ToursControllerWeb', 'area');
...
//rutas para 1 day tour (tour de un dia). ""
$route['*']['/one-day-tour'] = array('ToursControllerWeb', 'onedaytour');
$route['*']['/tours/one-day-tour'] = array('ToursControllerWeb', 'onedaytour');
$route['*']['/tours/onedaytour/:sentido/:idArea/:fechaS/:adult/:child'] = array('ToursControllerWeb', 'selectTrip');
$route['*']['/tours/onedaytour/:sentido/:idArea/:fechaS/:opcionPickup'] = array('ToursControllerWeb', 'selectTrip');
//$route['*']['/tours/onedaytour/pax/:adults/:childs'] = array('ToursControllerWeb', 'selectTrip');
$route['*']['/tours/onedaytour-pickup/:id/:idArea'] = array('ToursControllerWeb', 'selectArea');
$route['*']['/tours/onedaytour-park'] = array('ToursControllerWeb', 'onedaytour_two');
$route['*']['/tours/onedaytour-park/:id/:resp'] = array('ToursControllerWeb', 'ajaxparks_onedaytour');
$route['*']['/tours/onedaytour-park2/:ides/:resp'] = array('ToursControllerWeb', 'ajaxparks_onedaytour');
...
$route['*']['/tours/confirmation_onedaytouy'] = array('ToursControllerWeb', 'onedaytour_confirma');
...
$route['*']['/agency/login'] = array('AgenciaController', 'login');
...
//$route['*']['/admin/reporte/cargar'] = array('admin/ReportePdfController', 'mostrar');
//ruta para resumen de transportacion

//$route['*']['/admin/reporte/cargar'] = array('admin/ReservasController', 'mostrar');
$route['*']['/admin/reporte/cargar/:idf/:variable/:metodo/:numref'] = array('admin/ReservasController', 'mostrar');
//ruta para resumen onedaytour
$route['*']['/admin/resumen/oneday_tour'] = array('admin/OnedaytourController', 'resumen');
//ruta para true or false de frm_rrates
//$route['*']['/admin/bcktari/rates_room'] = array('admin/RatesroomController', 'bcktari');

$route['*']['/admin/reservas'] = array('admin/ReservasController', 'index');
//$route['*']['/admin/reservas/temporal/:temporal'] = array('admin/ReservasController', 'tablas');
...
$route['*']['/admin/reservas/:infonav/add'] = array('admin/ReservasController', 'add');
$route['*']['/admin/reservas/add/trip/:id/:tipo/:id_agency'] = array('admin/ReservasController', 'SelectTrip');
//$route['*']['/admin/reservas/add/trip/:tripNo'] = array('admin/ReservasController', 'trips');
...
$route['*']['/admin/reservas/EnviarContact'] = array('admin/ReservasController', 'EnviarContact');
$route['*']['/admin/reservas/saveprofileag'] = array('admin/ReservasController', 'saveprofileag');
$route['*']['/admin/reservas/changeicon'] = array('admin/ReservasController', 'changeicon');
$route['*']['/admin/setting_agency/delete/:id'] = array('admin/ReservasController', 'deleteuseragency');
$route['*']['/admin/setting_agency/add/:firstname/:lastname/:email/:status/:pass/:admin'] = array('admin/ReservasController', 'adduseragency');
$route['*']['/admin/setting_agency/setinfo/:id/:firstname/:lastname/:email/:status/:admin/:pass'] = array('admin/ReservasController', 'setuseragency');
$route['*']['/admin/setting_agency/search/:contenido'] = array('admin/ReservasController', 'searchuser');

//$route['*']['/admin/reservas/miscript/:variable_post'] = array('admin/ReservasController', 'miscript');
...
$route['*']['/admin/reservas/MostrarReserva'] = array('admin/ReservasController', 'MostrarReserva');

$route['*']['/admin/Restart/:iduser'] = array('admin/AdminController', 'restartsession');

//$route['*']['/admin/reservas/edit/:id_reserva'] = array('admin/ReservasController', 'editReserve');
...
//pagos reserva
$route['*']['/proccess'] = array('MainController', 'proccess');
...
$route['*']['/load_pickup/:from/:trip'] = array('admin/ReservasController', 'getpickup');
$route['*']['/load_dropoff/:to/:trip'] = array('admin/ReservasController', 'getdropoff');
...
/** Pagos Agentes **/
$route['*']['/admin/pago/agente/:cantidad/:ssl_email/:ssl_first_name/:ssl_last_name/:ssl_phone/:reserva'] = array('admin/ReservasController', 'pago_agente');
$route['*']['/admin/transaction/pago/agente/decline'] = array('admin/ReservasController', 'decline');
$route['*']['/admin/transaction/pago/agente/approval'] = array('admin/ReservasController', 'approval');
...
/*$route['*']['/tours'] = array('ErrorController','error_tour');*/
...
$route['*']['/tours/pago'] = array('ToursControllerWeb', 'pago');
...
/*response_approval : respuesta de aprovacion o sactifacion si se registra la reserva pagada de tours */
...
$route['*']['/admin/oneday/getcosttransf/:type_rate/:fecha/:id_agencia/:total_pax'] = array('admin/OnedaytourController','getCosto'); //obtiene el costo x niño y adulto del transfer de onedaytour
...
$route['*']['/admin/onedaytour/save'] = array('admin/OnedaytourController','save_oneday');
$route['*']['/admin/onedaytour/save_edited'] = array('admin/OnedaytourController','save_edited_oneday');
...
$route['*']['/admin/onedaytour/quoted/:filtro/:texto/page/:pindex'] = array('admin/OnedaytourController', 'list_quoted');
...
//Eliminar pagos collect on board
$route['*']['/admin/onedaytour/elimina_pagos_cob/:id_oneday/:id_radio/:saldoactual_copy/:paid_driver_copy/:balance_due_copy/:totalAmount_copy/:pay_amount_copy/:tot_amount_paid_copy/:agency_balance_due_copy/:temp_copy/:valor_pagado/:metodo_pago/:tipo_pago/:fecha_actual/:usuario/:otheramount_copy'] = array('admin/OnedaytourController','eliminar_pagos_cob');
...
/*actualizacion 2018-08-15*/
$route['*']['/admin/traffic/tiketes_pdf/:fecha_inicial'] = array('admin/TrafficController', 'tiketes_pdf');

$route['*']['/admin/traffic/daily_arrival_exten_pdf/:date'] = array('admin/TrafficController', 'daily_arrival_exten_pdf');
...
$route['get']['/admin/pagos/cancelar'] = array('admin/PagosController','cancel_pay');

$route['*']['/admin/pagos/recibirId/:id_reserva/:tipo_reserva'] = array('admin/PagosController','cancel_pay');

$route['get']['/admin/pagos/buscar/:id_reserva/:id_filtro'] = array('admin/PagosController','cancel_pay_search');
$route['*']['/admin/pagos/cancelando/new'] = array('admin/PagosController','cancel_pay_process');
...
$route['*']['/admin/reports/cost_range_report/:fini/:ffin'] = array('admin/ReportsController','daily_sales_report');
...
/*actualizacion 2018-08-16*/
$route['*']['/admin/reports/daily_arrival_report/:fecha_inicio/:fecha_final'] = array('admin/ReportsController','daily_arrival_report');


$route['*']['/admin/reports/total_service_by_client/:id_cliente'] = array('admin/ReportsController','total_service_by_client');
//$route['*']['/admin/reports/total_service_by_client/:id_cliente'] = array('admin/ReportePdfController','total_service_by_client');
...
$route['*']['/admin/reports/hotel_services_report/:fecha_inicio/:fecha_final'] = array('admin/ReportsController', 'daily_report_hotel');/*hotel_services_report*/
