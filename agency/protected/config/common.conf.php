 ...
 */
//$config['pagesize'] = 10;
$config['langs'] = array('es','en');
$config['RELATIVE_IMG_DIR'] = '/uploads/';
$config['IMG_DIR'] = $_SERVER['DOCUMENT_ROOT'].'/uploads/';

#archivo de configuracion
$config["ini"] = parse_ini_file(realpath('')."/config.ini");
