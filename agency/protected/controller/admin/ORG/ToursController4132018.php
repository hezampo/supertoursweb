...
//                exit();
                ...
                $tours->comments2 = 'RATE: ' . "[".$tarifario ."]". "\n\n" . $comments ."\n\n". $fecha . "; USER: $operador1. \n\n";
...
//                exit;
                    ...
                    //$this->calcularValorPark($park->adult, $park->child);
                    //$this->totalValorPark($park->adult, $park->child, $agencia->id);
...
//            print_r($prices);      
    ...
    public function selectTrip1() {
        ...
        if (isset($this->params["from"]) && isset($this->params["to"]) && isset($this->params["fecha"]) && isset($this->params["totalpax"]) && isset($this->params["tipo_pass"]) && isset($this->params["agency"])) {
            ...
            $to = $this->params["to"];
            $fecha_salida = $this->params["fecha"];
            $tipo_reserva = $this->params["tipo_reserva"];
            $totalpaxx = $this->params["total_pasajeros"];
...
//            exit();
            ...
            foreach ($salida as $e) {
                    ...
                    echo '<tr class="row' . $i . '">  
                    <td style="color:#000;"><input type="radio" name="trip1" id="trip1' . $e['trip_no'] . '"  value="' . $e['trip_no'] . '" />
                    ...
                    <td style="color:#000;">' . $e['trip_no'] . '</td>
                    <td style="color:#000;">' . date("g:i a", strtotime($e['trip_departure'])) . '</td>
                    <td style="color:#000;">' . date("g:i a", strtotime($e['trip_arrival'])) . '</td>
                    <td style="color:#000;">' . $priceAdult . ' <input type="hidden" name="priceTransporAdult1_' . $e['trip_no'] . '"  id="priceTransporAdult_' . $e['trip_no'] . '" value="' . $priceAdult . '" /> 
					</td>
                    <td style="color:#000;">' . $priceChild . '
					<input type="hidden" name="priceTransporChild_' . $e['trip_no'] . '"  id="priceTransporChild_' . $e['trip_no'] . '" value="' . $priceChild . '" />
					</td>
                    <td style="color:#000;">' . $e['equipment'] . '</td>
                    <!--<td style="color:#000;">' . $disponible . '</td>-->
                    <td title="' . $tituloDisponible . '" ><img id="sold' . $e['trip_no'] . 't1" src="' . Doo::conf()->APP_URL . 'global/img/soldout.gif" style="display:none; position: absolute; margin-left: -25.8px;  margin-top: -16px; border:0px; width:72px; height:46px;"  /><input type="text" name="disponible"  id="disponible' . $e['trip_no'] . '" style=" width: 24px; text-align: center; background-color: transparent; border: 0px; font-weight:normal;" value="' . $disponible . '" /></td>
                    </tr>';
        ...
        if(trips == 101201301){
            ...
            if(seats_remain301 == "0"){
                ...
                document.getElementById("trip1301").disabled = true;
                document.getElementById("disponible301").value = 0;
                document.getElementById("sold301t1").style.display = ""; 
    ...
    $(document).ready(function() {   
        ...
        if(trips == 101201301){  
            ...
            if(seats_remain101 == "0"){                    
                document.getElementById("trip1101").style.cursor = "not-allowed";
                document.getElementById("trip1101").disabled = true; 
                document.getElementById("sold101t1").style.display = "";    
            }else{
                document.getElementById("sold101t1").style.display = "none"; 
            }

            if(seats_remain201 == "0"){                    
                document.getElementById("trip1201").style.cursor = "not-allowed";
                document.getElementById("trip1201").disabled = true; 
                document.getElementById("sold201t1").style.display = "";   
            }else{
                document.getElementById("sold201t1").style.display = "none"; 
            }
            ...
            if(seats_remain301 == "0"){                    
                ...
                document.getElementById("sold301t1").style.display = "none"; 
            }
...
//            exit;
            ...
            $sql2 = "SELECT  nombre FROM areas WHERE id = ?";
            $rs2 = Doo::db()->query($sql2, array($from));
            $from = $rs2->fetch();

            $sql3 = "SELECT  nombre FROM areas WHERE id = ?";
            $rs3 = Doo::db()->query($sql3, array($to));
            $to = $rs3->fetch();
            ...
            <style type="text/css" media="screen">
             ...
             <thead>
                 ...
                 <tr>
                     <!--<th width="1px;" style="">Select</th>-->
                     <th class="pasajeros" style="width: 5%; border-right-color: transparent; text-align: left; "><label></label><input type="number" name="infante" id="infante" min="0" max="15" size="2"  maxlength="2" value="0"  style="display:none; height: 13px; font-weight: bold; text-align: center; width:50px; margin-top:-22px; margin-left: 2px;" autocomplete="off" /></th>
                     <th class="pasajeros" style="width: 1%; text-align: left; "><label style="color:#000;">Adult(s):</label><input type="number" name="pasadult2"  min="1" id="pasadult2" size="2" maxlength="2" value="1"  onkeyup="valida_adultos2();" onchange="valida_adultos2();" style=" height: 13px; font-weight: bold; text-align: center; width:50px; margin-top:-21px; margin-left: 3px;"  autocomplete="off" /></th>
                     <th class="pasajeros" style="width: 1%; border-left-color: transparent; text-align: left; "><label style="color:#000;">Child(s):</label><input type="number" name="pasanino2" id="pasanino2" min="0" max="15" size="2"  maxlength="2" value="0" onkeyup="valida_adultos2();valida_chicos2();" onchange="valida_adultos2();valida_chicos2();" style=" height: 13px; font-weight: bold; text-align: center; width:50px; margin-top:-22px; margin-left: 2px;" autocomplete="off" /></th>                     
                     <th class="standard" style="width: 5px; padding-right:0px; text-align:right;  font-weight:bold; font-size:18px; color:#191955; font-face: verdana;" colspan="2"><u>MULTIDAY&nbsp;</u></th>                     
                     <th class="superflex" style="width: 8px; padding-left:0px; text-align:left;  font-weight:bold; font-size:18px; color:#191955; font-face: verdana;" colspan="2"><u>&nbsp;TOURS</u></th>
            ...
            if (count($salida) > 0) {
                ...
                foreach ($salida as $e) {
                        ...
                        //$seats = 57;
                        echo '<tr class="row' . $i . '">  
                        <td style="color:#000;"><input type="radio" name="trip2" id="trip2' . $e['trip_no'] . '"  value="' . $e['trip_no'] . '" />
                                            <input type="hidden" name="capacidad_trip_' . $e['trip_no'] . '"  id="capacidad_trip_' . $e['trip_no'] . '" value="' . $disponible . '" />
                        ...
                        <td style="color:#000;">' . $e['equipment'] . '</td>
                        <!--<td style="color:#000;">' . $disponible . '</td>-->
                        <td title="' . $tituloDisponible . '" ><img id="sold' . $e['trip_no'] . 't2" src="' . Doo::conf()->APP_URL . 'global/img/soldout.gif" style="display:none; position: absolute; margin-left: -25.8px;  margin-top: -16px; border:0px; width:72px; height:46px;"  /><input type="text" name="disponible"  id="disponible' . $e['trip_no'] . '" style=" width: 24px; text-align: center; background-color: transparent; border: 0px; font-weight:normal;" value="' . $disponible . '" /></td>
                    </tr>';
		 ...
		 <input  class="selector" type="button" id="btn-cancelarTrip" value="Cancel" /> 
            ...
            <script type="text/javascript">
                    ...
                    var pasadult = document.getElementById("pasadult2").value;
                    var pasanino = document.getElementById("pasanino2").value;
                    var adultos = $("#pasadult2").val();
                    var peques = $("#pasanino2").val();
                    var totpax = parseInt(adultos) + parseInt(peques);                    
                    var trips = "' . $trips . '";  
                    ...
                    if(pasadult2 == ""){                    
                            document.getElementById("pasadult2").value = "1";
                            $("#pasadult").focus();                    
                    }
                ...
                function valida_chicos2(){

                    var pasanino = document.getElementById("pasanino2").value;                    

                    if(pasanino == ""){                    
                            document.getElementById("pasanino2").value = "0";
                            $("#pasanino2").focus();                    
                    }
		...
		$(document).ready(function() {   
                ...
                var adulto2 = $("#adult").val();
                var nino2 =  $("#child").val();
                
                var adult2 = document.getElementById("adult").value;
                var nin2 = document.getElementById("child").value;
                ...
                if(trips == 100200300){  
                    ...
                    var seats_remain200 = "' . $seats_remain200 . '";
                    var seats_remain300 = "' . $seats_remain300 . '";     
                    var radio100 = document.getElementById("trip1100").checked;
                    var radio200 = document.getElementById("trip1200").checked;
                    var radio300 = document.getElementById("trip1300").checked;            


                    if(totpax > seats_remain100){

                    document.getElementById("trip1100").style.cursor = "not-allowed";
                    document.getElementById("trip1100").disabled = true;
                    //document.getElementById("trip1100").checked = false;

                    }

                    if(totpax > seats_remain200){                    
                        document.getElementById("trip1200").style.cursor = "not-allowed";
                        document.getElementById("trip1200").disabled = true;
                        //document.getElementById("trip1200").checked = false;
                    }

                    if(totpax > seats_remain300){                    
                        document.getElementById("trip1300").style.cursor = "not-allowed";
                        document.getElementById("trip1300").disabled = true;
                        //document.getElementById("trip1300").checked = false;
                    }
                    ...
                    if(seats_remain100 == "0"){                    
                        document.getElementById("trip1100").style.cursor = "not-allowed";
                        document.getElementById("trip1100").disabled = true; 
                        document.getElementById("sold100t2").style.display = "";    
                    }else{
                        document.getElementById("sold100t2").style.display = "none"; 
                    }

                    if(seats_remain200 == "0"){                    
                        document.getElementById("trip1200").style.cursor = "not-allowed";
                        document.getElementById("trip1200").disabled = true; 
                        document.getElementById("sold200t2").style.display = "";   
                    }else{
                        document.getElementById("sold200t1").style.display = "none"; 
                    }

                    if(seats_remain300 == "0"){                    
                        document.getElementById("trip1300").style.cursor = "not-allowed";
                        document.getElementById("trip1300").disabled = true; 
                        document.getElementById("sold300t2").style.display = "";    
                    }else{
                        document.getElementById("sold300t2").style.display = "none"; 
                    }
                ...
                if(trips == 100200){
                    ...
                    if(seats_remain200 == "0"){                    
                        ...
                        document.getElementById("sold200t2").style.display = "none"; 
                    }
                ...
                $("#pasadult2").change(function(){

                    var pasadult = $("#pasadult2").val(); 
                    $("#adult").val(pasadult);
                    valorTransferGeneral();
                    habitaciones();
                    calcularTotalPago();
                ...
                $("#pasanino2").change(function(){

                    var pasanino = $("#pasanino2").val();                  
                    $("#child").val(pasanino);
                    valorTransferGeneral();
                    habitaciones();
                    calcularTotalPago();
                ...
                var tipo_reserva = "' . $tipo_reserva . '";                     
                var total_pasajeros = "' . $totalpaxx . '";  
                var totalpaxe2 = parseInt(adult) + parseInt(child);  
                var totalpax = parseInt(adult) + parseInt(child); 
                ...
                if(tipo_reserva == "Editado" && trip == trip2){                              
                    
                    var totalpax = totalpaxe2 - total_pasajeros;        
...
//                            $precio_child = $park["ticket"]["child"];
//                            $precio_adulto = $park["ticket"]["adult"];
