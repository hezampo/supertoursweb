...
//                $prices["priceadult"] = $_POST["priceadults"];
//                $prices["pricechild"] = $_POST["pricechilds"];
//                
//                $prices["priceadult"] = $precio_adulto;
//                $prices["pricechild"] = $precio_nino;
...
//                
//                if ($grupo_parque == 2){
//                $reserve->precio_trip1_a = $prices["priceadult_WATERP"];
//                $reserve->precio_trip1_c = $prices["pricechild_WATERP"];
//                $reserve->precio_trip2_a = $prices["priceadult_WATERP"];
//                $reserve->precio_trip2_c = $prices["pricechild_WATERP"];
//                
//                $reserve->precioA = $prices["priceadult_WATERP"]; 
//                    if ($child > 0) {
//                    $reserve->precioN = $prices["pricechild_WATERP"]; 
//                        }
//                    }
//                
//                if ($grupo_parque == 3){
//                $reserve->precio_trip1_a = $prices["priceadult_KENNEDYSPC"];
//                $reserve->precio_trip1_c = $prices["pricechild_KENNEDYSPC"];
//                $reserve->precio_trip2_a = $prices["priceadult_KENNEDYSPC"];
//                $reserve->precio_trip2_c = $prices["pricechild_KENNEDYSPC"];
//                
//                $reserve->precioA = $prices["priceadult_KENNEDYSPC"]; 
//                    if ($child > 0) {
//                    $reserve->precioN = $prices["pricechild_KENNEDYSPC"]; 
//                        }
//                    }
...
//            $tour->comments = $notes;
            ...
            $time = time();
            $fechaone = date("[m/d/Y-H:i:s]", $time);
            
            $sql = "SELECT comments2 FROM  tours_oneday  WHERE id_reserva = $tour->id_reserva";
...
//            if ($grupo_parque == 1){
//
//            $tour->t_price_adult = $prices["priceadult_WDW"];            
//            $tour->t_price_child = $prices["pricechild_WDW"];
//            print_r($tour);
//            exit;
//       
//           } 
...
//            if ($grupo_parque == 3){
//
//            $tour->t_price_adult = $prices["priceadult_KENNEDYSPC"];
//            $tour->t_price_child = $prices["pricechild_KENNEDYSPC"];
//            print_r($tour);
//            exit;
//            
//            
...
//Primera letra en Mayuscula
        ...
        $sql5 = "SELECT op_pago FROM tours_oneday 
            ...
            $service_fee1 = ($rprecioA1+$rprecioC1)*0.04;
        ...
        $pdf = new DooPDF('Summary One Day Tours', $codigoHTML, false, 'letter', 'letter');
        $pdf->doPDF();
        $archivo = $pdf;
