...
//                  print($tours->starting_date);
//                  print($tours->ending_date);
                    
                    
//                  print($park->id_park);                  
//                  print($park->group);
//                  print($tours->platinum);
//                  print($park->adult);
//                  print($park->child);
//                  print($park->admission);
//                  print($park->trafic);
...
//        GLOBAL $tarifa1;
        ...
        $this->ticketPark($dat, $adult, $child, $fecha_salida, $fecha_retorno);
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public function ticketPark($dat, $adult, $child, $fecha_salida, $fecha_retorno) {
...
//                    print($cantidad_consulta);
                    ...
                    $sql02 = 'SELECT  adults,child,id_parque,cantidad
								FROM admin_parques_tarifa
								WHERE type_rate = 2 AND id_agency = ? AND  id_parque = ? AND cantidad = 1 AND fecha_ini <= ? AND fecha_fin >= ?';
...
//        echo '<br />fecha_fin33=' . $fecha_fin;
        ...
        $sql0 = 'SELECT adults,child,id_parque ,cantidad
		FROM admin_parques_tarifa
                WHERE type_rate = 2 AND id_parque = 0 AND id_agency = ? AND  id_grupo = ? AND cantidad = ? fecha_ini <= ? AND fecha_fin >= ?';
