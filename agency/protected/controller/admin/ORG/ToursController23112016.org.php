...
//                }
                ...
                $tours->comments = $comments;
                $time = time();
                $fechamulti = date("[m/d/Y-H:i:s]", $time);
...
//                exit;            
                ...
                $tours->comments2 = ("New Note: " . $comments . " " . $fechamulti . ";\n" . $notes2);
...
//                    echo $type_rate;
            ...
            $sql = "select 
                         ...
                         left join areas  t4 on (t2.trip_from = t4.id)
                         left join areas  t5 on  (t2.trip_to  = t5.id)
                         where t2.type_rate = " . $dat->type_rate . " and t2.trip_from = ? AND t2.trip_to = ? and fecha = ? AND t2.trip_departure > '' and t1.estado = '1' and t2.anno = ?  and t2.fecha_ini = '$fecha_ini1' ORDER BY t2.trip_departure ASC";
...
//            exit();
            ...
            if ($dat->type_rate == 1) {// Salidas Especial Net
                $sqlNet = "select 
                         ...
                         left join areas  t4 on (t2.trip_from = t4.id)
                         left join areas  t5 on  (t2.trip_to  = t5.id)
                         where t2.type_rate = 2 and t2.trip_from = ? AND t2.trip_to = ? and fecha = ? AND t2.trip_departure > '' and t1.estado = '1' and t2.anno = ? and t2.fecha_ini = '$fecha_ini1' AND t2.id_agency = ?
                         ORDER BY t2.trip_departure ASC";
...
//                    $tarifa1 = $type_rate;
            ...
            $sql = "select 
                         ...
                         left join areas  t4 on (t2.trip_from = t4.id)
                         left join areas  t5 on  (t2.trip_to  = t5.id)
                         where t2.type_rate = " . $dat->type_rate . " and t2.trip_from = ? AND t2.trip_to = ? and fecha = ? AND t2.trip_departure > '' and t1.estado = '1' and t2.anno = ? and t2.fecha_ini = '$fecha_sal1' ORDER BY t2.trip_departure ASC";
            ...
            if ($dat->type_rate == 1) { // Salidas Especial Net
                $sqlNet = "select 
							 ...
							 left join areas  t4 on (t2.trip_from = t4.id)
							 left join areas  t5 on  (t2.trip_to  = t5.id)
							 where t2.type_rate = 2 and t2.trip_from = ? AND t2.trip_to = ? and fecha = ? AND t2.trip_departure > '' and t1.estado = '1' and t2.anno = ? and t2.fecha_ini = '$fecha_sal1' AND t2.id_agency = ?
							 ORDER BY t2.trip_departure ASC";
...
//            $select = 4;
    ...
    public function acomodacion() {
        ...
        echo '&nbsp;&nbsp;&nbsp;
		<ul style="display:inline-table; border: 1px solid #000;padding: 14px;"> ';
        for ($i = 1; $i <= $rooms; $i++) {
...
//                    print_r(Doo::db()->showSQL());
                    ...
                    if ($numNoches['noches'] == 1 && $categor == 2 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += $costohotel ['sgl'] + ($chv21 * $room1_c) + ($fdv_adult21 * $room1 * $frday) + ($fdv_child21 * $room1_c * $frday);
                            //echo $priceRoom1;
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += $costohotel ['dbl'] + (($chv21 * $room1_c) / 2) + (($fdv_adult21 * $room1 * $frday) / 2) + (($fdv_child21 * $room1_c * $frday) / 2);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += $costohotel ['tpl'] + (($chv21 * $room1_c) / 3) + (($fdv_adult21 * $room1 * $frday) / 3) + (($fdv_child21 * $room1_c * $frday) / 3);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += $costohotel ['qua'] + (($chv21 * $room1_c) / 4) + (($fdv_adult21 * $room1 * $frday) / 4) + (($fdv_child21 * $room1_c * $frday) / 4);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 1 && $categor == 3 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += $costohotel ['sglm'] + ($chm21 * $room1_c) + ($fdm_adult21 * $room1 * $frday) + ($fdm_child21 * $room1_c * $frday);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += $costohotel ['dblm'] + (($chm21 * $room1_c) / 2) + (($fdm_adult21 * $room1 * $frday) / 2) + (($fdm_child21 * $room1_c * $frday) / 2);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += $costohotel ['tplm'] + (($chm21 * $room1_c) / 3) + (($fdm_adult21 * $room1 * $frday) / 3) + (($fdm_child21 * $room1_c * $frday) / 3);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += $costohotel ['quam'] + (($chm21 * $room1_c) / 4) + (($fdm_adult21 * $room1 * $frday) / 4) + (($fdm_child21 * $room1_c * $frday) / 4);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 2 && $categor == 2 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sgl2'] / 2) + (($chv32 * $room1_c) / 2) + (($fdv_adult32 * $room1 * $frday) / 2) + (($fdv_child32 * $room1_c * $frday) / 2);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dbl2'] / 2) + (($chv32 * $room1_c) / 4) + (($fdv_adult32 * $room1 * $frday) / 4) + (($fdv_child32 * $room1_c * $frday) / 4);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tpl2'] / 2) + (($chv32 * $room1_c) / 6) + (($fdv_adult32 * $room1 * $frday) / 6) + (($fdv_child32 * $room1_c * $frday) / 6);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['qua2'] / 2) + (($chv32 * $room1_c) / 8) + (($fdv_adult32 * $room1 * $frday) / 8) + (($fdv_child32 * $room1_c * $frday) / 8);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 2 && $categor == 3 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sglm2'] / 2) + (($chm32 * $room1_c) / 2) + (($fdm_adult32 * $room1 * $frday) / 2) + (($fdm_child32 * $room1_c * $frday) / 2);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dblm2'] / 2) + (($chm32 * $room1_c) / 4) + (($fdm_adult32 * $room1 * $frday) / 4) + (($fdm_child32 * $room1_c * $frday) / 4);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tplm2'] / 2) + (($chm32 * $room1_c) / 6) + (($fdm_adult32 * $room1 * $frday) / 6) + (($fdm_child32 * $room1_c * $frday) / 6);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['quam2'] / 2) + (($chm32 * $room1_c) / 8) + (($fdm_adult32 * $room1 * $frday) / 8) + (($fdm_child32 * $room1_c * $frday) / 8);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 3 && $categor == 2 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sgl3'] / 3) + (($chv43 * $room1_c) / 3) + (($fdv_adult43 * $room1 * $frday) / 3) + (($fdv_child43 * $room1_c * $frday) / 3);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dbl3'] / 3) + (($chv43 * $room1_c) / 6) + (($fdv_adult43 * $room1 * $frday) / 6) + (($fdv_child43 * $room1_c * $frday) / 6);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tpl3'] / 3) + (($chv43 * $room1_c) / 9) + (($fdv_adult43 * $room1 * $frday) / 9) + (($fdv_child43 * $room1_c * $frday) / 9);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['qua3'] / 3) + (($chv43 * $room1_c) / 12) + (($fdv_adult43 * $room1 * $frday) / 12) + (($fdv_child43 * $room1_c * $frday) / 12);
                        }
                    }
                    //TOUR 43 MODERATE
                    ...
                    if ($numNoches['noches'] == 3 && $categor == 3 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sglm3'] / 3) + (($chm43 * $room1_c) / 3) + (($fdm_adult43 * $room1 * $frday) / 3) + (($fdm_child43 * $room1_c * $frday) / 3);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dblm3'] / 3) + (($chm43 * $room1_c) / 6) + (($fdm_adult43 * $room1 * $frday) / 6) + (($fdm_child43 * $room1_c * $frday) / 3);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tplm3'] / 3) + (($chm43 * $room1_c) / 9) + (($fdm_adult43 * $room1 * $frday) / 9) + (($fdm_child43 * $room1_c * $frday) / 9);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['quam3'] / 3) + (($chm43 * $room1_c) / 12) + (($fdm_adult43 * $room1 * $frday) / 12) + (($fdm_child43 * $room1_c * $frday) / 12);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 4 && $categor == 2 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sgl4'] / 4) + (($chv54 * $room1_c) / 4) + (($fdv_adult54 * $room1 * $frday) / 4) + (($fdv_child54 * $room1_c * $frday) / 4);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dbl4'] / 4) + (($chv54 * $room1_c) / 8) + (($fdv_adult54 * $room1 * $frday) / 8) + (($fdv_child54 * $room1_c * $frday) / 8);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tpl4'] / 4) + (($chv54 * $room1_c) / 12) + (($fdv_adult54 * $room1 * $frday) / 12) + (($fdv_child54 * $room1_c * $frday) / 12);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['qua4'] / 4) + (($chv54 * $room1_c) / 16) + (($fdv_adult54 * $room1 * $frday) / 16) + (($fdv_child54 * $room1_c * $frday) / 16);
                        }
                    }
                    //TOUR 54 MODERATE
                    ...
                    if ($numNoches['noches'] == 4 && $categor == 3 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sglm4'] / 4) + (($chm54 * $room1_c) / 4) + (($fdm_adult54 * $room1 * $frday) / 4) + (($fdm_child54 * $room1_c * $frday) / 4);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dblm4'] / 4) + (($chm54 * $room1_c) / 8) + (($fdm_adult54 * $room1 * $frday) / 8) + (($fdm_child54 * $room1_c * $frday) / 8);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tplm4'] / 4) + (($chm54 * $room1_c) / 12) + (($fdm_adult54 * $room1 * $frday) / 12) + (($fdm_child54 * $room1_c * $frday) / 12);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['quam4'] / 4) + (($chm54 * $room1_c) / 16) + (($fdm_adult54 * $room1 * $frday) / 16) + (($fdm_child54 * $room1_c * $frday) / 16);
                        }
                    }
                    //TOUR 65 VALUE
                    ...
                    if ($numNoches['noches'] == 5 && $categor == 2 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sgl5'] / 5) + (($chv65 * $room1_c) / 5) + (($fdv_adult65 * $room1 * $frday) / 5) + (($fdv_child65 * $room1_c * $frday) / 5);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dbl5'] / 5) + (($chv65 * $room1_c) / 10) + (($fdv_adult65 * $room1 * $frday) / 10) + (($fdv_child65 * $room1_c * $frday) / 10);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tpl5'] / 5) + (($chv65 * $room1_c) / 15) + (($fdv_adult65 * $room1 * $frday) / 15) + (($fdv_child65 * $room1_c * $frday) / 15);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['qua5'] / 5) + (($chv65 * $room1_c) / 20) + (($fdv_adult65 * $room1 * $frday) / 20) + (($fdv_child65 * $room1_c * $frday) / 20);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 5 && $categor == 3 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sglm5']) / 5 + (($chm65 * $room1_c) / 5) + (($fdm_adult65 * $room1 * $frday) / 5) + (($fdm_child65 * $room1_c * $frday) / 5);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dblm5']) / 5 + (($chm65 * $room1_c) / 10) + (($fdm_adult65 * $room1 * $frday) / 10) + (($fdm_child65 * $room1_c * $frday) / 10);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tplm5']) / 5 + (($chm65 * $room1_c) / 15) + (($fdm_adult65 * $room1 * $frday) / 15) + (($fdm_child65 * $room1_c * $frday) / 15);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['quam5']) / 5 + (($chm65 * $room1_c) / 20) + (($fdm_adult65 * $room1 * $frday) / 20) + (($fdm_child65 * $room1_c * $frday) / 20);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 6 && $categor == 2 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sgl6']) / 6 + (($chv76 * $room1_c) / 6) + (($fdv_adult76 * $room1 * $frday) / 6) + (($fdv_child76 * $room1_c * $frday) / 6);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dbl6']) / 6 + (($chv76 * $room1_c) / 12) + (($fdv_adult76 * $room1 * $frday) / 12) + (($fdv_child76 * $room1_c * $frday) / 12);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tpl6']) / 6 + (($chv76 * $room1_c) / 18) + (($fdv_adult76 * $room1 * $frday) / 18) + (($fdv_child76 * $room1_c * $frday) / 18);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['qua6']) / 6 + (($chv76 * $room1_c) / 24) + (($fdv_adult76 * $room1 * $frday) / 24) + (($fdv_child76 * $room1_c * $frday) / 24);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 6 && $categor == 3 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sglm6']) / 6 + (($chm76 * $room1_c) / 6) + (($fdm_adult76 * $room1 * $frday) / 6) + (($fdm_child76 * $room1_c * $frday) / 6);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dblm6']) / 6 + (($chm76 * $room1_c) / 12) + (($fdm_adult76 * $room1 * $frday) / 12) + (($fdm_child76 * $room1_c * $frday) / 12);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tplm6']) / 6 + (($chm76 * $room1_c) / 18) + (($fdm_adult76 * $room1 * $frday) / 18) + (($fdm_child76 * $room1_c * $frday) / 18);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['quam6']) / 6 + (($chm76 * $room1_c) / 24) + (($fdm_adult76 * $room1 * $frday) / 24) + (($fdm_child76 * $room1_c * $frday) / 24);
                        }
                    }
                    //************************************************************************************************************************************         
                    //TOUR 87 VALUE
                    ...
                    if ($numNoches['noches'] == 7 && $categor == 2 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sgl7']) / 7 + (($chv87 * $room1_c) / 7) + (($fdv_adult87 * $room1 * $frday) / 7) + (($fdv_child87 * $room1_c * $frday) / 7);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dbl7']) / 7 + (($chv87 * $room1_c) / 14) + (($fdv_adult87 * $room1 * $frday) / 14) + (($fdv_child87 * $room1_c * $frday) / 14);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tpl7']) / 7 + (($chv87 * $room1_c) / 21) + (($fdv_adult87 * $room1 * $frday) / 21) + (($fdv_child87 * $room1_c * $frday) / 21);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['qua7']) / 7 + (($chv87 * $room1_c) / 28) + (($fdv_adult87 * $room1 * $frday) / 28) + (($fdv_child87 * $room1_c * $frday) / 28);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 7 && $categor == 3 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sglm7']) / 7 + (($chm87 * $room1_c) / 7) + (($fdm_adult87 * $room1 * $frday) / 7) + (($fdm_child87 * $room1_c * $frday) / 7);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dblm7']) / 7 + (($chm87 * $room1_c) / 14) + (($fdm_adult87 * $room1 * $frday) / 14) + (($fdm_child87 * $room1_c * $frday) / 14);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tplm7']) / 7 + (($chm87 * $room1_c) / 21) + (($fdm_adult87 * $room1 * $frday) / 21) + (($fdm_child87 * $room1_c * $frday) / 21);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['quam7']) / 7 + (($chm87 * $room1_c) / 28) + (($fdm_adult87 * $room1 * $frday) / 28) + (($fdm_child87 * $room1_c * $frday) / 28);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 8 && $categor == 2 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sgl8']) / 8 + (($chv98 * $room1_c) / 8) + (($fdv_adult98 * $room1 * $frday) / 8) + (($fdv_child98 * $room1_c * $frday) / 8);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dbl8']) / 8 + (($chv98 * $room1_c) / 16) + (($fdv_adult98 * $room1 * $frday) / 16) + (($fdv_child98 * $room1_c * $frday) / 16);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tpl8']) / 8 + (($chv98 * $room1_c) / 24) + (($fdv_adult98 * $room1 * $frday) / 24) + (($fdv_child98 * $room1_c * $frday) / 24);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['qua8']) / 8 + (($chv98 * $room1_c) / 32) + (($fdv_adult98 * $room1 * $frday) / 32) + (($fdv_child98 * $room1_c * $frday) / 32);
                        }
                    }
                    ...
                    if ($numNoches['noches'] == 8 && $categor == 3 && $room1 > 0) {
                        ...
                        if ($room1 == 1) {
                            $priceRoom1 += ($costohotel ['sglm8']) / 8 + (($chm98 * $room1_c) / 8) + (($fdm_adult98 * $room1 * $frday) / 8) + (($fdm_child98 * $room1_c * $frday) / 8);
                        }
                        if ($room1 == 2) {
                            $priceRoom1 += ($costohotel ['dblm8']) / 8 + (($chm98 * $room1_c) / 16) + (($fdm_adult98 * $room1 * $frday) / 16) + (($fdm_child98 * $room1_c * $frday) / 16);
                        }
                        if ($room1 == 3) {
                            $priceRoom1 += ($costohotel ['tplm8']) / 8 + (($chm98 * $room1_c) / 24) + (($fdm_adult98 * $room1 * $frday) / 24) + (($fdm_child98 * $room1_c * $frday) / 24);
                        }
                        if ($room1 == 4) {
                            $priceRoom1 += ($costohotel ['quam8']) / 8 + (($chm98 * $room1_c) / 32) + (($fdm_adult98 * $room1 * $frday) / 32) + (($fdm_child98 * $room1_c * $frday) / 32);
                        }
                    }
            ...
            while ($fecha2->format("Y-m-d") < $fecha_fin->format("Y-m-d")) {
                ...
                if ($numNoches['noches'] == 1 && $categor == 2 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += $costohotel ['sgl'] + ($chv21 * $room2_c) + ($fdv_adult21 * $room2 * $frday) + ($fdv_child21 * $room2_c * $frday);
                        //echo $priceRoom2;
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += $costohotel ['dbl'] + (($chv21 * $room2_c) / 2) + (($fdv_adult21 * $room2 * $frday) / 2) + (($fdv_child21 * $room2_c * $frday) / 2);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += $costohotel ['tpl'] + (($chv21 * $room2_c) / 3) + (($fdv_adult21 * $room2 * $frday) / 3) + (($fdv_child21 * $room2_c * $frday) / 3);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += $costohotel ['qua'] + (($chv21 * $room2_c) / 4) + (($fdv_adult21 * $room2 * $frday) / 4) + (($fdv_child21 * $room2_c * $frday) / 4);
                    }
                }
                ...
                if ($numNoches['noches'] == 1 && $categor == 3 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += $costohotel ['sglm'] + ($chm21 * $room2_c) + ($fdm_adult21 * $room2 * $frday) + ($fdm_child21 * $room2_c * $frday);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += $costohotel ['dblm'] + (($chm21 * $room2_c) / 2) + (($fdm_adult21 * $room2 * $frday) / 2) + (($fdm_child21 * $room2_c * $frday) / 2);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += $costohotel ['tplm'] + (($chm21 * $room2_c) / 3) + (($fdm_adult21 * $room2 * $frday) / 3) + (($fdm_child21 * $room2_c * $frday) / 3);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += $costohotel ['quam'] + (($chm21 * $room2_c) / 4) + (($fdm_adult21 * $room2 * $frday) / 4) + (($fdm_child21 * $room2_c * $frday) / 4);
                    }
                }
                ...
                if ($numNoches['noches'] == 2 && $categor == 2 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sgl2']) / 2 + (($chv32 * $room2_c) / 2) + (($fdv_adult32 * $room2 * $frday) / 2) + (($fdv_child32 * $room2_c * $frday) / 2);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dbl2']) / 2 + (($chv32 * $room2_c) / 4) + (($fdv_adult32 * $room2 * $frday) / 4) + (($fdv_child32 * $room2_c * $frday) / 4);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tpl2']) / 2 + (($chv32 * $room2_c) / 6) + (($fdv_adult32 * $room2 * $frday) / 6) + (($fdv_child32 * $room2_c * $frday) / 6);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['qua2']) / 2 + (($chv32 * $room2_c) / 8) + (($fdv_adult32 * $room2 * $frday) / 8) + (($fdv_child32 * $room2_c * $frday) / 8);
                    }
                }
                ...
                if ($numNoches['noches'] == 2 && $categor == 3 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sglm2']) / 2 + (($chm32 * $room2_c) / 2) + (($fdm_adult32 * $room2 * $frday) / 2) + (($fdm_child32 * $room2_c * $frday) / 2);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dblm2']) / 2 + (($chm32 * $room2_c) / 4) + (($fdm_adult32 * $room2 * $frday) / 4) + (($fdm_child32 * $room2_c * $frday) / 4);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tplm2']) / 2 + (($chm32 * $room2_c) / 6) + (($fdm_adult32 * $room2 * $frday) / 6) + (($fdm_child32 * $room2_c * $frday) / 6);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['quam2']) / 2 + (($chm32 * $room2_c) / 8) + (($fdm_adult32 * $room2 * $frday) / 8) + (($fdm_child32 * $room2_c * $frday) / 8);
                    }
                }
                ...
                if ($numNoches['noches'] == 3 && $categor == 2 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sgl3']) / 3 + (($chv43 * $room2_c) / 3) + (($fdv_adult43 * $room2 * $frday) / 3) + (($fdv_child43 * $room2_c * $frday) / 3);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dbl3']) / 3 + (($chv43 * $room2_c) / 6) + (($fdv_adult43 * $room2 * $frday) / 6) + (($fdv_child43 * $room2_c * $frday) / 6);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tpl3']) / 3 + (($chv43 * $room2_c) / 9) + (($fdv_adult43 * $room2 * $frday) / 9) + (($fdv_child43 * $room2_c * $frday) / 9);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['qua3']) / 3 + (($chv43 * $room2_c) / 12) + (($fdv_adult43 * $room2 * $frday) / 12) + (($fdv_child43 * $room2_c * $frday) / 12);
                    }
                }
                ...
                if ($numNoches['noches'] == 3 && $categor == 3 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sglm3']) / 3 + (($chm43 * $room2_c) / 3) + (($fdm_adult43 * $room2 * $frday) / 3) + (($fdm_child43 * $room2_c * $frday) / 3);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dblm3']) / 3 + (($chm43 * $room2_c) / 6) + (($fdm_adult43 * $room2 * $frday) / 6) + (($fdm_child43 * $room2_c * $frday) / 6);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tplm3']) / 3 + (($chm43 * $room2_c) / 9) + (($fdm_adult43 * $room2 * $frday) / 9) + (($fdm_child43 * $room2_c * $frday) / 9);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['quam3']) / 3 + (($chm43 * $room2_c) / 12) + (($fdm_adult43 * $room2 * $frday) / 12) + (($fdm_child43 * $room2_c * $frday) / 12);
                    }
                }
                ...
                if ($numNoches['noches'] == 4 && $categor == 2 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sgl4']) / 4 + (($chv54 * $room2_c) / 4) + (($fdv_adult54 * $room2 * $frday) / 4) + (($fdv_child54 * $room2_c * $frday) / 4);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dbl4']) / 4 + (($chv54 * $room2_c) / 8) + (($fdv_adult54 * $room2 * $frday) / 8) + (($fdv_child54 * $room2_c * $frday) / 8);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tpl4']) / 4 + (($chv54 * $room2_c) / 12) + (($fdv_adult54 * $room2 * $frday) / 12) + (($fdv_child54 * $room2_c * $frday) / 12);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['qua4']) / 4 + (($chv54 * $room2_c) / 16) + (($fdv_adult54 * $room2 * $frday) / 16) + (($fdv_child54 * $room2_c * $frday) / 16);
                    }
                }
                ...
                if ($numNoches['noches'] == 4 && $categor == 3 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sglm4']) / 4 + (($chm54 * $room2_c) / 4) + (($fdm_adult54 * $room2 * $frday) / 4) + (($fdm_child54 * $room2_c * $frday) / 4);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dblm4']) / 4 + (($chm54 * $room2_c) / 8) + (($fdm_adult54 * $room2 * $frday) / 8) + (($fdm_child54 * $room2_c * $frday) / 8);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tplm4']) / 4 + (($chm54 * $room2_c) / 12) + (($fdm_adult54 * $room2 * $frday) / 12) + (($fdm_child54 * $room2_c * $frday) / 12);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['quam4']) / 4 + (($chm54 * $room2_c) / 16) + (($fdm_adult54 * $room2 * $frday) / 16) + (($fdm_child54 * $room2_c * $frday) / 16);
                    }
                }
                ...
                if ($numNoches['noches'] == 5 && $categor == 2 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sgl5']) / 5 + (($chv65 * $room2_c) / 5) + (($fdv_adult65 * $room2 * $frday) / 5) + (($fdv_child65 * $room2_c * $frday) / 5);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dbl5']) / 5 + (($chv65 * $room2_c) / 10) + (($fdv_adult65 * $room2 * $frday) / 10) + (($fdv_child65 * $room2_c * $frday) / 10);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tpl5']) / 5 + (($chv65 * $room2_c) / 15) + (($fdv_adult65 * $room2 * $frday) / 15) + (($fdv_child65 * $room2_c * $frday) / 15);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['qua5']) / 5 + (($chv65 * $room2_c) / 20) + (($fdv_adult65 * $room2 * $frday) / 20) + (($fdv_child65 * $room2_c * $frday) / 20);
                    }
                }
                ...
                if ($numNoches['noches'] == 5 && $categor == 3 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sglm5']) / 5 + (($chm65 * $room2_c) / 5) + (($fdm_adult65 * $room2 * $frday) / 5) + (($fdm_child65 * $room2_c * $frday) / 5);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dblm5']) / 5 + (($chm65 * $room2_c) / 10) + (($fdm_adult65 * $room2 * $frday) / 10) + (($fdm_child65 * $room2_c * $frday) / 10);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tplm5']) / 5 + (($chm65 * $room2_c) / 15) + (($fdm_adult65 * $room2 * $frday) / 15) + (($fdm_child65 * $room2_c * $frday) / 15);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['quam5']) / 5 + (($chm65 * $room2_c) / 20) + (($fdm_adult65 * $room2 * $frday) / 20) + (($fdm_child65 * $room2_c * $frday) / 20);
                    }
                }
                ...
                if ($numNoches['noches'] == 6 && $categor == 2 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sgl6']) / 6 + (($chv76 * $room2_c) / 6) + (($fdv_adult76 * $room2 * $frday) / 6) + (($fdv_child76 * $room2_c * $frday) / 6);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dbl6']) / 6 + (($chv76 * $room2_c) / 12) + (($fdv_adult76 * $room2 * $frday) / 12) + (($fdv_child76 * $room2_c * $frday) / 12);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tpl6']) / 6 + (($chv76 * $room2_c) / 18) + (($fdv_adult76 * $room2 * $frday) / 18) + (($fdv_child76 * $room2_c * $frday) / 18);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['qua6']) / 6 + (($chv76 * $room2_c) / 24) + (($fdv_adult76 * $room2 * $frday) / 24) + (($fdv_child76 * $room2_c * $frday) / 24);
                    }
                }
                ...
                if ($numNoches['noches'] == 6 && $categor == 3 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sglm6']) / 6 + (($chm76 * $room2_c) / 6) + (($fdm_adult76 * $room2 * $frday) / 6) + (($fdm_child76 * $room2_c * $frday) / 6);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dblm6']) / 6 + (($chm76 * $room2_c) / 12) + (($fdm_adult76 * $room2 * $frday) / 12) + (($fdm_child76 * $room2_c * $frday) / 12);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tplm6']) / 6 + (($chm76 * $room2_c) / 18) + (($fdm_adult76 * $room2 * $frday) / 18) + (($fdm_child76 * $room2_c * $frday) / 18);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['quam6']) / 6 + (($chm76 * $room2_c) / 24) + (($fdm_adult76 * $room2 * $frday) / 24) + (($fdm_child76 * $room2_c * $frday) / 24);
                    }
                }
                ...
                if ($numNoches['noches'] == 7 && $categor == 2 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sgl7']) / 7 + (($chv87 * $room2_c) / 7) + (($fdv_adult87 * $room2 * $frday) / 7) + (($fdv_child87 * $room2_c * $frday) / 7);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dbl7']) / 7 + (($chv87 * $room2_c) / 14) + (($fdv_adult87 * $room2 * $frday) / 14) + (($fdv_child87 * $room2_c * $frday) / 14);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tpl7']) / 7 + (($chv87 * $room2_c) / 21) + (($fdv_adult87 * $room2 * $frday) / 21) + (($fdv_child87 * $room2_c * $frday) / 21);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['qua7']) / 7 + (($chv87 * $room2_c) / 28) + (($fdv_adult87 * $room2 * $frday) / 28) + (($fdv_child87 * $room2_c * $frday) / 28);
                    }
                }
                ...
                if ($numNoches['noches'] == 7 && $categor == 3 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sglm7']) / 7 + (($chm87 * $room2_c) / 7) + (($fdm_adult87 * $room2 * $frday) / 7) + (($fdm_child87 * $room2_c * $frday) / 7);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dblm7']) / 7 + (($chm87 * $room2_c) / 14) + (($fdm_adult87 * $room2 * $frday) / 14) + (($fdm_child87 * $room2_c * $frday) / 14);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tplm7']) / 7 + (($chm87 * $room2_c) / 21) + (($fdm_adult87 * $room2 * $frday) / 21) + (($fdm_child87 * $room2_c * $frday) / 21);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['quam7']) / 7 + (($chm87 * $room2_c) / 28) + (($fdm_adult87 * $room2 * $frday) / 28) + (($fdm_child87 * $room2_c * $frday) / 28);
                    }
                }
                ...
                if ($numNoches['noches'] == 8 && $categor == 2 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sgl8']) / 8 + (($chv98 * $room2_c) / 8) + (($fdv_adult98 * $room2 * $frday) / 8) + (($fdv_child98 * $room2_c * $frday) / 8);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dbl8']) / 8 + (($chv98 * $room2_c) / 16) + (($fdv_adult98 * $room2 * $frday) / 16) + (($fdv_child98 * $room2_c * $frday) / 16);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tpl8']) / 8 + (($chv98 * $room2_c) / 24) + (($fdv_adult98 * $room2 * $frday) / 24) + (($fdv_child98 * $room2_c * $frday) / 24);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['qua8']) / 8 + (($chv98 * $room2_c) / 32) + (($fdv_adult98 * $room2 * $frday) / 32) + (($fdv_child98 * $room2_c * $frday) / 32);
                    }
                }
                ...
                if ($numNoches['noches'] == 8 && $categor == 3 && $room2 > 0) {
                    ...
                    if ($room2 == 1) {
                        ...
                        $priceRoom2 += ($costohotel ['sglm8']) / 8 + (($chm98 * $room2_c) / 8) + (($fdm_adult98 * $room2 * $frday) / 8) + (($fdm_child98 * $room2_c * $frday) / 8);
                    }
                    if ($room2 == 2) {

                        $priceRoom2 += ($costohotel ['dblm8']) / 8 + (($chm98 * $room2_c) / 16) + (($fdm_adult98 * $room2 * $frday) / 16) + (($fdm_child98 * $room2_c * $frday) / 16);
                    }
                    if ($room2 == 3) {

                        $priceRoom2 += ($costohotel ['tplm8']) / 8 + (($chm98 * $room2_c) / 24) + (($fdm_adult98 * $room2 * $frday) / 24) + (($fdm_child98 * $room2_c * $frday) / 24);
                    }
                    if ($room2 == 4) {

                        $priceRoom2 += ($costohotel ['quam8']) / 8 + (($chm98 * $room2_c) / 32) + (($fdm_adult98 * $room2 * $frday) / 32) + (($fdm_child98 * $room2_c * $frday) / 32);
                    }
                }
            ...
            while ($fecha3->format("Y-m-d") < $fecha_fin->format("Y-m-d")) {
                ...
                if ($numNoches['noches'] == 1 && $categor == 2 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += $costohotel ['sgl'] + ($chv21 * $room3_c) + ($fdv_adult21 * $room3 * $frday) + ($fdv_child21 * $room3_c * $frday);
                        //echo $priceRoom3;
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += $costohotel ['dbl'] + (($chv21 * $room3_c) / 2) + (($fdv_adult21 * $room3 * $frday) / 2) + (($fdv_child21 * $room3_c * $frday) / 2);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += $costohotel ['tpl'] + (($chv21 * $room3_c) / 3) + (($fdv_adult21 * $room3 * $frday) / 3) + (($fdv_child21 * $room3_c * $frday) / 3);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += $costohotel ['qua'] + (($chv21 * $room3_c) / 4) + (($fdv_adult21 * $room3 * $frday) / 4) + (($fdv_child21 * $room3_c * $frday) / 4);
                    }
                }
                ...
                if ($numNoches['noches'] == 1 && $categor == 3 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += $costohotel ['sglm'] + ($chm21 * $room3_c) + ($fdm_adult21 * $room3 * $frday) + ($fdm_child21 * $room3_c * $frday);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += $costohotel ['dblm'] + (($chm21 * $room3_c) / 2) + (($fdm_adult21 * $room3 * $frday) / 2) + (($fdm_child21 * $room3_c * $frday) / 2);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += $costohotel ['tplm'] + (($chm21 * $room3_c) / 3) + (($fdm_adult21 * $room3 * $frday) / 3) + (($fdm_child21 * $room3_c * $frday) / 3);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += $costohotel ['quam'] + (($chm21 * $room3_c) / 4) + (($fdm_adult21 * $room3 * $frday) / 4) + (($fdm_child21 * $room3_c * $frday) / 4);
                    }
                }
                ...
                if ($numNoches['noches'] == 2 && $categor == 2 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sgl2']) / 2 + (($chv32 * $room3_c) / 2) + (($fdv_adult32 * $room3 * $frday) / 2) + (($fdv_child32 * $room3_c * $frday) / 2);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dbl2']) / 2 + (($chv32 * $room3_c) / 4) + (($fdv_adult32 * $room3 * $frday) / 4) + (($fdv_child32 * $room3_c * $frday) / 4);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tpl2']) / 2 + (($chv32 * $room3_c) / 6) + (($fdv_adult32 * $room3 * $frday) / 6) + (($fdv_child32 * $room3_c * $frday) / 6);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['qua2']) / 2 + (($chv32 * $room3_c) / 8) + (($fdv_adult32 * $room3 * $frday) / 8) + (($fdv_child32 * $room3_c * $frday) / 8);
                    }
                }
                ...
                if ($numNoches['noches'] == 2 && $categor == 3 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sglm2']) / 2 + (($chm32 * $room3_c) / 2) + (($fdm_adult32 * $room3 * $frday) / 2) + (($fdm_child32 * $room3_c * $frday) / 2);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dblm2']) / 2 + (($chm32 * $room3_c) / 4) + (($fdm_adult32 * $room3 * $frday) / 4) + (($fdm_child32 * $room3_c * $frday) / 4);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tplm2']) / 2 + (($chm32 * $room3_c) / 6) + (($fdm_adult32 * $room3 * $frday) / 6) + (($fdm_child32 * $room3_c * $frday) / 6);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['quam2']) / 2 + (($chm32 * $room3_c) / 8) + (($fdm_adult32 * $room3 * $frday) / 8) + (($fdm_child32 * $room3_c * $frday) / 8);
                    }
                }
                ...
                if ($numNoches['noches'] == 3 && $categor == 2 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sgl3']) / 3 + (($chv43 * $room3_c) / 3) + (($fdv_adult43 * $room3 * $frday) / 3) + (($fdv_child43 * $room3_c * $frday) / 3);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dbl3']) / 3 + (($chv43 * $room3_c) / 6) + (($fdv_adult43 * $room3 * $frday) / 6) + (($fdv_child43 * $room3_c * $frday) / 6);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tpl3']) / 3 + (($chv43 * $room3_c) / 9) + (($fdv_adult43 * $room3 * $frday) / 9) + (($fdv_child43 * $room3_c * $frday) / 9);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['qua3']) / 3 + (($chv43 * $room3_c) / 12) + (($fdv_adult43 * $room3 * $frday) / 12) + (($fdv_child43 * $room3_c * $frday) / 12);
                    }
                }
                ...
                if ($numNoches['noches'] == 3 && $categor == 3 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sglm3']) / 3 + (($chm43 * $room3_c) / 3) + (($fdm_adult43 * $room3 * $frday) / 3) + (($fdm_child43 * $room3_c * $frday) / 3);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dblm3']) / 3 + (($chm43 * $room3_c) / 6) + (($fdm_adult43 * $room3 * $frday) / 6) + (($fdm_child43 * $room3_c * $frday) / 6);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tplm3']) / 3 + (($chm43 * $room3_c) / 9) + (($fdm_adult43 * $room3 * $frday) / 9) + (($fdm_child43 * $room3_c * $frday) / 9);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['quam3']) / 3 + (($chm43 * $room3_c) / 12) + (($fdm_adult43 * $room3 * $frday) / 12) + (($fdm_child43 * $room3_c * $frday) / 12);
                    }
                }
                ...
                if ($numNoches['noches'] == 4 && $categor == 2 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sgl4']) / 4 + (($chv54 * $room3_c) / 4) + (($fdv_adult54 * $room3 * $frday) / 4) + (($fdv_child54 * $room3_c * $frday) / 4);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dbl4']) / 4 + (($chv54 * $room3_c) / 8) + (($fdv_adult54 * $room3 * $frday) / 8) + (($fdv_child54 * $room3_c * $frday) / 8);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tpl4']) / 4 + (($chv54 * $room3_c) / 12) + (($fdv_adult54 * $room3 * $frday) / 12) + (($fdv_child54 * $room3_c * $frday) / 12);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['qua4']) / 4 + (($chv54 * $room3_c) / 16) + (($fdv_adult54 * $room3 * $frday) / 16) + (($fdv_child54 * $room3_c * $frday) / 16);
                    }
                }
                ...
                if ($numNoches['noches'] == 4 && $categor == 3 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sglm4']) / 4 + (($chm54 * $room3_c) / 4) + (($fdm_adult54 * $room3 * $frday) / 4) + (($fdm_child54 * $room3_c * $frday) / 4);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dblm4']) / 4 + (($chm54 * $room3_c) / 8) + (($fdm_adult54 * $room3 * $frday) / 8) + (($fdm_child54 * $room3_c * $frday) / 8);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tplm4']) / 4 + (($chm54 * $room3_c) / 12) + (($fdm_adult54 * $room3 * $frday) / 12) + (($fdm_child54 * $room3_c * $frday) / 12);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['quam4']) / 4 + (($chm54 * $room3_c) / 16) + (($fdm_adult54 * $room3 * $frday) / 16) + (($fdm_child54 * $room3_c * $frday) / 16);
                    }
                }
                ...
                if ($numNoches['noches'] == 5 && $categor == 2 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sgl5']) / 5 + (($chv65 * $room3_c) / 5) + (($fdv_adult65 * $room3 * $frday) / 5) + (($fdv_child65 * $room3_c * $frday) / 5);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dbl5']) / 5 + (($chv65 * $room3_c) / 10) + (($fdv_adult65 * $room3 * $frday) / 10) + (($fdv_child65 * $room3_c * $frday) / 10);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tpl5']) / 5 + (($chv65 * $room3_c) / 15) + (($fdv_adult65 * $room3 * $frday) / 15) + (($fdv_child65 * $room3_c * $frday) / 15);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['qua5']) / 5 + (($chv65 * $room3_c) / 20) + (($fdv_adult65 * $room3 * $frday) / 20) + (($fdv_child65 * $room3_c * $frday) / 20);
                    }
                }
                ...
                if ($numNoches['noches'] == 5 && $categor == 3 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sglm5']) / 5 + (($chm65 * $room3_c) / 5) + (($fdm_adult65 * $room3 * $frday) / 5) + (($fdm_child65 * $room3_c * $frday) / 5);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dblm5']) / 5 + (($chm65 * $room3_c) / 10) + (($fdm_adult65 * $room3 * $frday) / 10) + (($fdm_child65 * $room3_c * $frday) / 10);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tplm5']) / 5 + (($chm65 * $room3_c) / 15) + (($fdm_adult65 * $room3 * $frday) / 15) + (($fdm_child65 * $room3_c * $frday) / 15);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['quam5']) / 5 + (($chm65 * $room3_c) / 20) + (($fdm_adult65 * $room3 * $frday) / 20) + (($fdm_child65 * $room3_c * $frday) / 20);
                    }
                }
                //TOUR 76 VALUE
                ...
                if ($numNoches['noches'] == 6 && $categor == 2 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sgl6']) / 6 + (($chv76 * $room3_c) / 6) + (($fdv_adult76 * $room3 * $frday) / 6) + (($fdv_child76 * $room3_c * $frday) / 6);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dbl6']) / 6 + (($chv76 * $room3_c) / 12) + (($fdv_adult76 * $room3 * $frday) / 12) + (($fdv_child76 * $room3_c * $frday) / 12);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tpl6']) / 6 + (($chv76 * $room3_c) / 18) + (($fdv_adult76 * $room3 * $frday) / 18) + (($fdv_child76 * $room3_c * $frday) / 18);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['qua6']) / 6 + (($chv76 * $room3_c) / 24) + (($fdv_adult76 * $room3 * $frday) / 24) + (($fdv_child76 * $room3_c * $frday) / 24);
                    }
                }
                ...
                if ($numNoches['noches'] == 6 && $categor == 3 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sglm6']) / 6 + (($chm76 * $room3_c) / 6) + (($fdm_adult76 * $room3 * $frday) / 6) + (($fdm_child76 * $room3_c * $frday) / 6);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dblm6']) / 6 + (($chm76 * $room3_c) / 12) + (($fdm_adult76 * $room3 * $frday) / 12) + (($fdm_child76 * $room3_c * $frday) / 12);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tplm6']) / 6 + (($chm76 * $room3_c) / 18) + (($fdm_adult76 * $room3 * $frday) / 18) + (($fdm_child76 * $room3_c * $frday) / 18);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['quam6']) / 6 + (($chm76 * $room3_c) / 24) + (($fdm_adult76 * $room3 * $frday) / 24) + (($fdm_child76 * $room3_c * $frday) / 24);
                    }
                }
                //TOUR 87 VALUE
                ...
                if ($numNoches['noches'] == 7 && $categor == 2 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sgl7']) / 7 + (($chv87 * $room3_c) / 7) + (($fdv_adult87 * $room3 * $frday) / 7) + (($fdv_child87 * $room3_c * $frday) / 7);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dbl7']) / 7 + (($chv87 * $room3_c) / 14) + (($fdv_adult87 * $room3 * $frday) / 14) + (($fdv_child87 * $room3_c * $frday) / 14);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tpl7']) / 7 + (($chv87 * $room3_c) / 21) + (($fdv_adult87 * $room3 * $frday) / 21) + (($fdv_child87 * $room3_c * $frday) / 21);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['qua7']) / 7 + (($chv87 * $room3_c) / 28) + (($fdv_adult87 * $room3 * $frday) / 28) + (($fdv_child87 * $room3_c * $frday) / 28);
                    }
                }
                ...
                if ($numNoches['noches'] == 7 && $categor == 3 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sglm7']) / 7 + (($chm87 * $room3_c) / 7) + (($fdm_adult87 * $room3 * $frday) / 7) + (($fdm_child87 * $room3_c * $frday) / 7);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dblm7']) / 7 + (($chm87 * $room3_c) / 14) + (($fdm_adult87 * $room3 * $frday) / 14) + (($fdm_child87 * $room3_c * $frday) / 14);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tplm7']) / 7 + (($chm87 * $room3_c) / 21) + (($fdm_adult87 * $room3 * $frday) / 21) + (($fdm_child87 * $room3_c * $frday) / 21);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['quam7']) / 7 + (($chm87 * $room3_c) / 28) + (($fdm_adult87 * $room3 * $frday) / 28) + (($fdm_child87 * $room3_c * $frday) / 28);
                    }
                }
                ...
                if ($numNoches['noches'] == 8 && $categor == 2 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sgl8']) / 8 + (($chv98 * $room3_c) / 8) + (($fdv_adult98 * $room3 * $frday) / 8) + (($fdv_child98 * $room3_c * $frday) / 8);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dbl8']) / 8 + (($chv98 * $room3_c) / 16) + (($fdv_adult98 * $room3 * $frday) / 16) + (($fdv_child98 * $room3_c * $frday) / 16);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tpl8']) / 8 + (($chv98 * $room3_c) / 24) + (($fdv_adult98 * $room3 * $frday) / 24) + (($fdv_child98 * $room3_c * $frday) / 24);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['qua8']) / 8 + (($chv98 * $room3_c) / 32) + (($fdv_adult98 * $room3 * $frday) / 32) + (($fdv_child98 * $room3_c * $frday) / 32);
                    }
                }
                //TOUR 98 MODERATE
                ...
                if ($numNoches['noches'] == 8 && $categor == 3 && $room3 > 0) {
                    ...
                    if ($room3 == 1) {
                        ...
                        $priceRoom3 += ($costohotel ['sglm8']) / 8 + (($chm98 * $room3_c) / 8) + (($fdm_adult98 * $room3 * $frday) / 8) + (($fdm_child98 * $room3_c * $frday) / 8);
                    }
                    if ($room3 == 2) {

                        $priceRoom3 += ($costohotel ['dblm8']) / 8 + (($chm98 * $room3_c) / 16) + (($fdm_adult98 * $room3 * $frday) / 16) + (($fdm_child98 * $room3_c * $frday) / 16);
                    }
                    if ($room3 == 3) {

                        $priceRoom3 += ($costohotel ['tplm8']) / 8 + (($chm98 * $room3_c) / 24) + (($fdm_adult98 * $room3 * $frday) / 24) + (($fdm_child98 * $room3_c * $frday) / 24);
                    }
                    if ($room3 == 4) {

                        $priceRoom3 += ($costohotel ['quam8']) / 8 + (($chm98 * $room3_c) / 32) + (($fdm_adult98 * $room3 * $frday) / 32) + (($fdm_child98 * $room3_c * $frday) / 32);
                    }
                }
            ...
            while ($fecha4->format("Y-m-d") < $fecha_fin->format("Y-m-d")) {
                ...
                if ($numNoches['noches'] == 1 && $categor == 2 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += $costohotel ['sgl'] + ($chv21 * $room4_c) + ($fdv_adult21 * $room4 * $frday) + ($fdv_child21 * $room4_c * $frday);
                        //echo $priceRoom4;
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += $costohotel ['dbl'] + (($chv21 * $room4_c) / 2) + (($fdv_adult21 * $room4 * $frday) / 2) + (($fdv_child21 * $room4_c * $frday) / 2);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += $costohotel ['tpl'] + (($chv21 * $room4_c) / 3) + (($fdv_adult21 * $room4 * $frday) / 3) + (($fdv_child21 * $room4_c * $frday) / 3);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += $costohotel ['qua'] + (($chv21 * $room4_c) / 4) + (($fdv_adult21 * $room4 * $frday) / 4) + (($fdv_child21 * $room4_c * $frday) / 4);
                    }
                }
                ...
                if ($numNoches['noches'] == 1 && $categor == 3 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += $costohotel ['sglm'] + ($chm21 * $room4_c) + ($fdm_adult21 * $room4 * $frday) + ($fdm_child21 * $room4_c * $frday);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += $costohotel ['dblm'] + (($chm21 * $room4_c) / 2) + (($fdm_adult21 * $room4 * $frday) / 2) + (($fdm_child21 * $room4_c * $frday) / 2);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += $costohotel ['tplm'] + (($chm21 * $room4_c) / 3) + (($fdm_adult21 * $room4 * $frday) / 3) + (($fdm_child21 * $room4_c * $frday) / 3);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += $costohotel ['quam'] + (($chm21 * $room4_c) / 4) + (($fdm_adult21 * $room4 * $frday) / 4) + (($fdm_child21 * $room4_c * $frday) / 4);
                    }
                }
                ...
                if ($numNoches['noches'] == 2 && $categor == 2 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sgl2']) / 2 + (($chv32 * $room4_c) / 2) + (($fdv_adult32 * $room4 * $frday) / 2) + (($fdv_child32 * $room4_c * $frday) / 2);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dbl2']) / 2 + (($chv32 * $room4_c) / 4) + (($fdv_adult32 * $room4 * $frday) / 4) + (($fdv_child32 * $room4_c * $frday) / 4);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tpl2']) / 2 + (($chv32 * $room4_c) / 6) + (($fdv_adult32 * $room4 * $frday) / 6) + (($fdv_child32 * $room4_c * $frday) / 6);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['qua2']) / 2 + (($chv32 * $room4_c) / 8) + (($fdv_adult32 * $room4 * $frday) / 8) + (($fdv_child32 * $room4_c * $frday) / 8);
                    }
                }
                ...
                if ($numNoches['noches'] == 2 && $categor == 3 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sglm2']) / 2 + (($chm32 * $room4_c) / 2) + (($fdm_adult32 * $room4 * $frday) / 2) + (($fdm_child32 * $room4_c * $frday) / 2);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dblm2']) / 2 + (($chm32 * $room4_c) / 4) + (($fdm_adult32 * $room4 * $frday) / 4) + (($fdm_child32 * $room4_c * $frday) / 4);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tplm2']) / 2 + (($chm32 * $room4_c) / 6) + (($fdm_adult32 * $room4 * $frday) / 6) + (($fdm_child32 * $room4_c * $frday) / 6);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['quam2']) / 2 + (($chm32 * $room4_c) / 8) + (($fdm_adult32 * $room4 * $frday) / 8) + (($fdm_child32 * $room4_c * $frday) / 8);
                    }
                }
                ...
                if ($numNoches['noches'] == 3 && $categor == 2 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sgl3']) / 3 + (($chv43 * $room4_c) / 3) + (($fdv_adult43 * $room4 * $frday) / 3) + (($fdv_child43 * $room4_c * $frday) / 3);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dbl3']) / 3 + (($chv43 * $room4_c) / 6) + (($fdv_adult43 * $room4 * $frday) / 6) + (($fdv_child43 * $room4_c * $frday) / 6);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tpl3']) / 3 + (($chv43 * $room4_c) / 9) + (($fdv_adult43 * $room4 * $frday) / 9) + (($fdv_child43 * $room4_c * $frday) / 9);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['qua3']) / 3 + (($chv43 * $room4_c) / 12) + (($fdv_adult43 * $room4 * $frday) / 12) + (($fdv_child43 * $room4_c * $frday) / 12);
                    }
                }
                ...
                if ($numNoches['noches'] == 3 && $categor == 3 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sglm3']) / 3 + (($chm43 * $room4_c) / 3) + (($fdm_adult43 * $room4 * $frday) / 3) + (($fdm_child43 * $room4_c * $frday) / 3);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dblm3']) / 3 + (($chm43 * $room4_c) / 6) + (($fdm_adult43 * $room4 * $frday) / 6) + (($fdm_child43 * $room4_c * $frday) / 6);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tplm3']) / 3 + (($chm43 * $room4_c) / 9) + (($fdm_adult43 * $room4 * $frday) / 9) + (($fdm_child43 * $room4_c * $frday) / 9);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['quam3']) / 3 + (($chm43 * $room4_c) / 12) + (($fdm_adult43 * $room4 * $frday) / 12) + (($fdm_child43 * $room4_c * $frday) / 12);
                    }
                }
                ...
                if ($numNoches['noches'] == 4 && $categor == 2 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sgl4']) / 4 + (($chv54 * $room4_c) / 4) + (($fdv_adult54 * $room4 * $frday) / 4) + (($fdv_child54 * $room4_c * $frday) / 4);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dbl4']) / 4 + (($chv54 * $room4_c) / 8) + (($fdv_adult54 * $room4 * $frday) / 8) + (($fdv_child54 * $room4_c * $frday) / 8);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tpl4']) / 4 + (($chv54 * $room4_c) / 12) + (($fdv_adult54 * $room4 * $frday) / 12) + (($fdv_child54 * $room4_c * $frday) / 12);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['qua4']) / 4 + (($chv54 * $room4_c) / 16) + (($fdv_adult54 * $room4 * $frday) / 16) + (($fdv_child54 * $room4_c * $frday) / 16);
                    }
                }
                ...
                if ($numNoches['noches'] == 4 && $categor == 3 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sglm4']) / 4 + (($chm54 * $room4_c) / 4) + (($fdm_adult54 * $room4 * $frday) / 4) + (($fdm_child54 * $room4_c * $frday) / 4);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dblm4']) / 4 + (($chm54 * $room4_c) / 8) + (($fdm_adult54 * $room4 * $frday) / 8) + (($fdm_child54 * $room4_c * $frday) / 8);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tplm4']) / 4 + (($chm54 * $room4_c) / 12) + (($fdm_adult54 * $room4 * $frday) / 12) + (($fdm_child54 * $room4_c * $frday) / 12);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['quam4']) / 4 + (($chm54 * $room4_c) / 16) + (($fdm_adult54 * $room4 * $frday) / 16) + (($fdm_child54 * $room4_c * $frday) / 16);
                    }
                }
                ...
                if ($numNoches['noches'] == 5 && $categor == 2 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sgl5']) / 5 + (($chv65 * $room4_c) / 5) + (($fdv_adult65 * $room4 * $frday) / 5) + (($fdv_child65 * $room4_c * $frday) / 5);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dbl5']) / 5 + (($chv65 * $room4_c) / 10) + (($fdv_adult65 * $room4 * $frday) / 10) + (($fdv_child65 * $room4_c * $frday) / 10);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tpl5']) / 5 + (($chv65 * $room4_c) / 15) + (($fdv_adult65 * $room4 * $frday) / 15) + (($fdv_child65 * $room4_c * $frday) / 15);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['qua5']) / 5 + (($chv65 * $room4_c) / 20) + (($fdv_adult65 * $room4 * $frday) / 20) + (($fdv_child65 * $room4_c * $frday) / 20);
                    }
                }
                ...
                if ($numNoches['noches'] == 5 && $categor == 3 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sglm5']) / 5 + (($chm65 * $room4_c) / 5) + (($fdm_adult65 * $room4 * $frday) / 5) + (($fdm_child65 * $room4_c * $frday) / 5);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dblm5']) / 5 + (($chm65 * $room4_c) / 10) + (($fdm_adult65 * $room4 * $frday) / 10) + (($fdm_child65 * $room4_c * $frday) / 10);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tplm5']) / 5 + (($chm65 * $room4_c) / 15) + (($fdm_adult65 * $room4 * $frday) / 15) + (($fdm_child65 * $room4_c * $frday) / 15);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['quam5']) / 5 + (($chm65 * $room4_c) / 20) + (($fdm_adult65 * $room4 * $frday) / 20) + (($fdm_child65 * $room4_c * $frday) / 20);
                    }
                }
                ...
                if ($numNoches['noches'] == 6 && $categor == 2 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sgl6']) / 6 + (($chv76 * $room4_c) / 6) + (($fdv_adult76 * $room4 * $frday) / 6) + (($fdv_child76 * $room4_c * $frday) / 6);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dbl6']) / 6 + (($chv76 * $room4_c) / 12) + (($fdv_adult76 * $room4 * $frday) / 12) + (($fdv_child76 * $room4_c * $frday) / 12);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tpl6']) / 6 + (($chv76 * $room4_c) / 18) + (($fdv_adult76 * $room4 * $frday) / 18) + (($fdv_child76 * $room4_c * $frday) / 18);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['qua6']) / 6 + (($chv76 * $room4_c) / 24) + (($fdv_adult76 * $room4 * $frday) / 24) + (($fdv_child76 * $room4_c * $frday) / 24);
                    }
                }
                ...
                if ($numNoches['noches'] == 6 && $categor == 3 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sglm6']) / 6 + (($chm76 * $room4_c) / 6) + (($fdm_adult76 * $room4 * $frday) / 6) + (($fdm_child76 * $room4_c * $frday) / 6);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dblm6']) / 6 + (($chm76 * $room4_c) / 12) + (($fdm_adult76 * $room4 * $frday) / 12) + (($fdm_child76 * $room4_c * $frday) / 12);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tplm6']) / 6 + (($chm76 * $room4_c) / 18) + (($fdm_adult76 * $room4 * $frday) / 18) + (($fdm_child76 * $room4_c * $frday) / 18);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['quam6']) / 6 + (($chm76 * $room4_c) / 24) + (($fdm_adult76 * $room4 * $frday) / 24) + (($fdm_child76 * $room4_c * $frday) / 24);
                    }
                }
                ...
                if ($numNoches['noches'] == 7 && $categor == 2 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sgl7']) / 7 + (($chv87 * $room4_c) / 7) + (($fdv_adult87 * $room4 * $frday) / 7) + (($fdv_child87 * $room4_c * $frday) / 7);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dbl7']) / 7 + (($chv87 * $room4_c) / 14) + (($fdv_adult87 * $room4 * $frday) / 14) + (($fdv_child87 * $room4_c * $frday) / 14);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tpl7']) / 7 + (($chv87 * $room4_c) / 21) + (($fdv_adult87 * $room4 * $frday) / 21) + (($fdv_child87 * $room4_c * $frday) / 21);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['qua7']) / 7 + (($chv87 * $room4_c) / 28) + (($fdv_adult87 * $room4 * $frday) / 28) + (($fdv_child87 * $room4_c * $frday) / 28);
                    }
                }
                ...
                if ($numNoches['noches'] == 7 && $categor == 3 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sglm7']) / 7 + (($chm87 * $room4_c) / 7) + (($fdm_adult87 * $room4 * $frday) / 7) + (($fdm_child87 * $room4_c * $frday) / 7);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dblm7']) / 7 + (($chm87 * $room4_c) / 14) + (($fdm_adult87 * $room4 * $frday) / 14) + (($fdm_child87 * $room4_c * $frday) / 14);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tplm7']) / 7 + (($chm87 * $room4_c) / 21) + (($fdm_adult87 * $room4 * $frday) / 21) + (($fdm_child87 * $room4_c * $frday) / 21);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['quam7']) / 7 + (($chm87 * $room4_c) / 28) + (($fdm_adult87 * $room4 * $frday) / 28) + (($fdm_child87 * $room4_c * $frday) / 28);
                    }
                }
                ...
                if ($numNoches['noches'] == 8 && $categor == 2 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sgl8']) / 8 + (($chv98 * $room4_c) / 8) + (($fdv_adult98 * $room4 * $frday) / 8) + (($fdv_child98 * $room4_c * $frday) / 8);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dbl8']) / 8 + (($chv98 * $room4_c) / 16) + (($fdv_adult98 * $room4 * $frday) / 16) + (($fdv_child98 * $room4_c * $frday) / 16);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tpl8']) / 8 + (($chv98 * $room4_c) / 24) + (($fdv_adult98 * $room4 * $frday) / 24) + (($fdv_child98 * $room4_c * $frday) / 24);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['qua8']) / 8 + (($chv98 * $room4_c) / 32) + (($fdv_adult98 * $room4 * $frday) / 32) + (($fdv_child98 * $room4_c * $frday) / 32);
                    }
                }
                ...
                if ($numNoches['noches'] == 8 && $categor == 3 && $room4 > 0) {
                    ...
                    if ($room4 == 1) {
                        ...
                        $priceRoom4 += ($costohotel ['sglm8']) / 8 + (($chm98 * $room4_c) / 8) + (($fdm_adult98 * $room4 * $frday) / 8) + (($fdm_child98 * $room4_c * $frday) / 8);
                    }
                    if ($room4 == 2) {

                        $priceRoom4 += ($costohotel ['dblm8']) / 8 + (($chm98 * $room4_c) / 16) + (($fdm_adult98 * $room4 * $frday) / 16) + (($fdm_child98 * $room4_c * $frday) / 16);
                    }
                    if ($room4 == 3) {

                        $priceRoom4 += ($costohotel ['tplm8']) / 8 + (($chm98 * $room4_c) / 24) + (($fdm_adult98 * $room4 * $frday) / 24) + (($fdm_child98 * $room4_c * $frday) / 24);
                    }
                    if ($room4 == 4) {

                        $priceRoom4 += ($costohotel ['quam8']) / 8 + (($chm98 * $room4_c) / 32) + (($fdm_adult98 * $room4 * $frday) / 32) + (($fdm_child98 * $room4_c * $frday) / 32);
                    }
                }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public function ticketPark($dat, $adult, $child, $fecha_retorno) {
        ...
        $fecha_retorno2 = $this->params["fecha_retorno"];
        ...
        foreach ($atraccion as $id_grupo => $grupo) {
            ...
            foreach ($grupo as $id_park => $park) {
                if ($dat->id != -1) {
                    $rs = Doo::db()->query($sql0, array($dat->id, trim($id_grupo), trim($cantidad), $fecha_ini, $fecha_fin));
                    $consulta = $rs->fetch();

                    if (empty($consulta) || $consulta ['id_parque'] != 0) {
                        $rs = Doo::db()->query($sql, array(trim($id_grupo), trim($cantidad), $fecha_ini, $fecha_fin));
                        $consulta = $rs->fetch();
                    }
                } else {
                    $rs = Doo::db()->query($sql, array(trim($id_grupo), trim($cantidad), $fecha_ini, $fecha_fin));
                ...
                if (!empty($consulta) && $consulta ['id_parque'] == 0) {
                    ...
                    $sql2 = 'SELECT  adults,child,id_parque,cantidad,fecha_fin
								FROM admin_parques_tarifa
                    ...
                    if ($dat->id != -1) {
                        ...
                        if (empty($consulta2)) {
                            $rs = Doo::db()->query($sql2, array(trim($park['id_park']), $fecha_ini, $fecha_fin));
                            $consulta2 = $rs->fetch();
                        }
                    } else {
                        $rs = Doo::db()->query($sql2, array(trim($park['id_park']), $fecha_ini, $fecha_fin));
                    ...
                    $sql2 = 'SELECT  adults,child,id_parque,cantidad, fecha_fin
								FROM admin_parques_tarifa
								WHERE type_rate = 1 AND id_agency =-1 AND  id_parque = ? AND cantidad = 1 AND fecha_ini <= '.$fecha_ini.' AND fecha_fin >= '.$fecha_fin.'';
                    $sql02 = 'SELECT  adults,child,id_parque,cantidad
								FROM admin_parques_tarifa
                    						WHERE type_rate = 2 AND id_agency = ? AND  id_parque = ? AND cantidad = 1 AND fecha_ini <= '.$fecha_ini.' AND fecha_fin >= '.$fecha_fin.'';
...
//de kissimmee a las demas areas


Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t3='$f2t3_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '3'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t4='$f2t4_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '4'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t5='$f2t5_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '5'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t6='$f2t6_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '6'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t7='$f2t7_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '7'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t8='$f2t8_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '8'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t9='$f2t9_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '9'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t10='$f2t10_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '10'");
//                Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t19='$f2t19_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '19'");
//                Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t11='$f2t11_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '11'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t12='$f2t11_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '12'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t13='$f2t13_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '13'");
Doo::db()->query("UPDATE routes SET vehicles='$vehicles_17', capacity='$capacity_17', seats_remain='$seats_remain_17', spprc_adult='$spprc_adult_17', spprc_child ='$spprc_child_17', sdprc_adult='$sdprc_adult_17', sdprc_child = '$sdprc_child_17', wfprc_adult = '$wfprc_adult_17', wfprc_child = '$wfprc_child_17', stprc_adult = '$stprc_adult_17', stprc_child = '$stprc_child_17', sflexprc_adult = '$sflexprc_adult_17', sflexprc_child = '$sflexprc_child_17', flresprc_adult = '$flresprc_adult_17', flresprc_child = '$flresprc_child_17', spseats = '$spseats_17', sdseats ='$sdseats_17', wfseats='$wfseats_17', stseats='$stseats_17', sflexseats='$sflexseats_17', spprcseats='$spprcseats_17', toursseats='$toursseats_17', univext='$univext_17', wdext='$wdext_17', f2t14='$f2t14_17' WHERE fecha_ini ='$fecha_iniforma17' AND trip_no = '$trip_nro' AND type_rate = '0' AND trip_from = '2' AND trip_to = '14'");
