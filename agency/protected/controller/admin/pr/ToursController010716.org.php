...
//Primera letra en Mayuscula
        ...
        $table = "<table  align='center' style='text-align: center;width: 300%;border: transparent;'>";    
            $table .="<tr>
          ...
          //*************************************************************************************************************  
            ...
            $adm_child1   = (($key3['ADM_CHILD'])/$child);
            ...
            $rprecioA = ($adm_adult+$prom_hotel)*$adult;
           ...
           // $rprecioA1 = number_format($rprecioA, 2, '.', '');
            ...
            $rprecioC = ($adm_child+$prom_hotel)*$child;
            ...
            $totalApagar5 = (($rprecioA1)+($rprecioC1))*0.04;
            ...
            $paquete_adultos = ($adm_adult + $prom_hotel);
            
            if ($child > 0){
            $paquete_ninos = ($adm_child + $prom_hotel);
            }else{
            $paquete_ninos = '0.00';
            }
            
            $totalApagar_1 =  ($rprecioA1+$transp_adult) + ($rprecioC1+$transp_child) + $totalApagar1;
...
//            }
        ...
        <div id="contenido">
            <p style="font-size: 27px;  margin-left: 45%; margin-top: -5%;">
                E-Ticket
            </p>
           ...
           <style type="text/css"> 
            ...
            <div id="caja-contenido" style="margin-left: 52%; margin-top: -41%;">
                <table border="0" width ="270"  bgcolor= "#D9E5F5" cellpadding="1" cellspacing="1" id="tabla" style="margin-left 15%;border: 1px solid #000;">                 
        ...
        if ($id == 0) {
            ...
            echo '
					  ...
					  <tr>
					   ...
					   <tr>
						<td width="77" height="7">&nbsp;</td>
						<td width="211"><div align="left">Remember the Hotel Check Out is at 11:00 am</div></td>
						<td>
                                                <label>
						 <!-- <input  autocomplete="off" name="hora2" type="text" id="hora2" size="6" class="required"/>-->
						</label>
                                                </td>
					  </tr>
        ...
        foreach ($atraccion as $id_grupo => $grupo) {
            ...
            foreach ($grupo as $id_park => $park) {
                ...
                if (!empty($consulta) && $consulta ['id_parque'] == 0) {
                    ...
                    $sql02 = 'SELECT  adults,child,id_parque,cantidad
								FROM admin_parques_tarifa
								WHERE type_rate = 2 AND id_agency = ? AND  id_parque = ? AND cantidad = 1  AND fecha_ini <= ?  AND fecha_ini >= ?';
                    if ($dat->id != -1) {
                        $rs = Doo::db()->query($sql02, array(
                            $dat->id,
                            trim($park['id_park']), $fecha_ini, $fecha_fin
