...
//						</script>";
    ...
    public function trips() {
        if (isset($this->params["from"]) && isset($this->params["to"]) && isset($this->params["fecha"])) {
            ...
            $sql = "select
                              t1.trip_no, t2.id, t1.fecha, t4.nombre as trip_from, t5.nombre as trip_to, t2.stprc_adult, t2.stprc_child,  t2.flresprc_child, t2.flresprc_adult, t2.sflexprc_adult, t2.sflexprc_child, t2.trip_departure, t2.trip_arrival, t3.equipment, t1.estado 
            ...
            echo '   <table class="table table-bordered table-striped" id="tbl1">
             <thead>
                 <tr>
                     ...
                     <th>' . ($resident == '1' ? 'Florida Resident ' : 'Standar Price ') . '</th>
                     
                     <th >' . ($resident == '1' ? 'Super Flex Resident ' : 'Super Flex') . '</th>
...
//                    if (!($fecha == date('Y-m-d') && date("H:i", strtotime($e['trip_departure'])) < date('H:i'))) {
                    echo '<tr class="row' . $i . '">
						...
						<td style="width: 90px;text-align: center;"> <font>' . ($resident == '1' ? $e['flresprc_adult'] : $e['stprc_adult'] ) . '</font><input type="radio" name="price"  value="" /> <font>' . ($resident == '1' ? $e['flresprc_child'] : $e['stprc_child'] ) . '</font></td>                                                
						
                                                <td style="width: 90px;text-align: center;"></font>' . ($resident == '1' ? $e['sflexprc_adult'] : $e['stprc_adult'] ) . '</font> <input type="radio" name="price1"  value="" /> <font>' . ($resident == '1' ? $e['sflexprc_child'] : $e['stprc_child'] ) . '</font></td>
