...
//            foreach ($salida as $clave => $key) {
//
//            }
//
//            $standard_adult = $key['stprc_adult'];
//            //echo $standard_adult;
//            if ($standard_adult > 0){
//            //echo '04:00:00 horas';
//             
//                $fecha_sal = (strtotime("$fecha"));
//                
//            }
//            else{
//                 $fecha_sal = (strtotime("$fecha -1 hour"));
//                 
//                 $sql = "select
//                              t1.trip_no, t2.id, t1.fecha, t4.nombre as trip_from, t5.nombre as trip_to,
//                              t2.stprc_adult, t2.stprc_child,  t2.flresprc_child, t2.flresprc_adult, t2.sflexprc_adult, t2.sflexprc_child,
...
//           $_POST["fecini"] = 2015-04-10;
//           
//           list($mes,$dia,$anyo) = explode("-",$_POST["fecini"]);
           //echo $fecha;
...
//                             from hotel_reserves
//                             
//                         where creation_date = '$fc' and id_cliente='105'";
//
//            $rsx = Doo::db()->query($sqlr);
//            $dr = $rsx->fetchAll(); // Salidas     
//           print_r($dr);
//           exit();
    ////////////////////////////////////////////////////////////////////////////////////////////////////////       
//            else{
...
//            }
            ...
            if ($dat->type_rate == 2) { // Salidas Especial Net
                $sqlNet = "select
                              t1.trip_no, t2.id, t1.fecha, t4.nombre as trip_from, t5.nombre as trip_to, 
                              t2.price, t2.price2, t2.price3,  t2.price4, t2.trip_departure, t2.trip_arrival, t3.equipment, t1.estado 
                             from programacion t1
            ...
            echo '   <table class="table table-bordered table-striped" id="tbl1">
             ...
             <thead>
                 <tr>
                     ...
                     <th style="width: 100px;" colspan="2">' . ($resident == '1' ? '&nbsp;FLA. Resident<br/>Adult&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="price1"  value="1" required/>&nbsp;&nbsp;&nbsp;&nbsp;Child' : '&nbsp;Standard Price<br/>Adult&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="price1"  value="1" id="standar" required/>&nbsp;&nbsp;&nbsp;&nbsp;Child ') . '</th>                     
                     <th style="width: 150px;" colspan="2">' . ($resident == '1' ? '&nbsp;Super Flex Resident<br/>Adult&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="price1"  value="2" required/>&nbsp;&nbsp;&nbsp;&nbsp;Child' : '&nbsp;Super Flex Price<br/>Adult&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="price1" id="super" value="2" required/>&nbsp;&nbsp;&nbsp;&nbsp;Child ') . '</th>
...
//                    }
            ...
            echo '  <p align="right">
         <button  class="selector" id="btn-continue" disabled="true"  >Select</button> <button  class="selector" id="btn-cancelar" >cancel</button>
       </p>
		...
		function enviar() {
                    ...
                    if(total_groups == checked) {
                        document.form1.btn-continue.disabled = false;
                        document.form1.btn-cancelar.disabled = false;
                }
}
