...
//                
            ...
            try {
                ...
                if ($borrado) {
                    ...
                    //Doo::db()->query("UPDATE comifijas SET sgl='$sqlt1',dbl='$dblt1',tpl='$tplt1',qua='$quat1' WHERE id_hotel='27' AND fecha_ini='$ratesroom->fecha_ini' AND fecha_fin='$ratesroom->fecha_fin' AND comtax='1'");
