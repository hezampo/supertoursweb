...
//            if (Doo::db()->update($tarifaonetour)) {
    ...
    public function add_oneday_tour() {
        ...
        $_SESSION['codconfone'] = $this->code_generation();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function save_oneday() {
        ...
        if (isset($_SESSION['codconfone']) || isset($_SESSION['tours_pago'])) {
//            unset($_SESSION['codconfone']);
        ...
        $codeconfone = $_SESSION['codconfone'];        
...
//                VALUES ('','$proximo_registro','ONE','08:00:00','Supertours Terminal','Supertours Terminal','00000','$date1','$idCliente','18:00:00','','','PARK','','','','ONE DAY TOUR','','');");
//
...
//                 echo 'PHONE';
            ...
            $reserve->codconf = $codeconfone;
            //$_SESSION['codconfone'];//$cod_conf;
...
//            exit;
            ...
            $tour->code_conf = $cod_conf;//$reserve->codconf;
...
//        $incluir_parke = $_POST['cambiar_tikete']; 
//              
//        
//        
//        if($incluir_parke == 0){            
...
//        //echo $grupo_parque;
        ...
        try {
            ...
            extract($_POST, EXTR_SKIP);
            //$tour->code_conf = $cod_conf;//$code_conf;
...
//            exit();
            ...
            //Doo::db()->query("UPDATE tours_oneday SET  id_park = '$incluir_parke'  WHERE code_conf = '$cod_conf'");
...
//            $salto = '<br>';
            ...
            //$tour->comments2 = ("New Note: " . $comments . " " . $fechaone . ";\n" . $notes2);
            //$tour->comments2 = ("New Note: " . $comments . " " . $fechaone . ";\n$operador." . "\n" . $notes2);
...
//            }
            ...
            if ($actual_diff > 0) {
                ...
                if ($opcion_pago == 2) {
                    $_SESSION['codconfone'] = $tour->code_conf;
                    if (isset($cardholder)) {
                        if ($zip != "" && $country != "" && $state != "" && $address != "" && $city != "") {
                            $cliente->zip = $zip;
                            $cliente->country = $country;
...
//                    return Doo::conf()->APP_URL . "admin/onedaytour";
                ...
                if ($opcion_pago == 1) {
                    ...
                    $this->data['rootUrl'] = Doo::conf()->APP_URL;
                    $this->data['apagar'] = abs($actual_diff);
                    echo $_SESSION['codconfone'] . ' -> ' . $_SESSION['tours_pago'];
//                    $this->view()->renderc('admin/configuracion/pago_onedaytour', $this->data);
//                    return Doo::conf()->APP_URL . "admin/onedaytour";
                }
...
//$archivo="resumen.pdf";
    ...
    public function approval_payment() {
        ...
        if (isset($_GET['ssl_approval_code']) && isset($_SESSION['codconfone'])) {
            //pago realizado.
//                        echo $_SESSION['codconfone'].' -> '.$_SESSION['tours_pago'];
            Doo::loadModel('Tour_oneday');
            $tour = new Tour_oneday();
            $tour->code_conf = $_SESSION['codconfone'];
            $tour = Doo::db()->getOne($tour);
            $idtour = $tour->id;
    ...
    public function code_generation() {
        do {
            ...
            $a = $this->db()->find('Tour_oneday', array('where' => 'code_conf = ?',
                'limit' => 1,
                'select' => 'code_conf',
                'param' => array($_SESSION['codconfone'])
                    )
            );
        } while ($a != null);
        return $codigo;
