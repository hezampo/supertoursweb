...
;(function($){
			...
			$elt.click(function(e){
				...
				initLoading(function(){
					...
					$innerbox.height( curSettings.boxHeight+"px" );
				        ...
				        /*	$.ajax({
								  url: 'http://localhost/supertoursface2/consul/trips',
	...
	function createElements(){
		if (!$.superbox.elementsReady){
			...
			// Box
			$superbox = $('<div id="superbox" style="width:470px; height:235px;"></div>').appendTo($container);
			
			// Inner box superbox-innerbox
			...
			// "Loading..."
			$loading = $('<p class="loading">'+ settings.loadTxt +'</p>').appendTo($container);
